# [MESMER XML GUI (MXG)](https://github.com/agdturner/mxg)
...
MXG can be used via GitHub Pages and can be installed onto devices as a Progressive Web Application (PWA) that can be used offline. Version 0.15.1 is served from GitHub Pages from where the respective PWA can be installed:
...
## Development Plans
- Version 1.0
  - There is no fixed timeline for completing testing and releasing Version 1.0. Version 0.15.1 is the latest beta test version.
