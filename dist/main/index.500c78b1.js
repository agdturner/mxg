 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    ...
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    $7e68913db756e51f$var$loadCalcMethod(control, xml, button);
        ...
        if (!control.index.has((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName)) {
            ...
            select.addEventListener("change", (event)=>{
                ...
                control.setCalcMethod(new (0, $b6873406fb778c0b$export$271191b096a55e63)(new Map()));
                    ...
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_FittingIterations_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                            cm.setFittingIterations(new (0, $b6873406fb778c0b$export$830a50cd13af6e84)(new Map(), parseFloat(target.value)));
                    ...
                    control.setCalcMethod(cm);
                    // MarquardtIterations.
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_MarquardtIterations_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // MarquardtTolerance.
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_MarquardtTolerance_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // MarquardtDerivDelta.
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_MarquardtDerivDelta_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    control.setCalcMethod(cm);
                    // "me:format".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idcm + "_Format_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                    ...
                    // "me:precision".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idcm + "_Precision_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                    ...
                    // "me:chebNumTemp".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebNumTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebNumConc".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebNumConc_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebMaxTemp".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebMaxTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebMinTemp".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebMinTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebMaxConc".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebMaxConc_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebMinConc".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebMinConc_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebTExSize".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebTExSize_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:chebPExSize".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_ChebPExSize_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    control.setCalcMethod(cm);
                    // "me:Tmin".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_Tmin_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:Tmid".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_Tmid_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:Tmax".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_Tmax_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    // "me:Tstep".
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_Tstep_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_SensitivityAnalysisSamples_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_SensitivityAnalysisOrder_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idcm + "_SensitivityNumVarRedIters_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    cmDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idcm + "_SensitivityVarRedMethod_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
 ...
 * @returns CalcMethod
 */ function $7e68913db756e51f$var$loadCalcMethod(control, xml, button) {
    if (xml.length > 0) {
        ...
        if (xsi_type == (0, $b6873406fb778c0b$export$afd374542f6f3da6).xsi_type) return new (0, $b6873406fb778c0b$export$afd374542f6f3da6)(attributes);
        else if (xsi_type == (0, $b6873406fb778c0b$export$271191b096a55e63).xsi_type) return new (0, $b6873406fb778c0b$export$271191b096a55e63)(attributes);
            ...
            control.setCalcMethod(cmsa);
        } else throw new Error("Unknown xsi:type: " + xsi_type);
    } else button.classList.toggle("optionOff");
}
/**
...
//# sourceMappingURL=index.500c78b1.js.map
