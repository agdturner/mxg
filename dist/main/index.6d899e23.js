...
function $f0396edd0a5c99f7$export$9dd922ab8346623d(type, id, onchange, inputString, label, marginLeft, marginTop, marginBottom) {
    let inputDiv = $f0396edd0a5c99f7$export$7c112ceec8941e67(type, id, onchange, inputString, label);
...
function $f0396edd0a5c99f7$export$78253536c0178a32(marginLeft, marginTop, marginBottom, marginRight) {
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    if (xml_title.length != 1) throw new Error("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found");
        ...
        $7e68913db756e51f$var$remove(titleDivId);
        // Create a new div element for the input.
        let titleDiv = document.createElement("div");
        titleDiv.id = titleDivId;
        titleDiv.style.marginTop = $7e68913db756e51f$var$margin1;
        titleDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
        // Create a text node.
        ...
        titleInput.style.fontSize = $7e68913db756e51f$var$fontSize1;
        titleDiv.appendChild(titleInput);
        // Add event listener to inputElement.
        titleInput.addEventListener("change", function() {
            if (titleInput.value != title) titleNode.value = titleInput.value;
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(titleInput, 0);
        });
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(titleInput, 0);
    ...
    $7e68913db756e51f$var$remove(moleculesDivId);
    if (moleculesElement == null) ;
    else {
        let moleculeDiv = $7e68913db756e51f$var$processMoleculeList(xml);
        moleculeDiv.id = moleculesDivId;
        moleculesElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(moleculeDiv, "Molecules", "molecules_button", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin0, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, moleculesDivId));
        $7e68913db756e51f$var$mesmer.setMoleculeList(new (0, $8677001474399221$export$19d70f3647dee606)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(moleculeDiv), Array.from($7e68913db756e51f$var$molecules.values())));
    }
    // Reactions.
    ...
    $7e68913db756e51f$var$remove(reactionsDivId);
    if (reactionsElement == null) ;
    else {
        let reactionDiv = $7e68913db756e51f$var$processReactionList(xml);
        reactionsElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactionDiv, "Reactions", "reactions_button", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin0, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, reactionsDivId));
        $7e68913db756e51f$var$mesmer.setReactionList(new (0, $8677001474399221$export$44466a39ca846289)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(reactionDiv), Array.from($7e68913db756e51f$var$reactions.values())));
    }
    ...
    $7e68913db756e51f$var$remove(conditionsDivId);
    if (conditionsElement == null) ;
    else {
        let conditionsListElement = $7e68913db756e51f$var$processConditions(xml);
        conditionsElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(conditionsListElement, "Conditions", "conditions_button", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin0, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, conditionsDivId));
    ...
    $7e68913db756e51f$var$remove(modelParametersDivId);
    if (modelParametersElement == null) ;
    else {
        let modelParametersListElement = $7e68913db756e51f$var$processModelParameters(xml);
        modelParametersElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(modelParametersListElement, "Model Parameters", "modelParameters_button", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin0, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, modelParametersDivId));
    ...
    $7e68913db756e51f$var$remove(controlDivId);
    if (controlElement == null) ;
    else {
        let controlListElement = $7e68913db756e51f$var$processControl(xml);
        controlElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(controlListElement, "Control", "control_button", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin0, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, controlDivId));
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_ExtraDOSCMethod.length > 0) {
            ...
            let extraDOSCMethodCollapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(extraDOSCMethodDiv, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, buttonId, $7e68913db756e51f$var$fontSize3, $7e68913db756e51f$var$margin50, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, contentDivId);
            ...
            if (xml_bondRefs.length > 0) {
                ...
                let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(bondIds, bondRef.value, molecule.id + "_" + (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName);
            ...
            if (xml_hinderedRotorPotentials.length > 0) {
                ...
                let buttonId = molecule.id + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName;
                ...
                let hinderedRotorPotentialCollapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(hinderedRotorPotentialDiv, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, buttonId, $7e68913db756e51f$var$fontSize3, $7e68913db756e51f$var$margin75, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, contentDivId);
                ...
                let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, hinderedRotorPotential.format, molecule.id + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
                selectElement.addEventListener("change", (event)=>{
                    if (event.target instanceof HTMLSelectElement) {
                ...
                let potentialPointButtonId = molecule.id + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName + "_" + (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName;
                ...
                let potentialPointCollapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(potentialPointsDiv, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName, potentialPointButtonId, $7e68913db756e51f$var$fontSize3, $7e68913db756e51f$var$margin100, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, potentialPointContentDivId);
                ...
                for(let k = 0; k < xml_potentialPoints.length; k++){
                    ...
                    let potentialPointDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin125, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
            ...
            if (xml_periodicities.length > 0) {
                ...
                container.appendChild(label);
                // Create a new div element for the input.
                let inputDiv = (0, $f0396edd0a5c99f7$export$7c112ceec8941e67)("number", molecule.id + "_" + (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName, (event)=>{
        ...
        if (xml_ReservoirSize.length > 0) {
            ...
            container.appendChild(label);
            // Create a new div element for the input.
            let inputDiv = (0, $f0396edd0a5c99f7$export$7c112ceec8941e67)("number", molecule.id + "_" + (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName, (event)=>{
                if (event.target instanceof HTMLInputElement) {
 ...
 * @param div 
 * @param margin 
 */ function $7e68913db756e51f$var$createAndProcessProperty(xml_P, units, molecule, div, margin) {
    let p = new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_P));
    molecule.setProperties(p);
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsEnergy, molecule, xml_P, div, margin);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsRotConsts, molecule, xml_P, div, margin);
    else $7e68913db756e51f$var$processProperty(p, undefined, molecule, xml_P, div, margin);
}
/**
 * Display the XML.
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    if (xml_bathGases.length > 0) {
        ...
        let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(Array.from(moleculeIDs), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
        // Set the initial value.
        ...
        (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(selectElement);
        containerDiv.style.marginLeft = $7e68913db756e51f$var$margin25;
    ...
    if (xml_PTss.length > 0) {
        ...
        let buttonId = (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName + "_button";
        let contentDivId = (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName + "_";
        let collapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pTsDiv, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName, buttonId, $7e68913db756e51f$var$fontSize2, $7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1, contentDivId);
        ...
        if (xml_PTPairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
            ...
            for(let i = 0; i < xml_PTPairs.length; i++){
                ...
                let containerDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin50, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
                ...
                if (xml_bathGass.length > 0) {
                    ...
                    // Get the ids of all the molecules.
                    let moleculeIDs = new Set($7e68913db756e51f$var$molecules.keys());
                    let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(Array.from(moleculeIDs), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
                    // Set the initial value.
                    selectElement.value = bathGas.value;
                    // Add event listener to selectElement.
                    selectElement.addEventListener("change", (event)=>{
                ...
                pInputDiv.style.marginLeft = $7e68913db756e51f$var$margin5;
            ...
            addButton.style.marginLeft = $7e68913db756e51f$var$margin50;
            addButton.style.marginTop = $7e68913db756e51f$var$margin1;
            addButton.style.marginBottom = $7e68913db756e51f$var$margin1;
            ...
            addButton.addEventListener("click", ()=>{
                ...
                let pInputDiv = (0, $f0396edd0a5c99f7$export$7c112ceec8941e67)("number", (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + "P", (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
                            pTPair.setP(parseFloat(event.target.value));
                            console.log("Set P to " + event.target.value);
                ...
                pInputDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
                containerDiv.appendChild(pInputDiv);
                let tInputDiv = (0, $f0396edd0a5c99f7$export$7c112ceec8941e67)("number", (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + "T", (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
                            pTPair.setT(parseFloat(event.target.value));
                            console.log("Set T to " + event.target.value);
                ...
                tInputDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
                containerDiv.appendChild(tInputDiv);
                $7e68913db756e51f$var$addAnyUnits(undefined, pTPairAttributes, containerDiv, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
            ...
            addMultipleButton.style.marginLeft = $7e68913db756e51f$var$margin50;
            addMultipleButton.style.marginTop = $7e68913db756e51f$var$margin1;
            addMultipleButton.style.marginBottom = $7e68913db756e51f$var$margin1;
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    if (xml_grainSizess.length > 0) {
        ...
        let grainSizeDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)();
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    // me:testDOS
    let testDOSDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    let printSpeciesProfileDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    // me:testMicroRates
    let testMicroRatesDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    // me:testRateConstant
    let testRateConstantDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    // me:printGrainDOS
    let printGrainDOSDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    // me:printCellDOS
    let printCellDOSDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    let printReactionOperatorColumnSumsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    let printTunnellingCoefficientsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    // me:printGrainkfE
    let printGrainkfEDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    let printGrainBoltzmannDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    // me:printGrainkbE
    let printGrainkbEDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$margin25, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
...
//# sourceMappingURL=index.6d899e23.js.map
