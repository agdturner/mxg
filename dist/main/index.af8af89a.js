...
function $7e68913db756e51f$export$7577c09cb43cc206(id) {
    $7e68913db756e51f$var$molecules.forEach((v, k)=>{
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, null, mDiv, m.getID(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Create a set of molecule tag names.
        let moleculeTagNames = new Set();
        let cns = xml_ms[i].childNodes;
        //console.log("cns.length=" + cns.length);
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        if (id == null) id = "";
        let molecule = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(new Map(), $7e68913db756e51f$var$molecules.size);
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$addEditIDButton(molecule, button, moleculeDiv, level) {
    ...
    editNameButton.addEventListener("click", ()=>{
        ...
        if (newMoleculeId != null) {
            let mid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(newMoleculeId, molecule.id);
            ...
            let omid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), molecule.id);
            $7e68913db756e51f$var$removeOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, omid);
            molecule.setID(mid);
            button.textContent = mid + " " + (0, $f0396edd0a5c99f7$export$e5e81646ee331a9e);
        }
    //}
    });
}
...
//# sourceMappingURL=index.af8af89a.js.map
