 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Initialise mesmer.
    ...
    $7e68913db756e51f$var$mesmer = new (0, $8677001474399221$export$692079bb871c6039)(mesmerAttributes);
    // Create the menu.
    ...
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, moleculesDiv, null, mlDiv, (0, $8677001474399221$export$19d70f3647dee606).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Add add molecule button.
    let mb = $7e68913db756e51f$var$getAddMoleculeButton(mlDiv);
    // Add add from library button.
    let lb = $7e68913db756e51f$var$getAddFromLibraryButton(mlDiv, mb);
    // Reactions.
    ...
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, reactionsDiv, null, rlDiv, (0, $8677001474399221$export$44466a39ca846289).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Add add reaction button.
    let rb = $7e68913db756e51f$var$getAddReactionButton(rlDiv);
});
/**
 * Create an add reaction button.
 */ function $7e68913db756e51f$var$getAddReactionButton(rlDiv) {
    let rb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, $7e68913db756e51f$var$addRID((0, $6f7aa7a716962086$export$d2ae4167a30cf6bb).tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)));
    rlDiv.appendChild(rb);
    rb.addEventListener("click", ()=>{
        let reactionAttributes = new Map();
        reactionAttributes.set((0, $6f7aa7a716962086$export$d2ae4167a30cf6bb).s_id, "R" + $7e68913db756e51f$var$reactions.size);
        let r = new (0, $6f7aa7a716962086$export$d2ae4167a30cf6bb)(reactionAttributes);
        $7e68913db756e51f$var$reactions.set(r.id, r);
        let rDivID = $7e68913db756e51f$var$addRID((0, $6f7aa7a716962086$export$d2ae4167a30cf6bb).tagName, r.id);
        let rDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rDivID);
        rlDiv.appendChild(rDiv);
        // Create collapsible content.
        let rcDivID = $7e68913db756e51f$var$addRID(rDivID, $7e68913db756e51f$var$s_container);
        let rcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rcDivID, rlDiv, null, rDiv, r.getLabel(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Add reactants (collapsible content).
        let rccDivID = $7e68913db756e51f$var$addRID(rcDivID, $7e68913db756e51f$var$s_container);
        let racDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rccDivID, rDiv, null, rcDiv, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
    // Add products (collapsible content).
    });
    return rb;
}
/**
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, rlDiv, null, $7e68913db756e51f$var$processReactionList(xml), (0, $8677001474399221$export$44466a39ca846289).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Reactions Diagram.
    ...
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, $7e68913db756e51f$var$processConditions(xml), "ConditionsList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Model Parameters.
    ...
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, $7e68913db756e51f$var$processModelParameters(xml), "ModelParametersList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Control.
    ...
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, $7e68913db756e51f$var$processControl(xml), "ControlList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // MetadataList.
    ...
    // Create collapsible content.
    let mdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mdDivID, mdDiv, null, $7e68913db756e51f$var$processMetadataList(xml), (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Analysis.
    ...
    // Create collapsible content.
    let acDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aDivID, aDiv, null, $7e68913db756e51f$var$processAnalysis(xml), (0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
}
/**
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        let attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[i]);
        let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(attributes, attributes.get((0, $ef5b9341e5193b70$export$3da9759ad07746a3).s_id));
 ...
 * 
 * Create an add molecule button.
 */ function $7e68913db756e51f$var$getAddMoleculeButton(mlDiv) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        let mid = "Kr";
        let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(new Map(), mid);
        mid = $7e68913db756e51f$var$setMoleculeID(mid, m, $7e68913db756e51f$var$molecules);
        $7e68913db756e51f$export$ac55d333e780178c(m, $7e68913db756e51f$var$molecules);
        ...
        let moleculeDivID = $7e68913db756e51f$var$addRID((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, mid);
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, mid, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Add the molecule to the BathGas select elements.
        $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, mid);
        // Add edit Name button.
 ...
 */ function $7e68913db756e51f$var$getAddFromLibraryButton(mlDiv, mb) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            let mid = molecule.getID();
            mid = $7e68913db756e51f$var$setMoleculeID(mid, molecule, $7e68913db756e51f$var$molecules);
            $7e68913db756e51f$var$molecules.set(mid, molecule);
            ...
            // Create collapsible Molecule HTMLDivElement.
            let mcDivID = $7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_container);
            let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, mb, moleculeDiv, molecule.getLabel(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            // Add the molecule to the BathGas select elements.
 ...
 */ function $7e68913db756e51f$var$setMoleculeID(mid, molecule, molecules) {
    while(true){
 ...
 */ function $7e68913db756e51f$var$createProperty(pap, pl, xml, plDiv, molecule, boundary, level) {
    ...
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml, plDiv, boundary, level);
    ...
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$d1d1720eff14586a).dictRef) // "me:symmetryNumber", scalar, No units.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml, plDiv, boundary, level);
    ...
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml, plDiv, boundary, level);
    else $7e68913db756e51f$var$processPropertyScalarString(pl, p, molecule, xml, plDiv, boundary, level);
    return p;
}
/**
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    let xml_mps = xml.getElementsByTagName((0, $8883b31bd809eb64$export$77f098867dc64198).tagName);
 ...
 */ function $7e68913db756e51f$var$getCalcMethod(control, divCm, xml, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId) {
    ...
    cm = new (0, $b6873406fb778c0b$export$afd374542f6f3da6)(attributes);
        ...
        processElement(xml, (0, $b6873406fb778c0b$export$93514d28bd18d75a), cmar.setFormat.bind(cmar), false);
        processElement(xml, (0, $b6873406fb778c0b$export$be201676156f3e60), cmar.setPrecision.bind(cmar), false);
        processElement(xml, (0, $b6873406fb778c0b$export$19d20f3642d82681), cmar.setChebNumTemp.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$906be0805438fd80), cmar.setChebNumConc.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$6ab4fe1621c91452), cmar.setChebMaxTemp.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$e9853d49316ae9ae), cmar.setChebMinTemp.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$39eacc768d7e9bb), cmar.setChebMaxConc.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$78194e57ce26d99a), cmar.setChebMinConc.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$96094ac7e31a750e), cmar.setChebTExSize.bind(cmar), true);
        processElement(xml, (0, $b6873406fb778c0b$export$ae695595d3952700), cmar.setChebPExSize.bind(cmar), true);
        ...
        if (name != undefined && name !== xsi_type) {
            ...
            return $7e68913db756e51f$var$getCalcMethod(control, divCm, xml, options, attributes, tagName, name, divCmDetailsId, divCmDetailsSelectId);
 ...
 */ function $7e68913db756e51f$var$processMetadataList(xml) {
    ...
    let xml_mls = xml.getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    if (xml_mls.length > 0) {
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    let xml_as = xml.getElementsByTagName((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    if (xml_as.length > 0) {
...
function $7e68913db756e51f$export$cffb3d6135ce44ec() {
    if ($7e68913db756e51f$var$mesmer == null) {
        ...
        if ($7e68913db756e51f$var$molecules != undefined) mesmerOrdered.setMoleculeList(new (0, $8677001474399221$export$19d70f3647dee606)(new Map(), Array.from($7e68913db756e51f$var$molecules.values())));
        if ($7e68913db756e51f$var$reactions != undefined) mesmerOrdered.setReactionList(new (0, $8677001474399221$export$44466a39ca846289)(new Map(), Array.from($7e68913db756e51f$var$reactions.values())));
        if ($7e68913db756e51f$var$mesmer.getConditionss() != undefined) mesmerOrdered.setConditionss($7e68913db756e51f$var$mesmer.getConditionss());
        if ($7e68913db756e51f$var$mesmer.getModelParameterss() != undefined) mesmerOrdered.setModelParameterss($7e68913db756e51f$var$mesmer.getModelParameterss());
        if ($7e68913db756e51f$var$mesmer.getControls() != undefined) mesmerOrdered.setControls($7e68913db756e51f$var$mesmer.getControls());
...
//# sourceMappingURL=index.244ca181.js.map
