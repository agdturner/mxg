 ...
 */ function $7e68913db756e51f$var$processMetadataList(xml) {
    ...
    let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$boundary1);
    let xml_ml = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    let ml = new (0, $288a4469bea65e97$export$3e18a603070a78a)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ml));
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    let xml_a = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml, (0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    let a = new (0, $49b337e689138e29$export$c4c153dc94cc96b4)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_a));
    $7e68913db756e51f$var$mesmer.setAnalysis(a);
    // "me:description".
    let xml_d = xml_a.getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
    if (xml_d.length > 0) {
        if (xml_d.length == 1) {
    ...
    // "me:eigenvalueList".
    let xml_el = xml_a.getElementsByTagName((0, $49b337e689138e29$export$f681829d43cbf50e).tagName);
    ...
    // "me:populationList".
    let xml_pl = xml_a.getElementsByTagName((0, $49b337e689138e29$export$8f9a53be9a409418).tagName);
    ...
    for(let i = 0; i < xml_pl.length; i++){
        ...
        let scatterPlot = new $7e68913db756e51f$var$ScatterPlot(canvas, t_ref_pop);
        scatterPlot.draw();
        // Create Table.
...
class $7e68913db756e51f$var$ScatterPlot {
     ...
     */ draw() {
        ...
        let xTickSpacing = Math.ceil(xrange / Math.pow(10, orderOfMagnitude));
        console.log("xTickSpacing=" + xTickSpacing);
        let xTicks = 10;
        //let xTickSpacing: number = (x1 - x0) / xTicks;
        for(let i = 0; i < xTicks; i++){
            let xTick = x0 + i * xTickSpacing;
            // Adjust xTick to space out around 0
            if (xTick < 0) xTick = xTick / 2;
            else if (xTick > 0) xTick = xTick * 2;
            ctx.beginPath();
            ctx.moveTo(xTick, y0);
...
//# sourceMappingURL=index.ed063893.js.map
