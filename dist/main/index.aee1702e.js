 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(Array.from($7e68913db756e51f$var$libraryMolecules.molecules.keys()), "Select molecule", "He", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, $7e68913db756e51f$var$s_Select), $7e68913db756e51f$var$level1);
        select.classList.add((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName);
        // Add the select element to the mlDiv.
        mlDiv.insertBefore(select, addMoleculeButton);
...
//# sourceMappingURL=index.aee1702e.js.map
