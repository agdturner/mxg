...
class $01410cda1eef5011$export$7254cc27399e90bd extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ getDegeneracy() {
        return parseInt(this.attributes.get($01410cda1eef5011$export$7254cc27399e90bd.s_degeneracy));
    }
    /**
...
function $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, mIDM, molecules) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            let mid = molecule.getID();
            while(true){
                mid = $174b37a7f81f9b54$export$194bfe7da61d65(false, mid, molecule, molecules);
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_states.length > 0) {
            ...
            for(let j = 0; j < xml_ss.length; j++){
                let s = new (0, $01410cda1eef5011$export$7254cc27399e90bd)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ss[j]));
                //state.push(s);
                ss.addState(s);
     ...
     */ parse(xml) {
        ...
        */ // Process the XML "molecule" elements.
        ...
        for(let i = 0; i < xml_msl; i++){
            ...
            let id;
            while(true){
                id = (0, $174b37a7f81f9b54$export$194bfe7da61d65)(true, mid, undefined, molecules);
...
//# sourceMappingURL=index.e602cb02.js.map
