...
class $ef5b9341e5193b70$export$86ca5149fcde8feb extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ constructor(attributes){
        ...
        this.angle = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(angle);
        ...
        this.potential = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(potential);
    }
    /**
     * @returns The angle.
     */ getAngle() {
...
class $ef5b9341e5193b70$export$9b8e857b9a081d2 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, potentialPoints){
        ...
        this.expansionSize = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(expansionSize);
...
const $7e68913db756e51f$var$s_container = "s_container";
...
// HTML IDs
const $7e68913db756e51f$var$menuDivID = "menu";
const $7e68913db756e51f$var$titleDivID = "title";
const $7e68913db756e51f$var$moleculesDivID = "molecules";
const $7e68913db756e51f$var$reactionsDivID = "reactions";
const $7e68913db756e51f$var$reactionsDiagramDivID = "reactionsDiagram";
const $7e68913db756e51f$var$conditionsDivID = "conditions";
const $7e68913db756e51f$var$modelParametersDivID = "modelParameters";
const $7e68913db756e51f$var$controlDivID = "control";
const $7e68913db756e51f$var$metadataListDivID = "metadata";
const $7e68913db756e51f$var$analysisDivID = "analysis";
const $7e68913db756e51f$var$xmlDivID = "xml";
const $7e68913db756e51f$var$welcomeDivID = "welcome";
// For dark/light mode.
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // Model Parameters.
    let mpDiv = document.getElementById($7e68913db756e51f$var$modelParametersDivID);
    let mpDivID = $7e68913db756e51f$var$addID((0, $8883b31bd809eb64$export$77f098867dc64198).tagName);
    // Remove any existing mpDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(mpDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    let mpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mpDivID, mpDiv, null, $7e68913db756e51f$var$processModelParameters(xml), (0, $8883b31bd809eb64$export$77f098867dc64198).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Control.
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_pls.length == 1) {
            ...
            pap.forEach(function(dictRef) {
                ...
                if (dictRef == "me:Hf0") {
                    ...
                    let ps = new (0, $ef5b9341e5193b70$export$d29b345ea2be5072)(new Map(), value);
                    let p = new (0, $ef5b9341e5193b70$export$90bccbae54bb6d4f)(attributes, ps);
                    //attributes.set(Hf0.s_units, "kJ/mol");
                    attributes.set("units", "kJ/mol");
                    $7e68913db756e51f$var$addPropertyScalar(attributes, value, (0, $8677001474399221$export$692079bb871c6039).energyUnits, pl, p, plDiv, $7e68913db756e51f$var$boundary1);
                    pl.setProperty(p);
                /*
        ...
        if (xml_edms.length > 0) {
            if (xml_edms.length != 1) throw new Error("Expecting only 1 extra DOSCMethod, but there are " + xml_edms.length);
            let edm = new (0, $ef5b9341e5193b70$export$ae98b7db6376163d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dms[0]));
            // Create collapsible ExtraDOSCMethod HTMLDivElement.
            let edmDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName);
            ...
            if (xml_hrps.length > 0) {
                ...
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    ...
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, hrp.getExpansionSize().toString(), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize));
                // Add useSineTerms.
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    let anglelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                        ...
                        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                    }, pp.getAngle().toExponential(), (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle);
            ...
            // Read periodicities.
            let xml_periodicities = xml_dms[0].getElementsByTagName((0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName);
            if (xml_periodicities.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", m.getID() + "_" + (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
...
function $7e68913db756e51f$var$addPropertyScalar(attributes, value, units, pl, p, plDiv, boundary) {
    // Add PropertyScalar.
    let ps = new (0, $ef5b9341e5193b70$export$d29b345ea2be5072)(attributes, value);
    p.setProperty(ps);
    ...
    let button = div.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    button.click();
/*
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    let xml_mps = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName);
    let mps = new (0, $8883b31bd809eb64$export$77f098867dc64198)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_mps));
    $7e68913db756e51f$var$mesmer.setModelParameters(mps);
    $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv);
    $7e68913db756e51f$var$processModelParametersN(mps, xml_mps, mpsDiv, (0, $b6873406fb778c0b$export$576b56ca6e34780b), mps.setAutomaticallySetMaxEne, mps.removeAutomaticallySetMaxEne);
    $7e68913db756e51f$var$processModelParametersN(mps, xml_mps, mpsDiv, (0, $8883b31bd809eb64$export$aa73446724166cdb), mps.setEnergyAboveTheTopHill, mps.removeEnergyAboveTheTopHill);
    $7e68913db756e51f$var$processModelParametersN(mps, xml_mps, mpsDiv, (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e), mps.setMaxTemperature, mps.removeMaxTemperature);
    return mpsDiv;
}
/**
...
//# sourceMappingURL=index.440621fc.js.map
