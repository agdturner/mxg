 ...
 */ function $7e68913db756e51f$var$getUnitsSelectElement(units, attributes, id, tagOrDictRef) {
    ...
    if (psUnits != undefined) {
        ...
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(units, "Units", psUnits, id, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processDOSCMethod(dOSCMethod, molecule, moleculeDiv) {
    ...
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, dOSCMethod.tagName, molecule.id + "_" + "Select_DOSCMethod", $7e68913db756e51f$var$boundary1);
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            for(let j = 0; j < xml_reactants.length; j++){
                ...
                let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Role", reactant.getMolecule().role, molecule.ref + "_" + "Select_Role", $7e68913db756e51f$var$boundary1);
        ...
        if (xml_products.length > 0) {
            ...
            for(let j = 0; j < xml_products.length; j++){
                ...
                let container = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role:", options, molecule.role, molecule.ref + "_" + "Select_Role", "Role", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3);
        ...
        if (xml_tunneling.length > 0) {
            ...
            let selectElement = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Tunneling", tunneling.getName(), reaction.id + "_" + "Select_Tunneling", $7e68913db756e51f$var$boundary1);
            // Set the initial value.
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    addBathGasButton.addEventListener("click", ()=>{
        ...
        containerDiv.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas));
        // Add a remove button.
        ...
        if (xml_PTPairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
            ...
            for(let i = 0; i < xml_PTPairs.length; i++){
                ...
                if (xml_bathGass.length > 0) {
                    ...
                    pTPairDiv.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas));
                }
 ...
 */ function $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", ()=>{
        ...
        let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas);
        // Set the initial value.
 ...
 * @param bathGas The bath gas.
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas) {
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, bathGas.value, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$boundary1);
    // Set the initial value.
    select.value = bathGas.value;
    // Add event listener to selectElement.
    select.addEventListener("change", (event)=>{
 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    ...
    if (xml.length > 0) {
        ...
        let select = $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, detailsDivId, options, tagName, xsi_type, ids);
        ...
        if (xsi_type == (0, $b6873406fb778c0b$export$afd374542f6f3da6).xsi_type || xsi_type == (0, $b6873406fb778c0b$export$afd374542f6f3da6).xsi_type2) {
        ...
        } else if (xsi_type == (0, $b6873406fb778c0b$export$271191b096a55e63).xsi_type || xsi_type == (0, $b6873406fb778c0b$export$271191b096a55e63).xsi_type2) {
            ...
            $7e68913db756e51f$var$processCalcMethodAnalyticalRepresentation(divCm, cmar, detailsDivId);
            ...
            $7e68913db756e51f$var$processCalcMethodThermodynamicTable(divCm, cmtt, detailsDivId);
            ...
            $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(divCm, cmsa, detailsDivId);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has(tagName)) {
            ...
            // Create the select element.
            let select = $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, detailsDivId, options, tagName, $7e68913db756e51f$var$selectAnotherOption, ids);
            divCm.appendChild(select);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
 ...
 * @param detailsDivId The details div id.
 */ function $7e68913db756e51f$var$processCalcMethodAnalyticalRepresentation(detailsDiv, cm, detailsDivId) {
    // "me:format".
    ...
    // Format value.
    cm.setFormat(format);
    let lwsFormat = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $b6873406fb778c0b$export$93514d28bd18d75a).tagName, (0, $b6873406fb778c0b$export$93514d28bd18d75a).options, (0, $b6873406fb778c0b$export$93514d28bd18d75a).tagName, format.value, detailsDivId + (0, $b6873406fb778c0b$export$93514d28bd18d75a).tagName + "_select", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    ...
    let lwsFormatRateUnits = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $b6873406fb778c0b$export$93514d28bd18d75a).rateUnits, (0, $b6873406fb778c0b$export$93514d28bd18d75a).rateUnitsOptions, (0, $b6873406fb778c0b$export$93514d28bd18d75a).rateUnits, value, detailsDivId + (0, $b6873406fb778c0b$export$93514d28bd18d75a).rateUnits + "_select", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    ...
    // "me:precision".
    let precision = cm.getPrecision() || new (0, $b6873406fb778c0b$export$be201676156f3e60)(new Map(), (0, $b6873406fb778c0b$export$be201676156f3e60).options[0]);
    cm.setPrecision(precision);
    let lwsPrecision = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $b6873406fb778c0b$export$be201676156f3e60).tagName, (0, $b6873406fb778c0b$export$be201676156f3e60).options, (0, $b6873406fb778c0b$export$be201676156f3e60).tagName, precision.value, detailsDivId + (0, $b6873406fb778c0b$export$be201676156f3e60).tagName + "_select", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
 ...
 * @param detailsDivId The details div id.
 */ function $7e68913db756e51f$var$processCalcMethodThermodynamicTable(detailsDiv, cm, detailsDivId) {
    // "me:Tmin".
 ...
 * @param detailsDivId The details div id.
 */ function $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(detailsDiv, cm, detailsDivId) {
    ...
    detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $b6873406fb778c0b$export$e98aeac6c6b1df09).tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options[0], detailsDivId + (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).tagName + "_select", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1));
    // Add event listener for the select element.
    let select = detailsDiv.querySelector("select");
    select?.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 * @param ids 
 * @returns 
 */ function $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, detailsDivId, options, tagName, value, ids) {
    ...
    select.addEventListener("change", (event)=>{
        ...
        control.setCalcMethod(new (0, $b6873406fb778c0b$export$271191b096a55e63)(attributes));
            ...
            control.setCalcMethod(cm);
            $7e68913db756e51f$var$processCalcMethodFitting(detailsDiv, cm, detailsDivId);
            ...
            control.setCalcMethod(cm);
            $7e68913db756e51f$var$processCalcMethodAnalyticalRepresentation(detailsDiv, cm, detailsDivId);
            ...
            control.setCalcMethod(cm);
            $7e68913db756e51f$var$processCalcMethodThermodynamicTable(detailsDiv, cm, detailsDivId);
            ...
            control.setCalcMethod(cm);
            $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(detailsDiv, cm, detailsDivId);
...
//# sourceMappingURL=index.3856653c.js.map
