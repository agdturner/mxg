...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, molecules) {
    ...
    if (!mlTagNames.has((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName)) {
        ...
        let amb = mlDiv.appendChild($174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, molecules));
...
function $589572943861997b$export$c1600199abe19050(conditionssDiv, conditionsIDs, molecules) {
...
function $dde1c59fe054f706$export$5733f83ee927902f(mpsDiv, modelParametersIDs) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), undefined, (0, $7e68913db756e51f$export$39c84188a71202f7));
...
function $180486e70a03b1bd$export$76caf53413cf3464(xml, controlIDs) {
    ...
    $180486e70a03b1bd$export$2e5ceda339237ce2(controlsDiv, controlIDs);
    return controlsDiv;
}
/**
 * @param control The control.
...
function $180486e70a03b1bd$export$2e5ceda339237ce2(controlsDiv, controlIDs) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), undefined, (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    button.addEventListener("click", (event)=>{
        ...
        // Controls with additional things to set.
        $180486e70a03b1bd$var$handleTestMicroRates(control, cDiv, controlIDs, null, (0, $7e68913db756e51f$export$39c84188a71202f7));
        $180486e70a03b1bd$var$handleCalcMethod(control, cDiv, controlIDs, null, (0, $7e68913db756e51f$export$39c84188a71202f7));
        $180486e70a03b1bd$var$getControlItems(control).forEach((item)=>{
            $180486e70a03b1bd$var$handleControl(control, cDiv, controlIDs, onOffControls, null, (0, $7e68913db756e51f$export$39c84188a71202f7), item.class, item.setMethod, item.removeMethod, true);
        });
        // Add a remove control button.
        let removeButton = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(cDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), (0, $7e68913db756e51f$export$3bb92be1f57fd129).removeControl.bind((0, $7e68913db756e51f$export$3bb92be1f57fd129)), i);
        removeButton.addEventListener("click", (event)=>{
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Initialise mesmer.
    ...
    // Create an add button to add a conditions.
    (0, $589572943861997b$export$c1600199abe19050)(conditionssDiv, $7e68913db756e51f$var$conditionsIDs, $7e68913db756e51f$var$molecules);
    // Create collapsible content.
    ...
    (0, $dde1c59fe054f706$export$5733f83ee927902f)(modelParameterssDiv, $7e68913db756e51f$var$modelParametersIDs);
    // Create collapsible content.
    ...
    // Create an add button to add a control.
    (0, $180486e70a03b1bd$export$2e5ceda339237ce2)(controlsDiv, $7e68913db756e51f$var$controlIDs);
    // Create collapsible content.
...
//# sourceMappingURL=index.3d4b6c76.js.map
