...
const $7e68913db756e51f$var$rdDivId = $7e68913db756e51f$var$addID("reactionsDiagram");
const $7e68913db756e51f$var$rdCanvasId = $7e68913db756e51f$var$addID("reactionsDiagramCanvas");
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // Create collapsible MoleculeList HTMLDivElement.
    let moleculescDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculesListDivId, $7e68913db756e51f$var$s_container);
    let moleculescDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(moleculescDivID, moleculesDiv, null, moleculeListDiv, (0, $8677001474399221$export$19d70f3647dee606).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    ...
    // Create collapsible ReactionList HTMLDivElement.
    let reactionscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactionsListDivId, $7e68913db756e51f$var$s_container);
    let reactionscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactionscDivID, reactionsDiv, null, reactionsListDiv, (0, $8677001474399221$export$44466a39ca846289).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    ...
    let rdDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$rdDivId, $7e68913db756e51f$var$level0);
    ...
    // Create collapsible Conditions HTMLDivElement.
    let conditionscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionssDivId, $7e68913db756e51f$var$s_container);
    let conditionscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(conditionscDivID, conditionsDiv, null, conditionssDiv, "ConditionsList", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Model Parameters.
    ...
    // Create collapsible ModelParameters HTMLDivElement.
    let modelParameterscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(modelParametersListDivId, $7e68913db756e51f$var$s_container);
    let modelParameterscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(modelParameterscDivID, modelParametersDiv, null, modelParametersListDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Control.
    ...
    // Create collapsible Controls HTMLDivElement.
    let controlcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(controlsDivId, $7e68913db756e51f$var$s_container);
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(controlcDivID, controlDiv, null, controlsDiv, "ControlList", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
}
/**
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_aas.length == 1) {
            ...
            for(let j = 0; j < xml_as.length; j++){
                ...
                aDivs.push((0, $f0396edd0a5c99f7$export$78253536c0178a32)(aDivID, $7e68913db756e51f$var$level1));
                aaDiv.appendChild(aDivs[j]);
                aDivs[j].appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(aID, $7e68913db756e51f$var$boundary1));
                let width = aDivs[j].offsetWidth;
                console.log("width=" + width);
                if (width > maxWidths[0]) maxWidths[0] = width;
                // elementType.
                $7e68913db756e51f$var$processElementType(a, aDivs[j], false, $7e68913db756e51f$var$boundary1);
                // coordinates.
                $7e68913db756e51f$var$processCoordinates(a, aDivs[j], $7e68913db756e51f$var$boundary1);
                $7e68913db756e51f$var$addRemoveButton(aDivs[j], $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$removeAtom, molecule, aID);
            }
            // Step 2: Set the width of the first child to the maximum width.
            for(let j = 0; j < xml_as.length; j++){
                let firstChild = aDivs[j].firstChild;
                firstChild.style.width = maxWidths[0] + "px";
            }
        ...
        if (xml_edms.length > 0) {
            ...
            let edmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(edmcDivID, moleculeDiv, null, edmDiv, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2);
            // Read bondRef.
            ...
            if (xml_brs.length > 0) {
                ...
                edmDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, bids, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, br.value, molecule.id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3));
            }
            ...
            if (xml_hrps.length > 0) {
                ...
                let hrpDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
                ...
                let hrpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(hrpcDivID, moleculeDiv, null, hrpDiv, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2);
                // Format.
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, hrp.getFormat(), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1));
                // Units.
                $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).energyUnits, hrpAttributes, hrpDiv, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_units), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1);
                // ExpansionSize.
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                    let target = event.target;
                    ...
                    if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) hrp.setExpansionSize(parseInt(target.value));
                        ...
                        target.value = hrp.getExpansionSize().toExponential();
                    }
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
 ...
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, bondArrayDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        let bond = new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)(attributes, molecule);
        let bondId = molecule.getBonds().addBond(bond);
        let bondDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeId, bondId), level);
        ...
        // atomRefs2.
        $7e68913db756e51f$var$processAtomRefs2(molecule, bondDiv, bond, boundary);
        // order.
        $7e68913db756e51f$var$processOrder(bondDiv, bond, boundary);
        let removeBond = (id)=>molecule.getBonds().removeBond(id);
 ...
 */ function $7e68913db756e51f$var$processProperty(p, units, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary);
        ...
        if (arrayNodes.length > 0) {
            ...
            $7e68913db756e51f$var$addAnyUnits(units, paAttributes, lwi, molecule.id + "_" + p.dictRef + "_Select_Units", p.dictRef, boundary);
            plDiv.appendChild(lwi);
        } else {
            // PropertyMatrix.
...
//# sourceMappingURL=index.25d8bba7.js.map
