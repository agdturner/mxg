...
function $cc8c7201a9bad777$export$2cd488e9ab180ce2(tagName, attributes, attributeName, attributeValue, padding) {
    let s = "";
...
function $cc8c7201a9bad777$export$dad497fe1f6e27c0(content, tagName, attributes, attributeName, attributeValue, padding, padValue) {
    let startTag = $cc8c7201a9bad777$export$2cd488e9ab180ce2(tagName, attributes, attributeName, attributeValue, padding);
...
class $1d994ffefe2ef4aa$export$21991851b0bb231f {
    ...
    */ /**
     ...
     */ toTag(tagName, padding) {
        let s = (0, $f0396edd0a5c99f7$export$ff083c49da8fe0f9)(this.attributes, tagName);
        if (padding) return "\n" + padding + s;
        return "\n" + s;
    }
    /**
     ...
     */ toXML(tagName, padding) {
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)("", tagName, this.attributes, undefined, undefined, padding, false);
    }
}
class $1d994ffefe2ef4aa$export$bf6a5b951c66187b extends $1d994ffefe2ef4aa$export$21991851b0bb231f {
     ...
     * @returns An XML representation.
     */ toXML(tagName, padding) {
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(this.value.toString().trim(), tagName, this.attributes, undefined, undefined, padding, false);
    }
}
class $1d994ffefe2ef4aa$export$a66b3a80833b522b extends $1d994ffefe2ef4aa$export$21991851b0bb231f {
     ...
     * @returns An XML representation.
     */ toXML(tagName, padding) {
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(this.values.toString().replaceAll(",", this.delimiter), tagName, this.attributes, undefined, undefined, padding, false);
    }
}
...
class $ef5b9341e5193b70$export$41b04b3a73e7216d extends (0, $1d994ffefe2ef4aa$export$21991851b0bb231f) {
    /**
     * @param {Map<string, string>} attributes The attributes.
     ...
     */ toXML(pad, padding) {
        ...
        if (this.property instanceof (0, $1d994ffefe2ef4aa$export$bf6a5b951c66187b)) return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(this.property.toXML("scalar", padding1), "property", this.attributes, undefined, undefined, padding, true);
        else return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(this.property.toXML("array", padding1), "property", this.attributes, undefined, undefined, padding, true);
    }
}
...
class $ef5b9341e5193b70$export$499950da20810ac9 extends (0, $1d994ffefe2ef4aa$export$21991851b0bb231f) {
    static{
        this.xmlTagName = "me:energyTransferModel";
    }
    /**
     * @param {Map<string, string>} attributes The attributes.
     ...
     */ toXML(pad, padding) {
        ...
        this.deltaEDowns.forEach((d)=>{
            deltaEDowns_xml += d.toXML($ef5b9341e5193b70$export$16fc56ab40b12b45.xmlTagName, padding1);
        });
        if (pad == undefined) return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(deltaEDowns_xml, $ef5b9341e5193b70$export$499950da20810ac9.xmlTagName, this.attributes, undefined, undefined, padding, false);
        else return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(deltaEDowns_xml, $ef5b9341e5193b70$export$499950da20810ac9.xmlTagName, this.attributes, undefined, undefined, padding, true);
    }
}
class $ef5b9341e5193b70$export$bbdce6c921702068 {
    static{
        this.xmlTagName = "me:DOSCMethod";
    }
    constructor(type){
        this.type = type;
    }
     ...
     * @returns A tag representation.
     */ toTag(padding) {
        let s = `<` + $ef5b9341e5193b70$export$bbdce6c921702068.xmlTagName + ` xsi:type="${this.type}"/>`;
        if (padding) return "\n" + padding + s;
        return "\n" + s;
    }
}
class $ef5b9341e5193b70$export$3da9759ad07746a3 extends (0, $1d994ffefe2ef4aa$export$21991851b0bb231f) {
    /**
     * Create a molecule.
     ...
     */ toXML(tagName, pad, level) {
        ...
        if (this.atoms.size > 1) {
            if (atoms_xml != "") atoms_xml = (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(atoms_xml, "atomArray", undefined, undefined, undefined, padding1, true);
        }
        // Bonds
        let bonds_xml = "";
        for (let bond of this.bonds.values())bonds_xml += bond.toTag("bond", padding2);
        if (bonds_xml != "") bonds_xml = (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(bonds_xml, "bondArray", undefined, undefined, undefined, padding1, true);
        // Properties
        let properties_xml = "";
        this.properties.forEach((property)=>{
            let property_xml = "";
            if (property.property instanceof (0, $1d994ffefe2ef4aa$export$bf6a5b951c66187b)) property_xml += property.property.toXML("scalar", padding3);
            else property_xml += property.property.toXML("array", padding3);
            properties_xml += (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(property_xml, "property", property.attributes, undefined, undefined, padding2, true);
        });
        if (this.properties.size > 1) {
            if (properties_xml != "") properties_xml = (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(properties_xml, "propertyList", undefined, undefined, undefined, padding1, true);
        }
        // EnergyTransferModel
        ...
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(atoms_xml + bonds_xml + properties_xml + energyTransferModel_xml + dOSCMethod_xml, tagName, this.attributes, undefined, undefined, padding0, true);
    }
}
...
class $6f7aa7a716962086$export$e8a062bb2fc9e2ba extends (0, $1d994ffefe2ef4aa$export$21991851b0bb231f) {
     ...
     */ toXML(tagName, pad, padding) {
        ...
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(s, tagName, undefined, undefined, undefined, padding, true);
    }
}
...
class $6f7aa7a716962086$export$191e95ebb11cc88 extends $6f7aa7a716962086$export$6fa70ee10f356b6 {
     ...
     */ toXML(tagName, padding) {
        ...
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(preExponential_xml + activationEnergy_xml + tInfinity_xml + nInfinity_xml, tagName, this.attributes, undefined, undefined, padding, true);
    }
}
...
class $6f7aa7a716962086$export$d2ae4167a30cf6bb extends (0, $1d994ffefe2ef4aa$export$21991851b0bb231f) {
    /**
     * @param {Map<string, string>} attributes The attributes.
     ...
     */ toXML(tagName, pad, level) {
        ...
        if (this.mCRCMethod != undefined) {
            if (this.mCRCMethod instanceof $6f7aa7a716962086$export$191e95ebb11cc88) mCRCMethod_xml = this.mCRCMethod.toXML("me:MCRCMethod", padding1);
            else mCRCMethod_xml = this.mCRCMethod.toTag("me:MCRCMethod", padding1);
        }
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(reactants_xml + products_xml + tunneling_xml + transitionState_xml + mCRCMethod_xml, tagName, this.attributes, undefined, undefined, padding0, true);
    }
}
...
class $ae74a7b44a6504a1$export$363c7374d425f4ad {
     ...
     */ toXML(pad, padding) {
        ...
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(s, "me:conditions", undefined, undefined, undefined, padding, true);
    }
}
...
class $8883b31bd809eb64$export$77f098867dc64198 {
    /**
     ...
     */ toXML(pad, padding) {
        ...
        s += (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(this.energyAboveTheTopHill.toString(), "me:EnergyAboveTheTopHill", undefined, undefined, undefined, padding2, false);
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(s, "me:modelParameters", undefined, undefined, undefined, padding, true);
    }
}
...
class $b6873406fb778c0b$export$7a7fa4424cb20976 {
     ...
     */ toXML(pad, padding) {
        ...
        return (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(s, "control", undefined, undefined, null, padding, true);
    }
}
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        for(let j = 0; j < xml_properties.length; j++){
            ...
            if (nodeName == "scalar") {
                ...
                properties.set(dictRef, new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)(attribs, new (0, $1d994ffefe2ef4aa$export$bf6a5b951c66187b)(nodeAttributes, value)));
                if (dictRef === "me:ZPE") {
                ...
                properties.set(dictRef, new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)(attribs, new (0, $1d994ffefe2ef4aa$export$a66b3a80833b522b)(nodeAttributes, (0, $b6110b5694cd3491$export$8cfbaad830aa9e0a)(textContent.split(/\s+/)), " ")));
        ...
        if (els != null) {
            ...
            if (el != null) {
                if (el != null) {
                    ...
                    if (type != null) dOSCMethod = new (0, $ef5b9341e5193b70$export$bbdce6c921702068)(type);
                }
            }
        }
 ...
 */ function $7e68913db756e51f$var$initModelParameters(xml) {
    ...
    let energyAboveTheTopHill = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_energyAboveTheTopHill)));
 ...
 */ window.saveXML = function() {
    ...
    moleculeList = (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(moleculeList, "moleculeList", undefined, undefined, undefined, pad, true);
    // Create reactionList.
    level = 2;
    let reactionList = "";
    $7e68913db756e51f$var$reactions.forEach(function(reaction, id) {
    ...
    reactionList = (0, $cc8c7201a9bad777$export$dad497fe1f6e27c0)(reactionList, "reactionList", undefined, undefined, undefined, pad, true);
...
//# sourceMappingURL=index.ba0fb1de.js.map
