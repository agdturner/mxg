...
function $cbb1ac0a822ffab5$export$b12ef0e3d99deb64(rIDM, rlDiv, reactions, molecules) {
    ...
    rb.addEventListener("click", ()=>{
        ...
        // If there are no reactions then the first reaction is R1.
        // If a reaction has been deleted then the next reaction should use the R1.
        // Get Reaction ID.
        ...
        let addReactantButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467) + " Reactant", rIDM.addID(rDivID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
        ...
        addReactantButton.addEventListener("click", ()=>{
            ...
            let selectReactant = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)((0, $7e68913db756e51f$export$5ac38056c0103baa)(molecules), "select", "", rIDM.addID(rcDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            selectReactant.addEventListener("change", (event)=>{
                ...
                rmAttributes.set((0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba).s_ref, molecule.getID());
                rmAttributes.set((0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba).s_role, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).s_deficientReactant);
...
function $cbb1ac0a822ffab5$export$ef4959ac45646090(xml, rIDM, reactions, molecules) {
    ...
    if (reactionListTagNames.size > 0) {
        ...
        for(let i = 0; i < xml_reactions.length; i++){
            ...
            let reactioncDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactioncDivID, rlDiv, null, reactionDiv, reaction.id + " (" + reaction.getLabel() + ")", (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            // Load tunneling.
            ...
            (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(reactionDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), ()=>{
                rlDiv.removeChild(reactioncDiv);
                //mlDiv.removeChild(mDiv);
                rIDM.removeIDs(reactionDivID);
                rIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactionDivID, (0, $7e68913db756e51f$export$7295f538b9762c5)));
...
//# sourceMappingURL=index.2f81d8ea.js.map
