 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // MetadataList.
    let mDiv = document.getElementById($7e68913db756e51f$var$metadataListDivID);
    let mDivID = $7e68913db756e51f$var$addID((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    // Remove any existing mDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(mDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mDivID, mDiv, null, $7e68913db756e51f$var$processMetadataList(xml), (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Analysis.
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        // There can be atoms in or not in an atom array.
        if (xml_aas.length == 1) {
            let xml_aa = xml_aas[0];
            let xml_as = xml_aa.getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
            if (xml_as.length == 0) throw new Error("Expecting 1 or more atoms in " + (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName + ", but finding 0!");
            let aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_aa));
            m.setAtoms(aa);
            for(let j = 0; j < xml_as.length; j++)//console.log("j=" + j);
            aaDiv.appendChild($7e68913db756e51f$var$addAtom(m, aa, new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        } else {
            let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
            if (xml_as.length == 1) {
                let aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map());
                aaDiv.appendChild($7e68913db756e51f$var$addAtom(m, aa, new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[0]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
                m.setAtoms(aa);
            } else if (xml_as.length > 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName + " but finding " + xml_as.length + ". Should these be in an " + (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName + "?");
        }
        //console.log("atomsNode=" + atomsNode);
        ...
        // There can be bonds in or not in a bond array.
        if (xml_bas.length > 0) {
            let xml_bs = xml_bas[0].getElementsByTagName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
            let ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bas[0]));
        ...
        if (xml_pls.length == 1) {
            ...
            for(let j = 0; j < xml_ps.length; j++){
                // Create a new Property.
                let p = $7e68913db756e51f$var$createProperty(pl, xml_ps[j], plDiv, m, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                pl.setProperty(p);
            }
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        } else {
            ...
            if (xml_ps.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName + " but finding " + xml_ps.length + ". Should these be in a " + (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName + "?");
            // Create a new Property.
            let p = $7e68913db756e51f$var$createProperty(pl, xml_ps[0], mDiv, m, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            pl.setProperty(p);
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName);
        }
        // Organise EnergyTransferModel.
        ...
        if (xml_edms.length > 0) {
            ...
            if (xml_hrps.length > 0) {
                ...
                // Format.
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, hrp.getFormat(), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
                // Units.
                $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).energyUnits, hrpAttributes, hrpDiv, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_units), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                // ExpansionSize.
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        if ($7e68913db756e51f$var$libraryMolecules == undefined) {
            alert("No library molecules! Please Load Molecule Library.");
            return;
        }
 ...
 */ function $7e68913db756e51f$var$createProperty(pl, xml, plDiv, molecule, boundary, level) {
 ...
 */ function $7e68913db756e51f$var$addNumber(div, id, name, value, setter, boundary) {
    ...
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, boundary);
    input.addEventListener("change", (event)=>{
        let target = event.target;
        try {
 ...
 */ function $7e68913db756e51f$var$processProperty(pl, p, units, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, div, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                */ let div = $7e68913db756e51f$var$processNumberArray((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                $7e68913db756e51f$var$addAnyUnits(units, paAttributes, div, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
                plDiv.appendChild(div);
            }
        /*
            if (textArea) {
            ...
            */ } else {
            ...
            if (matrixNodes.length > 0) {
                ...
                $7e68913db756e51f$var$addAnyUnits(units, pmAttributes, inputDiv, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, $7e68913db756e51f$var$s_Select, "Units"), p.dictRef, boundary, boundary);
 ...
 * @param boundary The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addAnyUnits(units, attributes, divToAppendTo, id, tagOrDictRef, boundary, level) {
    if (units != undefined) {
        let lws = $7e68913db756e51f$var$getUnitsLabelWithSelect(units, attributes, id, tagOrDictRef, boundary, level);
        if (lws != undefined) divToAppendTo.appendChild(lws);
    } else {
                    ...
                    if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                        ...
                        if (xml_pe != null) {
                            if (xml_pe[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, peAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName), (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mmDiv.appendChild(lwi);
                            }
                        }
                        ...
                        if (xml_ae != null) {
                            if (xml_ae[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, aeAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName), (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mmDiv.appendChild(lwi);
                            }
                        }
                        ...
                        if (xml_ti != null) {
                            if (xml_ti[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, tiAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName), (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mmDiv.appendChild(lwi);
                            }
                        }
                        ...
                        if (xml_ni != null) {
                            if (xml_ni[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, niAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName), (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mmDiv.appendChild(lwi);
                            }
                        }
        ...
        if (xml_PTss.length > 0) {
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    // Create pTpairDiv.
                    pTsDiv.append($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, conditionsIndex, i, moleculeKeys, $7e68913db756e51f$var$level1));
                }
            }
 ...
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDivId, conditionsIndex, pTIndex, moleculeKeys, level) {
    ...
    $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).pressureUnits, pTpair.attributes, pTpairDiv, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$processModelParametersN(modelParameters, xml_modelParameters, modelParametersDiv, ModelParameterType, setModelParameter, removeModelParameter) {
    ...
    if (xml.length == 1) {
        ...
        valueString = "";
        mp = new ModelParameterType(new Map(), $7e68913db756e51f$var$big0);
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
    }
    // Add event listener for the button.
 ...
 */ function $7e68913db756e51f$var$createInputModelParameters(modelParameters, div, element, id, ids, valueString, setElementMethod, units) {
    ...
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    div.appendChild(input);
    $7e68913db756e51f$var$addAnyUnits(units, element.attributes, div, ids, element.constructor.tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
}
/**
...
//# sourceMappingURL=index.a2adb8d0.js.map
