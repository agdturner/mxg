...
class $ef5b9341e5193b70$export$96f29f03cf201f97 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ getHeader() {
        return [
            "T units(" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsT) + ")",
            "H(T)-H(0) units(" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsH) + ")",
            "S(T) units(" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsS) + ")",
            "G(T) units(" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsG) + ")",
            "Cp(T) units(" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsCp) + ")"
        ];
    }
    /**
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let popButtonDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rdDivID, "pop");
    //remove(popButtonDivId);
    let popButtonDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(popButtonDivId);
    rdDiv.appendChild(popButtonDiv);
    let popButtonID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(popButtonDivId, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let popOutText = "Pop into a new Window";
    let popButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(popOutText, popButtonID);
    ...
    saveButton.addEventListener("click", ()=>{
        ...
        a.download = (title + $7e68913db756e51f$var$s_Reactions_Diagram).replace(/[^a-z0-9]/gi, "_") + ".png";
        a.click();
    });
    // Conditions.
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_tts.length > 0) {
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                let saveButtonID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ttDivId, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
                let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as CSV", saveButtonID, $7e68913db756e51f$var$boundary1);
                ...
                saveButton.addEventListener("click", ()=>{
                    ...
                    let title = $7e68913db756e51f$var$mesmer.getTitle()?.value;
                    a.download = title.replace(/[^a-z0-9]/gi, "_") + "_" + mID + "_" + (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName + ".csv";
 ...
 */ function $7e68913db756e51f$var$createProperty(pl, xml, plDiv, molecule, boundary, level) {
    ...
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$2762c8fbc03043ca).dictRef) {
        console.log("VibFreqs");
        $7e68913db756e51f$var$processProperty(pl, p, undefined, molecule, xml, plDiv, boundary, level);
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
                    ...
                    if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                        ...
                        if (xml_nInfinity != null) {
                            if (xml_nInfinity[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, nInfinityAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
        ...
        if (xml_excessReactantConc.length > 0) {
            ...
            let value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_excessReactantConc[0])));
...
//# sourceMappingURL=index.173de5eb.js.map
