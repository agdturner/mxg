...
function $cbb1ac0a822ffab5$export$b12ef0e3d99deb64(rIDM, rlDiv, reactions, molecules) {
    ...
    rb.addEventListener("click", ()=>{
        ...
        $cbb1ac0a822ffab5$var$addAddReactantButton(rIDM, rDivID, rsDiv, molecules, reactants);
        ...
        $cbb1ac0a822ffab5$var$addAddProductButton(rIDM, rDivID, psDiv, molecules, products);
        ...
        $cbb1ac0a822ffab5$var$addAddTransitionStateButton;
 ...
 */ function $cbb1ac0a822ffab5$var$addAddReactantButton(rIDM, rDivID, rsDiv, molecules, reactants) {
 ...
 */ function $cbb1ac0a822ffab5$var$addAddProductButton(rIDM, rDivID, psDiv, molecules, products) {
    ...
    addProductButton.addEventListener("click", ()=>{
        ...
        selectProduct.addEventListener("change", (event)=>{
            ...
            let rmAttributes = new Map();
            let mid = molecule.getID();
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).tagName, mid);
            if (products.has(mid)) {
 ...
 * @param molecules The molecules map.
 * @param reactants The reactants map.
 */ function $cbb1ac0a822ffab5$var$addAddTransitionStateButton(rIDM, rDivID, rsDiv, molecules, transitionStates) {
    // Add an add button to add a reactant.
    let addTSButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
    rsDiv.appendChild(addTSButton);
    addTSButton.addEventListener("click", ()=>{
        ...
        let tsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined);
        rsDiv.insertBefore(tsDiv, addTSButton);
        // Create a selector to select a molecule as a reactant.
        ...
        selectTS.addEventListener("change", (event)=>{
            ...
            tsDiv.id = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).tagName, mid);
            rmAttributes.set((0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba).s_ref, mid);
            let rm = new (0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba)(rmAttributes);
            ...
            let rrb = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(tsDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
                rsDiv.removeChild(tsDiv);
...
function $cbb1ac0a822ffab5$export$ef4959ac45646090(xml, rIDM, reactions, molecules) {
    ...
    if (reactionListTagNames.size > 0) {
        ...
        for(let i = 0; i < xml_reactions.length; i++){
            ...
            $cbb1ac0a822ffab5$var$addAddReactantButton(rIDM, reactionDivID, rsDiv, molecules, reactants);
            // Load products.
            ...
            $cbb1ac0a822ffab5$var$addAddProductButton(rIDM, reactionDivID, psDiv, molecules, products);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, rlDiv, null, (0, $cbb1ac0a822ffab5$export$ef4959ac45646090)(xml, $7e68913db756e51f$var$rIDM, $7e68913db756e51f$var$reactions, $7e68913db756e51f$var$molecules), (0, $69ecbdaa96f3962d$export$44466a39ca846289).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Reactions Diagram.
    let rddDiv = document.getElementById($7e68913db756e51f$var$reactionsDiagramDivID);
...
//# sourceMappingURL=index.dad4f040.js.map
