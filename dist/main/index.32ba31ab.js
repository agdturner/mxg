    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            for(let j = 0; j < xml_reactants.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role", (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).roleOptions, "Role", molecule.role, $7e68913db756e51f$var$addRID(reactantDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_products.length > 0) {
            ...
            for(let j = 0; j < xml_products.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role", (0, $6f7aa7a716962086$export$264ad599d7cef668).roleOptions, molecule.role, molecule.ref, $7e68913db756e51f$var$addRID(psDivID, j, "Role"), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                let select = lws.querySelector("select");
        ...
        if (xml_transitionStates.length > 0) {
            ...
            for(let j = 0; j < xml_transitionStates.length; j++){
                ...
                let label = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(molecule.ref + " role transitionState", $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    for(let i = 0; i < xml_mps.length; i++){
        ...
        $7e68913db756e51f$var$setGrainSize(mp, xml_mps[i], mpDiv);
 ...
 */ function $7e68913db756e51f$var$addGrainSize(mps, mpsDiv) {
    ...
    button.addEventListener("click", ()=>{
        ...
        if (!mps.index.has((0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName)) {
            ...
            mps.removeGrainSize();
            document.getElementById(idi)?.remove();
            document.getElementById($7e68913db756e51f$var$addRID(idi, $7e68913db756e51f$var$s_units))?.remove();
            button.textContent = buttonTextContentDeselected;
        }
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
...
function $7e68913db756e51f$var$getDefaultGrainsize(tagName) {
    ...
    if ($7e68913db756e51f$var$defaults != undefined) {
        ...
        value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))("100");
        attributes = new Map();
 ...
 */ function $7e68913db756e51f$var$createInputModelParameters(mps, div, element, id, valueString, setElementMethod, units) {
    ...
    input.value = valueString;
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    $7e68913db756e51f$var$addAnyUnits(units, element.attributes, div, input, $7e68913db756e51f$var$addRID(id, $7e68913db756e51f$var$s_units), element.constructor.tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
}
/**
 * @param controlsDiv 
 * @param level The level.
...
//# sourceMappingURL=index.32ba31ab.js.map
