 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_atomArrays.length == 1) {
            ...
            for(let j = 0; j < xml_atoms.length; j++){
                ...
                // elementType.
                $7e68913db756e51f$var$processElementType(inputId, atom, atomDiv, false, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                // coordinates.
                $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_bondArrays.length > 0) {
            ...
            for(let j = 0; j < xml_bonds.length; j++){
                ...
                // atomRefs2.
                $7e68913db756e51f$var$processAtomsRefs2(bondDiv, bond, inputId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$fontSize3);
                // order.
        ...
        bondArrayDiv.appendChild($7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, bondArrayDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3, $7e68913db756e51f$var$fontSize4));
        ...
        function create3DViewer() {
            ...
            atomArray.atoms.forEach(function(atom) {
                ...
                else radius = (0, $8677001474399221$export$692079bb871c6039).atomRadii.get(atom.getElementType()) || 1;
                let ax = atom.getX3() || 0;
                let ay = atom.getY3() || 0;
                let az = atom.getZ3() || 0;
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        bondArrayDiv.appendChild($7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, bondArrayDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2, $7e68913db756e51f$var$fontSize2));
        // Properties.
...
function $7e68913db756e51f$var$getAddAtomButton(molecule, moleculeId, atomArrayDiv, typeID, boundary, level, fontSize) {
    ...
    addAtomButton.addEventListener("click", ()=>{
        ...
        // Coordinates.
        $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv, boundary, level);
        let removeAtom = (id)=>molecule.getAtoms().removeAtom(id);
...
function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, bondArrayDiv, typeID, boundary, level, fontSize) {
    ...
    button.addEventListener("click", ()=>{
        ...
        // atomRefs2.
        $7e68913db756e51f$var$processAtomsRefs2(bondDiv, bond, inputId, boundary, boundary, fontSize);
        // order.
...
function $7e68913db756e51f$var$processAtomsRefs2(bondDiv, bond, inputId, boundary, level, fontSize) {
    let atomRefs2 = bond.atomRefs2;
    let atomRefs2lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(inputId, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2), boundary, level, (event)=>{
        let target = event.target;
        bond.setAtomRefs2(target.value);
        console.log((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + " changed from " + atomRefs2 + " to " + target.value);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, atomRefs2, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, fontSize);
...
function $7e68913db756e51f$var$getAddProperty(molecule, moleculeId, bondArrayDiv, typeID, boundary, level, fontSize) {
    ...
    button.addEventListener("click", ()=>{
        ...
        let bondDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, level);
        let inputId = moleculeId + "_" + bondId;
        bondDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_id + " " + bondId, boundary));
        // atomRefs2.
        let atomRefs2 = bond.atomRefs2;
        let atomRefs2lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, boundary, boundary, (event)=>{
            let target = event.target;
            bond.setAtomRefs2(target.value);
        ...
        let orderlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", inputId + "_" + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
            ...
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
        }, orderString, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order, fontSize);
...
function $7e68913db756e51f$var$processElementType(inputId, atom, atomDiv, first, boundary, level) {
    ...
    if (elementType == undefined) {
        ...
        console.log("Atom.s_elementTypes " + (0, $134d19e749bf0414$export$4323cc4280d5be7)((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).elementTypes));
    }
    ...
    $7e68913db756e51f$var$selectAnotherOptionEventListener(selectTypes, lws.querySelector("select"));
    /*
        // Input.
        let lwi: HTMLDivElement = createLabelWithInput("text", getID(inputId, Atom.s_elementType), boundary, boundary,
            (event: Event) => {
                let target = event.target as HTMLInputElement;
                atom.setElementType(target.value);
                console.log(Atom.s_elementType + " changed to " + target.value);
                resizeInputElement(target);
            }, elementType, Atom.s_elementType, fontSize);
...
//# sourceMappingURL=index.f189f7f5.js.map
