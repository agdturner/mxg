...
function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    function createViewer() {
        ...
        molecule.getBonds().bonds.forEach(function(bond) {
            ...
            if (showAtomLabels) viewer.addLabel(bond.getId(), {
                position: {
                    x: (a1x + a2x) / 2,
                    y: (a1y + a2y) / 2,
                    z: (a1z + a2z) / 2
    ...
    let atomLabelbutton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Show " + s_Atom_Labels, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, s_Atom_Labels), $7e68913db756e51f$var$boundary1);
    atomLabelbutton.addEventListener("change", ()=>{
        if (showAtomLabels) {
            atomLabelbutton.textContent = "Show " + s_Atom_Labels;
            showAtomLabels = true;
        } else {
            atomLabelbutton.textContent = "Hide " + s_Atom_Labels;
...
//# sourceMappingURL=index.799928ae.js.map
