    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_edms.length > 0) {
            ...
            if (xml_hrps.length > 0) {
                ...
                hrpDiv.appendChild(useSineTermsLabel);
                ...
                useSineTermsInput.checked = hrp.getUseSineTerms();
                useSineTermsInput.addEventListener('change', (event: Event) => {
                    let target = event.target as HTMLInputElement;
                    hrp.setUseSineTerms(target.checked);
                });
                hrpDiv.appendChild(useSineTermsInput);
                */ // Load PotentialPoints.
                ...
                let ppscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ppscDivID, moleculeDiv, null, ppsDiv, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3);
                hrpDiv.appendChild(ppsDiv);
                let pps = [];
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    let ppDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(ppDivID, $7e68913db756e51f$var$level5);
                    ...
                    ppDiv.appendChild(angleLabel);
                    let angleInputElementId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle);
                    ...
                    angleInputElement.addEventListener("change", (event)=>{
                        ...
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                            ...
                            angleInputElement.value = pp.getAngle().toExponential();
                        }
                        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(angleInputElement);
                    });
                    angleInputElement.value = pp.getAngle().toExponential();
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(angleInputElement);
                    ppDiv.appendChild(angleInputElement);
 ...
 */ function $7e68913db756e51f$var$displayXML(xmlFilename, xml) {
    ...
    // Create collapsible content.
    let xml2Div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(xml2DivID, $7e68913db756e51f$var$level0);
 ...
 */ function $7e68913db756e51f$var$processProperty(p, units, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, level);
        ...
        if (arrayNodes.length > 0) {
            ...
            $7e68913db756e51f$var$addAnyUnits(units, paAttributes, lwi, molecule.id + "_" + p.dictRef + "_Select_Units", p.dictRef, boundary, level);
            plDiv.appendChild(lwi);
        } else {
            // PropertyMatrix.
            ...
            if (matrixNodes.length > 0) {
                ...
                $7e68913db756e51f$var$addAnyUnits(units, pmAttributes, inputDiv, molecule.id + "_" + p.dictRef + "_Select_Units", p.dictRef, boundary, level);
...
function $7e68913db756e51f$export$b1e4cbf5b56e0e21(node, input) {
    if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(input.value)) {
        ...
        let c = 7;
        if (node.value < 0) c = 8;
        let inputString = node.value.toString();
        if (inputString.length > c) input.value = node.value.toExponential();
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    if (xml_ers.length > 0) {
                        ...
                        pTpair.setExperimentalRate(new (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ers[0]), parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_ers[0])))));
                    }
                    // ExperimentalYield.
                    ...
                    if (xml_eys.length > 0) {
                        ...
                        pTpair.setExperimentalYield(new (0, $ae74a7b44a6504a1$export$c291f4faacd745a6)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_eys[0]), parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_eys[0])))));
                    }
                    ...
                    if (xml_ees.length > 0) {
                        ...
                        pTpair.setExperimentalEigenvalue(new (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ees[0]), parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_ees[0])))));
                    }
                    // Create pTpairDiv.
 ...
 */ function $7e68913db756e51f$var$drawReactionDiagram(canvas, dark, font, lw, lwc) {
    ...
    if (canvas != null) {
        ...
        reorders.forEach(function(value) {
            ...
            let energyRescaled = (0, $134d19e749bf0414$export$bd2782c820638828)(energyMin, energyRange, 0, $7e68913db756e51f$var$rdcHeight, energy);
            // Get text width.
...
//# sourceMappingURL=index.bd5889ec.js.map
