...
function $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, moleculeIDs, molecules) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let mDivID = (0, $7e68913db756e51f$export$bea69a603fae01a6)((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName, mid);
        ...
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(mcDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
            mcDiv.removeChild(mDiv);
            molecules.delete(m.getID());
            moleculeIDs.removeID(m.getID());
        });
    });
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        */ // Organise EnergyTransferModel.
        ...
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(mDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
            ...
            moleculeDivIDs.removeID(mDivID);
            molecules.delete(m.getID());
        });
    }
...
function $dde1c59fe054f706$export$7502110c3a5d7b36(xml, modelParametersIDs) {
    ...
    $dde1c59fe054f706$export$5733f83ee927902f(mpsDiv, modelParametersIDs);
    return mpsDiv;
}
/**
 ...
 */ function $180486e70a03b1bd$var$handleCalcMethod(control, cDiv, controlIDM, xml_control, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has(tagName)) {
            ...
            // Remove select.
            //remove(divCmId);
            controlIDM.removeID(divCmDetailsId);
            controlIDM.removeID(divCmDetailsSelectId);
...
//# sourceMappingURL=index.32ca0152.js.map
