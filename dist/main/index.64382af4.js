                ...
                reader.onload = function(e) {
                    ...
                    if (file != null) {
                        if (start < file.size) {
                            ...
                            $cccccb2a0a919d2e$var$parse(xml);
                        }
                    }
                };
...
function $cccccb2a0a919d2e$var$parse(xml) {
    // Process the XML.
    let xml_defaults = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml, $cccccb2a0a919d2e$export$79d0bd4671c1fc67.tagName);
    let attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_defaults);
    console.log((0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(attributes));
}
...
class $991aea17c2d860ae$export$7587e661a05e5158 {
     ...
     */ parse(xml) {
        ...
        if (!mlTagNames.has((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName)) throw new Error('Expecting tags with "' + (0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName + '" tagName but there are none!');
...
const $7e68913db756e51f$var$s_select = "select";
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    // Add Load Molecule Library button.
    let s_Load_molecule_library = "Load Molecule Library (librarymols.xml)";
    let lmlb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_molecule_library, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(s_Load_molecule_library), $7e68913db756e51f$var$boundary1);
    lmlb.addEventListener("click", (event)=>{
        $7e68913db756e51f$var$libraryMolecules = new (0, $991aea17c2d860ae$export$7587e661a05e5158)();
    });
    menuDiv.appendChild(lmlb);
    // Add Load Defaults button.
    let s_Load_default_xml = "Load Defaults (defaults.xml)";
    ...
    wDiv.appendChild(p1);
    p1.appendChild(document.createTextNode("Welcome to MXG - a free and open source program to assist in creating, editing and         visualising MESMER program data. The current MXG development repository is: "));
    ...
    p8.appendChild($7e68913db756e51f$var$t3Dmol_a);
    ...
    p8.appendChild($7e68913db756e51f$var$t3Dmol_citation_a);
    ...
    p9.appendChild($7e68913db756e51f$var$bigjs_a);
    p9.appendChild(document.createTextNode("."));
    // p10.
    let p10 = document.createElement("p");
    wDiv.appendChild(p10);
    p10.textContent = "MXG is a work in progress and not currently recommended for general use, a community release is scheduled at the end of April.         The intention is to allow users to create MESMER files from scratch, but currently the only user pathway is to begin by loading an         existing MESMER file.";
});
/**
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        pap.forEach(function(dictRef) {
            ...
            if (dictRef == "me:Hf0") {
                let value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))("0");
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let options = Array.from($7e68913db756e51f$var$libraryMolecules.molecules.keys());
        $7e68913db756e51f$var$addOrRemoveInstructions(options, true);
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Select molecule", $7e68913db756e51f$var$s_selectOption, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, $7e68913db756e51f$var$s_select), $7e68913db756e51f$var$boundary1);
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = $7e68913db756e51f$var$libraryMolecules.molecules.get(mID);
    ...
    if (scalarNodes.length > 0) {
        ...
        if (arrayNodes.length > 0) {
            ...
            if (matrixNodes.length > 0) {
                ...
                $7e68913db756e51f$var$addAnyUnits(units, pmAttributes, inputDiv, ta, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, $7e68913db756e51f$var$s_select, "Units"), p.dictRef, boundary, boundary);
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            for(let j = 0; j < xml_reactants.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role", (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).roleOptions, "Role", molecule.role, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactantDivID, $7e68913db756e51f$var$s_select), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas, first, id) {
    ...
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, value, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_select), $7e68913db756e51f$var$boundary1);
    select.classList.add((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    $7e68913db756e51f$var$selectAnotherOptionEventListener(options, select);
    // Add event listener to selectElement.
    select.addEventListener("change", (event)=>{
 ...
 */ function $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv) {
    ...
    let ids = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_select);
    let gs;
    let valueString;
    if (xml_mps != null) {
        ...
        if (xml.length == 1) {
            ...
            button.textContent = buttonTextContentSelected;
            $7e68913db756e51f$var$createInputModelParameters(mps, div, gs, idi, ids, valueString, mps.setGrainSize, (0, $8677001474399221$export$692079bb871c6039).energyUnits);
            button.classList.toggle($7e68913db756e51f$var$s_optionOff);
        } else {
            valueString = "";
            gs = new (0, $8883b31bd809eb64$export$26e33f0df9ce919d)(new Map(), $7e68913db756e51f$var$big0);
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        }
    }
 ...
 */ function $7e68913db756e51f$var$processModelParametersN(mps, xml_mps, mpsDiv, mpt, setModelParameter, removeModelParameter) {
    ...
    if (xml_mps != null) {
        ...
        if (xml.length == 1) {
            ...
            button.textContent = buttonTextContentSelected;
            $7e68913db756e51f$var$createInputModelParameters(mps, div, mp, idi, ids, valueString, setModelParameter, undefined);
            button.classList.toggle($7e68913db756e51f$var$s_optionOff);
        } else {
            valueString = "";
 ...
 * @param units The units.
 */ function $7e68913db756e51f$var$createInputModelParameters(mps, div, element, id, ids, valueString, setElementMethod, units) {
    ...
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    div.appendChild(input);
    if (element != undefined) $7e68913db756e51f$var$addAnyUnits(units, element.attributes, div, null, ids, element.constructor.tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
}
/**
 * @param controlsDiv 
 * @param level The level.
...
//# sourceMappingURL=index.64382af4.js.map
