 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        let atomArrayDiv = $7e68913db756e51f$var$createAtomArrayDiv(moleculeId, moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2);
        if (xml_atomArrays.length == 1) {
            ...
            for(let j = 0; j < xml_atoms.length; j++){
                ...
                atomDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_id, atomId), $7e68913db756e51f$var$boundary1));
                // elementType.
                ...
                $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv);
        ...
        atomArrayDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, moleculeId, atomArrayDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3, $7e68913db756e51f$var$fontSize4));
        ...
        // Create an add bond button.
        let addBondButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$addString, undefined, $7e68913db756e51f$var$level3);
        addBondButton.addEventListener("click", ()=>{
            let attributes = new Map();
            attributes.set((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, "Please specify an " + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
            ...
            let atomRefs2lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                let target = event.target;
                bond.setAtomRefs2(target.value);
                console.log("The " + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + " has changed to " + target.value);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
            }, atomRefs2, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
            bondDiv.appendChild(atomRefs2lwi);
            // order.
            let order = bond.getOrder() || 1;
            let orderString = order.toString();
            let orderlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", inputId + "_" + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                let target = event.target;
                bond.setOrder(parseFloat(target.value));
                console.log("The " + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order + " has changed to " + target.value);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
            }, orderString, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order);
            bondDiv.appendChild(orderlwi);
            $7e68913db756e51f$var$addRemoveButton(bondDiv, $7e68913db756e51f$var$boundary1, removeBond, bondId);
            bondArrayDiv.insertBefore(bondDiv, addBondButton);
        });
        bondArrayDiv.appendChild(addBondButton);
        ...
        let viewerContainerDivID = $7e68913db756e51f$var$addID(moleculeId, "viewerContainer");
        let viewerContainerDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(viewerContainerDivID, $7e68913db756e51f$var$level2);
        moleculeDiv.appendChild(viewerContainerDiv);
        let viewerDivID = $7e68913db756e51f$var$addID(moleculeId, "viewer");
        function create3DViewer() {
            //if (moleculeHasCoordinates) {
            let viewerDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(viewerDivID, $7e68913db756e51f$var$level2);
        ...
        //} else {
        // Provide an alert to let the user know that coordinates need adding to the molecule.
        //    alert("Please add coordinates to the molecule to create a 3D viewer.");
        //}
        }
        // Add a redraw button.
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let atomArrayDiv = $7e68913db756e51f$var$createAtomArrayDiv(moleculeId, moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        atomArrayDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, moleculeId, atomArrayDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$fontSize2));
    //let bondArrayDiv: HTMLDivElement = createBondArrayDiv(moleculeId!, moleculeDiv);
    });
    return moleculeListDiv;
}
function $7e68913db756e51f$var$createAtomArrayDiv(moleculeId, moleculeDiv, boundary, level) {
    ...
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        boundary: boundary,
        level: level,
        contentDivId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeId, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName)
    });
    return atomArrayDiv;
}
function $7e68913db756e51f$var$getAddAtomButton(molecule, moleculeId, atomArrayDiv, boundary, level, fontSize) {
    // Create an add atom button.
    let addAtomButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$addString, undefined, level);
    addAtomButton.addEventListener("click", ()=>{
        let attributes = new Map();
        attributes.set((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, "Please specify " + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType);
        ...
        let inputId = moleculeId + "_" + atomId;
        atomDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_id + " " + atomId, boundary));
        let elementType = atom.getElementType();
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, boundary, boundary, (event)=>{
            let target = event.target;
            atom.setElementType(target.value);
            console.log((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType + " changed to " + target.value);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
        }, elementType, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, fontSize);
        atomDiv.appendChild(lwi);
        $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv);
        let removeAtom = (id)=>molecule.getAtoms().removeAtom(id);
 ...
 */ function $7e68913db756e51f$var$processOrder(bond, bondDiv, orderId, order) {
    ...
    button.addEventListener("click", (event)=>{
        if (document.getElementById(orderId) == null) {
            $7e68913db756e51f$var$addOrder(div, bond, orderId, 1, $7e68913db756e51f$var$boundary1);
            button.textContent = buttonTextContentSelected;
        } else {
            // Remove any existing div.
 ...
 */ function $7e68913db756e51f$var$addOrder(div, bond, id, value, boundary) {
    let valueString = (value || NaN).toExponential();
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, "Input"), boundary);
    input.addEventListener("change", (event)=>{
        let target = event.target;
        bond.setOrder(parseFloat(target.value));
...
//# sourceMappingURL=index.3f55b418.js.map
