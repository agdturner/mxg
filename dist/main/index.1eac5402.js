 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            let rsDivID = $7e68913db756e51f$var$addRID(reaction.id, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName);
            ...
            for(let j = 0; j < xml_reactants.length; j++){
                let reactantDivID = $7e68913db756e51f$var$addRID(reaction.id, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName, j);
        ...
        if (xml_MCRCMethod.length > 0) {
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                let mmDivId = $7e68913db756e51f$var$addRID(reaction.id, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName);
        ...
        if (xml_erc.length > 0) {
            ...
            let id = $7e68913db756e51f$var$addRID(reaction.id, (0, $6f7aa7a716962086$export$284227145ed02b04).tagName);
        ...
        if (xml_crl.length > 0) {
            ...
            let crlDivID = $7e68913db756e51f$var$addRID(reaction.id, (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName);
            ...
            if (xml_k.length > 0) {
                ...
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(crlDiv, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (i > 0) {
            let aboveElement = document.getElementById($7e68913db756e51f$var$addRID((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, (i - 1).toString(), $7e68913db756e51f$var$s_container));
 ...
 */ function $7e68913db756e51f$var$createAddModelParametersButton(mpsDiv) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let elementToInsertBefore;
        if (i > 0) {
            let aboveElement = document.getElementById($7e68913db756e51f$var$addRID(tn, (i - 1).toString(), $7e68913db756e51f$var$s_container));
            let nextElementSibling = aboveElement.nextElementSibling;
            // If nextElementSibling is not a child of conditionssDiv the element.
            if (nextElementSibling != null) {
 ...
 */ function $7e68913db756e51f$var$createAddControlButton(controlsDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let elementToInsertBefore;
        if (i > 0) {
            let aboveElement = document.getElementById($7e68913db756e51f$var$addRID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, (i - 1).toString(), $7e68913db756e51f$var$s_container));
            let nextElementSibling = aboveElement.nextElementSibling;
...
//# sourceMappingURL=index.1eac5402.js.map
