...
function $7e68913db756e51f$var$handlePTs(conditions, conditionsDiv, xml_conditions, level, nextLevel) {
        ...
        if (xml_PTss.length > 0) {
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    // Create pTpairDiv.
                    pTsDiv.append($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, i, moleculeKeys, nextLevel));
                }
            }
    ...
    addButton.addEventListener("click", ()=>{
        ...
        pTsDiv.insertBefore($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, pTpairIndex, moleculeKeys, nextLevel), pTsButtonsDiv);
    });
...
//# sourceMappingURL=index.76a5fd57.js.map
