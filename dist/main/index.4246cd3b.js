...
let $7e68913db756e51f$var$rdCanvas;
 ...
 */ function $7e68913db756e51f$var$redrawReactionsDiagram() {
    if ($7e68913db756e51f$var$popWindow == null) $7e68913db756e51f$var$drawReactionDiagram($7e68913db756e51f$var$rdCanvas, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc);
    else {
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let canvas = document.getElementById($7e68913db756e51f$var$rdCanvasId);
    ...
    $7e68913db756e51f$var$rdCanvas = document.createElement("canvas");
    $7e68913db756e51f$var$rdCanvas.id = $7e68913db756e51f$var$rdCanvasId;
    rdDiv.appendChild($7e68913db756e51f$var$rdCanvas);
    //rd_canvas.width = rd_canvas_width;
    $7e68913db756e51f$var$rdCanvas.height = $7e68913db756e51f$var$rdCanvasHeight;
    $7e68913db756e51f$var$rdCanvas.style.border = "1px solid black";
    $7e68913db756e51f$var$drawReactionDiagram($7e68913db756e51f$var$rdCanvas, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc);
    // Add action listener to the pop diagram button.
    popButton.addEventListener("click", ()=>{
        if ($7e68913db756e51f$var$popWindow == null) {
            /**
             * Cloning is necessary for Chrome.
             */ let c = $7e68913db756e51f$var$rdCanvas.cloneNode(true);
            c.id = $7e68913db756e51f$var$rdCanvasId;
...
//# sourceMappingURL=index.4246cd3b.js.map
