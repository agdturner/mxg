...
function $f0396edd0a5c99f7$export$4e9ec2b27757d9dd(type, id, boundary, level, func, value, labelContent, inputFontsize, labelFontsize) {
    ...
    let label = $f0396edd0a5c99f7$export$f2839682b8c07f35(labelContent, boundary, labelFontsize);
    label.htmlFor = id;
...
function $f0396edd0a5c99f7$export$d80fffb1deb3b97e(type, id, boundary) {
...
function $f0396edd0a5c99f7$export$b89bf4b169286865(options, name, id, boundary) {
...
function $f0396edd0a5c99f7$export$cc4306e505fa54b1(textContent, options, name, id, boundary, level) {
    let div = $f0396edd0a5c99f7$export$331ff980f0d45cff(level);
    let label = $f0396edd0a5c99f7$export$f2839682b8c07f35(textContent, boundary);
...
function $f0396edd0a5c99f7$export$331ff980f0d45cff(boundary) {
    let div = document.createElement("div");
    Object.assign(div.style, boundary);
    return div;
}
function $f0396edd0a5c99f7$export$78253536c0178a32(boundary) {
    let div = $f0396edd0a5c99f7$export$331ff980f0d45cff(boundary);
    div.style.display = "flex";
    return div;
}
function $f0396edd0a5c99f7$export$f2839682b8c07f35(textContent, boundary, fontsize) {
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    loadButton.addEventListener("click", $7e68913db756e51f$var$load);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    if (xml_title.length != 1) throw new Error("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found");
        ...
        let titleDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", titleId + "Input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        ...
        }, titleString, "Title", $7e68913db756e51f$var$fontSize1);
        titleDiv.id = titleId;
                    ...
                    potentialInputElement.addEventListener("change", (event)=>{
                        if (event.target instanceof HTMLInputElement) {
                            ...
                            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
                                ...
                                console.log("Set " + (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName + " to " + value.toString());
                            } else {
                                // Reset the input to the current value.
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3, (event)=>{
                if (event.target instanceof HTMLInputElement) {
                    $7e68913db756e51f$export$b1e4cbf5b56e0e21(deltaEDown, event.target);
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    let reactionListDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$boundary1);
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_products.length > 0) {
            ...
            for(let j = 0; j < xml_products.length; j++){
                ...
                let container = (0, $f0396edd0a5c99f7$export$cc4306e505fa54b1)(molecule.ref + " role:", options, molecule.ref + "_" + "Select_Role", "Role", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3);
        ...
        if (xml_excessReactantConc.length > 0) {
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2, (event)=>{
                if (event.target instanceof HTMLInputElement) $7e68913db756e51f$export$b1e4cbf5b56e0e21(excessReactantConc, event.target);
            }, value.toString(), (0, $6f7aa7a716962086$export$284227145ed02b04).tagName);
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    if (xml_grainSizes.length > 0) {
        ...
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", grainSizeId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units.
        $7e68913db756e51f$var$addAnyUnits(undefined, grainSizeAttributes, lwi, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, $7e68913db756e51f$var$boundary1);
    ...
    if (xml_automaticallySetMaxEnes.length > 0) {
        ...
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", automaticallySetMaxEneId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units.
        $7e68913db756e51f$var$addAnyUnits(undefined, automaticallySetMaxEneAttributes, lwi, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, $7e68913db756e51f$var$boundary1);
        modelParametersDiv.appendChild(lwi);
    }
    ...
    if (xml_energyAboveTheTopHills.length > 0) {
        ...
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", energyAboveTheTopHillId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, energyAboveTheTopHillAttributes, lwi, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, $7e68913db756e51f$var$boundary1);
        modelParametersDiv.appendChild(lwi);
    }
    ...
    if (xml_maxTemperatures.length > 0) {
        ...
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", maxTemperatureId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, maxTemperatureAttributes, lwi, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, $7e68913db756e51f$var$boundary1);
        modelParametersDiv.appendChild(lwi);
    }
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    $7e68913db756e51f$var$processCalculateRateCoefficientsOnly(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintCellDOS(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintCellTransitionStateFlux(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintReactionOperatorColumnSums(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintGrainBoltzmann(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintGrainDOS(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintGrainkbE(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintGrainkfE(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintTSsos(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintGrainedSpeciesProfile(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintGrainTransitionStateFlux(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintReactionOperatorSize(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintSpeciesProfile(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintPhenomenologicalEvolution(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintTunnelingCoefficients(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processPrintCrossingCoefficients(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processTestDOS(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processTestRateConstants(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processUseTheSameCellNumberForAllConditions(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processHideInactive(control, controlsDiv, xml_control);
    $7e68913db756e51f$var$processForceMacroDetailedBalance(control, controlsDiv, xml_control);
    ...
    $7e68913db756e51f$var$processAutomaticallySetMaxEne(control, controlsDiv, xml_control);
 ...
 */ function $7e68913db756e51f$var$setCheck(input, xml) {
 ...
 */ function $7e68913db756e51f$var$processCalculateRateCoefficientsOnly(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setCalculateRateCoefficientsOnly(new (0, $b6873406fb778c0b$export$7d9247c9879133fb)());
            else control.removeCalculateRateCoefficientsOnly();
        }
    }, "", (0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName))) control.setCalculateRateCoefficientsOnly(new (0, $b6873406fb778c0b$export$7d9247c9879133fb)());
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintCellDOS(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$60b233651e162b60).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintCellDOS(new (0, $b6873406fb778c0b$export$60b233651e162b60)());
            else control.removePrintCellDOS();
        }
    }, "", (0, $b6873406fb778c0b$export$60b233651e162b60).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$60b233651e162b60).tagName))) control.setPrintCellDOS(new (0, $b6873406fb778c0b$export$60b233651e162b60)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintCellTransitionStateFlux(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintCellTransitionStateFlux(new (0, $b6873406fb778c0b$export$7e63e5104be309ff)());
            else control.removePrintCellTransitionStateFlux();
        }
    }, "", (0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName))) control.setPrintCellTransitionStateFlux(new (0, $b6873406fb778c0b$export$7e63e5104be309ff)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintReactionOperatorColumnSums(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$a915db169f144f37).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintReactionOperatorColumnSums(new (0, $b6873406fb778c0b$export$a915db169f144f37)());
            else control.removePrintReactionOperatorColumnSums();
        }
    }, "", (0, $b6873406fb778c0b$export$a915db169f144f37).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$a915db169f144f37).tagName))) control.setPrintReactionOperatorColumnSums(new (0, $b6873406fb778c0b$export$a915db169f144f37)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainBoltzmann(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$e7fff349901f700d).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintGrainBoltzmann(new (0, $b6873406fb778c0b$export$e7fff349901f700d)());
            else control.removePrintGrainBoltzmann();
        }
    }, "", (0, $b6873406fb778c0b$export$e7fff349901f700d).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$e7fff349901f700d).tagName))) control.setPrintGrainBoltzmann(new (0, $b6873406fb778c0b$export$e7fff349901f700d)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainDOS(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintGrainDOS(new (0, $b6873406fb778c0b$export$d23243bda4dfae2b)());
            else control.removePrintGrainDOS();
        }
    }, "", (0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName))) control.setPrintGrainDOS(new (0, $b6873406fb778c0b$export$d23243bda4dfae2b)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainkbE(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintGrainkbE(new (0, $b6873406fb778c0b$export$55888ef4e813a34d)());
            else control.removePrintGrainkbE();
        }
    }, "", (0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName))) control.setPrintGrainkbE(new (0, $b6873406fb778c0b$export$55888ef4e813a34d)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainkfE(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintGrainkfE(new (0, $b6873406fb778c0b$export$f8d814a406a0ff5b)());
            else control.removePrintGrainkfE();
        }
    }, "", (0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName))) control.setPrintGrainkfE(new (0, $b6873406fb778c0b$export$f8d814a406a0ff5b)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintTSsos(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintTSsos(new (0, $b6873406fb778c0b$export$3627f2b606ffd3cb)());
            else control.removePrintTSsos();
        }
    }, "", (0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName);
    $7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName));
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName))) control.setPrintTSsos(new (0, $b6873406fb778c0b$export$3627f2b606ffd3cb)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainedSpeciesProfile(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintGrainedSpeciesProfile(new (0, $b6873406fb778c0b$export$c5481d114fddc81c)());
            else control.removePrintGrainedSpeciesProfile();
        }
    }, "", (0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName))) control.setPrintGrainedSpeciesProfile(new (0, $b6873406fb778c0b$export$c5481d114fddc81c)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainTransitionStateFlux(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintGrainTransitionStateFlux(new (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab)());
            else control.removePrintGrainTransitionStateFlux();
        }
    }, "", (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName))) control.setPrintGrainTransitionStateFlux(new (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintReactionOperatorSize(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$8420ab6988728a65).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintReactionOperatorSize(new (0, $b6873406fb778c0b$export$8420ab6988728a65)());
            else control.removePrintReactionOperatorSize();
        }
    }, "", (0, $b6873406fb778c0b$export$8420ab6988728a65).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$8420ab6988728a65).tagName))) control.setPrintReactionOperatorSize(new (0, $b6873406fb778c0b$export$8420ab6988728a65)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintSpeciesProfile(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintSpeciesProfile(new (0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1)());
            else control.removePrintSpeciesProfile();
        }
    }, "", (0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName))) control.setPrintSpeciesProfile(new (0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintPhenomenologicalEvolution(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintPhenomenologicalEvolution(new (0, $b6873406fb778c0b$export$9f7939759d8efd9f)());
            else control.removePrintPhenomenologicalEvolution();
        }
    }, "", (0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName))) control.setPrintPhenomenologicalEvolution(new (0, $b6873406fb778c0b$export$9f7939759d8efd9f)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintTunnelingCoefficients(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintTunnelingCoefficients(new (0, $b6873406fb778c0b$export$fc99460819e23ac5)());
            else control.removePrintTunnelingCoefficients();
        }
    }, "", (0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName))) control.setPrintTunnelingCoefficients(new (0, $b6873406fb778c0b$export$fc99460819e23ac5)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintCrossingCoefficients(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setPrintCrossingCoefficients(new (0, $b6873406fb778c0b$export$2f2eaac8983031ef)());
            else control.removePrintCrossingCoefficients();
        }
    }, "", (0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName))) control.setPrintCrossingCoefficients(new (0, $b6873406fb778c0b$export$2f2eaac8983031ef)());
    controlsDiv.appendChild(input);
}
/**
 * Process "me:testDOS".
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processTestDOS(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setTestDOS(new (0, $b6873406fb778c0b$export$a3d7e677521f681f)());
            else control.removeTestDOS();
        }
    }, "", (0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName))) control.setTestDOS(new (0, $b6873406fb778c0b$export$a3d7e677521f681f)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processTestRateConstants(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setTestRateConstants(new (0, $b6873406fb778c0b$export$724a5a49739f4b4a)());
            else control.removeTestRateConstants();
        }
    }, "", (0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName))) control.setTestRateConstants(new (0, $b6873406fb778c0b$export$724a5a49739f4b4a)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processUseTheSameCellNumberForAllConditions(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setUseTheSameCellNumberForAllConditions(new (0, $b6873406fb778c0b$export$5d7dbeba4bf49655)());
            else control.removeUseTheSameCellNumberForAllConditions();
        }
    }, "", (0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName))) control.setUseTheSameCellNumberForAllConditions(new (0, $b6873406fb778c0b$export$5d7dbeba4bf49655)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processHideInactive(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setHideInactive(new (0, $b6873406fb778c0b$export$9d51752a8549e2d6)());
            else control.removeHideInactive();
        }
    }, "", (0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName))) control.setHideInactive(new (0, $b6873406fb778c0b$export$9d51752a8549e2d6)());
    controlsDiv.appendChild(input);
}
/**
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processForceMacroDetailedBalance(control, controlsDiv, xml_control) {
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName + "_checkbox";
    let input = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) control.setForceMacroDetailedBalance(new (0, $b6873406fb778c0b$export$6ffea14bdffd427f)());
            else control.removeForceMacroDetailedBalance();
        }
    }, "", (0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName);
    if ($7e68913db756e51f$var$setCheck(input, xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName))) control.setForceMacroDetailedBalance(new (0, $b6873406fb778c0b$export$6ffea14bdffd427f)());
    controlsDiv.appendChild(input);
}
/**
 ...
 */ function $7e68913db756e51f$var$processTestMicroRates(control, controlsDiv, xml_control) {
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName + "_checkbox";
    ...
    let xml_tmr = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName);
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createTestMicroRates(div, xml_tmr, idTmax, idTmin, idTstep, control);
            else {
    ...
    }, "", (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml_tmr)) $7e68913db756e51f$var$createTestMicroRates(div, xml_tmr, idTmax, idTmin, idTstep, control);
}
/**
 * @param div The div.
 ...
 * @param control The control.
 */ function $7e68913db756e51f$var$createTestMicroRates(div, xml_tmr, idTmax, idTmin, idTstep, control) {
    let attributes;
    let tmr;
    if (xml_tmr.length == 1) {
 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName + "_checkbox";
    let idI = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName + "_input";
    let xml_cm = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName);
    let cm;
    if (xml_cm.length == 1) cm = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_cm[0]), (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_cm[0])));
    else cm = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)(new Map(), "");
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createCalcMethodInput(control, div, cm, idI, cm.value);
            else {
                control.removeTestMicroRates();
    ...
    }, "", (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml_cm)) $7e68913db756e51f$var$createCalcMethodInput(control, div, cm, idI, cm.value);
}
/**
 * @param control The control.
 * @param div The div.
 ...
 */ function $7e68913db756e51f$var$createCalcMethodInput(control, div, cm, id, valueString) {
    let value = cm.value;
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).options, value, id, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processEigenvalues(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName);
    let eigenvalues;
    let valueString;
    if (xml.length == 1) {
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName + "_checkbox";
    let idI = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName + "_input";
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createEigenValuesInput(control, div, eigenvalues, idI, valueString);
            else {
    ...
    }, "", (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml)) $7e68913db756e51f$var$createEigenValuesInput(control, div, eigenvalues, idI, valueString);
}
/**
 * @param control The control.
 * @param div The div.
 ...
 */ function $7e68913db756e51f$var$processShortestTimeOfInterest(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$421603058c6718db).tagName);
    let stoi;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$421603058c6718db).tagName + "_checkbox";
    let idI = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$421603058c6718db).tagName + "_input";
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createShortestTimeOfInterest(control, div, stoi, idI, valueString);
            else {
    ...
    }, "", (0, $b6873406fb778c0b$export$421603058c6718db).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml)) $7e68913db756e51f$var$createShortestTimeOfInterest(control, div, stoi, idI, valueString);
}
/**
 * @param control The control.
 * @param div The div.
 ...
 */ function $7e68913db756e51f$var$createShortestTimeOfInterest(control, div, stoi, id, valueString) {
    ...
    input.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            $7e68913db756e51f$export$b1e4cbf5b56e0e21(stoi, event.target);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
        }
    });
    input.value = valueString;
 ...
 */ function $7e68913db756e51f$var$processMaximumEvolutionTime(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$b51d7314540831ed).tagName);
    let met;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName + "_checkbox";
    let idI = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName + "_input";
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createMaximumEvolutionTimeInput(control, div, met, idI, valueString);
            else {
    ...
    }, "", (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml)) $7e68913db756e51f$var$createMaximumEvolutionTimeInput(control, div, met, idI, valueString);
}
/**
 * @param control The control.
 * @param div The div.
 ...
 */ function $7e68913db756e51f$var$createMaximumEvolutionTimeInput(control, div, met, id, valueString) {
    ...
    input.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            $7e68913db756e51f$export$b1e4cbf5b56e0e21(met, event.target);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
        }
    });
    input.value = valueString;
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processAutomaticallySetMaxEne(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName);
    let asme;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName + "_checkbox";
    let idI = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName + "_input";
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createAutomaticallySetMaxEneInput(control, div, asme, idI, valueString);
            else {
    ...
    }, "", (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml)) $7e68913db756e51f$var$createAutomaticallySetMaxEneInput(control, div, asme, idI, valueString);
}
/**
 * @param control The control.
 * @param div The div.
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createAutomaticallySetMaxEneInput(control, div, asme, id, valueString) {
    control.setAutomaticallySetMaxEne(asme);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            $7e68913db756e51f$export$b1e4cbf5b56e0e21(asme, event.target);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
        }
    });
    input.value = valueString;
 ...
 */ function $7e68913db756e51f$var$processDiagramEnergyOffset(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName);
    let deo;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName + "_checkbox";
    let idI = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName + "_input";
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createDiagramEnergyOffsetInput(control, div, deo, idI, valueString);
            else {
    ...
    }, "", (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml)) $7e68913db756e51f$var$createDiagramEnergyOffsetInput(control, div, deo, idI, valueString);
}
/**
 * @param control The control.
 * @param div The div.
 ...
 */ function $7e68913db756e51f$var$createDiagramEnergyOffsetInput(control, div, deo, id, valueString) {
    ...
    input.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            $7e68913db756e51f$export$b1e4cbf5b56e0e21(deo, event.target);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
        }
    });
    input.value = valueString;
...
//# sourceMappingURL=index.beb5e337.js.map
