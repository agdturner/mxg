 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let existingCanvas = document.getElementById($7e68913db756e51f$var$rdCanvasId);
    ...
    popButton.addEventListener("click", ()=>{
        let cid = $7e68913db756e51f$var$rdCanvasId + "clone";
        if ($7e68913db756e51f$var$popWindow == null) {
            /**
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    let control1 = new (0, $b6873406fb778c0b$export$7a7fa4424cb20976)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_control));
    $7e68913db756e51f$var$mesmer.setControl(control1);
    ...
    $7e68913db756e51f$var$processCalculateRateCoefficientsOnly(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintCellDOS(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintCellTransitionStateFlux(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintReactionOperatorColumnSums(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintGrainBoltzmann(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintGrainDOS(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintGrainkbE(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintGrainkfE(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintTSsos(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintGrainedSpeciesProfile(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintGrainTransitionStateFlux(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintReactionOperatorSize(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintSpeciesProfile(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintPhenomenologicalEvolution(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintTunnelingCoefficients(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processPrintCrossingCoefficients(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processTestDOS(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processTestRateConstants(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processUseTheSameCellNumberForAllConditions(control1, onOffControls, xml_control);
    $7e68913db756e51f$var$processForceMacroDetailedBalance(control1, onOffControls, xml_control);
    ...
    $7e68913db756e51f$var$processTestMicroRates(control1, controlsDiv, xml_control);
    $7e68913db756e51f$var$processCalcMethod(control1, controlsDiv, xml_control);
    $7e68913db756e51f$var$processEigenvalues(control1, controlsDiv, xml_control);
    $7e68913db756e51f$var$processShortestTimeOfInterest(control1, controlsDiv, xml_control);
    $7e68913db756e51f$var$processMaximumEvolutionTime(control1, controlsDiv, xml_control);
    $7e68913db756e51f$var$processAutomaticallySetMaxEneControl(control1, controlsDiv, xml_control);
    $7e68913db756e51f$var$processDiagramEnergyOffset(control1, controlsDiv, xml_control);
    return controlsDiv;
}
/**
 ...
 */ function $7e68913db756e51f$var$processCalculateRateCoefficientsOnly(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setCalculateRateCoefficientsOnly(crco);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName)) {
            control1.setCalculateRateCoefficientsOnly(crco);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removeCalculateRateCoefficientsOnly();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintCellDOS(control1, onOffControls, xml_control) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$60b233651e162b60).tagName)) {
            control1.setPrintCellDOS(pcd);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintCellDOS();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintCellTransitionStateFlux(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintCellTransitionStateFlux(pctsf);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName)) {
            control1.setPrintCellTransitionStateFlux(pctsf);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintCellTransitionStateFlux();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintReactionOperatorColumnSums(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintReactionOperatorColumnSums(proc);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$a915db169f144f37).tagName)) {
            control1.setPrintReactionOperatorColumnSums(proc);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintReactionOperatorColumnSums();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainBoltzmann(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintGrainBoltzmann(pgb);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$e7fff349901f700d).tagName)) {
            control1.setPrintGrainBoltzmann(pgb);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintGrainBoltzmann();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainDOS(control1, onOffControls, xml_control) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName)) {
            control1.setPrintGrainDOS(pgd);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintGrainDOS();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainkbE(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintGrainkbE(pgkbE);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName)) {
            control1.setPrintGrainkbE(pgkbE);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintGrainkbE();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainkfE(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintGrainkfE(pgkfE);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName)) {
            control1.setPrintGrainkfE(pgkfE);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintGrainkfE();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintTSsos(control1, onOffControls, xml_control) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName)) {
            control1.setPrintTSsos(pts);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintTSsos();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainedSpeciesProfile(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintGrainedSpeciesProfile(pgsp);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName)) {
            control1.setPrintGrainedSpeciesProfile(pgsp);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintGrainedSpeciesProfile();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintGrainTransitionStateFlux(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintGrainTransitionStateFlux(pgtsf);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName)) {
            control1.setPrintGrainTransitionStateFlux(pgtsf);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintGrainTransitionStateFlux();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintReactionOperatorSize(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintReactionOperatorSize(pros);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$8420ab6988728a65).tagName)) {
            control1.setPrintReactionOperatorSize(pros);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintReactionOperatorSize();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintSpeciesProfile(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintSpeciesProfile(psp);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName)) {
            control1.setPrintSpeciesProfile(psp);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintSpeciesProfile();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintPhenomenologicalEvolution(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintPhenomenologicalEvolution(ppe);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName)) {
            control1.setPrintPhenomenologicalEvolution(ppe);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintPhenomenologicalEvolution();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintTunnelingCoefficients(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintTunnelingCoefficients(ptc);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName)) {
            control1.setPrintTunnelingCoefficients(ptc);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintTunnelingCoefficients();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processPrintCrossingCoefficients(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setPrintCrossingCoefficients(pcc);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName)) {
            control1.setPrintCrossingCoefficients(pcc);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removePrintCrossingCoefficients();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processTestDOS(control1, onOffControls, xml_control) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName)) {
            control1.setTestDOS(tdos);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removeTestDOS();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processTestRateConstants(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setTestRateConstants(trc);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName)) {
            control1.setTestRateConstants(trc);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removeTestRateConstants();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processUseTheSameCellNumberForAllConditions(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setUseTheSameCellNumberForAllConditions(utsnfac);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName)) {
            control1.setUseTheSameCellNumberForAllConditions(utsnfac);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removeUseTheSameCellNumberForAllConditions();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param onOffControls The on/off controls map.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processForceMacroDetailedBalance(control1, onOffControls, xml_control) {
    ...
    if (xml.length == 1) {
        control1.setForceMacroDetailedBalance(fmd);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName)) {
            control1.setForceMacroDetailedBalance(fmd);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removeForceMacroDetailedBalance();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
            button.classList.toggle("optionOff");
        }
 ...
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processTestMicroRates(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml.length == 1) {
        button.textContent = buttonTextContentSelected;
        $7e68913db756e51f$var$createTestMicroRates(control1, div, xml, idTmax, idTmin, idTstep);
        button.classList.toggle("optionOff");
    } else {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle("optionOn");
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has(tagName)) {
            $7e68913db756e51f$var$createTestMicroRates(control1, div, xml, idTmax, idTmin, idTstep);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
            control1.removeTestMicroRates();
 ...
 */ function $7e68913db756e51f$var$createTestMicroRates(control1, div, xml_tmr, idTmax, idTmin, idTstep) {
    let attributes;
    let tmr;
    if (xml_tmr.length == 1) {
    ...
    control1.setTestMicroRates(tmr);
    // Tmax.
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processCalcMethod(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    ...
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    let divCmId = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + tagName;
    ...
    if (xml.length > 0) {
        ...
        let select = $7e68913db756e51f$var$createSelectElementCalcMethod(control1, div, detailsDivId, options, tagName, ids);
        ...
        if (xsi_type == (0, $b6873406fb778c0b$export$afd374542f6f3da6).xsi_type) {
        ...
        } else if (xsi_type == (0, $b6873406fb778c0b$export$271191b096a55e63).xsi_type) {
            cm = new (0, $b6873406fb778c0b$export$271191b096a55e63)(attributes);
            // Set the select element to the correct value.
            select.value = xsi_type;
        } else if (xsi_type == (0, $b6873406fb778c0b$export$654b70df01671c79).xsi_type) {
            ...
            select.value = xsi_type;
            // Add the details div.
            let detailsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$boundary1);
            detailsDiv.id = detailsDivId;
            divCm.appendChild(detailsDiv);
            $7e68913db756e51f$var$processCalcMethodFitting(detailsDiv, cmf, detailsDivId);
        } else if (xsi_type == (0, $b6873406fb778c0b$export$7968aa666bcf62fa).xsi_type) {
            ...
            detailsDiv.id = detailsDivId;
            divCm.appendChild(detailsDiv);
            $7e68913db756e51f$var$processCalcMethodMarquardt(detailsDiv, cmm, detailsDivId);
        ...
        } else if (xsi_type == (0, $b6873406fb778c0b$export$16ef3f79998b60b4).xsi_type) {
        ...
        } else if (xsi_type == (0, $b6873406fb778c0b$export$a532500cc43efbef).xsi_type) {
...
function $7e68913db756e51f$var$processCalcMethodFitting(detailsDiv, cm, detailsDivId) {
    control.setCalcMethod(cm);
    // FittingIterations.
    let fittingIterations = cm.getFittingIterations();
    if (fittingIterations == undefined) {
        fittingIterations = new (0, $b6873406fb778c0b$export$830a50cd13af6e84)(new Map(), NaN);
        cm.setFittingIterations(fittingIterations);
    }
    detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_FittingIterations_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
            cm.setFittingIterations(new (0, $b6873406fb778c0b$export$830a50cd13af6e84)(new Map(), parseInt(target.value)));
 ...
 */ function $7e68913db756e51f$var$processCalcMethodMarquardt(detailsDiv, cm, detailsDivId) {
    // MarquardtIterations.
    ...
    detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_MarquardtIterations_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
    ...
    detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_MarquardtTolerance_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
    ...
    detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_MarquardtDerivDelta_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
...
function $7e68913db756e51f$var$createSelectElementCalcMethod(control1, div, detailsDivId, options, tagName, ids) {
    ...
    select.addEventListener("change", (event)=>{
        ...
        detailsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$boundary1);
        detailsDiv.id = detailsDivId;
        ...
        control1.setCalcMethod(new (0, $b6873406fb778c0b$export$afd374542f6f3da6)(new Map()));
        ...
        control1.setCalcMethod(new (0, $b6873406fb778c0b$export$271191b096a55e63)(new Map()));
            ...
            let cm = new (0, $b6873406fb778c0b$export$654b70df01671c79)(new Map());
            control1.setCalcMethod(cm);
            $7e68913db756e51f$var$processCalcMethodFitting(control1, detailsDiv, cm, detailsDivId);
            ...
            let cm = new (0, $b6873406fb778c0b$export$7968aa666bcf62fa)(new Map());
            control1.setCalcMethod(cm);
            $7e68913db756e51f$var$processCalcMethodMarquardt(detailsDiv, cm, detailsDivId);
            ...
            let cm = new (0, $b6873406fb778c0b$export$fe9781900d201bdf)(new Map());
            control1.setCalcMethod(cm);
            // "me:format".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", detailsDivId + "_Format_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                cm.setFormat(new (0, $b6873406fb778c0b$export$93514d28bd18d75a)(new Map(), target.value));
                console.log("Set Format to " + target.value);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
            }, "", (0, $b6873406fb778c0b$export$93514d28bd18d75a).tagName));
            // "me:precision".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", detailsDivId + "_Precision_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                cm.setPrecision(new (0, $b6873406fb778c0b$export$be201676156f3e60)(new Map(), target.value));
                console.log("Set Precision to " + target.value);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
            }, "", (0, $b6873406fb778c0b$export$be201676156f3e60).tagName));
            // "me:chebNumTemp".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebNumTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebNumTemp(new (0, $b6873406fb778c0b$export$19d20f3642d82681)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebNumConc".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebNumConc_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebNumConc(new (0, $b6873406fb778c0b$export$906be0805438fd80)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebMaxTemp".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebMaxTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebMaxTemp(new (0, $b6873406fb778c0b$export$6ab4fe1621c91452)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebMinTemp".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebMinTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebMinTemp(new (0, $b6873406fb778c0b$export$e9853d49316ae9ae)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebMaxConc".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebMaxConc_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebMaxConc(new (0, $b6873406fb778c0b$export$39eacc768d7e9bb)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebMinConc".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebMinConc_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebMinConc(new (0, $b6873406fb778c0b$export$78194e57ce26d99a)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebTExSize".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebTExSize_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebTExSize(new (0, $b6873406fb778c0b$export$96094ac7e31a750e)(new Map(), parseFloat(target.value)));
            ...
            // "me:chebPExSize".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_ChebPExSize_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setChebPExSize(new (0, $b6873406fb778c0b$export$ae695595d3952700)(new Map(), parseFloat(target.value)));
            ...
            let cm = new (0, $b6873406fb778c0b$export$16ef3f79998b60b4)(new Map());
            control1.setCalcMethod(cm);
            // "me:Tmin".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_Tmin_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setTmin(new (0, $b6873406fb778c0b$export$7be1a36e1f74dbc7)(new Map(), parseFloat(target.value)));
                    console.log("Set Tmin to " + target.value);
                } else {
                    alert("Value is not numeric, resetting...");
                    target.value = NaN.toString();
            ...
            // "me:Tmid".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_Tmid_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setTmid(new (0, $b6873406fb778c0b$export$ac2eb7df727f506d)(new Map(), parseFloat(target.value)));
            ...
            // "me:Tmax".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_Tmax_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setTmax(new (0, $b6873406fb778c0b$export$58c8f4b7ec654137)(new Map(), parseFloat(target.value)));
                    console.log("Set Tmax to " + target.value);
                } else {
                    alert("Value is not numeric, resetting...");
                    target.value = NaN.toString();
            ...
            // "me:Tstep".
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_Tstep_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setTstep(new (0, $b6873406fb778c0b$export$7b8cfe3a6a460886)(new Map(), parseFloat(target.value)));
                    console.log("Set Tstep to " + target.value);
                } else {
                    alert("Value is not numeric, resetting...");
                    target.value = NaN.toString();
            ...
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_SensitivityAnalysisSamples_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setSensitivityAnalysisSamples(new (0, $b6873406fb778c0b$export$37d0520a9fac7849)(new Map(), parseFloat(target.value)));
            ...
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_SensitivityAnalysisOrder_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setSensitivityAnalysisOrder(new (0, $b6873406fb778c0b$export$9a832710e54827ea)(new Map(), parseFloat(target.value)));
            ...
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", detailsDivId + "_SensitivityNumVarRedIters_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                // Check the value is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    cm.setSensitivityNumVarRedIters(new (0, $b6873406fb778c0b$export$b43b57458ce8fb96)(new Map(), parseFloat(target.value)));
            ...
            detailsDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", detailsDivId + "_SensitivityVarRedMethod_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                let target = event.target;
                cm.setSensitivityVarRedMethod(new (0, $b6873406fb778c0b$export$e98aeac6c6b1df09)(new Map(), target.value));
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processEigenvalues(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = buttonTextContentSelected;
        $7e68913db756e51f$var$createEigenValuesInput(control1, div, eigenvalues, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName)) {
            $7e68913db756e51f$var$createEigenValuesInput(control1, div, eigenvalues, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
 ...
 * @param id The id.
 * @param valueString The value string. 
 */ function $7e68913db756e51f$var$createEigenValuesInput(control1, div, eigenvalues, id, valueString) {
    control1.setEigenvalues(eigenvalues);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processShortestTimeOfInterest(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = buttonTextContentSelected;
        $7e68913db756e51f$var$createShortestTimeOfInterest(control1, div, stoi, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$421603058c6718db).tagName)) {
            $7e68913db756e51f$var$createShortestTimeOfInterest(control1, div, stoi, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
            ...
            control1.removeShortestTimeOfInterest();
            // Remove any existing div.
            document.getElementById(id)?.remove();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createShortestTimeOfInterest(control1, div, stoi, id, valueString) {
    control1.setShortestTimeOfInterest(stoi);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processMaximumEvolutionTime(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = buttonTextContentSelected;
        $7e68913db756e51f$var$createMaximumEvolutionTimeInput(control1, div, met, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$b51d7314540831ed).tagName)) {
            $7e68913db756e51f$var$createMaximumEvolutionTimeInput(control1, div, met, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
            ...
            control1.removeMaximumEvolutionTime();
            // Remove any existing div.
            document.getElementById(id)?.remove();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createMaximumEvolutionTimeInput(control1, div, met, id, valueString) {
    control1.setMaximumEvolutionTime(met);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processAutomaticallySetMaxEneControl(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let tagName = (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName;
    let xml = xml_control.getElementsByTagName(tagName);
    ...
    if (xml.length == 1) {
        ...
        asme = new (0, $b6873406fb778c0b$export$576b56ca6e34780b)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml[0]), value);
        button.textContent = buttonTextContentSelected;
        $7e68913db756e51f$var$createAutomaticallySetMaxEneInputControl(control1, div, asme, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
        asme = new (0, $b6873406fb778c0b$export$576b56ca6e34780b)(new Map(), NaN);
    ...
    button.addEventListener("click", (event)=>{
        // Check if the AutomaticallySetMaxEne already exists
        if (!control1.index.has((0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName)) {
            $7e68913db756e51f$var$createAutomaticallySetMaxEneInputControl(control1, div, asme, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
            ...
            valueString = asme.value.toExponential();
            control1.removeAutomaticallySetMaxEne();
            // Remove any existing div.
            document.getElementById(id)?.remove();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createAutomaticallySetMaxEneInputControl(control1, div, asme, id, valueString) {
    control1.setAutomaticallySetMaxEne(asme);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
        $7e68913db756e51f$export$b1e4cbf5b56e0e21(asme, target);
 ...
 * @param controlsDiv The controls div.
 * @param xml_control The xml control.
 */ function $7e68913db756e51f$var$processDiagramEnergyOffset(control1, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = buttonTextContentSelected;
        $7e68913db756e51f$var$createDiagramEnergyOffsetInput(control1, div, deo, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control1.index.has((0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName)) {
            $7e68913db756e51f$var$createDiagramEnergyOffsetInput(control1, div, deo, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
            ...
            control1.removeDiagramEnergyOffset();
            // Remove any existing div.
            document.getElementById(id)?.remove();
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle("optionOn");
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createDiagramEnergyOffsetInput(control1, div, deo, id, valueString) {
    control1.setDiagramEnergyOffset(deo);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
...
//# sourceMappingURL=index.a332fcae.js.map
