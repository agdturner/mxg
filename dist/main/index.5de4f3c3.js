 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    for(let i = 0; i < xml_pl.length; i++){
        ...
        // Create Tables
        let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
    ...
    //addSaveAsCSVButton(PopulationList.toCSV, pDiv, tableDiv, labelText, boundary1);
    }
    return aDiv;
}
/**
 ...
 */ function $7e68913db756e51f$var$addSaveAsCSVButton(toCSV, divToAddTo, elementToInsertBefore, name, margin) {
    ...
    b.addEventListener("click", ()=>{
        let csv = toCSV();
        let title = $7e68913db756e51f$var$mesmer.getTitle()?.value;
        $7e68913db756e51f$var$saveDataAsFile(csv, "text/csv", $7e68913db756e51f$var$getFilename(title + "_" + name) + ".csv");
    });
}
...
//# sourceMappingURL=index.5de4f3c3.js.map
