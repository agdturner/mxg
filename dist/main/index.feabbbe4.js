...
class $cc8c7201a9bad777$export$82583fad49645fc9 extends $cc8c7201a9bad777$export$ca4ceee82ec565dc {
     ...
     */ toXML(padding) {
        ...
        let c;
        if (this.value < new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(0)) c = 7;
        else c = 6;
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_pls.length == 1) {
            ...
            // There is a Property on its own. For consistency, this is stored in a PropertyList.
            // Create a new PropertyList.
 ...
 */ function $7e68913db756e51f$var$createProperty(pl, xml, plDiv, molecule, boundary, level) {
    ...
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml, plDiv, false, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(pl, p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml, plDiv, false, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$2762c8fbc03043ca).dictRef) {
        console.log("VibFreqs");
        $7e68913db756e51f$var$processProperty(pl, p, undefined, molecule, xml, plDiv, true, boundary, level);
    } else $7e68913db756e51f$var$processProperty(pl, p, undefined, molecule, xml, plDiv, false, boundary, level);
    return p;
}
/**
 ...
 * @param setter The setter function.
 * @param margin The margin.
 */ function $7e68913db756e51f$var$processNumberArray(id, name, getter, setter, remover, marginComponent, margin) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, margin);
    let buttonTextContentSelected = name + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = name + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), marginComponent);
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addNumberArray(div, inputId, name, value, setter, marginComponent);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
    }
    // Add event listener for the button.
 ...
 * @param boundary The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addNumberArray(div, id, name, values, setter, boundary) {
    let valueString;
    ...
    ta.addEventListener("change", (event)=>{
        let target = event.target;
        try {
            setter((0, $134d19e749bf0414$export$8cfbaad830aa9e0a)(target.value.trim().split(/\s+/)));
 ...
 */ function $7e68913db756e51f$var$processProperty(pl, p, units, molecule, element, plDiv, textArea, boundary, level) {
    // PropertyScalar.
    ...
    if (scalarNodes.length > 0) {
        ...
        if (arrayNodes.length > 0) {
            ...
            let psAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(arrayNodes[0]);
            pa.setValues = (function(values) {
                pa.values = values;
                console.log("Set " + p.dictRef + " of " + molecule.getID() + " to " + values);
            }).bind(pa);
            let div = $7e68913db756e51f$var$processNumberArray((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), p.dictRef, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            $7e68913db756e51f$var$addAnyUnits(units, psAttributes, div, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
            plDiv.appendChild(div);
        /*
            if (textArea) {
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            // Create a new div element for the input.
            let id = molecule.getID() + "_" + (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName + "_" + (0, $ef5b9341e5193b70$export$16fc56ab40b12b45).tagName + "_" + k;
...
function $7e68913db756e51f$export$819b5ff7dff3652c(node, input) {
    ...
    inputStrings.forEach(function(value) {
        ...
        values.push(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(value));
    });
    if (!success) {
...
//# sourceMappingURL=index.feabbbe4.js.map
