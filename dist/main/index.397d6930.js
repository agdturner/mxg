 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    // Create Save button.
    let s_Save = "Save To MESMER File";
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        // Atoms may or may not be in an AtomArray.
        // This implementation allows for there to be multiple AtomArray elements.
        // If AtomArray elements have attributes, a warning is sent to the console as these get lost/ignored.
        // Atoms will be stored in a single AtomArray.
        let aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map());
        m.setAtoms(aa);
        for(let j = 0; j < xml_aas.length; j++){
            let xml_aa = xml_aas[j];
            let aa_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_aa);
            if (aa_attributes.size > 0) console.warn("AtomArray has attributes but these get lost/ignored: " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(aa_attributes));
        }
        let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        m.setAtoms(aa);
        ...
        // Bonds may or may not be in an BondArray.
        // This implementation allows for there to be multiple BondArray elements.
        // If BondArray elements have attributes, a warning is sent to the console as these get lost/ignored.
        // Bonds will be stored in a single BondArray.
        let ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)(new Map());
        m.setBonds(ba);
        for(let j = 0; j < xml_bas.length; j++){
            let xml_ba = xml_bas[j];
            let ba_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ba);
            if (ba_attributes.size > 0) console.warn("BondArray has attributes but these get lost/ignored: " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(ba_attributes));
        }
        ...
        let xml_pls = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        if (xml_pls.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName + " but finding " + xml_pls.length + "!");
        // Get a set of property dictRefs: 
        ...
        if (xml_pls.length == 1) {
            ...
            if (xml_ps.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName + " but finding " + xml_ps.length + ". Should these be in a " + (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName + "?");
            // Create a new Property.
            let p = $7e68913db756e51f$var$createProperty(pap, pl, xml_ps[0], mDiv, m, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            pl.setProperty(p);
            // Add Properties not in xml_ps.
            pap.forEach(function(dictRef) {
                console.log("dictRef=" + dictRef);
 ...
 */ function $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv) {
    ...
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $8883b31bd809eb64$export$77f098867dc64198).tagName, tagName);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$createInputModelParameters(mps, div, element, id, ids, valueString, setElementMethod, units) {
    ...
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    div.appendChild(input);
    $7e68913db756e51f$var$addAnyUnits(units, element.attributes, div, null, ids, element.constructor.tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
}
/**
...
//# sourceMappingURL=index.397d6930.js.map
