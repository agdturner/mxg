...
function $f0396edd0a5c99f7$export$4e9ec2b27757d9dd(type, id, boundary, level, func, value, labelTextContent, inputFontsize) {
    ...
    let div = $f0396edd0a5c99f7$export$78253536c0178a32(undefined, level);
...
function $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4(textContent, options, name, value, id, componentMargin, divMargin) {
    let div = $f0396edd0a5c99f7$export$331ff980f0d45cff(undefined, divMargin);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let conditionsListDivId = $7e68913db756e51f$var$addID("conditionsList");
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_atomArrays.length == 1) {
            ...
            for(let j = 0; j < xml_atoms.length; j++){
                ...
                **/ atomDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_id + " " + atomId, $7e68913db756e51f$var$boundary1));
                ...
                // Coordinates.
                moleculeHasCoordinates = $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv);
        ...
        let addAtomButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$addString, undefined, $7e68913db756e51f$var$level3);
        ...
        if (xml_bondArrays.length > 0) {
            ...
            for(let j = 0; j < xml_bonds.length; j++){
                ...
                bondDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_id + " " + bondId, $7e68913db756e51f$var$boundary1));
                // atomRefs2.
                let atomRefs2 = bond.atomRefs2;
                let atomRefs2lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                    let target = event.target;
                    bond.setAtomRefs2(target.value);
                    console.log("The " + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + " has changed from " + atomRefs2 + " to " + target.value);
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, atomRefs2, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, $7e68913db756e51f$var$fontSize3);
                bondDiv.appendChild(atomRefs2lwi);
                // order.
                let orderId = inputId + "_" + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order;
                $7e68913db756e51f$var$processOrder(bond, bondDiv, orderId, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order);
        ...
        if (moleculeHasCoordinates) {
            let viewerDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$level2);
            ...
            atomArray.atoms.forEach(function(atom) {
                let color = (0, $8677001474399221$export$692079bb871c6039).atomColors.get(atom.getElementType()) || "Purple";
                let am = (0, $8677001474399221$export$692079bb871c6039).atomMasses.get(atom.getElementType()) || 1;
                let radius = (0, $8677001474399221$export$692079bb871c6039).atomRadii.get(atom.getElementType()) || 1;
 ...
 */ function $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv) {
 ...
 */ function $7e68913db756e51f$var$processCoordinate(atom, atomDiv, id, coordinate, getter, setter) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$boundary1);
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addCoordinate(div, atom, id + "_input", value, setter, coordinate, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$addRemoveButton(div, margin, removeFunction, ...args) {
    ...
    div.appendChild(button);
    button.style.fontSize = $7e68913db756e51f$var$fontSize4;
 ...
 */ function $7e68913db756e51f$var$processOrder(bond, bondDiv, orderId, order) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$boundary1);
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addOrder(div, bond, orderId, value, $7e68913db756e51f$var$boundary1);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle("optionOff");
    }
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
        ...
        if (document.getElementById(orderId) == null) {
            $7e68913db756e51f$var$addOrder(div, bond, orderId, NaN, $7e68913db756e51f$var$boundary1);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    for(let i = 0; i < xml_conditionss.length; i++){
        ...
        let conditionsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$boundary1);
        conditionsDiv.id = "conditions" + i.toString();
        let conditions = new (0, $ae74a7b44a6504a1$export$363c7374d425f4ad)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_conditions), i);
        ...
        if (xml_PTss.length > 0) {
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    // Create pTpairDiv.
                    $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, i, moleculeKeys, nextLevel);
                }
            }
        ...
        let addButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$addString, undefined, nextLevel);
        ...
        addButton.addEventListener("click", ()=>{
            ...
            $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, pTpairIndex, moleculeKeys, nextLevel);
        });
        ...
        addMultipleButton.addEventListener("click", ()=>{
            ...
            let inputElement = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", addFromSpreadsheetId, nextLevel);
 ...
 * @param level The level.
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, index, moleculeKeys, level) {
    ...
    // ExcessReactantConc.
    $7e68913db756e51f$var$addButtonWithToggle(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_excessReactantConc, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_excessReactantConc + index, [
        pTpair
    ...
    // Precision.
    $7e68913db756e51f$var$addButtonWithToggle(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_precision, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_precision + index, [
        pTpair
    ], $7e68913db756e51f$var$createPrecisionSelectElement);
    // BathGas.
    $7e68913db756e51f$var$addButtonWithToggle(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName + index, [
        pTpair,
        moleculeKeys,
        true
    ], $7e68913db756e51f$var$createBathGasSelectElement);
    // ExperimentalRate.
    $7e68913db756e51f$var$addExperimentalDetails(pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + "_" + index, (pTpair)=>pTpair.getExperimentalRate(), (pTpair, value)=>pTpair.setExperimentalRate(value), (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b), [
        {
    ...
    // ExperimentalYield.
    $7e68913db756e51f$var$addExperimentalDetails(pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName + "_" + index, (pTpair)=>pTpair.getExperimentalYield(), (pTpair, value)=>pTpair.setExperimentalYield(value), (0, $ae74a7b44a6504a1$export$c291f4faacd745a6), [
        {
    ...
    // ExperimentalEigenvalue.
    $7e68913db756e51f$var$addExperimentalDetails(pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName + "_" + index, (pTpair)=>pTpair.getExperimentalEigenvalue(), (pTpair, value)=>pTpair.setExperimentalEigenvalue(value), (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1), [
        {
    ...
    $7e68913db756e51f$var$addRemoveButton(pTpairDiv, $7e68913db756e51f$var$boundary1, removePTpair, pTpairDiv, index, pTpair);
    return pTpairDiv;
}
/**
 * @param pTpairDiv The pTpair div.
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    for(let i = 0; i < xml_controls.length; i++){
        ...
        let controlID = $7e68913db756e51f$var$addID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, i.toString());
        ...
        $7e68913db756e51f$var$getControlOptionsSimple(control).forEach((option)=>{
            $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, xml_control, null, option.class, option.setMethod, option.removeMethod);
        });
        ...
        $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, xml_control, level, (0, $b6873406fb778c0b$export$1f37c7c73e401f31), control.setTestMicroRates, control.removeTestMicroRates);
        ...
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, xml_control, level, item.class, item.setMethod, item.removeMethod);
        });
 ...
 */ function $7e68913db756e51f$var$createAddControlButton(controlsDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let onOffControls = new Map();
        $7e68913db756e51f$var$getControlOptionsSimple(control).forEach((option)=>{
            $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, null, null, option.class, option.setMethod, option.removeMethod);
        });
        // Create a div for the on/off controls.
        let onOffControlsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, level);
        let orderedOnOffControls = new Map([
        ...
        controlDiv.appendChild(onOffControlsDiv);
        // Controls with additional things to set.
        $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, null, level, (0, $b6873406fb778c0b$export$1f37c7c73e401f31), control.setTestMicroRates, control.removeTestMicroRates);
        $7e68913db756e51f$var$handleCalcMethod(control, controlDiv, i, null, level);
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, null, level, item.class, item.setMethod, item.removeMethod);
        });
        // Add a remove control button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(controlDiv, $7e68913db756e51f$var$level2, $7e68913db756e51f$var$mesmer.removeControl.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
 ...
 */ function $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, xml_control, level, ControlClass, setControlMethod, removeControlMethod, handleInput = false) {
    ...
    if (level) {
        ...
        div.appendChild(button);
        id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + tagName + "_input";
    }
    if (xml_control) {
    ...
    } else controlInstance = new ControlClass(new Map());
    button.addEventListener("click", (event)=>{
 ...
 */ function $7e68913db756e51f$var$handleCalcMethod(control, controlDiv, i, xml_control, level) {
    ...
    let divCmId = $7e68913db756e51f$var$addID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName, i.toString());
    ...
    if (xml_control) {
        ...
        if (xml.length > 0) {
            ...
            cm = $7e68913db756e51f$var$getCalcMethod(control, div, xml, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId, divCm);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has(tagName)) {
            ...
            let select = $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, options, tagName, $7e68913db756e51f$var$selectAnotherOption, divCmDetailsId, divCmDetailsSelectId);
 ...
 */ function $7e68913db756e51f$var$getCalcMethod(control, div, xml, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId, divCm) {
    let cm;
    // Create the select element.
    let select = $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, options, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId);
 ...
 */ function $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, options, tagName, value, divCmDetailsId, divCmDetailsSelectId) {
    ...
    select.addEventListener("change", (event)=>{
        ...
        divCmDetails = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$boundary1);
...
//# sourceMappingURL=index.e7288202.js.map
