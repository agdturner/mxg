...
function $f0396edd0a5c99f7$export$8b2cd46c11844202({ divToAddTo: divToAppendTo, elementToInsertBefore: elementToInsertBefore, content: content, buttonLabel: buttonLabel, buttonId: buttonId, margin: margin = {
    marginLeft: "",
    marginTop: "",
    marginBottom: "",
    marginRight: ""
}, contentDivId: contentDivId = "", contentDivClassName: contentDivClassName = "" }) {
    let div = $f0396edd0a5c99f7$export$331ff980f0d45cff(contentDivId);
    div.className = contentDivClassName;
    //let button: HTMLButtonElement = document.createElement('button');
    //button.id = contentDivId + 'Button';
    //button.innerText = `${buttonLabel} ▼`;
    let button = $f0396edd0a5c99f7$export$9b6d6ca62970729f(`${buttonLabel} \u{25BC}`, buttonId, margin);
 ...
 */ // Symbols.
let $7e68913db756e51f$var$sy_downTriangle = "\u25BC"; // ▼
let $7e68913db756e51f$var$sy_upTriangle = "\u25B2"; // ▲
let $7e68913db756e51f$var$sy_edit = "\u270E"; // ✎
let $7e68913db756e51f$var$sy_add = "\uFF0B"; // ＋
let $7e68913db756e51f$var$sy_remove = "\u2715"; // ✕
let $7e68913db756e51f$var$sy_refresh = "\u27F3"; // ⟳
let $7e68913db756e51f$var$sy_selected = " \u2713"; // ✓
let $7e68913db756e51f$var$sy_deselected = " \u2717"; // ✗
// Strings.
let $7e68913db756e51f$var$s_Add_sy_add = "Add " + $7e68913db756e51f$var$sy_add;
let $7e68913db756e51f$var$s_Add_from_spreadsheet = "Add from spreadsheet " + $7e68913db756e51f$var$sy_add;
let $7e68913db756e51f$var$s_button = "button";
...
let $7e68913db756e51f$var$s_Refresh_sy_refresh = "Refresh " + $7e68913db756e51f$var$sy_refresh;
let $7e68913db756e51f$var$s_Remove_sy_remove = "Remove " + $7e68913db756e51f$var$sy_remove;
let $7e68913db756e51f$var$s_Rename = "Rename";
let $7e68913db756e51f$var$s_Select = "Select";
let $7e68913db756e51f$var$s_selectOption = "Select an option (use keys to cycle through options)...";
// HTML IDs
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeListDiv.id, $7e68913db756e51f$var$s_button),
        margin: $7e68913db756e51f$var$level0,
    ...
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactionsListDiv.id, $7e68913db756e51f$var$s_button),
        margin: $7e68913db756e51f$var$level0,
    ...
    //remove(saveButtonID);
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save To PNG Image File", saveButtonID, $7e68913db756e51f$var$boundary1);
    ...
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionssDiv.id, $7e68913db756e51f$var$s_button),
        margin: $7e68913db756e51f$var$level0,
    ...
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(modelParametersListDiv.id, $7e68913db756e51f$var$s_button),
        margin: $7e68913db756e51f$var$level0,
    ...
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(controlsDiv.id, $7e68913db756e51f$var$s_button),
        margin: $7e68913db756e51f$var$level0,
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        let atomArrayDiv = $7e68913db756e51f$var$getCollapsibleContentDiv(moleculeId, moleculeDiv, null, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, $7e68913db756e51f$var$level2);
        ...
        if (xml_atomArrays.length == 1) {
            ...
            for(let j = 0; j < xml_atoms.length; j++){
                // Create a new Atom.
                let atom = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_atoms[j]), molecule);
                ...
                // elementType.
                $7e68913db756e51f$var$processElementType(inputId, atom, atomDiv, false, $7e68913db756e51f$var$boundary1);
                // coordinates.
                $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv, $7e68913db756e51f$var$boundary1);
                $7e68913db756e51f$var$addRemoveButton(atomDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$removeAtom, molecule, atomId);
            }
            ...
            if (xml_atoms.length == 1) {
                ...
                atomArray.addAtom(new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_atoms[0]), molecule));
                molecule.setAtoms(atomArray);
        ...
        atomArrayDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, atomArrayDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3));
        ...
        let bondArrayDiv = $7e68913db756e51f$var$getCollapsibleContentDiv(moleculeId, moleculeDiv, null, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, $7e68913db756e51f$var$level2);
        if (xml_bondArrays.length > 0) {
            ...
            for(let j = 0; j < xml_bonds.length; j++){
                // Create a new Bond.
                let bond = new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bonds[j]), molecule);
            ...
            if (xml_bonds.length > 0) {
                ...
                bondArray.addBond(new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bonds[0]), molecule));
                molecule.setBonds(bondArray);
            }
        }
        ...
        if (xml_PLs.length == 1) {
            ...
            let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
            (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
                divToAddTo: moleculeDiv,
                elementToInsertBefore: null,
                content: plDiv,
                buttonLabel: (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName,
                buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, $7e68913db756e51f$var$s_button),
                margin: $7e68913db756e51f$var$level2,
        ...
        if (xml_ExtraDOSCMethod.length > 0) {
            ...
            let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName);
            (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
                divToAddTo: moleculeDiv,
                elementToInsertBefore: null,
                content: extraDOSCMethodDiv,
                buttonLabel: (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName,
                buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_button),
                margin: $7e68913db756e51f$var$level2,
                contentDivId: contentDivId
            });
            // Read bondRef.
            ...
            if (xml_hinderedRotorPotentials.length > 0) {
                ...
                let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
                (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
                    ...
                    buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_button),
                    margin: $7e68913db756e51f$var$level3,
                    contentDivId: contentDivId
                });
                // Format.
                ...
                let potentialPointContentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName);
                let potentialPointCollapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
                    ...
                    buttonId: (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(potentialPointContentDivId, $7e68913db756e51f$var$s_button),
                    margin: $7e68913db756e51f$var$level4,
        ...
        let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.tagName, molecule.id);
        ...
        (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
            ...
            buttonId: buttonId,
            margin: $7e68913db756e51f$var$level1,
            contentDivId: contentDivId
        });
    }
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let buttonId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_button);
        // Create a new collapsible div for the molecule.
        let div = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
            divToAddTo: moleculeListDiv,
        ...
        // Add a rename button.
        let renameButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Rename, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_Rename), $7e68913db756e51f$var$level1);
        renameButton.addEventListener("click", ()=>{
            ...
            if (newMoleculeId != null) {
                ...
                $7e68913db756e51f$var$removeOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.id);
                molecule.id = mid;
                moleculeDiv.id = mid;
        ...
        // Atoms.
        let atomArrayDiv = $7e68913db756e51f$var$getCollapsibleContentDiv(moleculeId, moleculeDiv, null, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, $7e68913db756e51f$var$level1);
        atomArrayDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, atomArrayDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2));
        // Bonds.
        let bondArrayDiv = $7e68913db756e51f$var$getCollapsibleContentDiv(moleculeId, moleculeDiv, null, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, $7e68913db756e51f$var$level1);
        ...
        // Properties.
        let propertiesDiv = $7e68913db756e51f$var$getCollapsibleContentDiv(moleculeId, moleculeDiv, null, (0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName, (0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$getCollapsibleContentDiv(moleculeId, divToAddTo, elementToInsertBefore, buttonLabel, typeID, level) {
    let div = document.createElement("div");
    let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeId, typeID);
    let buttonId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_button);
    (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, atomArrayDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        let attributes = new Map();
        let atom = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)(attributes, molecule);
        let atomId = molecule.getAtoms().addAtom(atom);
        let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, atomId);
        let atomDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, level);
        atomDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(atomId, boundary));
        // elementType.
        $7e68913db756e51f$var$processElementType(id, atom, atomDiv, true, boundary);
        // Coordinates.
        $7e68913db756e51f$var$processCoordinates(id, atom, atomDiv, boundary);
        $7e68913db756e51f$var$addRemoveButton(atomDiv, boundary, $7e68913db756e51f$var$removeAtom, molecule, atomId);
        ...
        $7e68913db756e51f$var$addOptionByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, atomId);
    });
    return button;
}
...
function $7e68913db756e51f$var$processElementType(inputId, atom, atomDiv, first, boundary) {
 ...
 */ function $7e68913db756e51f$var$processCoordinates(inputId, atom, atomDiv, boundary) {
    let x3id = inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3;
    $7e68913db756e51f$var$processCoordinate(atomDiv, x3id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, atom.getX3.bind(atom), atom.setX3.bind(atom), boundary);
    let y3id = inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3;
    $7e68913db756e51f$var$processCoordinate(atomDiv, y3id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, atom.getY3.bind(atom), atom.setY3.bind(atom), boundary);
    let z3id = inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3;
    $7e68913db756e51f$var$processCoordinate(atomDiv, z3id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, atom.getZ3.bind(atom), atom.setZ3.bind(atom), boundary);
}
/**
 ...
 * @param boundary The boundary.
 */ function $7e68913db756e51f$var$processCoordinate(atomDiv, id, coordinate, getter, setter, boundary) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, "Button"), boundary);
    div.appendChild(button);
    ...
    button.addEventListener("click", (event)=>{
        if (document.getElementById(inputId) == null) {
            $7e68913db756e51f$var$addCoordinate(div, inputId, 0, setter, boundary);
            button.textContent = buttonTextContentSelected;
        } else {
            // Remove existing.
 ...
 */ function $7e68913db756e51f$var$processOrder(bondDiv, bond, inputId, order, margin) {
    ...
    let buttonTextContentSelected = order + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = order + $7e68913db756e51f$var$sy_deselected;
...
function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save Image", undefined);
    saveButton.addEventListener("click", ()=>{
...
//# sourceMappingURL=index.dcbea873.js.map
