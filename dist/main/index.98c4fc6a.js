    ...
    while(true){
        ...
        if (mid2 == null) alert("The molecule ID cannot be null.");
            ...
            if (mid == mid2) {
                ...
                return mid;
            } else alert("The molecule ID " + mid2 + " is already in use.");
        } else {
            mid = mid2;
            if (molecule != undefined) {
                molecule.setID(mid);
...
//# sourceMappingURL=index.98c4fc6a.js.map
