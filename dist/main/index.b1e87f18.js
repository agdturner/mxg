 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    wDiv.appendChild(p1);
    p1.appendChild(document.createTextNode("Welcome to MXG - a free and open source program to assist in creating, editing and         visualising MESMER program data. The main MXG development repository is: "));
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            if (metadataList != undefined) metadataList.getMetadata().forEach((md)=>{
                mlistDiv.appendChild((0, $f0396edd0a5c99f7$export$331ff980f0d45cff)().appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(md.getLabelText(), $7e68913db756e51f$var$boundary1)));
            });
            // Create collapsible AtomArray HTMLDivElement.
            let aaDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
            let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
            ...
            molecule.getBonds().bonds.forEach((b)=>{
                baDiv.appendChild($7e68913db756e51f$var$addBond(molecule, atoms, molecule.getBonds(), b, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
    ...
    for(let i = 0; i < xml_reactions.length; i++){
            ...
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                if (name == undefined || name == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                    ...
                    if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                        ...
                        let mDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName);
                        let mDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mDivId);
                        let mcDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivId, $7e68913db756e51f$var$s_container);
                        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivId, reactionDiv, null, mDiv, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                        ...
                        if (xml_preExponential != null) {
                            if (xml_preExponential[0] != null) {
                                ...
                                inputElement.addEventListener("change", (event)=>{
                                    let target = event.target;
                                    inputString = target.value;
                                    preExponential.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
                                    console.log("Set " + id + " to " + inputString);
                                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputElement);
                                });
                                $7e68913db756e51f$var$addAnyUnits(undefined, preExponentialAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
                        ...
                        if (xml_tInfinity != null) {
                            if (xml_tInfinity[0] != null) {
                                ...
                                inputElement.addEventListener("change", (event)=>{
                                    let target = event.target;
                                    inputString = target.value;
                                    tInfinity.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
                                    console.log("Set " + id + " to " + inputString);
                                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputElement);
                                });
                                $7e68913db756e51f$var$addAnyUnits(undefined, tInfinityAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
                        ...
                        if (xml_nInfinity != null) {
                            if (xml_nInfinity[0] != null) {
                                ...
                                inputElement.addEventListener("change", (event)=>{
                                    let target = event.target;
                                    inputString = target.value;
                                    nInfinity.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
                                    console.log("Set " + id + " to " + inputString);
                                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputElement);
                                });
                                $7e68913db756e51f$var$addAnyUnits(undefined, nInfinityAttributes, lwi, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                                mCRCMethodDiv.appendChild(lwi);
                            }
                        }
        ...
        if (xml_crl.length > 0) {
            ...
            if (xml_d.length > 0) {
                ...
                let l = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(description + " (" + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(clr_attributes) + ")", $7e68913db756e51f$var$level1);
            ...
            if (xml_k.length > 0) {
                ...
                $7e68913db756e51f$var$addSaveAsCSVButton(crl.toCSV.bind(crl), crlDiv, t, reaction.id + "_" + (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName, $7e68913db756e51f$var$boundary1);
            }
        }
    }
 ...
 */ function $7e68913db756e51f$var$saveXML() {
    if ($7e68913db756e51f$var$mesmer == null) {
        ...
        console.log("saveXML");
        const pad = "  ";
        let xmlData = (0, $8677001474399221$export$692079bb871c6039).header + $7e68913db756e51f$var$mesmer.toXML(pad, "");
        let title = $7e68913db756e51f$var$mesmer.getTitle()?.value;
...
//# sourceMappingURL=index.b1e87f18.js.map
