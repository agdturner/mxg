...
/**
 * MXG.
 */ let $7e68913db756e51f$var$mxg_url = "https://github.com/mesmer-kinetics/mxg";
...
/**
 * Example data.
 */ let $7e68913db756e51f$var$mxgDataExamples_url = "https://github.com/mesmer-kinetics/mxg/tree/main/data/examples";
...
let $7e68913db756e51f$var$mesmer_url = "https://github.com/MESMER-kinetics/MESMER-code";
let $7e68913db756e51f$var$mesmer_a = document.createElement("a");
$7e68913db756e51f$var$mesmer_a.href = $7e68913db756e51f$var$mesmer_url;
$7e68913db756e51f$var$mesmer_a.textContent = $7e68913db756e51f$var$mesmer_url;
/**
 * EPSRC.
 */ let $7e68913db756e51f$var$epsrc_url = "https://epsrc.ukri.org/";
let $7e68913db756e51f$var$epsrc_a = document.createElement("a");
$7e68913db756e51f$var$epsrc_a.href = $7e68913db756e51f$var$epsrc_url;
$7e68913db756e51f$var$epsrc_a.textContent = "The UK Engineering and Physical Sciences Research Council (EPSRC)";
/**
 * University of Leeds
 */ let $7e68913db756e51f$var$uol_url = "https://www.leeds.ac.uk/";
let $7e68913db756e51f$var$uol_a = document.createElement("a");
$7e68913db756e51f$var$uol_a.href = $7e68913db756e51f$var$uol_url;
$7e68913db756e51f$var$uol_a.textContent = "The University of Leeds";
/**
 * 3DMol.
...
let $7e68913db756e51f$var$t3Dmol_citation_url = "http://doi.org/10.1093/bioinformatics/btu829";
let $7e68913db756e51f$var$t3Dmol_citation_a = document.createElement("a");
$7e68913db756e51f$var$t3Dmol_citation_a.href = $7e68913db756e51f$var$t3Dmol_citation_url;
$7e68913db756e51f$var$t3Dmol_citation_a.textContent = "doi:10.1093/bioinformatics/btu829";
/**
 * Big.js.
 */ let $7e68913db756e51f$var$bigjs_url = "https://mikemcl.github.io/big.js/";
let $7e68913db756e51f$var$bigjs_a = document.createElement("a");
$7e68913db756e51f$var$bigjs_a.href = $7e68913db756e51f$var$bigjs_url;
$7e68913db756e51f$var$bigjs_a.textContent = $7e68913db756e51f$var$bigjs_url;
 ...
 */ function $7e68913db756e51f$var$addRID(...parts) {
    let validID = $7e68913db756e51f$var$addID(...parts);
...
// index.html IDs
const $7e68913db756e51f$var$menuDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_menu);
const $7e68913db756e51f$var$titleDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_title);
const $7e68913db756e51f$var$moleculesDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_molecules);
const $7e68913db756e51f$var$reactionsDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_reactions);
const $7e68913db756e51f$var$reactionsDiagramDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_reactionsDiagram);
const $7e68913db756e51f$var$conditionsDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_conditions);
const $7e68913db756e51f$var$modelParametersDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_modelParameters);
const $7e68913db756e51f$var$controlDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_control);
const $7e68913db756e51f$var$metadataListDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_metadata);
const $7e68913db756e51f$var$analysisDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_analysis);
const $7e68913db756e51f$var$xmlDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_xml);
const $7e68913db756e51f$var$welcomeDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_welcome);
// For dark/light mode.
 ...
 */ let $7e68913db756e51f$var$defaults;
/**
 * For storing molecules loaded from files.
 */ let $7e68913db756e51f$var$libmols = new Map();
/**
 ...
 */ function $7e68913db756e51f$var$addMolecule(m, ms) {
    let id = m.getID();
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    let lmb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_Molecules, $7e68913db756e51f$var$addID(s_Load_Molecules), $7e68913db756e51f$var$boundary1);
    ...
    lmb.addEventListener("click", async (event)=>{
        ...
        ms.forEach((v, k)=>{
            $7e68913db756e51f$var$addMolecule(v, $7e68913db756e51f$var$libmols);
        });
    });
    // Add Load Defaults button.
    let s_Load_Defaults = "Load Defaults";
    let ldb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_Defaults, $7e68913db756e51f$var$addID(s_Load_Defaults), $7e68913db756e51f$var$boundary1);
    ldb.addEventListener("click", (event)=>{
        $7e68913db756e51f$var$defaults = new (0, $cccccb2a0a919d2e$export$79d0bd4671c1fc67)();
        $7e68913db756e51f$var$defaults.readFile();
    });
    menuDiv.appendChild(ldb);
    // Add Load MESMER File button.
    let s_Load = "Load MESMER File";
    let lb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load, $7e68913db756e51f$var$addID(s_Load), $7e68913db756e51f$var$boundary1);
    ...
    let increaseFontSizeButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Increase_Fontsize, $7e68913db756e51f$var$addID(s_Increase_Fontsize), $7e68913db756e51f$var$boundary1);
    increaseFontSizeButton.addEventListener("click", ()=>{
        let fontSize = parseInt(getComputedStyle(document.body).fontSize);
        document.body.style.fontSize = fontSize + 1 + "px";
        if ($7e68913db756e51f$var$rdWindow != null) //let fontSize = parseInt(getComputedStyle(popWindow.document.body).fontSize);
        $7e68913db756e51f$var$rdWindow.document.body.style.fontSize = fontSize + 1 + "px";
        $7e68913db756e51f$var$redrawReactionsDiagram();
        $7e68913db756e51f$var$redrawScatterPlots();
    });
    menuDiv.appendChild(increaseFontSizeButton);
    // Add Decrease Fontsize button.
    let s_Decrease_Fontsize = "Decrease Fontsize";
    let decreaseFontSizeButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Decrease_Fontsize, $7e68913db756e51f$var$addID(s_Decrease_Fontsize), $7e68913db756e51f$var$boundary1);
    ...
    let lightDarkModeButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Light_Dark_Mode, $7e68913db756e51f$var$addID(s_Light_Dark_Mode), $7e68913db756e51f$var$boundary1);
    ...
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Save_MESMER_File, $7e68913db756e51f$var$addID(s_Save_MESMER_File), $7e68913db756e51f$var$boundary1);
    saveButton.addEventListener("click", $7e68913db756e51f$var$saveXML);
    menuDiv.appendChild(saveButton);
    // Welcome Text.
    let wDiv = document.getElementById($7e68913db756e51f$var$welcomeDivID);
    document.body.appendChild(wDiv);
    // p1.
    let p1 = document.createElement("p");
    wDiv.appendChild(p1);
    p1.appendChild(document.createTextNode("Welcome to the MESMER XML GUI (MXG) - a free and open source program to assist         in creating, editing and visualising MESMER program data for gas phase reaction kinetics. The current MXG development         repository is: "));
    p1.appendChild($7e68913db756e51f$var$mxg_a);
    p1.appendChild(document.createTextNode(". Details of MESMER - the Master Equation Solver for Multi Energy-well Reactions         can be found at: "));
    p1.appendChild($7e68913db756e51f$var$mesmer_a);
    p1.appendChild(document.createTextNode("."));
    // p2.
    let p2 = document.createElement("p");
    wDiv.appendChild(p2);
    p2.appendChild(document.createTextNode("MXG is being developed by a team based at "));
    p2.appendChild($7e68913db756e51f$var$uol_a);
    p2.appendChild(document.createTextNode(" funded by "));
    p2.appendChild($7e68913db756e51f$var$epsrc_a);
    p2.appendChild(document.createTextNode(". MXG is a work in progress. Developers are reporting known issues and testing and         documenting the program ahead of a version 1.0 community supported release. Whilst the program may have some utility         as is and may save MESMER users some time for specific usage scenarios, there are other usage scenarios that it is         currently not suitable for. Like MESMER itself, MXG development aims to be driven in part by users helping to document         issues, help prioritise feature requests, and submitting patches and pull requests as is normal for openly developed         research software."));
    ...
    p3.appendChild($7e68913db756e51f$var$mxg_a.cloneNode(true));
    ...
    p7.appendChild($7e68913db756e51f$var$t3Dmol_a);
    ...
    p7.appendChild($7e68913db756e51f$var$t3Dmol_citation_a);
    ...
    p8.appendChild($7e68913db756e51f$var$bigjs_a);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(lwiId, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
    ...
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, mlDiv, null, $7e68913db756e51f$var$processMoleculeList(xml), (0, $8677001474399221$export$19d70f3647dee606).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    ...
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, rlDiv, null, $7e68913db756e51f$var$processReactionList(xml), (0, $8677001474399221$export$44466a39ca846289).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Reactions Diagram.
    ...
    let rdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rdDivID, rddDiv, null, rdDiv, $7e68913db756e51f$var$s_Reactions_Diagram, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    ...
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, $7e68913db756e51f$var$processConditions(xml), "ConditionsList", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Model Parameters.
    ...
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, $7e68913db756e51f$var$processModelParameters(xml), "ModelParametersList", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Control.
    ...
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, $7e68913db756e51f$var$processControl(xml), "ControlList", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // MetadataList.
    ...
    // Create collapsible content.
    let mdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mdDivID, mdDiv, null, $7e68913db756e51f$var$processMetadataList(xml), (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // Analysis.
    ...
    // Create collapsible content.
    let acDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aDivID, aDiv, null, $7e68913db756e51f$var$processAnalysis(xml), (0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
}
/**
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$boundary1);
    // Get the XML "moleculeList" element.
    let xml_ml = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml, (0, $8677001474399221$export$19d70f3647dee606).tagName);
    // Check the XML "moleculeList" element has one or more "molecule" elements and no other elements.
    let mlTagNames = new Set();
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        $7e68913db756e51f$var$addMolecule(m, $7e68913db756e51f$var$molecules);
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, null, mDiv, m.label, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Create a set of molecule tag names.
        let moleculeTagNames = new Set();
        let cns = xml_ms[i].childNodes;
        //console.log("cns.length=" + cns.length);
        ...
        // Description
        mDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(mDivID, $7e68913db756e51f$var$s_description), m.getDescription.bind(m), m.setDescription.bind(m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Init metadataList.
        //console.log("Init metadataList.");
        let xml_mls = xml_ms[i].getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        if (xml_mls.length > 0) {
            ...
            let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlcDivID, mDiv, null, mlDiv, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            ...
            for(let j = 0; j < xml_ms.length; j++){
                // Create a new Metadata.
                let md = new (0, $288a4469bea65e97$export$e7adebdc1ebd2fed)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[j]));
                mlDiv.appendChild($7e68913db756e51f$var$addMetadata(m, md, ml, $7e68913db756e51f$var$addRID(mlDivID, j), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            }
            moleculeTagNames.delete((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        }
        // Init atoms.
        ...
        let aacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aacDivID, mDiv, null, aaDiv, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        for(let j = 0; j < xml_as.length; j++)aaDiv.appendChild($7e68913db756e51f$var$addAtom(m, aaDivID, aa, new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(m, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        moleculeTagNames.delete((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        // Init bonds.
        let xml_bas = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        ...
        let bacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bacDivID, mDiv, null, baDiv, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        for(let j = 0; j < xml_bs.length; j++){
            ...
            if (b_attributes.has((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_id)) baDiv.appendChild($7e68913db756e51f$var$addBond(m, baDivID, m.getAtoms().atoms, ba, new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        }
        ...
        baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(m, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        moleculeTagNames.delete((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
        ...
        let viewercDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(viewercDivID, mDiv, null, viewerDiv, "viewer", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$create3DViewer(m, viewerDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Init properties.
        let xml_pls = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        ...
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plcDivID, mDiv, null, plDiv, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        for(let j = 0; j < xml_ps.length; j++){
            // Create a new Property.
            let p = $7e68913db756e51f$var$createProperty(pap, pl, xml_ps[j], plDiv, m, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            pl.setProperty(p);
        }
        ...
        */ // Organise EnergyTransferModel.
        ...
        if (xml_dms.length > 0) {
            if (xml_dms.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + " but finding " + xml_dms.length + "!");
            let doscm = new (0, $ef5b9341e5193b70$export$bbdce6c921702068)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dms[0]));
            mDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$bbdce6c921702068).xsi_typeOptions, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, doscm.getXsiType(), $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
        }
        // Organise DistributionCalcMethod. (Output only)
        let xml_dcms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
        ...
        if (xml_dosl.length > 0) {
            ...
            let doslcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(doslcDivID, mDiv, null, doslDiv, (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            let xml_dos = xml_dosl[0].getElementsByTagName((0, $ef5b9341e5193b70$export$126b026a4280c589).tagName);
            // Organise Description.
            let xml_ds = xml_dosl[0].getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
            if (xml_ds.length > 0) {
        ...
        if (xml_tts.length > 0) {
            ...
            let ttcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ttcDivId, mDiv, null, ttDiv, tttn, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            let tvs;
        ...
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            ...
            let edmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(edmcDivID, mDiv, null, edmDiv, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Read bondRef.
            ...
            if (xml_brs.length > 0) {
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, bids, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, br.value, $7e68913db756e51f$var$addRID(edmDivID, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            ...
            if (xml_hrps.length > 0) {
                ...
                let hrpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(hrpcDivID, edmDiv, null, hrpDiv, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                // Format.
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, hrp.getFormat(), $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                hrpDiv.appendChild(lws);
                // Units.
                $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).energyUnits, hrpAttributes, hrpDiv, lws, $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_units), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                // ExpansionSize.
                let es = hrp.getExpansionSize() ?? $7e68913db756e51f$var$s_undefined;
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
                ...
                let ppscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ppscDivID, mDiv, null, ppsDiv, "PotentialPoints", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    let l = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName + " " + k, $7e68913db756e51f$var$boundary1);
                    ppDiv.appendChild(l);
                    // Process angle
                    let a = pp.getAngle() ?? $7e68913db756e51f$var$s_undefined;
                    let anglelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                        let target = event.target;
                        // Check the input is a number.
                    ...
                    let potentialInputElement = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", potentialInputElementId, $7e68913db756e51f$var$boundary1);
            ...
            if (xml_periodicities.length > 0) {
                ...
                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(edmDivID, (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
        ...
        if (xml_ReservoirSize.length > 0) {
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", m.getID() + "_" + (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, mid + " " + id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        // Description
        moleculeDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_description), m.getDescription.bind(m), m.setDescription.bind(m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Create collapsible AtomArray HTMLDivElement.
        let aaDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = $7e68913db756e51f$var$addRID(aaDivID, $7e68913db756e51f$var$s_container);
        let aacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aacDivID, moleculeDiv, null, aaDiv, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(m, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Create collapsible BondArray HTMLDivElement.
        let baDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = $7e68913db756e51f$var$addRID(baDivID, $7e68913db756e51f$var$s_container);
        let bacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bacDivID, moleculeDiv, null, baDiv, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(m, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        $7e68913db756e51f$var$create3DViewer(m, moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
        let plcDivID = $7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_container);
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plcDivID, moleculeDiv, null, plDiv, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    // Add code to add propertyArray...
    });
    // Create add from library button.
    let addFromLibraryButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_from_library, undefined, $7e68913db756e51f$var$boundary1);
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let options = Array.from($7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$var$libmols));
        if (options.length == 0) {
        ...
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Select molecule", $7e68913db756e51f$var$s_selectOption, $7e68913db756e51f$var$addRID(selectID), $7e68913db756e51f$var$boundary1);
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = $7e68913db756e51f$export$7577c09cb43cc206(label, $7e68913db756e51f$var$libmols);
            ...
            // Create collapsible Molecule HTMLDivElement.
            let mcDivID = $7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_container);
            let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, molecule.getLabel(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Add the molecule to the BathGas select elements.
            ...
            // Description
            moleculeDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_description), molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            // Create collapsible MetadataList HTMLDivElement.
            ...
            let mlistcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlistcDivID, moleculeDiv, null, mlistDiv, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Add metadata.
            ...
            if (metadataList != undefined) metadataList.getMetadata().forEach((md)=>{
                ...
                mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(md.getLabelText(), $7e68913db756e51f$var$boundary1));
            });
            // Create collapsible AtomArray HTMLDivElement.
            let aaDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
            let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
            ...
            if (aa != undefined) aa.atoms.forEach((a)=>{
                aaDiv.appendChild($7e68913db756e51f$var$addAtom(molecule, aaDivID, molecule.getAtoms(), a, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
            aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            // Create collapsible BondArray HTMLDivElement.
            let baDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
            let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
            let bacDivID = $7e68913db756e51f$var$addRID(baDivID, $7e68913db756e51f$var$s_container);
            ...
            if (ba != undefined) molecule.getBonds().bonds.forEach((b)=>{
                ...
                baDiv.appendChild($7e68913db756e51f$var$addBond(molecule, baDivID, aa.atoms, molecule.getBonds(), b, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
            baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(molecule, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Create collapsible Properties HTMLDivElement.
            let plDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
            let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
            let plcDivID = $7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_container);
...
function $7e68913db756e51f$var$addMetadata(m, md, ml, mdDivID, boundary, level) {
    ...
    mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(m.getLabel(), $7e68913db756e51f$var$boundary1));
    return mdDiv;
}
/**
 * Adds an atom.
...
function $7e68913db756e51f$var$addPropertyScalarNumber(attributes, iDs, value, units, pl, p, plDiv, boundary) {
    ...
    let div = $7e68913db756e51f$var$processNumber(id, iDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", $7e68913db756e51f$var$addRID(viewerDivID, $7e68913db756e51f$var$s_save), $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$displayXML(xmlFilename, xml) {
    ...
    let xmlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(xml2DivID, xmlDiv, null, xml2Div, xmlFilename, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
 ...
 */ function $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, units, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = $7e68913db756e51f$var$processNumber($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), pIDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                p.setProperty(pa);
                let div = $7e68913db756e51f$var$processNumberArray($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$processPropertyScalarString(pl, p, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = $7e68913db756e51f$var$processString($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), pIDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        plDiv.appendChild(div);
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let etmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(etmcDivID, moleculeDiv, null, etmDiv, (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        let deltaEDowns = [];
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            let rscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rscDivID, reactionDiv, null, rsDiv, "Reactants", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            let reactants = [];
            for(let j = 0; j < xml_reactants.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.getRef() + " role", (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).roleOptions, "Role", molecule.getRole(), $7e68913db756e51f$var$addRID(reactantDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_products.length > 0) {
            ...
            let pscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pscDivID, reactionDiv, null, psDiv, "Products", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            let products = [];
            for(let j = 0; j < xml_products.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.getRef() + " role", (0, $6f7aa7a716962086$export$264ad599d7cef668).roleOptions, molecule.getRole(), molecule.getRef(), $7e68913db756e51f$var$addRID(psDivID, j, "Role"), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                let select = lws.querySelector("select");
        ...
        let reactioncDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactioncDivID, reactionListDiv, null, reactionDiv, reaction.id + " (" + reaction.getLabel() + ")", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Load tunneling.
        ...
        if (xml_tunneling.length > 0) {
            ...
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).options, "Tunneling", tunneling.getName(), $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            lws.querySelector("select")?.addEventListener("change", (event)=>{
                let target = event.target;
        ...
        if (xml_transitionStates.length > 0) {
            ...
            let tscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(tscDivID, reactionDiv, null, tsDiv, "Transition States", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_MCRCMethod.length > 0) {
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                    ...
                    let mmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mmcDivId, reactionDiv, null, mmDiv, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                    ...
                    if (xml_pe != null) {
                        if (xml_pe[0] != null) {
                            ...
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                            ...
                            $7e68913db756e51f$var$addAnyUnits(undefined, peAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName), (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                            mmDiv.appendChild(lwi);
                        }
                    }
                    ...
                    if (xml_ae != null) {
                        if (xml_ae[0] != null) {
                            ...
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                            ...
                            $7e68913db756e51f$var$addAnyUnits(undefined, aeAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName), (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                            mmDiv.appendChild(lwi);
                        }
                    }
                    ...
                    if (xml_ti != null) {
                        if (xml_ti[0] != null) {
                            ...
                            mm.setTInfinity(ti);
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                            ...
                            $7e68913db756e51f$var$addAnyUnits(undefined, tiAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName), (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                            mmDiv.appendChild(lwi);
                        }
                    }
                    ...
                    if (xml_ni != null) {
                        if (xml_ni[0] != null) {
                            ...
                            mm.setNInfinity(ni);
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                            ...
                            $7e68913db756e51f$var$addAnyUnits(undefined, niAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName), (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                            mmDiv.appendChild(lwi);
                        }
                    }
                } else {
        ...
        if (xml_erc.length > 0) {
            ...
            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
        ...
        if (xml_crl.length > 0) {
            ...
            let crlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(crlcDivID, reactionDiv, null, crlDiv, (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            ...
            if (xml_d.length > 0) {
                ...
                let l = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(description + " (" + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(clr_attributes) + ")", $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    for(let i = 0; i < xml_conditionss.length; i++){
        ...
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, $7e68913db756e51f$var$boundary1);
        let ccDivID = $7e68913db756e51f$var$addRID(cDivID, $7e68913db756e51f$var$s_container);
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, conditionssDiv, null, cDiv, (0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName + " " + i.toString(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$handleBathGases(conditions, cDiv, xml_conditions) {
    ...
    let bscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bscDivID, cDiv, null, bsDiv, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    // Add add button.
 ...
 */ function $7e68913db756e51f$var$handlePTs(conditions, cDiv, xml_conditions) {
    ...
    let pTscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pTscDivId, cDiv, null, pTsDiv, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    let pTs;
    if (xml_conditions) {
    ...
    let addButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, conditionssDiv, elementToInsertBefore, cDiv, (0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName + " " + i.toString(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Add the conditions
 ...
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, cDivID, pTIndex, moleculeKeys, level) {
    ...
    $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).pressureUnits, pTpair.attributes, pTpairDiv, null, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$addPorT(pTpairDiv, name, getter, setter) {
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + name, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        try {
            setter(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value));
 ...
 */ function $7e68913db756e51f$var$addPercentExcessReactantConc(pTpairDiv, pTpair) {
    ...
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$var$boundary1);
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
 ...
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas, first, id) {
    ...
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, value, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1);
    select.classList.add((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    $7e68913db756e51f$var$selectAnotherOptionEventListener(options, select);
    // Add event listener to selectElement.
    select.addEventListener("change", (event)=>{
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    let mpsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$boundary1);
    ...
    for(let i = 0; i < xml_mps.length; i++){
        ...
        let mpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mpDivID, $7e68913db756e51f$var$boundary1);
        let mpcDivID = $7e68913db756e51f$var$addRID(mpDivID, $7e68913db756e51f$var$s_container);
        let mpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mpcDivID, mpsDiv, null, mpDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + " " + i.toString(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv) {
    ...
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, $7e68913db756e51f$var$modelParametersIDs.addID(mpsDiv.id, tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    div.appendChild(button);
...
function $7e68913db756e51f$var$getDefaultGrainsize(tagName) {
    let value;
    let attributes;
    if ($7e68913db756e51f$var$defaults != undefined) {
        let valueString = $7e68913db756e51f$var$defaults.values.get(tagName) ?? "";
        ...
        attributes = $7e68913db756e51f$var$defaults.attributess.get(tagName) ?? new Map();
    } else {
 ...
 */ function $7e68913db756e51f$var$createInputModelParameters(mps, div, element, id, valueString, setElementMethod, units) {
    ...
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", id, $7e68913db756e51f$var$boundary1);
    div.appendChild(input);
    input.addEventListener("change", (event)=>{
        let target = event.target;
    ...
    input.value = valueString;
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    $7e68913db756e51f$var$addAnyUnits(units, element.attributes, div, input, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_units), element.constructor.tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
}
/**
 * @param controlsDiv 
 * @param level The level.
 ...
 */ function $7e68913db756e51f$var$createAddModelParametersButton(mpsDiv) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let mpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mpcDivID, mpsDiv, elementToInsertBefore, mpDiv, tn + " " + i.toString(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    for(let i = 0; i < xml_controls.length; i++){
        ...
        let ccDivID = $7e68913db756e51f$var$addRID(cDivID, $7e68913db756e51f$var$s_container);
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, controlsDiv, null, cDiv, (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + " " + i.toString(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_fdb.length == 1) {
            ...
            let fdbl = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName + " " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(fdb_attributes) + " " + s, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$createAddControlButton(controlsDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        // Create a collapsible div for each conditions.
        let ccDivID = $7e68913db756e51f$var$addRID(cDivID, $7e68913db756e51f$var$s_container);
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, controlsDiv, elementToInsertBefore, cDiv, (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + " " + i.toString(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Add the control
 ...
 */ function $7e68913db756e51f$var$handleTestMicroRates(control, cDiv, xml_control, level) {
    ...
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
 ...
 */ function $7e68913db756e51f$var$createTestMicroRates(control, div, xml_tmr, idTmax, idTmin, idTstep) {
    ...
    let tMaxlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idTmax + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
    ...
    let tSteplwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idTstep + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
 ...
 */ function $7e68913db756e51f$var$getCalcMethod(control, divCm, xml, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId) {
    ...
    divCm.appendChild(select);
    // Add the details div.
    let divCmDetails = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divCmDetailsId, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processCalcMethodFitting(divCmDetails, cm) {
    ...
    divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, (0, $b6873406fb778c0b$export$830a50cd13af6e84).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
 ...
 */ function $7e68913db756e51f$var$processCalcMethodMarquardt(divCmDetails, cm) {
    ...
    createLabelWithInputForObject(mi, divCmDetails, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // MarquardtTolerance.
    ...
    createLabelWithInputForObject(mt, divCmDetails, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    // MarquardtDerivDelta.
    ...
    createLabelWithInputForObject(mdd, divCmDetails, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
}
/**
 * @param divCmDetails The details div.
 ...
 */ function $7e68913db756e51f$var$processCalcMethodAnalyticalRepresentation(divCmDetails, cm) {
    ...
    function processElement(ClassConstructor, getter, setter, tagName) {
        ...
        setter(element);
        divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", divCmDetails.id + `_${tagName}_input`, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, $7e68913db756e51f$var$handleEvent(element, tagName), element.value.toString(), tagName));
    }
 ...
 */ function $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(divCmDetails, cm) {
    ...
    function processNumberElement(ClassConstructor, getter, setter, tagName) {
        let element = getter() || new ClassConstructor(new Map(), NaN);
        setter(element);
        divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, $7e68913db756e51f$var$handleEvent(element, tagName), element.value.toString(), tagName));
    }
    ...
    divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options, tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options[0], (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, tagName, "select"), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1));
 ...
 */ function $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, options, tagName, value, divCmDetailsId, divCmDetailsSelectId) {
    ...
    select.addEventListener("change", (event)=>{
        ...
        divCmDetails = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divCmDetailsId, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processMetadataList(xml) {
    ...
    let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID((0, $288a4469bea65e97$export$3e18a603070a78a).tagName, 0), $7e68913db756e51f$var$boundary1);
        ...
        function handleElement(tagName, constructor, setter) {
            ...
            if (xml_elements.length > 0) {
                if (xml_elements.length == 1) {
                    ...
                    cDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(n.tagName + " " + s, $7e68913db756e51f$var$boundary1));
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    let aDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aDivID, $7e68913db756e51f$var$boundary1);
    ...
    if (xml_as.length > 0) {
        ...
        if (xml_d.length > 0) {
            if (xml_d.length == 1) {
                ...
                dDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(d.tagName + " " + s, $7e68913db756e51f$var$boundary1));
                a.setDescription(d);
        ...
        let elcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(elDivID, aDiv, null, elDiv, (0, $49b337e689138e29$export$f681829d43cbf50e).tagName + "s", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        if (xml_el.length > 0) for(let i = 0; i < xml_el.length; i++){
            ...
            let ecDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(eDivID, elDiv, null, eDiv, labelText, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
            ...
            eDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $134d19e749bf0414$export$4323cc4280d5be7)(evs, ", "), $7e68913db756e51f$var$boundary1));
        }
        // "me:populationList".
        ...
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plDivID, aDiv, null, plDiv, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName + "s", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        for(let i = 0; i < xml_pl.length; i++){
            ...
            let pcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pDivID, plDiv, null, pDiv, labelText, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
            ...
            // Create graph.
            let graphDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(pDivID, $7e68913db756e51f$var$s_graph), $7e68913db756e51f$var$boundary1);
            ...
            // Create Table.
            let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(pDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$boundary1);
            pDiv.appendChild(tableDiv);
            let tab = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$boundary1);
            ...
            $7e68913db756e51f$var$addSaveAsCSVButton(()=>$7e68913db756e51f$var$tableToCSV(tab), pDiv, tableDiv, labelText, $7e68913db756e51f$var$boundary1);
        }
        // me:rateList.
        ...
        let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, aDiv, null, rlDiv, (0, $49b337e689138e29$export$9cdf0fcb7c05190f).tagName + "s", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        if (xml_rl.length > 0) {
            // Create Table.
            let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(rlDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$boundary1);
            ...
            tableDiv.appendChild(tab);
            // Insert a save as csv button.
            $7e68913db756e51f$var$addSaveAsCSVButton(()=>$7e68913db756e51f$var$tableToCSV(tab), rlDiv, tableDiv, "Bartis-Widom Phenomenological Rate Coefficients", $7e68913db756e51f$var$boundary1);
        }
    }
    return aDiv;
}
 ...
 */ function $7e68913db756e51f$var$addSaveAsPNGButton(canvas, divToAddTo, elementToInsertBefore, name) {
    ...
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", saveButtonID, $7e68913db756e51f$var$boundary1);
...
export {$7e68913db756e51f$export$7577c09cb43cc206 as getMolecule, $7e68913db756e51f$export$819b5ff7dff3652c as setNumberArrayNode, $7e68913db756e51f$export$b1e4cbf5b56e0e21 as setNumberNode};
//# sourceMappingURL=index.9f1eca60.js.map
