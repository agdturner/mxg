 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let controlsDiv = document.getElementById(controlsDivId);
    let controlsListDiv = $7e68913db756e51f$var$processControl(xml);
    controlsListDiv.id = "controlsList";
    // If the controlListDiv already exists, remove it.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(controlsListDiv.id);
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    for(let i = 0; i < xml_controls.length; i++){
        ...
        $7e68913db756e51f$var$processTestMicroRates(control, controlDiv, xml_control);
        $7e68913db756e51f$var$processCalcMethod(control, controlDiv, xml_control);
        $7e68913db756e51f$var$processEigenvalues(control, controlDiv, xml_control);
        $7e68913db756e51f$var$processShortestTimeOfInterest(control, controlDiv, xml_control);
        $7e68913db756e51f$var$processMaximumEvolutionTime(control, controlDiv, xml_control);
        $7e68913db756e51f$var$processAutomaticallySetMaxEneControl(control, controlDiv, xml_control);
        $7e68913db756e51f$var$processDiagramEnergyOffset(control, controlDiv, xml_control);
...
//# sourceMappingURL=index.b7e55dd8.js.map
