 ...
 */ let $7e68913db756e51f$var$reactionsDiagramId = "reactionsDiagram";
let $7e68913db756e51f$var$rd_canvas_Id = "reactionsDiagramCanvas";
let $7e68913db756e51f$var$rd_canvas;
//let rd_canvas_width: number = 800;
let $7e68913db756e51f$var$rd_canvas_height = 400;
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Create style/theme option buttons.
    ...
    lightDarkModeButton.addEventListener("click", ()=>{
        ...
        localStorage.setItem("darkMode", $7e68913db756e51f$var$dark ? "true" : "false");
 ...
 */ function $7e68913db756e51f$var$redrawReactionsDiagram() {
    if ($7e68913db756e51f$var$popWindow == null) $7e68913db756e51f$var$drawReactionDiagram($7e68913db756e51f$var$rd_canvas, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc);
    else {
        let c = $7e68913db756e51f$var$popWindow.document.getElementById($7e68913db756e51f$var$rd_canvas_Id);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let reactionsDiagramDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$boundary1);
    reactionsDiagramDiv.id = $7e68913db756e51f$var$reactionsDiagramId;
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)($7e68913db756e51f$var$rd_canvas_Id);
    // Create a new canvas.
    $7e68913db756e51f$var$rd_canvas = document.createElement("canvas");
    $7e68913db756e51f$var$rd_canvas.id = $7e68913db756e51f$var$rd_canvas_Id;
    reactionsDiagramDiv.appendChild($7e68913db756e51f$var$rd_canvas);
    //rd_canvas.width = rd_canvas_width;
    $7e68913db756e51f$var$rd_canvas.height = $7e68913db756e51f$var$rd_canvas_height;
    $7e68913db756e51f$var$rd_canvas.style.border = "1px solid black";
    $7e68913db756e51f$var$drawReactionDiagram($7e68913db756e51f$var$rd_canvas, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc);
    // Add action listener to the pop diagram button.
    popButton.addEventListener("click", ()=>{
        if ($7e68913db756e51f$var$popWindow == null) {
            let c = $7e68913db756e51f$var$rd_canvas;
            c.id = $7e68913db756e51f$var$rd_canvas_Id;
            ...
            let c = $7e68913db756e51f$var$popWindow.document.getElementById($7e68913db756e51f$var$rd_canvas_Id);
            $7e68913db756e51f$var$rd_canvas = c;
    ...
    $7e68913db756e51f$var$mesmer.setConditions(new (0, $ae74a7b44a6504a1$export$363c7374d425f4ad)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(conditionsDiv)));
    // Model Parameters.
    ...
    $7e68913db756e51f$var$mesmer.setModelParameters(new (0, $8883b31bd809eb64$export$77f098867dc64198)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(modelParametersDiv)));
    // Control.
    ...
    $7e68913db756e51f$var$mesmer.setControl(new (0, $b6873406fb778c0b$export$7a7fa4424cb20976)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(controlDiv)));
 ...
 */ function $7e68913db756e51f$var$processGrainSize(modelParameters, xml_modelParameters, modelParametersDiv) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processAutomaticallySetMaxEneModelParameters(modelParameters, xml_modelParameters, modelParametersDiv) {
    ...
    if (xml.length == 1) {
        ...
        button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedLoadedValueText;
        $7e68913db756e51f$var$createAutomaticallySetMaxEneInputModelParameters(modelParameters, div, asme, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createAutomaticallySetMaxEneInputModelParameters(modelParameters, div, asme, id, valueString) {
    modelParameters.setAutomaticallySetMaxEne(asme);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 */ function $7e68913db756e51f$var$processEnergyAboveTheTopHill(modelParameters, xml_modelParameters, modelParametersDiv) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedLoadedValueText;
        $7e68913db756e51f$var$createEnergyAboveTheTopHillInput(modelParameters, div, eatth, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createEnergyAboveTheTopHillInput(modelParameters, div, eatth, id, valueString) {
    modelParameters.setEnergyAboveTheTopHill(eatth);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            $7e68913db756e51f$export$b1e4cbf5b56e0e21(eatth, event.target);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
        }
    });
    input.value = valueString;
 ...
 */ function $7e68913db756e51f$var$processMaxTemperature(modelParameters, xml_modelParameters, modelParametersDiv) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedLoadedValueText;
        $7e68913db756e51f$var$createMaxTemperatureInput(modelParameters, div, mt, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
 ...
 * @param id The id.
 * @param valueString The value string.
 */ function $7e68913db756e51f$var$createMaxTemperatureInput(modelParameters, div, mt, id, valueString) {
    modelParameters.setMaxTemperature(mt);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            $7e68913db756e51f$export$b1e4cbf5b56e0e21(mt, event.target);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
        }
    });
    input.value = valueString;
 ...
 */ function $7e68913db756e51f$var$processCalculateRateCoefficientsOnly(control, controlsDiv, xml_control) {
    ...
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintCellDOS(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$60b233651e162b60).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$60b233651e162b60).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintCellTransitionStateFlux(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintReactionOperatorColumnSums(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$a915db169f144f37).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$a915db169f144f37).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainBoltzmann(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$e7fff349901f700d).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$e7fff349901f700d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainDOS(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainkbE(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainkfE(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintTSsos(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainedSpeciesProfile(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainTransitionStateFlux(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintReactionOperatorSize(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$8420ab6988728a65).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$8420ab6988728a65).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintSpeciesProfile(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintPhenomenologicalEvolution(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintTunnelingCoefficients(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintCrossingCoefficients(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processTestDOS(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processTestRateConstants(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processUseTheSameCellNumberForAllConditions(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processHideInactive(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let hi = new (0, $b6873406fb778c0b$export$9d51752a8549e2d6)();
    if (xml.length == 1) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has((0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName)) {
            control.setHideInactive(hi);
            button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedValueText;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
 ...
 */ function $7e68913db756e51f$var$processForceMacroDetailedBalance(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processTestMicroRates(control, controlsDiv, xml_control) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName + "_input";
 ...
 */ function $7e68913db756e51f$var$drawReactionDiagram(canvas, dark, font, lw, lwc) {
    ...
    if (canvas != null) {
        ...
        reorders.forEach(function(value) {
            ...
            let energyRescaled = (0, $134d19e749bf0414$export$bd2782c820638828)(energyMin, energyRange, 0, $7e68913db756e51f$var$rd_canvas_height, energy);
            // Get text width.
        ...
        let canvasHeightWithBorder = $7e68913db756e51f$var$rd_canvas_height + 4 * th + 2 * lw;
        //console.log("canvasHeightWithBorder=" + canvasHeightWithBorder);
        let originalCanvasHeight = $7e68913db756e51f$var$rd_canvas_height;
...
//# sourceMappingURL=index.0c7111d3.js.map
