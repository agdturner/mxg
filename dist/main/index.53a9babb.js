        ...
        if (xml_PLs.length == 1) {
            ...
            for(let j = 0; j < xml_Ps.length; j++){
                ...
                if (scalarNodes.length > 0) {
                    ...
                    let displayValue = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(scalarNodes[0])).trim();
                    let value = parseFloat(displayValue);
                    p.setProperty(new (0, $ef5b9341e5193b70$export$d29b345ea2be5072)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(scalarNodes[0]), value));
                    let label = p.dictRef;
                    ...
                    inputElement.addEventListener("change", (event)=>{
                        ...
                        ps.value = parseFloat(inputValue);
                        console.log("Set " + p.dictRef + " of " + molecule.id + " to " + inputValue);
                        (0, $f0396edd0a5c99f7$export$4b454580398e92d5)(inputElement);
                    });
                } else {
                    ...
                    if (arrayNodes.length > 0) {
                        ...
                        inputElement.addEventListener("change", (event)=>{
                            ...
                            let values = inputValue.split(/\s+/).map(parseFloat);
                            pa.values = values;
                            console.log("Set " + p.dictRef + " of " + molecule.id + " to " + inputValue);
                            (0, $f0396edd0a5c99f7$export$4b454580398e92d5)(inputElement);
                        });
...
//# sourceMappingURL=index.53a9babb.js.map
