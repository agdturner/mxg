...
class $b6873406fb778c0b$export$2417b4f54a2ad10f extends $b6873406fb778c0b$export$f0bfd84d03c3a22d {
    static{
        /**
     * The tag name.
...
class $b6873406fb778c0b$export$aed609c3dc1bbed2 extends $b6873406fb778c0b$export$f0bfd84d03c3a22d {
    static{
        /**
     * The tag name.
...
/*
    ...
    button.addEventListener('click', (event: MouseEvent) => {
        ...
        if (!control.index.has(CalcMethod.tagName)) {
            ...
            first = createCalcMethodInput(control, options, div, cm, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle('optionOff');
            button.classList.toggle('optionOn');
        } else {
    ...
    if (xml.length == 1) {
        ...
        button.textContent = buttonTextContentSelected;
        first = createCalcMethodInput(control, options, div, cm, id, value);
        button.classList.toggle('optionOff');
    } else {
 ...
 */ function $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, valueString) {
    ...
    select.addEventListener('change', (event: Event) => {
        ...
        if (xsi_type == CalcMethodMarquardt.xsi_type) {
            ...
            let mi_xml: HTMLCollectionOf<Element> = xml_control.getElementsByTagName(MarquardtIterations.tagName);
            if (mi_xml.length > 0) {
                if (mi_xml.length == 1) {
            ...
            cm = cmm;
        //} else if (xsi_type == CalcMethodSimplex.xsi_type) {
        //    cm = 
        }
...
//# sourceMappingURL=index.86b5771e.js.map
