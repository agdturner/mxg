...
function $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plcDivID, mDiv, null, plDiv, (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        // Add properties.
...
function $174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, paom, values) {
    if (pl.getProperty(dictRef) == undefined) {
        ...
        $174b37a7f81f9b54$export$b7771d60d308862f(dictRef, values);
        pl.setProperty(p);
        console.log("Set property " + dictRef);
    } else console.log("Property " + dictRef + " already exists.");
...
function $174b37a7f81f9b54$export$183579040c2dd680(pl, p, units, molecule, mIDM, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)((0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef), mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, psAttributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, boundary, boundary);
        plDiv.appendChild(div);
    } else {
        // PropertyArray.
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                p.setProperty(pa);
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(mIDM.addID(plDiv.id, p.dictRef), mIDM, p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, paAttributes, div, div.querySelector((0, $7e68913db756e51f$export$de72b11c4a138de9)), mIDM.addID(plDiv.id, p.dictRef, (0, $01410cda1eef5011$export$9f93a3fdf2490572).s_units), p.dictRef, boundary, boundary);
                plDiv.appendChild(div);
            }
        } else {
            // PropertyMatrix.
            ...
            if (matrixNodes.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$60fee6710ef6fb16)((0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef), boundary, level, (event)=>{
                    let target = event.target;
                    $174b37a7f81f9b54$export$819b5ff7dff3652c(p.dictRef, pm, target);
                }, inputString, label);
                ...
                (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, pmAttributes, inputDiv, ta, (0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef, (0, $f0396edd0a5c99f7$export$8797b0c8298d191), "Units"), p.dictRef, boundary, boundary);
...
function $174b37a7f81f9b54$export$56da8d49d79e2ff7(dictRef, ps, id, boundary, level) {
...
function $174b37a7f81f9b54$export$f729a71031e2cfe2(attributes, mIDM, value, units, pl, p, plDiv, boundary) {
...
function $174b37a7f81f9b54$export$e5600fc4ea245d6d(id, mIDM, name, pa, getter, setter, remover, marginComponent, margin) {
    ...
    if (value == undefined) {
        ...
        $174b37a7f81f9b54$var$addNumberArray(div, inputId, name, value, pa, getter, setter, marginComponent);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle((0, $7e68913db756e51f$export$d52efe23389358db));
    }
    // Add event listener for the button.
 ...
 */ function $174b37a7f81f9b54$var$addNumberArray(div, id, name, values, paom, getter, setter, boundary) {
    ...
    ta.addEventListener("change", (event)=>{
        let target = event.target;
        $174b37a7f81f9b54$export$819b5ff7dff3652c(name, paom, ta);
...
function $174b37a7f81f9b54$export$819b5ff7dff3652c(dictRef, node, ta) {
    ...
    if (node.getValues().length == 0) {
        let n = (0, $7e68913db756e51f$export$88ed5e596ed31b40)("Please enter the number of elements in the " + dictRef + " array");
        let values = [];
        for(let i = 0; i < n; i++)values.push(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(0));
 ...
 */ let $7e68913db756e51f$var$mIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
/**
 * For reactionList Div ID management.
 */ let $7e68913db756e51f$var$rIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
/**
 * For conditionsList Div ID management.
 */ let $7e68913db756e51f$var$conditionsIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
/**
 * For ModelParametersList Div ID management.
 */ let $7e68913db756e51f$var$mpIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
/**
 * For ControlList Div ID management.
 */ let $7e68913db756e51f$var$controlIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
...
function $7e68913db756e51f$export$2f77af1e417942e1() {
    // Clear content.
    $7e68913db756e51f$var$clearContent();
    // Title.
...
/**
 * Remove existing content and initialise data containers.
 */ function $7e68913db756e51f$var$clearContent() {
...
//# sourceMappingURL=index.05b81d73.js.map
