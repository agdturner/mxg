 ...
 */ function $f0396edd0a5c99f7$export$8b2cd46c11844202(content, buttonLabel, contentDivId, contentDivClassName, buttonId, buttonFontSize, marginLeft, marginTop, marginBottom) {
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    if (xml_title.length != 1) throw new Error("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found");
        ...
        moleculesElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(moleculeListElement, "Molecules", "moleculesList", "moleculesList", "molecules", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom));
        ...
        reactionListElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactionListElement, "Reactions", "reactionsList", "reactionsList", "reactions", $7e68913db756e51f$var$fontSize1, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom));
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_PLs.length == 1) {
            ...
            let collapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plDiv, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName, contentDivId, contentDivId, buttonId, $7e68913db756e51f$var$fontSize3, $7e68913db756e51f$var$margin3, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom);
        ...
        let collapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(moleculeDiv, molecule.getLabel(), molecule.tagName + "_" + molecule.id, "level2", molecule.tagName + "_" + molecule.id + "_button", $7e68913db756e51f$var$fontSize2, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom);
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv, margin) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let collapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(etmDiv, (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName, contentDivId, "level3", buttonId, $7e68913db756e51f$var$fontSize3, $7e68913db756e51f$var$margin3, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom);
        moleculeDiv.appendChild(collapsibleDiv);
        let deltaEDowns = [];
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        let collapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactionDiv, reaction.getLabel(), reaction.tagName + "_" + reaction.id, "level2", reaction.tagName + "_" + reaction.id + "_button", $7e68913db756e51f$var$fontSize2, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom);
...
//# sourceMappingURL=index.a872c69a.js.map
