 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_dcms.length > 0) {
            ...
            let dcmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName));
        ...
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            ...
            if (xml_hrps.length > 0) {
                ...
                let ppsDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName);
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    pps.push(pp);
                    let ppDivID = $7e68913db756e51f$var$addRID(ppsDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName, k);
        ...
        molstarDiv.id = $7e68913db756e51f$var$addRID(m.getID(), "molstar");
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Select molecule", $7e68913db756e51f$var$s_selectOption, $7e68913db756e51f$var$addRID((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1);
...
function $7e68913db756e51f$var$addPropertyScalar(attributes, value, units, pl, p, plDiv, boundary) {
    ...
    console.log("unitsID " + $7e68913db756e51f$var$addRID(id, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units));
 ...
 */ function $7e68913db756e51f$var$processProperty(pl, p, units, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, div, div.querySelector($7e68913db756e51f$var$s_input), $7e68913db756e51f$var$addRID(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
        plDiv.appendChild(div);
    } else {
        // PropertyArray.
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                $7e68913db756e51f$var$addAnyUnits(units, paAttributes, div, div.querySelector($7e68913db756e51f$var$s_textarea), $7e68913db756e51f$var$addRID(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
                plDiv.appendChild(div);
            }
        } else {
            // PropertyMatrix.
 ...
 */ function $7e68913db756e51f$var$processMetadataList(xml) {
    ...
    let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addID((0, $288a4469bea65e97$export$3e18a603070a78a).tagName, 0), $7e68913db756e51f$var$boundary1);
...
//# sourceMappingURL=index.033d49cd.js.map
