...
function $7e68913db756e51f$export$7577c09cb43cc206(id) {
    for (let [key, molecule] of $7e68913db756e51f$var$molecules)if (molecule.getID() == id) {
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    lmb.addEventListener("click", async (event)=>{
        ...
        ms.forEach((v, k)=>{
            $7e68913db756e51f$var$libmols.set($7e68913db756e51f$var$libmols.size, v);
        });
    });
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        $7e68913db756e51f$var$molecules.set(i, m);
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, null, mDiv, m.getLabel(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Create a set of molecule tag names.
        let moleculeTagNames = new Set();
        let cns = xml_ms[i].childNodes;
        //console.log("cns.length=" + cns.length);
        ...
        */ // Organise EnergyTransferModel.
        ...
        if (xml_dosl.length > 0) {
            ...
            if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $ef5b9341e5193b70$export$126b026a4280c589).tagName + " but finding 0!");
                ...
                $7e68913db756e51f$var$addSaveAsCSVButton(dosl.toCSV, doslDiv, t, m.getLabel() + "_" + (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName, $7e68913db756e51f$var$level1);
            }
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
        }
        ...
        if (xml_tts.length > 0) {
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                ttDiv.appendChild(t);
                tt.init(tvs);
                $7e68913db756e51f$var$addSaveAsCSVButton(tt.toCSV.bind(tt), ttDiv, t, m.getLabel() + "_" + (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName, $7e68913db756e51f$var$level1);
            }
            m.setThermoTable(tt);
        ...
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            ...
            // Read bondRef.
            let xml_brs = xml_edms[0].getElementsByTagName((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName);
            if (xml_brs.length > 0) {
            ...
            let xml_hrps = xml_edms[0].getElementsByTagName((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
        ...
        if (xml_ReservoirSize.length > 0) {
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", m.getLabel() + "_" + (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let molecule = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(new Map(), id);
        molecule.setAtoms(new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map()));
        molecule.setBonds(new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)(new Map()));
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            // Add the molecule to the BathGas select elements.
            $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.getLabel());
            // Add edit Name button.
            $7e68913db756e51f$var$addEditIDButton(molecule, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), moleculeDiv, $7e68913db756e51f$var$level1);
            // Description
            moleculeDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_description), molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
 ...
 */ function $7e68913db756e51f$var$addEditIDButton(molecule, button, moleculeDiv, level) {
    ...
    editNameButton.addEventListener("click", ()=>{
        ...
        $7e68913db756e51f$var$removeOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.getLabel());
        molecule.setID(newMoleculeId);
        let moleculeLabel = molecule.getLabel();
        $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, moleculeLabel);
        button.textContent = moleculeLabel + " " + (0, $f0396edd0a5c99f7$export$e5e81646ee331a9e);
    });
}
/**
 * Process description.
...
//# sourceMappingURL=index.7dc28254.js.map
