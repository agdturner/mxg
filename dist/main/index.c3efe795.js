...
class $ef5b9341e5193b70$export$9cea715eceba39a0 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    ...
    */ this.tagName = "atomArray";
     ...
     */ constructor(attributes, atoms){
        ...
        if (atoms != undefined) atoms.forEach((atom)=>{
     ...
     */ getAtoms() {
        ...
        this.nodes.forEach((node)=>{
            if (node instanceof $ef5b9341e5193b70$export$80986e6afdd7e0cb) atoms.push(node);
        });
        return atoms;
    }
}
...
class $ef5b9341e5193b70$export$3da9759ad07746a3 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ setAtoms(atoms) {
        let i = this.index.get($ef5b9341e5193b70$export$80986e6afdd7e0cb.tagName);
        if (i == undefined) {
            this.index.set($ef5b9341e5193b70$export$80986e6afdd7e0cb.tagName, this.nodes.size);
            this.addNode(atoms);
        } else this.nodes.set(i, atoms);
    }
    /**
     * @param atom The atom to add.
     */ addAtom(atom) {
        let atoms = this.getAtoms();
        if (atoms instanceof $ef5b9341e5193b70$export$80986e6afdd7e0cb) {
            let atomArray = new $ef5b9341e5193b70$export$9cea715eceba39a0(new Map());
            atomArray.addNode(atoms);
            atomArray.addNode(atom);
            this.nodes.set(this.nodes.size, atomArray);
            this.index.set($ef5b9341e5193b70$export$9cea715eceba39a0.tagName, this.nodes.size - 1);
            this.index.delete($ef5b9341e5193b70$export$80986e6afdd7e0cb.tagName);
        } else if (atoms instanceof $ef5b9341e5193b70$export$9cea715eceba39a0) atoms.addNode(atom);
        else {
            this.nodes.set(this.nodes.size, atom);
            this.index.set($ef5b9341e5193b70$export$80986e6afdd7e0cb.tagName, this.nodes.size - 1);
        }
    }
    /**
     * @param i The index of the atom to remove.
     */ removeAtom(i) {
        ...
        if (atoms instanceof $ef5b9341e5193b70$export$80986e6afdd7e0cb) {
            if (i == 0) {
                this.nodes.delete(this.index.get($ef5b9341e5193b70$export$80986e6afdd7e0cb.tagName));
                this.index.delete($ef5b9341e5193b70$export$80986e6afdd7e0cb.tagName);
            } else throw new Error("Index out of range");
        } else if (atoms instanceof $ef5b9341e5193b70$export$9cea715eceba39a0) atoms.removeAtom(i);
        else throw new Error("No atoms to remove");
    }
    /**
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_atomArrays.length == 1) {
            ...
            for(let j = 0; j < xml_atoms.length; j++){
                ...
                // id.
                let atomId = atoms[j].getId() || `a${j}`;
                let inputId = moleculeId + "_" + atomId;
                let atomIdlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                    let target = event.target;
                    atoms[j].setId(target.value);
                    console.log("The id has changed from " + atomId + " to " + target.value);
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, atomId, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_id, $7e68913db756e51f$var$fontSize3);
                atomDiv.appendChild(atomIdlwi);
                // elementType.
                let elementType = atoms[j].getElementType();
                let elementTypelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                    let target = event.target;
                    atoms[j].setElementType(target.value);
                ...
                // x3.
                $7e68913db756e51f$var$processX3(molecule, atom, atomDiv, inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3);
                // y3.
                let y3 = (atoms[j].getY3() || 0).toString();
                let y3lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                    let target = event.target;
                    atoms[j].setY3(parseFloat(target.value));
                    console.log("The y3 has changed from " + y3 + " to " + target.value);
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, y3, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, $7e68913db756e51f$var$fontSize3);
                atomDiv.appendChild(y3lwi);
                // z3.
                let z3 = atoms[j].getZ3();
                // Add a 
                if (z3 == undefined) z3 = (atoms[j].getZ3() || 0).toString();
                let z3lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                    let target = event.target;
                    atoms[j].setZ3(parseFloat(target.value));
                    console.log("The z3 has changed from " + z3 + " to " + target.value);
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, z3, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, $7e68913db756e51f$var$fontSize3);
                atomDiv.appendChild(z3lwi);
            }
 ...
 * @param molecule The molecule.
 * @param atom_xml The atom xml.
 * @param atomDiv The atom div.
 * @param id The id.
 */ function $7e68913db756e51f$var$processX3(molecule, atom, atomDiv, id) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$boundary1);
    atomDiv.appendChild(div);
    let buttonTextContentSelected = (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3 + $7e68913db756e51f$var$selected;
    let buttonTextContentDeselected = (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3 + $7e68913db756e51f$var$deselected;
    ...
    if (x3 == undefined) {
        x3 = NaN;
        let attributes = new Map();
        attributes.set((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, $7e68913db756e51f$var$selectAnotherOption);
        atom = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)(attributes);
        $7e68913db756e51f$var$addX3(div, atom, id, x3, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!molecule.index.has((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName)) {
            $7e68913db756e51f$var$addX3(div, atom, id, x3, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
...
function $7e68913db756e51f$var$addX3(div, atom, id, x3, boundary, level) {
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", id + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, boundary, level, (event)=>{
        let target = event.target;
        atom.setX3(parseFloat(target.value));
        console.log("The x3 has changed from " + x3 + " to " + target.value);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, x3.toExponential(), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, $7e68913db756e51f$var$fontSize3);
    div.appendChild(lwi);
}
/**
 * Display the XML.
...
//# sourceMappingURL=index.c3efe795.js.map
