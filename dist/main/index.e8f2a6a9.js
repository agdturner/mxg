...
let $7e68913db756e51f$var$selectedLoadedValueText = " The appended input(s) display loaded value(s) that can be changed:";
let $7e68913db756e51f$var$unselectedText = " Then use the appended input to specify.";
let $7e68913db756e51f$var$selectedValueText = " Or use the appended input(s) to specify:";
/**
 * For mesmer.
 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    ...
    */ let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml.length == 1) {
        ...
        $7e68913db756e51f$var$createCalcMethodInput(control, div, cm, id, value);
        button.classList.toggle("optionOff");
    } else {
        cm = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)(new Map(), "Please use the dropdown to select a value...");
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName)) {
            $7e68913db756e51f$var$createCalcMethodInput(control, div, cm, id, valueString);
...
//# sourceMappingURL=index.e8f2a6a9.js.map
