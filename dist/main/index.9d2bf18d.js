    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_dosl.length > 0) {
            ...
            if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $ef5b9341e5193b70$export$126b026a4280c589).tagName + " but finding 0!");
                ...
                for(let j = 0; j < xml_dos.length; j++){
                    ...
                    $7e68913db756e51f$var$addSaveAsCSVButton(dosl.toCSV, doslDiv, t, mID + "_" + (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
                }
            }
        ...
        if (xml_tts.length > 0) {
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                ttDiv.appendChild(t);
                tt.init(tvs);
                $7e68913db756e51f$var$addSaveAsCSVButton(tt.toCSV, ttDiv, t, mID + "_" + (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName);
            }
            m.setThermoTable(tt);
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_crl.length > 0) {
            ...
            let crl = new (0, $6f7aa7a716962086$export$3f85289af9546f7e)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_crl[0]));
            ...
            // me:description.
            let xml_d = xml_crl[i].getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
            ...
            if (xml_d.length > 0) {
                ...
                let l = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(description, $7e68913db756e51f$var$level1);
                crlDiv.appendChild(l);
            }
            // me:kinf.
            let xml_k = xml_crl[i].getElementsByTagName((0, $6f7aa7a716962086$export$5eb02c9a0d4a6c5).tagName);
        // meT.
        // Val.
        // Rev.
        // Keq.
 ...
 * @param elementToInsertBefore The element to insert before.
 * @param name The name to be appended to the file.
 */ function $7e68913db756e51f$var$addSaveAsCSVButton(toCSV, divToAddTo, elementToInsertBefore, name) {
    ...
    let b = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as CSV", bID, $7e68913db756e51f$var$level1);
...
//# sourceMappingURL=index.9d2bf18d.js.map
