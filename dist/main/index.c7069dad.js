 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    /* Create Banner.
    let bannerDiv: HTMLDivElement = document.createElement('div');
    bannerDiv.innerHTML = '<h1>MXG</h1>'; // Replace with your banner text
    // Load image from data/UOL_Logo.webp
    let uolLogo: HTMLImageElement = document.createElement('img');
    uolLogo.src = '../images/UoL_Logo.png';
    uolLogo.onload = function() {
        console.log('Image loaded successfully');
    };
    uolLogo.onerror = function() {
        console.log('Error loading image');
    };
    uolLogo.alt = 'University of Leeds Logo';
    // Add the image to the banner.
    bannerDiv.appendChild(uolLogo);
    // Insert the banner before the menu
    document.body.insertBefore(bannerDiv, menuDiv);
*/ // Add About MXG button.
    let s_About = "About";
    let ab = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_About, $7e68913db756e51f$var$addID(s_About), $7e68913db756e51f$var$boundary1);
    menuDiv.appendChild(ab);
    ab.addEventListener("click", async (event)=>{
        let aw = window.open("", "", "width=600,height=400");
        $7e68913db756e51f$var$generateAbout(aw);
    });
 ...
 */ function $7e68913db756e51f$var$generateAbout(w) {
    if (w == null) return;
    ...
    p2.appendChild(w.document.createTextNode(". MXG is a work in progress and is undergoing user testing ahead of a Version 1.0         release. Like MESMER, MXG development aims to be driven in part by users reporting issues, submitting feature requests,         and getting involved in development."));
    // p3.
...
//# sourceMappingURL=index.c7069dad.js.map
