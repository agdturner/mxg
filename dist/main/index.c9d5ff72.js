...
class $991aea17c2d860ae$export$7587e661a05e5158 {
     ...
     * Read the file.
     */ static async create() {
        let lm = new $991aea17c2d860ae$export$7587e661a05e5158();
        // Create a file input element to prompt the user to select the default.xml file.
        let input = document.createElement("input");
        input.type = "file";
        let self = this;
...
// HTML IDs
const $7e68913db756e51f$var$menuDivID = $7e68913db756e51f$var$s_menu;
const $7e68913db756e51f$var$titleDivID = $7e68913db756e51f$var$s_title;
const $7e68913db756e51f$var$moleculesDivID = $7e68913db756e51f$var$s_molecules;
const $7e68913db756e51f$var$reactionsDivID = $7e68913db756e51f$var$s_reactions;
const $7e68913db756e51f$var$reactionsDiagramDivID = $7e68913db756e51f$var$s_reactionsDiagram;
const $7e68913db756e51f$var$conditionsDivID = $7e68913db756e51f$var$s_conditions;
const $7e68913db756e51f$var$modelParametersDivID = $7e68913db756e51f$var$s_modelParameters;
const $7e68913db756e51f$var$controlDivID = $7e68913db756e51f$var$s_control;
const $7e68913db756e51f$var$metadataListDivID = $7e68913db756e51f$var$s_metadata;
const $7e68913db756e51f$var$analysisDivID = $7e68913db756e51f$var$s_analysis;
const $7e68913db756e51f$var$xmlDivID = $7e68913db756e51f$var$s_xml;
const $7e68913db756e51f$var$welcomeDivID = $7e68913db756e51f$var$s_welcome;
// For dark/light mode.
 ...
 */ let $7e68913db756e51f$var$libraryMolecules;
/**
...
const $7e68913db756e51f$var$rdDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)($7e68913db756e51f$var$s_Reactions_Diagram);
const $7e68913db756e51f$var$rdcID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)($7e68913db756e51f$var$rdDivID, "Canvas");
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    let lmlb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_Molecules, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(s_Load_Molecules), $7e68913db756e51f$var$boundary1);
    menuDiv.appendChild(lmlb);
    lmlb.addEventListener("click", async (event)=>{
        //let lm: LibraryMolecules = new LibraryMolecules();
        let lm = await (0, $991aea17c2d860ae$export$7587e661a05e5158).create();
        if ($7e68913db756e51f$var$libraryMolecules == null) {
            $7e68913db756e51f$var$libraryMolecules = lm.molecules;
            console.log("xlibraryMolecules.size=" + $7e68913db756e51f$var$libraryMolecules.size);
        } else {
            $7e68913db756e51f$var$libraryMolecules = new Map([
                ...$7e68913db756e51f$var$libraryMolecules,
                ...lm.molecules
            ]);
            lm.molecules.forEach((molecule)=>{
                let mID = molecule.getID();
                console.log("mID=" + mID);
                //libraryMolecules.set(mID, molecule);
                $7e68913db756e51f$var$addOptionByClassName((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, mID);
            });
            console.log("libraryMolecules.size=" + $7e68913db756e51f$var$libraryMolecules.size);
        }
    });
    // Add Load Defaults button.
    let s_Load_default_xml = "Load Defaults";
    console.log(s_Load_default_xml);
    let ldb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_default_xml, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(s_Load_default_xml), $7e68913db756e51f$var$boundary1);
    ...
    let lb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(s_Load), $7e68913db756e51f$var$boundary1);
    ...
    let s_Save_To_MESMER_File = "Save To MESMER File";
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Save_To_MESMER_File, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(s_Save_To_MESMER_File), $7e68913db756e51f$var$boundary1);
    ...
    wDiv.appendChild(p1);
    p1.appendChild(document.createTextNode("Welcome to MXG - a free and open source program to assist in creating, editing and         visualising MESMER program data for gas phase reaction kinetics. The current MXG development repository is: "));
    ...
    wDiv.appendChild(p3);
    p3.textContent = 'The Menu contains 7 buttons. The Load MESMER File button is for loading a complete or partially complete MESMER         data file in an XML format. A complete MESMER data file will contain the following child elements of the parent         "me:mesmer" element: "me:title", "moleculeList", "reactionList", "me:conditions", "me:modelParameters", and "me:control". If a         child element is missing or there are multiple "me:title", "moleculeList" or "reactionList" elements, a warning should appear.         If the file is a MESMER output data file, there should also be "me:metadataList" and "me:analysis" child elements. The Load         Molecule Library button is for loading data for any additional molecules that might want to be included. The Load Defaults         button is for loading default values and units which are used to initialise default values for things that may also be set via         the interface. The Save To MESMER File button is for saving a new MESMER data file. The saved file should have the same content         as any loaded file except: it will contain no comments or extra white space, values will be trimmed of white space, some         numbers may be output in a different style (albeit with no loss of precision). For each molecule there will be a single         AtomArray containing all atoms, a single BondArray containing any bonds and a single PropertyList containing all the         properties. The saved file will reflect any changes specified via the interface. Between the Load and Save buttons are buttons         to increase or decrease the fontsize and to change between a light and dark theme. In addition to increasing or decreasing the         fontsize of text elements, the fontsize buttons can be actioned to redraw the reaction diagram and any species plots with a         larger or smaller fontsize respectively.';
    // p4.
    let p4 = document.createElement("p");
    wDiv.appendChild(p4);
    p4.appendChild(document.createTextNode("MXG can be used online, and also installed locally and used offline as a Progressive Web         App (PWA). PWA installation varies by Web browser/device. For guidance please see the MXG main development repository README: "));
    p4.appendChild($7e68913db756e51f$var$mxg_a.cloneNode(true));
    ...
    wDiv.appendChild(p9);
    p9.textContent = "MXG is a work in progress and not currently recommended for general use, a community release is scheduled at the end of April.         The intention is to allow users to create MESMER files from scratch, but currently the only user pathway is to begin by loading an         existing MESMER file.";
});
/**
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    if (xml_title.length != 1) throw new Error("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found");
        ...
        (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(lwiId, $7e68913db756e51f$var$ids);
        // Create input element.
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(lwiId, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
    ...
    let mlDivID = $7e68913db756e51f$var$addID((0, $8677001474399221$export$19d70f3647dee606).tagName);
    // Remove any existing mlDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(mlDivID, $7e68913db756e51f$var$ids);
    ...
    let rlDivID = $7e68913db756e51f$var$addID((0, $8677001474399221$export$44466a39ca846289).tagName);
    // Remove any existing rlDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(rlDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    ...
    let rdDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_Reactions_Diagram);
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(rdDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    ...
    let bDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rdDivID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e) + "s");
    //remove(popButtonDivId);
    let bDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(bDivId);
    rdDiv.appendChild(bDiv);
    let pbID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bDivId, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    ...
    pb.addEventListener("click", ()=>{
        if ($7e68913db756e51f$var$rdWindow == null) {
            ...
            (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)($7e68913db756e51f$var$rdcID, $7e68913db756e51f$var$ids);
    ...
    let cdlDivID = $7e68913db756e51f$var$addID((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName);
    // Remove any existing cdlDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(cdlDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    ...
    let mplDivID = $7e68913db756e51f$var$addID((0, $8883b31bd809eb64$export$77f098867dc64198).tagName, "list");
    // Remove any existing mpDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(mplDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    ...
    let clDivID = $7e68913db756e51f$var$addID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName);
    // Remove any existing clDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(clDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    ...
    let mdDivID = $7e68913db756e51f$var$addID((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    // Remove any existing mdDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(mdDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
    ...
    let aDivID = $7e68913db756e51f$var$addID((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    // Remove any existing aDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(aDivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        // Create a new Molecule.
        let mDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, i);
        ...
        let mcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, $7e68913db756e51f$var$s_container);
        ...
        // Description
        mDiv.appendChild($7e68913db756e51f$var$processDescription((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(m.getID(), $7e68913db756e51f$var$s_description), m.getDescription.bind(m), m.setDescription.bind(m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Init metadataList.
        //console.log("Init metadataList.");
        let xml_mls = xml_ms[i].getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        if (xml_mls.length > 0) {
            ...
            let mlDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
            let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mlDivID);
            let mlcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mlDivID, $7e68913db756e51f$var$s_container);
            ...
            for(let j = 0; j < xml_ms.length; j++){
                // Create a new Metadata.
                let md = new (0, $288a4469bea65e97$export$e7adebdc1ebd2fed)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[j]));
                mlDiv.appendChild($7e68913db756e51f$var$addMetadata(m, md, ml, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mlDivID, j), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            /*
                ml.addMetadata(md);
        ...
        let aaDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aaDivID, $7e68913db756e51f$var$s_container);
        ...
        let baDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(baDivID, $7e68913db756e51f$var$s_container);
        ...
        for(let j = 0; j < xml_bs.length; j++)baDiv.appendChild($7e68913db756e51f$var$addBond(m, m.getAtoms().atoms, ba, new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        ...
        let viewerDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, "viewer");
        let viewerDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(viewerDivID);
        let viewercDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(viewerDivID, $7e68913db756e51f$var$s_container);
        ...
        let plDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
        let plcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDivID, $7e68913db756e51f$var$s_container);
        ...
        pap.forEach(function(dictRef) {
            ...
            if (dictRef == "me:Hf0") {
                ...
                let ps = new (0, $ef5b9341e5193b70$export$d29b345ea2be5072)(s_attributes, value);
                let p = new (0, $ef5b9341e5193b70$export$90bccbae54bb6d4f)(attributes, ps);
                //attributes.set(Hf0.s_units, "kJ/mol");
                $7e68913db756e51f$var$addPropertyScalar(s_attributes, value, (0, $8677001474399221$export$692079bb871c6039).energyUnits, pl, p, plDiv, $7e68913db756e51f$var$boundary1);
                pl.setProperty(p);
            /*
                    ...
                    //plDiv.appendChild(addProperty(dictRef, ps, getID(plDivID, dictRef), boundary1, level1));
        ...
        if (xml_dcms.length > 0) {
            ...
            let dcm = new (0, $ef5b9341e5193b70$export$3f9657e7f71262a)(dcmAttributes);
            m.setDistributionCalcMethod(dcm);
            let dcmDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
            let dcmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName));
        ...
        if (xml_dosl.length > 0) {
            ...
            let doslDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
            let doslDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(doslDivID);
            let doslcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(doslDivID, $7e68913db756e51f$var$s_container);
            ...
            if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $ef5b9341e5193b70$export$126b026a4280c589).tagName + " but finding 0!");
                ...
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(doslDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
                ...
                for(let j = 0; j < xml_dos.length; j++){
                    ...
                    let dos = new (0, $ef5b9341e5193b70$export$126b026a4280c589)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dos[j]));
                    dosl.addDensityOfStates(dos);
                    let dosDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(doslDivID, j);
        ...
        if (xml_tts.length > 0) {
            ...
            // Create collapsible div.
            let ttDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName);
            let ttDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ttDivId);
            let ttcDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ttDivId, $7e68913db756e51f$var$s_container);
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                tvs = [];
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ttDivId, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
        ...
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            ...
            let edmDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, j);
            let edmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(edmDivID);
            let edmcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(edmDivID, $7e68913db756e51f$var$s_container);
            ...
            if (xml_hrps.length > 0) {
                ...
                let hrpDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(edmDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
                let hrpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(hrpDivID);
                let hrpcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, $7e68913db756e51f$var$s_container);
                ...
                // Format.
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, hrp.getFormat(), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                hrpDiv.appendChild(lws);
                // Units.
                $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).energyUnits, hrpAttributes, hrpDiv, lws, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_units), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                // ExpansionSize.
                let es = hrp.getExpansionSize() ?? $7e68913db756e51f$var$s_undefined;
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
                ...
                let ppsDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName);
                let ppsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ppsDivID);
                let ppscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppsDivID, $7e68913db756e51f$var$s_container);
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    pps.push(pp);
                    let ppDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppsDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName, k);
                    ...
                    let anglelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                        let target = event.target;
                        // Check the input is a number.
                    ...
                    let potentialInputElementId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_potential);
            ...
            if (xml_periodicities.length > 0) {
                ...
                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(edmDivID, (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
        ...
        molstarDiv.id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(m.getID(), "molstar");
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let moleculeDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, $7e68913db756e51f$var$molecules.size);
        let moleculeDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(moleculeDivID);
        // Create collapsible Molecule HTMLDivElement.
        let mcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, $7e68913db756e51f$var$s_container);
        ...
        // Description
        moleculeDiv.appendChild($7e68913db756e51f$var$processDescription((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), $7e68913db756e51f$var$s_description), molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Create collapsible AtomArray HTMLDivElement.
        let aaDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aaDivID, $7e68913db756e51f$var$s_container);
        ...
        // Create collapsible BondArray HTMLDivElement.
        let baDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(baDivID, $7e68913db756e51f$var$s_container);
        ...
        let plDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
        let plcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDivID, $7e68913db756e51f$var$s_container);
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        // If there are no library molecules, then return.
        if ($7e68913db756e51f$var$libraryMolecules == undefined) {
            alert("Use the menu to load a molecule library, then try again...");
            return;
        }
        ...
        let selectDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(selectDivID, $7e68913db756e51f$var$level1);
        let options = Array.from($7e68913db756e51f$var$libraryMolecules.keys());
        console.log("options.length=" + options.length);
        $7e68913db756e51f$var$addOrRemoveInstructions(options, true);
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Select molecule", $7e68913db756e51f$var$s_selectOption, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1);
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = $7e68913db756e51f$var$libraryMolecules.get(mID);
            ...
            moleculeDiv.appendChild($7e68913db756e51f$var$processDescription((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), $7e68913db756e51f$var$s_description), molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            // Create collapsible MetadataList HTMLDivElement.
            let mlistDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
            let mlistDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mlistDivID, $7e68913db756e51f$var$level1);
            let mlistcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mlistDivID, $7e68913db756e51f$var$s_container);
 ...
 */ function $7e68913db756e51f$var$addEditIDButton(molecule, button, moleculeDiv, level) {
    ...
    let editNameButtonID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDiv.id, s_editName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    ...
    editNameButton.addEventListener("click", ()=>{
        ...
        if (newMoleculeId != null) {
            let mid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(newMoleculeId) // This ensures that all special chars are handled.
            ;
 ...
 */ function $7e68913db756e51f$var$processDescription(id, getter, setter, marginComponent, marginDiv) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), marginComponent);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let inputId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_description, $7e68913db756e51f$var$s_input);
    let value = getter();
    if (value == undefined) {
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, typeID, boundary, level) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), "Add" + typeID + "Button"), level);
 ...
 */ function $7e68913db756e51f$var$addAtom(molecule, aa, a, boundary, level) {
    ...
    let aDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), aID);
    ...
    // elementType.
    $7e68913db756e51f$var$processElementType(a, aDiv, true, boundary);
    // Coordinates.
    $7e68913db756e51f$var$processCoordinates(a, aDiv, boundary, boundary);
    $7e68913db756e51f$var$addRemoveButton(aDiv, boundary, $7e68913db756e51f$var$removeAtom, molecule, aID);
 ...
 */ function $7e68913db756e51f$var$removeAtom(molecule, id) {
 ...
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, baDiv, typeID, boundary, level) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeId, "Add" + typeID + "Button"), level);
    button.addEventListener("click", ()=>{
 ...
 */ function $7e68913db756e51f$var$processAtomRefs2(molecule, bDiv, bond, margin) {
    ...
    // alws.
    let alws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + "[0]", atomRefOptions, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, atomRefs[0], (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, 0), margin, margin);
    ...
    // blws.
    let blws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + "[1]", atomRefOptions, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, atomRefs[1], (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, 1), margin, margin);
...
function $7e68913db756e51f$var$addProperty(dictRef, ps, id, boundary, level) {
    ...
    let valueInputId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_input);
...
function $7e68913db756e51f$var$addPropertyScalar(attributes, value, units, pl, p, plDiv, boundary) {
    ...
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef);
    console.log("div ID " + id);
    let div = $7e68913db756e51f$var$processNumber(id, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    console.log("unitsID " + (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units));
    $7e68913db756e51f$var$addAnyUnits(units, attributes, div, div.querySelector($7e68913db756e51f$var$s_input), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
    plDiv.appendChild(div);
/*
    // Get the button from the div and click it.
    let button: HTMLButtonElement = div.querySelector(s_button) as HTMLButtonElement;
    button.click();
    */ /*
    ...
    // Start observing the div with configuration
 ...
 */ function $7e68913db756e51f$var$createProperty(pap, pl, xml, plDiv, molecule, boundary, level) {
    ...
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(pl, p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$2762c8fbc03043ca).dictRef) $7e68913db756e51f$var$processProperty(pl, p, undefined, molecule, xml, plDiv, boundary, level);
    else $7e68913db756e51f$var$processProperty(pl, p, undefined, molecule, xml, plDiv, boundary, level);
    return p;
}
/**
 ...
 */ function $7e68913db756e51f$var$processElementType(a, aDiv, first, margin) {
 ...
 */ function $7e68913db756e51f$var$processCoordinates(a, aDiv, marginComponent, margin) {
    aDiv.appendChild($7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, a.getX3.bind(a), a.setX3.bind(a), a.removeX3, marginComponent, margin));
    aDiv.appendChild($7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, a.getY3.bind(a), a.setY3.bind(a), a.removeY3, marginComponent, margin));
    aDiv.appendChild($7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, a.getZ3.bind(a), a.setZ3.bind(a), a.removeZ3, marginComponent, margin));
}
/**
 ...
 * @param margin The margin.
 */ function $7e68913db756e51f$var$processNumber(id, name, getter, setter, remover, marginComponent, margin) {
    ...
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let inputId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, name, $7e68913db756e51f$var$s_input);
    let value = getter();
    if (value == undefined) {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
 ...
 */ function $7e68913db756e51f$var$processUseSineTerms(hrpDiv, hrp, margin) {
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDiv.id, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_useSineTerms);
 ...
 */ function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    let viewerContainerDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), "viewerContainer");
    ...
    let viewerDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), "viewer");
    ...
    let atomLabelbutton = createLabelButton(s_Atom_Labels, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), s_Atom_Labels), showAtomLabels, (newState)=>showAtomLabels = newState);
    viewerContainerDiv.appendChild(atomLabelbutton);
    // Bond Labels.
    let s_Bond_Labels = "Bond Labels";
    let bondLabelbutton = createLabelButton(s_Bond_Labels, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), s_Bond_Labels), showBondLabels, (newState)=>showBondLabels = newState);
    viewerContainerDiv.appendChild(bondLabelbutton);
    // Add a save button to save the viewer as an image.
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), $7e68913db756e51f$var$s_save), $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$displayXML(xmlFilename, xml) {
    ...
    let xml2DivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$xmlDivID, 2);
    // Remove any existing mlDivID HTMLDivElement.
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(xml2DivID, $7e68913db756e51f$var$ids);
    // Create collapsible content.
 ...
 */ function $7e68913db756e51f$var$processProperty(pl, p, units, molecule, element, plDiv, boundary, level) {
    // PropertyScalar.
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = $7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, div, div.querySelector($7e68913db756e51f$var$s_input), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
        plDiv.appendChild(div);
    } else {
        // PropertyArray.
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                p.setProperty(pa);
                let div = $7e68913db756e51f$var$processNumberArray((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                $7e68913db756e51f$var$addAnyUnits(units, paAttributes, div, div.querySelector($7e68913db756e51f$var$s_textarea), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
                plDiv.appendChild(div);
            }
        } else {
            // PropertyMatrix.
            ...
            if (matrixNodes.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$60fee6710ef6fb16)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), boundary, level, (event)=>{
                    let target = event.target;
                ...
                $7e68913db756e51f$var$addAnyUnits(units, pmAttributes, inputDiv, ta, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $f0396edd0a5c99f7$export$8797b0c8298d191), "Units"), p.dictRef, boundary, boundary);
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let etmdivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
        let etmDiv = document.createElement("div");
        let etmcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(etmdivID, $7e68913db756e51f$var$s_container);
        ...
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            // Create a new div element for the input.
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(etmdivID, (0, $ef5b9341e5193b70$export$16fc56ab40b12b45).tagName, k);
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        let reactionDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $6f7aa7a716962086$export$d2ae4167a30cf6bb).tagName, i);
        ...
        if (xml_reactants.length > 0) {
            ...
            let rsDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName);
            let rsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rsDivID);
            let rscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rsDivID, $7e68913db756e51f$var$s_container);
            ...
            for(let j = 0; j < xml_reactants.length; j++){
                let reactantDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName, j);
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role", (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).roleOptions, "Role", molecule.role, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactantDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_products.length > 0) {
            ...
            let psDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactionDivID, (0, $6f7aa7a716962086$export$264ad599d7cef668).tagName);
            let psDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(psDivID);
            let pscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(psDivID, $7e68913db756e51f$var$s_container);
            ...
            for(let j = 0; j < xml_products.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role", (0, $6f7aa7a716962086$export$264ad599d7cef668).roleOptions, molecule.role, molecule.ref, "Role", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                let select = lws.querySelector("select");
        ...
        let reactioncDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactionDivID, $7e68913db756e51f$var$s_container);
        ...
        if (xml_tunneling.length > 0) {
            ...
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).options, "Tunneling", tunneling.getName(), reaction.id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            lws.querySelector("select")?.addEventListener("change", (event)=>{
                let target = event.target;
        ...
        if (xml_transitionStates.length > 0) {
            // Create collapsible div.
            let tsDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reactionDivID, (0, $6f7aa7a716962086$export$264ad599d7cef668).tagName);
            let tsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(tsDivID);
            let tscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(tsDivID, $7e68913db756e51f$var$s_container);
        ...
        if (xml_MCRCMethod.length > 0) {
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                let mmDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName);
                ...
                if (name == undefined || name == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                    ...
                    let mmcDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, $7e68913db756e51f$var$s_container);
                    ...
                    if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                        ...
                        if (xml_pe != null) {
                            if (xml_pe[0] != null) {
                                ...
                                // Create a new div element for the input.
                                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                    let target = event.target;
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, peAttributes, lwi, null, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName), (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                                mmDiv.appendChild(lwi);
                            }
                        }
                        ...
                        if (xml_ae != null) {
                            if (xml_ae[0] != null) {
                                ...
                                // Create a new div element for the input.
                                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                    let target = event.target;
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, aeAttributes, lwi, null, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName), (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                                mmDiv.appendChild(lwi);
                            }
                        }
                        ...
                        if (xml_ti != null) {
                            if (xml_ti[0] != null) {
                                ...
                                mm.setTInfinity(ti);
                                // Create a new div element for the input.
                                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                    let target = event.target;
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, tiAttributes, lwi, null, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName), (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                                mmDiv.appendChild(lwi);
                            }
                        }
                        ...
                        if (xml_ni != null) {
                            if (xml_ni[0] != null) {
                                ...
                                mm.setNInfinity(ni);
                                // Create a new div element for the input.
                                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                                    let target = event.target;
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, niAttributes, lwi, null, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName), (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                                mmDiv.appendChild(lwi);
                            }
                        }
        ...
        if (xml_erc.length > 0) {
            ...
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$284227145ed02b04).tagName);
        ...
        if (xml_crl.length > 0) {
            ...
            let crlDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName);
            let crlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(crlDivID);
            let crlcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(crlDivID, $7e68913db756e51f$var$s_container);
            ...
            if (xml_k.length > 0) {
                ...
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(crlDiv, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    for(let i = 0; i < xml_conditionss.length; i++){
        ...
        let cDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, i.toString());
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, $7e68913db756e51f$var$boundary1);
        let ccDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(cDivID, $7e68913db756e51f$var$s_container);
        ...
        $7e68913db756e51f$var$handleBathGases(conditions, cDiv, i, xml_conditions);
        $7e68913db756e51f$var$handlePTs(conditions, cDiv, i, xml_conditions);
        ...
        removeButton.addEventListener("click", (event)=>{
            ...
            (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(ccDivID, $7e68913db756e51f$var$ids);
        });
    }
 ...
 */ function $7e68913db756e51f$var$handleBathGases(conditions, conditionsDiv, conditionsIndex, xml_conditions) {
    // Bath Gases
    // Create a collapsible div.
    let bsDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    let bsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(bsDivID);
    let bscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bsDivID, $7e68913db756e51f$var$s_container);
    let bscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bscDivID, conditionsDiv, null, bsDiv, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    // Add add button.
    let addBathGasButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, $7e68913db756e51f$var$level1);
    ...
    addBathGasButton.addEventListener("click", ()=>{
        ...
        let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bsDivID, bathGasIndex.toString());
    ...
    if (xml_conditions != null) {
        ...
        if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
            ...
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bsDivID, "0");
            let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bsDivID, 0), $7e68913db756e51f$var$level1);
 ...
 * @param level 
 * @param nextLevel 
 */ function $7e68913db756e51f$var$handlePTs(conditions, conditionsDiv, conditionsIndex, xml_conditions) {
    // PTs
    let moleculeKeys = new Set($7e68913db756e51f$var$molecules.keys());
    // Create collapsible div.
    let pTsDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionsDiv.id, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName);
    let pTsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(pTsDivId);
    let pTscDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pTsDivId, $7e68913db756e51f$var$s_container);
    let pTscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pTscDivId, conditionsDiv, null, pTsDiv, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    let pTs;
    if (xml_conditions) {
        ...
        if (xml_PTss.length > 0) {
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    // Create pTpairDiv.
                    pTsDiv.appendChild($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, conditionsIndex, i, moleculeKeys, $7e68913db756e51f$var$level1));
                }
            }
    ...
    addButton.addEventListener("click", ()=>{
        ...
        pTsDiv.insertBefore($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, conditionsIndex, pTpairIndex, moleculeKeys, $7e68913db756e51f$var$level1), pTsButtonsDiv);
    });
    ...
    addMultipleButton.addEventListener("click", ()=>{
        ...
        let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$level1);
        let addFromSpreadsheetId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName, "addFromSpreadsheet");
 ...
 */ function $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        $7e68913db756e51f$var$handleBathGases(conditions, cDiv, i, null);
        $7e68913db756e51f$var$handlePTs(conditions, cDiv, i, null);
        // Add a remove conditions button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(cDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeConditions.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the conditions.
 ...
 * @param level The level.
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDivId, conditionsIndex, pTIndex, moleculeKeys, level) {
    ...
    $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, conditionsIndex, pTIndex, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_excessReactantConc, $7e68913db756e51f$var$createExcessReactantConcInputElement);
    ...
    $7e68913db756e51f$var$addPercentExcessReactantConc(pTpairDiv, pTpair, conditionsIndex, pTIndex);
    // Precision.
    ...
    $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, conditionsIndex, pTIndex, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_precision, $7e68913db756e51f$var$createPrecisionSelectElement);
    ...
    $7e68913db756e51f$var$addBathGas(pTpairDiv, pTpair, conditionsIndex, pTIndex, moleculeKeys);
    /*
    ...
    */ // ExperimentalRate.
    ...
    $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, conditionsIndex, pTIndex, (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName, (pTpair)=>pTpair.getExperimentalRate(), $7e68913db756e51f$var$createExperimentalRateDetails);
    // ExperimentalYield.
    ...
    $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, conditionsIndex, pTIndex, (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName, (pTpair)=>pTpair.getExperimentalYield(), $7e68913db756e51f$var$createExperimentalYieldDetails);
    // ExperimentalEigenvalue.
    ...
    $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, conditionsIndex, pTIndex, (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName, (pTpair)=>pTpair.getExperimentalEigenvalue(), $7e68913db756e51f$var$createExperimentalEigenvalueDetails);
 ...
 */ function $7e68913db756e51f$var$addPercentExcessReactantConc(pTpairDiv, pTpair, conditionsIndex, pTIndex) {
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionsIndex.toString(), pTIndex.toString(), (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_percentExcessReactantConc);
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
 ...
 */ function $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, conditionsIndex, pTIndex, attribute, createInputElement) {
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionsIndex.toString(), pTIndex.toString(), attribute);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$var$boundary1);
    pTpairDiv.appendChild(div);
    let buttonTextContentSelected = attribute + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = attribute + $7e68913db756e51f$var$sy_deselected;
    ...
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let iid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_input);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (button.textContent === buttonTextContentDeselected) {
            ...
            (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(iid);
        }
    });
}
/**
 ...
 * @param i The index.
 * @param moleculeKeys The molecule keys.
 */ function $7e68913db756e51f$var$addBathGas(pTpairDiv, pTpair, conditionsIndex, pTIndex, moleculeKeys) {
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionsIndex.toString(), pTIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$var$boundary1);
    pTpairDiv.appendChild(div);
 ...
 * @param getAttribute 
 * @param createElement 
 */ function $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, conditionsIndex, pTIndex, tagName, getAttribute, createElement) {
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(conditionsIndex.toString(), pTIndex.toString(), tagName);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$var$boundary1);
    pTpairDiv.appendChild(div);
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
 ...
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas, first, id) {
    ...
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, value, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$var$boundary1);
    select.classList.add((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    $7e68913db756e51f$var$selectAnotherOptionEventListener(options, select);
    // Add event listener to selectElement.
    select.addEventListener("change", (event)=>{
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    for(let i = 0; i < xml_mps.length; i++){
        ...
        let mpDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $8883b31bd809eb64$export$77f098867dc64198).tagName, i.toString());
        let mpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mpDivID, $7e68913db756e51f$var$boundary1);
        let mpcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mpDivID, $7e68913db756e51f$var$s_container);
        ...
        removeButton.addEventListener("click", (event)=>{
            // Remove the conditions.
            (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(mpcDivID, $7e68913db756e51f$var$ids);
        });
    }
    // Create an add button to add a modelParamters.
 ...
 */ function $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv) {
    ...
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mpsDiv.id, tagName);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, $7e68913db756e51f$var$level1);
    mpsDiv.appendChild(div);
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    div.appendChild(button);
    let idi = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_input);
    let gs;
    let valueString;
    if (xml_mps != null) {
        ...
        if (xml.length == 1) {
            ...
            gs = new (0, $8883b31bd809eb64$export$26e33f0df9ce919d)(attributes, $7e68913db756e51f$var$big0);
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        }
    } else {
 ...
 */ function $7e68913db756e51f$var$createInputModelParameters(mps, div, element, id, valueString, setElementMethod, units) {
    ...
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id), $7e68913db756e51f$var$boundary1);
    input.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 */ function $7e68913db756e51f$var$createAddModelParametersButton(mpsDiv) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        // Create collapsible div.
        let mpDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(tn, i.toString());
        let mpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mpDivID, $7e68913db756e51f$var$boundary1);
        let mpcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mpDivID, $7e68913db756e51f$var$s_container);
        // ElementToInsert before is element after the conditions div with the previous index.
        let elementToInsertBefore;
        ...
        $7e68913db756e51f$var$processGrainSize(mp, null, mpDiv);
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    for(let i = 0; i < xml_controls.length; i++){
        ...
        let cDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, i.toString());
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, $7e68913db756e51f$var$boundary1);
        ...
        $7e68913db756e51f$var$getControlOptionsSimple(control).forEach((option)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, i, onOffControls, xml_control, null, option.class, option.setMethod, option.removeMethod);
        });
        ...
        $7e68913db756e51f$var$handleCalcMethod(control, cDiv, i, xml_control, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, i, onOffControls, xml_control, $7e68913db756e51f$var$level1, item.class, item.setMethod, item.removeMethod, true);
        });
        // me:ForceMacroDetailedBalance
        ...
        if (xml_fdb.length == 1) {
            ...
            let fdbDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$createAddControlButton(controlsDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let onOffControls = new Map();
        $7e68913db756e51f$var$getControlOptionsSimple(control).forEach((option)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, i, onOffControls, null, null, option.class, option.setMethod, option.removeMethod);
        });
        // Create a div for the on/off controls.
        ...
        $7e68913db756e51f$var$handleCalcMethod(control, cDiv, i, null, level);
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, i, onOffControls, null, level, item.class, item.setMethod, item.removeMethod, true);
        });
        // Add a remove control button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(cDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeControl.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
 ...
 */ function $7e68913db756e51f$var$handleControl(control, controlDiv, index, onOffControls, xml_control, level, ControlClass, setControlMethod, removeControlMethod, handleInput = false) {
    ...
    if (level) {
        ...
        div.appendChild(button);
        id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, tagName, $7e68913db756e51f$var$s_input);
    }
    if (xml_control) {
 ...
 */ function $7e68913db756e51f$var$handleCalcMethod(control, controlDiv, i, xml_control, level) {
    ...
    let divCmId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, tagName, i.toString());
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    let aDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    ...
    if (xml_as.length > 0) {
        ...
        if (xml_d.length > 0) {
            if (xml_d.length == 1) {
                ...
                let dDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDivID, (0, $8677001474399221$export$393edc798c47379d).tagName), $7e68913db756e51f$var$level1);
        ...
        let elDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv, (0, $49b337e689138e29$export$f681829d43cbf50e).tagName);
        ...
        if (xml_el.length > 0) for(let i = 0; i < xml_el.length; i++){
            ...
            let eDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(elDiv.id, i.toString());
        ...
        let plDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName);
        ...
        for(let i = 0; i < xml_pl.length; i++){
            ...
            let plDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName, i.toString());
            // Create a new collapsible div for the EigenvalueList.
            let pDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDivID, i.toString());
            ...
            // Create graph.
            let graphDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pDivID, $7e68913db756e51f$var$s_graph), $7e68913db756e51f$var$boundary1);
            ...
            // Create Table.
            let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$boundary1);
            pDiv.appendChild(tableDiv);
            let tab = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$boundary1);
        ...
        let rlDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv, (0, $49b337e689138e29$export$9cdf0fcb7c05190f).tagName);
        ...
        if (xml_rl.length > 0) {
            // Create Table.
            let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rlDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$addSaveAsPNGButton(canvas, divToAddTo, elementToInsertBefore, name) {
    ...
    let saveButtonID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)("saveButton");
 ...
 */ function $7e68913db756e51f$var$addSaveAsCSVButton(toCSV, divToAddTo, elementToInsertBefore, name, margin) {
    let bID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divToAddTo.id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e), $7e68913db756e51f$var$s_save);
...
//# sourceMappingURL=index.c9d5ff72.js.map
