...
class $eb0e80bd8405358c$export$d0e9917d83c120a0 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
     ...
     */ getLower() {
        ...
        if (lower != undefined) return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(lower);
    }
    /**
     ...
     */ getUpper() {
        ...
        if (upper != undefined) return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(upper);
    }
    /**
     ...
     */ getStepsize() {
        ...
        if (stepsize != undefined) return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(stepsize);
    }
    /**
...
class $49b337e689138e29$export$877cee35188549c7 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, value){
        super(attributes, $49b337e689138e29$export$877cee35188549c7.tagName, value);
    }
}
class $49b337e689138e29$export$f681829d43cbf50e extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, eigenvalues){
        super(attributes, $49b337e689138e29$export$f681829d43cbf50e.tagName);
...
class $49b337e689138e29$export$910c21a5819ebc2e extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * Tag name.
     */ this.tagName = "me:pop";
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $49b337e689138e29$export$910c21a5819ebc2e.tagName, value);
    }
}
class $49b337e689138e29$export$9764fff2991ff94a extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, pops){
        super(attributes, $49b337e689138e29$export$9764fff2991ff94a.tagName);
    }
    /**
     * Add a pop.
     */ addPop(p) {
...
class $49b337e689138e29$export$8f9a53be9a409418 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, populations){
        super(attributes, $49b337e689138e29$export$8f9a53be9a409418.tagName);
...
class $49b337e689138e29$export$2450ca15ad4d2ed0 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * Tag name.
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $49b337e689138e29$export$2450ca15ad4d2ed0.tagName, value);
    }
}
class $49b337e689138e29$export$984142e8329468e6 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * Tag name.
...
class $49b337e689138e29$export$9cdf0fcb7c05190f extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, firstOrderLosses, firstOrderRates){
        super(attributes, $49b337e689138e29$export$c4c153dc94cc96b4.tagName);
        this.index = new Map();
        this.folIndex = new Map();
        if (firstOrderLosses) {
            let i = 0;
            firstOrderLosses.forEach((fol)=>{
                this.index.set($49b337e689138e29$export$2450ca15ad4d2ed0.tagName + i.toString(), this.nodes.size);
        ...
        if (firstOrderRates) {
            ...
            firstOrderRates.forEach((forr)=>{
                this.index.set($49b337e689138e29$export$984142e8329468e6.tagName + i.toString(), this.nodes.size);
     ...
     */ addFirstOrderLoss(f) {
        this.folIndex.set(this.folIndex.size, this.nodes.size);
        this.index.set($49b337e689138e29$export$2450ca15ad4d2ed0.tagName + this.folIndex.size.toString(), this.nodes.size);
        this.fols.push(f);
        this.addNode(f);
    }
    /**
     ...
     */ addFirstOrderRate(f) {
        this.forIndex.set(this.forIndex.size, this.nodes.size);
        this.index.set($49b337e689138e29$export$984142e8329468e6.tagName + this.forIndex.size.toString(), this.nodes.size);
        this.fors.push(f);
        this.addNode(f);
    }
}
class $49b337e689138e29$export$c4c153dc94cc96b4 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, description, els, pls, rls){
        ...
        this.index = new Map();
        if (description) {
            this.index.set((0, $8677001474399221$export$393edc798c47379d).tagName, this.nodes.size);
            this.addNode(description);
        }
        this.elIndex = new Map();
        if (els) {
            els.forEach((el)=>{
                this.index.set($49b337e689138e29$export$f681829d43cbf50e.tagName, this.nodes.size);
        ...
        if (pls) {
            pls.forEach((pl)=>{
                this.index.set($49b337e689138e29$export$8f9a53be9a409418.tagName, this.nodes.size);
        ...
        if (rls) {
            rls.forEach((rl)=>{
                this.index.set($49b337e689138e29$export$9cdf0fcb7c05190f.tagName, this.nodes.size);
     ...
     * Get the description.
     */ getDescription() {
        if (this.index.has((0, $8677001474399221$export$393edc798c47379d).tagName)) {
            let i = this.index.get((0, $8677001474399221$export$393edc798c47379d).tagName);
...
class $ae74a7b44a6504a1$export$cdeafdd1d936ed5b extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
     ...
     */ getError() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ae74a7b44a6504a1$export$cdeafdd1d936ed5b.s_error));
    }
    /**
...
class $ae74a7b44a6504a1$export$c291f4faacd745a6 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
     ...
     * @returns The error attribute or undefined if there is no error attribute.
     */ getError() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ae74a7b44a6504a1$export$c291f4faacd745a6.s_error));
    }
    /**
     * Set the error attribute.
     * @param error The error.
     ...
     */ getYieldTime() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ae74a7b44a6504a1$export$c291f4faacd745a6.s_yieldTime));
    }
    /**
...
class $ae74a7b44a6504a1$export$ed9dfbc127680fd1 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    ...
    */ this.tagName = "me:experimentalEigenvalue";
     ...
     * @returns The error attribute or undefined if there is no error attribute.
     */ getError() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ae74a7b44a6504a1$export$ed9dfbc127680fd1.s_error));
    }
    /**
     * Set the error attribute.
     * @param error The error.
...
class $b6873406fb778c0b$export$6ffea14bdffd427f extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * The tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes, value){
        super(attributes, $b6873406fb778c0b$export$6ffea14bdffd427f.tagName, value);
    }
}
...
class $288a4469bea65e97$export$e7adebdc1ebd2fed extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes){
        super(attributes, $288a4469bea65e97$export$e7adebdc1ebd2fed.tagName);
    }
    /**
...
class $288a4469bea65e97$export$7969c02c126c11b8 extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * Tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes, value){
        super(attributes, $288a4469bea65e97$export$7969c02c126c11b8.tagName, value);
    }
}
class $288a4469bea65e97$export$c78a95f4a27bad68 extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * Tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes, value){
        super(attributes, $288a4469bea65e97$export$c78a95f4a27bad68.tagName, value);
    }
}
class $288a4469bea65e97$export$61180682f135a7f2 extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * Tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes, value){
        super(attributes, $288a4469bea65e97$export$61180682f135a7f2.tagName, value);
    }
}
class $288a4469bea65e97$export$bf6d63a1cea4a33c extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * Tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes, value){
        super(attributes, $288a4469bea65e97$export$bf6d63a1cea4a33c.tagName, value);
    }
}
class $288a4469bea65e97$export$2b747e617c849cca extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * Tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes, value){
        super(attributes, $288a4469bea65e97$export$2b747e617c849cca.tagName, value);
    }
}
class $288a4469bea65e97$export$3e18a603070a78a extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * Tag name.
     ...
     */ constructor(attributes, title, source, creator, date, contributor){
        super(attributes, $288a4469bea65e97$export$3e18a603070a78a.tagName);
        this.index = new Map();
        this.metadataIndex = new Map();
        if (title) {
            this.index.set($288a4469bea65e97$export$7969c02c126c11b8.tagName, this.nodes.size);
            this.addNode(title);
        }
        if (source) {
            this.index.set($288a4469bea65e97$export$c78a95f4a27bad68.tagName, this.nodes.size);
            this.addNode(source);
        }
        if (creator) {
            this.index.set($288a4469bea65e97$export$61180682f135a7f2.tagName, this.nodes.size);
            this.addNode(creator);
        }
        if (date) {
            this.index.set($288a4469bea65e97$export$bf6d63a1cea4a33c.tagName, this.nodes.size);
            this.addNode(date);
        }
        if (contributor) {
            this.index.set($288a4469bea65e97$export$2b747e617c849cca.tagName, this.nodes.size);
     ...
     * Get the title.
     */ getTitle() {
        if (this.index.has($288a4469bea65e97$export$7969c02c126c11b8.tagName)) {
            let i = this.index.get($288a4469bea65e97$export$7969c02c126c11b8.tagName);
            return this.nodes.get(i);
        }
    }
    /**
     ...
     * Get the source.
     */ getSource() {
        if (this.index.has($288a4469bea65e97$export$c78a95f4a27bad68.tagName)) {
            let i = this.index.get($288a4469bea65e97$export$c78a95f4a27bad68.tagName);
            return this.nodes.get(i);
        }
    }
    /**
     ...
     * Get the creator.
     */ getCreator() {
        if (this.index.has($288a4469bea65e97$export$61180682f135a7f2.tagName)) {
            let i = this.index.get($288a4469bea65e97$export$61180682f135a7f2.tagName);
            return this.nodes.get(i);
        }
    }
    /**
     ...
     * Get the date.
     */ getDate() {
        if (this.index.has($288a4469bea65e97$export$bf6d63a1cea4a33c.tagName)) {
            let i = this.index.get($288a4469bea65e97$export$bf6d63a1cea4a33c.tagName);
            return this.nodes.get(i);
        }
    }
    /**
     ...
     * Get the contributor.
     */ getContributor() {
        if (this.index.has($288a4469bea65e97$export$2b747e617c849cca.tagName)) {
            let i = this.index.get($288a4469bea65e97$export$2b747e617c849cca.tagName);
            return this.nodes.get(i);
        }
    }
    /**
...
class $8677001474399221$export$a46a5ec84602acfd extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * The tag name.
     ...
     */ constructor(attributes, modelParameterss){
        super(attributes, $8677001474399221$export$a46a5ec84602acfd.tagName);
        this.index = new Map();
...
<?xml-stylesheet type='text/xsl' href='../../mesmer1.xsl' media='screen'?>`;
     ...
     */ constructor(attributes, title, moleculeList, reactionList, conditionss, modelParameterss, controls, metadataList, analysis){
        ...
        if (modelParameterss != undefined) modelParameterss.forEach((modelParameters)=>{
            this.index.set((0, $8883b31bd809eb64$export$77f098867dc64198).tagName + modelParameters.id, this.nodes.size);
        ...
        if (metadataList != undefined) {
            this.index.set((0, $288a4469bea65e97$export$3e18a603070a78a).tagName, this.nodes.size);
            this.addNode(metadataList);
        }
        if (analysis != undefined) {
            this.index.set((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName, this.nodes.size);
     ...
     * @param modelParameters The ModelParameters.
     */ addModelParameters(modelParameters) {
        let id = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + modelParameters.id;
        let i = this.index.get(id);
     ...
     */ removeModelParameters(modelParametersID) {
        ...
        if (i != undefined) {
            this.nodes.delete(i);
            this.index.delete((0, $8883b31bd809eb64$export$77f098867dc64198).tagName + modelParametersID);
     ...
     */ getMetadataList() {
        let i = this.index.get((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        if (i != undefined) return this.nodes.get(i);
    }
    /**
     ...
     */ getAnalysis() {
        let i = this.index.get((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
        if (i != undefined) return this.nodes.get(i);
    }
    /**
...
class $8677001474399221$export$393edc798c47379d extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * The tag name.
     ...
     */ constructor(attributes, description){
        super(attributes, $8677001474399221$export$393edc798c47379d.tagName, description);
    }
}
class $8677001474399221$export$971d5caa766a69d7 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     */ this.tagName = "me:T";
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $8677001474399221$export$971d5caa766a69d7.tagName, value);
    }
}
...
class $ef5b9341e5193b70$export$80986e6afdd7e0cb extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ getX3() {
        ...
        if (x3 != undefined) return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(x3);
    }
    /**
     ...
     */ getY3() {
        ...
        if (y3 != undefined) return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(y3);
    }
    /**
     ...
     */ getZ3() {
        ...
        if (z3 != undefined) return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(z3);
    }
    /**
...
class $ef5b9341e5193b70$export$153327fc99ac0c53 extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ getAtomRefs2() {
        let atomRefs2 = this.attributes.get($ef5b9341e5193b70$export$153327fc99ac0c53.s_atomRefs2);
...
class $ef5b9341e5193b70$export$eb6936faa5f138bb extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * The tag name.
     */ this.tagName = "scalar";
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $ef5b9341e5193b70$export$eb6936faa5f138bb.tagName, value);
    }
    /**
     * @returns The value.
     */ getValue() {
...
class $ef5b9341e5193b70$export$742f9ce317ef8ba3 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     */ this.tagName = "scalar";
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $ef5b9341e5193b70$export$742f9ce317ef8ba3.tagName, value);
    }
    /**
     ...
     */ updateUnits(units) {
        ...
        if (units) {
            let existingUnits = this.attributes.get($ef5b9341e5193b70$export$742f9ce317ef8ba3.s_units);
            if (existingUnits != undefined) {
                if (existingUnits != units) //console.log('Units are not the same, changing units...');
                this.attributes.set($ef5b9341e5193b70$export$742f9ce317ef8ba3.s_units, units);
            }
        }
    }
    /**
...
class $ef5b9341e5193b70$export$41b04b3a73e7216d extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, property){
        ...
        if (dictRef == undefined) {
            ...
            if (title == undefined) throw new Error($ef5b9341e5193b70$export$41b04b3a73e7216d.s_dictRef + " and title are undefined!");
            else {
...
class $ef5b9341e5193b70$export$90bccbae54bb6d4f extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
     */ this.dictRef = "me:Hf0";
...
class $ef5b9341e5193b70$export$a4fe62a56eafa45d extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $ef5b9341e5193b70$export$e7df60530792b964 extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $ef5b9341e5193b70$export$d1d1720eff14586a extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
    * The dictionary reference.
...
class $ef5b9341e5193b70$export$886461cafebcdaed extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
    * The dictionary reference.
...
class $ef5b9341e5193b70$export$415ad1120b60f9f3 extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $ef5b9341e5193b70$export$cb998ac70542b2c3 extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
    * The dictionary reference.
...
class $ef5b9341e5193b70$export$79e850ed2864d13d extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
    * The dictionary reference.
...
class $ef5b9341e5193b70$export$789e4dcdcb815c05 extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $ef5b9341e5193b70$export$f3e9ef5020c299b5 extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $ef5b9341e5193b70$export$25f02bc420569a7e extends $ef5b9341e5193b70$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $ef5b9341e5193b70$export$86ca5149fcde8feb extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     * @returns The angle.
     */ getAngle() {
        return this.attributes.get($ef5b9341e5193b70$export$86ca5149fcde8feb.s_angle);
    }
    /**
     ...
     */ getPotential() {
        return this.attributes.get($ef5b9341e5193b70$export$86ca5149fcde8feb.s_potential);
    }
    /**
...
class $ef5b9341e5193b70$export$3f9657e7f71262a extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
    static{
        /**
     * The tag name.
     ...
     * @param attributes The attributes.
     */ constructor(attributes){
        super(attributes, $ef5b9341e5193b70$export$3f9657e7f71262a.tagName);
    }
    /**
     * @returns The default.
     */ getDefault() {
        return this.attributes.get($ef5b9341e5193b70$export$3f9657e7f71262a.s_default);
    }
    /**
    ...
    */ /**
     * @returns The name.
     */ getName() {
        return this.attributes.get($ef5b9341e5193b70$export$3f9657e7f71262a.s_name);
    }
}
class $ef5b9341e5193b70$export$3ee0c201412b230 extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
    static{
        /**
     * The tag name.
     ...
     * @returns The temperature.
     */ getT() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ef5b9341e5193b70$export$3ee0c201412b230.s_T));
    }
    /**
     ...
     */ getH() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ef5b9341e5193b70$export$3ee0c201412b230.s_H));
    }
    /**
     ...
     * @returns The entropy.
     */ getS() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ef5b9341e5193b70$export$3ee0c201412b230.s_S));
    }
    /**
     * @param S The entropy.
     *
     ...
     */ getG() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ef5b9341e5193b70$export$3ee0c201412b230.s_G));
    }
    /**
     ...
     */ getCp() {
        return new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(this.attributes.get($ef5b9341e5193b70$export$3ee0c201412b230.s_Cp));
    }
    /**
...
class $ef5b9341e5193b70$export$96f29f03cf201f97 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * The tag name.
     ...
     */ constructor(attributes, tvs){
        super(attributes, $ef5b9341e5193b70$export$96f29f03cf201f97.tagName);
        if (tvs != undefined) {
            tvs.forEach((tv)=>{
                this.addNode(tv);
            });
     ...
     */ getHeader() {
        return [
            "T (" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsT) + ")",
            "H(T)-H(0) (" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsH) + ")",
            "S(T) (" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsS) + ")",
            "G(T) (" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsG) + ")",
            "Cp(T) (" + this.attributes.get($ef5b9341e5193b70$export$96f29f03cf201f97.s_unitsCp) + ")"
        ];
    }
    /**
...
class $ef5b9341e5193b70$export$9b8e857b9a081d2 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ getExpansionSize() {
        return this.attributes.get($ef5b9341e5193b70$export$9b8e857b9a081d2.s_expansionSize);
    }
    /**
...
class $ef5b9341e5193b70$export$656e8af5996be26 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $ef5b9341e5193b70$export$656e8af5996be26.tagName, value);
    }
}
class $ef5b9341e5193b70$export$c8de58561fc3a710 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $ef5b9341e5193b70$export$c8de58561fc3a710.tagName, value);
    }
}
class $ef5b9341e5193b70$export$159051b21d796f59 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $ef5b9341e5193b70$export$159051b21d796f59.tagName, value);
    }
}
class $ef5b9341e5193b70$export$126b026a4280c589 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * The tag name.
     ...
     * The header.
     */ this.header = [
            (0, $8677001474399221$export$971d5caa766a69d7).tagName,
            $ef5b9341e5193b70$export$656e8af5996be26.tagName,
            $ef5b9341e5193b70$export$c8de58561fc3a710.tagName,
            $ef5b9341e5193b70$export$159051b21d796f59.tagName
        ];
    }
    /**
     * @param attributes The attributes.
     */ constructor(attributes){
        super(attributes, $ef5b9341e5193b70$export$126b026a4280c589.tagName);
        this.index = new Map();
    }
    /**
     * @returns The T.
     */ getT() {
        let i = this.index.get((0, $8677001474399221$export$971d5caa766a69d7).tagName);
        if (i != undefined) return this.nodes.get(i);
    }
    /**
     * Set the T.
     ...
     * @returns The Qtot.
     */ getQtot() {
        let i = this.index.get($ef5b9341e5193b70$export$656e8af5996be26.tagName);
        if (i != undefined) return this.nodes.get(i);
    }
    /**
     * Set the Qtot.
     ...
     * @returns The Sumc.
     */ getSumc() {
        let i = this.index.get($ef5b9341e5193b70$export$c8de58561fc3a710.tagName);
        if (i != undefined) return this.nodes.get(i);
    }
    /**
     * Set the Sumc.
     ...
     * @returns The Sumg.
     */ getSumg() {
        let i = this.index.get($ef5b9341e5193b70$export$159051b21d796f59.tagName);
        if (i != undefined) return this.nodes.get(i);
    }
    /**
     * Set the Sumg.
...
class $ef5b9341e5193b70$export$dcce836c71a83df extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
    * The tag name.
    */ this.tagName = "me:densityOfStatesList";
     ...
     */ constructor(attributes, description, densityOfStates){
        super(attributes, $ef5b9341e5193b70$export$dcce836c71a83df.tagName);
        this.index = new Map();
        this.dosIndex = new Map();
        if (description) {
            this.nodes.set(this.nodes.size, description);
            this.index.set((0, $8677001474399221$export$393edc798c47379d).tagName, this.nodes.size - 1);
        }
        if (densityOfStates) {
            let i = 0;
     ...
     */ toCSV() {
        let csv = "";
        let header = $ef5b9341e5193b70$export$126b026a4280c589.header;
        csv += header.join(",") + "\n";
...
class $ef5b9341e5193b70$export$3da9759ad07746a3 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, id, metadataList, atoms, bonds, properties, energyTransferModel, dOSCMethod, distributionCalcMethod, extraDOSCMethods, reservoirSize, tt){
        ...
        if (metadataList) {
            ...
            this.index.set((0, $288a4469bea65e97$export$3e18a603070a78a).tagName, i);
            i++;
        }
        // Atoms
        if (atoms) {
        ...
        if (distributionCalcMethod) {
            ...
            this.index.set($ef5b9341e5193b70$export$3f9657e7f71262a.tagName, i);
            i++;
        }
        // ExtraDOSCMethod
        ...
        if (tt) {
            this.nodes.set(i, tt);
            this.index.set($ef5b9341e5193b70$export$96f29f03cf201f97.tagName, i);
        }
    }
    /**
     ...
     * @returns The id of the molecule.
     */ getID() {
        return this.attributes.get($ef5b9341e5193b70$export$3da9759ad07746a3.s_id);
    }
    /**
     * @param id The id of the molecule.
     */ setID(id) {
        this.attributes.set($ef5b9341e5193b70$export$3da9759ad07746a3.s_id, id);
    }
    /**
     ...
     */ getDistributionCalcMethod() {
        let i = this.index.get($ef5b9341e5193b70$export$3f9657e7f71262a.tagName);
        if (i == undefined) return undefined;
        else return this.nodes.get(i);
    }
    /**
     ...
     */ setDistributionCalcMethod(distributionCalcMethod) {
        let i = this.index.get($ef5b9341e5193b70$export$3f9657e7f71262a.tagName);
        if (i == undefined) {
            this.index.set($ef5b9341e5193b70$export$3f9657e7f71262a.tagName, this.nodes.size);
     ...
     */ getDensityOfStatesList() {
        let i = this.index.get($ef5b9341e5193b70$export$dcce836c71a83df.tagName);
        if (i == undefined) return undefined;
        else return this.nodes.get(i);
    }
    /**
     ...
     */ setDensityOfStatesList(densityOfStatesList) {
        let i = this.index.get($ef5b9341e5193b70$export$dcce836c71a83df.tagName);
        if (i == undefined) {
            this.index.set($ef5b9341e5193b70$export$dcce836c71a83df.tagName, this.nodes.size);
     ...
     */ getThermoTable() {
        let i = this.index.get($ef5b9341e5193b70$export$96f29f03cf201f97.tagName);
        if (i == undefined) return undefined;
        else return this.nodes.get(i);
    }
    /**
     ...
     */ setThermoTable(tt) {
        let i = this.index.get($ef5b9341e5193b70$export$96f29f03cf201f97.tagName);
        if (i == undefined) {
            this.index.set($ef5b9341e5193b70$export$96f29f03cf201f97.tagName, this.nodes.size);
            this.addNode(tt);
     ...
     */ getEnergy() {
        ...
        try {
            p = this.getProperty($ef5b9341e5193b70$export$95174cf0748f45cd.dictRef);
        } catch (e) {
            try {
                p = this.getProperty($ef5b9341e5193b70$export$90bccbae54bb6d4f.dictRef);
            } catch (e) {
                try {
                    p = this.getProperty($ef5b9341e5193b70$export$e7df60530792b964.dictRef);
                } catch (e) {
                    try {
                        p = this.getProperty($ef5b9341e5193b70$export$a4fe62a56eafa45d.dictRef);
                    } catch (e) {
                        p = undefined;
                    }
                }
        ...
        if (p == undefined) return (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(0);
...
class $6f7aa7a716962086$export$38dfac6a73b2b45e extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     */ this.tagName = "me:val";
     ...
     * @param value The value of the factor.
     */ constructor(attributes, value){
        super(attributes, $6f7aa7a716962086$export$38dfac6a73b2b45e.tagName, value);
    }
}
class $6f7aa7a716962086$export$a292f79afb9ad235 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     */ this.tagName = "me:rev";
     ...
     * @param value The value of the factor.
     */ constructor(attributes, value){
        super(attributes, $6f7aa7a716962086$export$a292f79afb9ad235.tagName, value);
    }
}
class $6f7aa7a716962086$export$835b53a514d067b0 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * The tag name.
     */ this.tagName = "me:Keq";
     ...
     * @param value The value of the factor.
     */ constructor(attributes, value){
        super(attributes, $6f7aa7a716962086$export$835b53a514d067b0.tagName, value);
    }
}
class $6f7aa7a716962086$export$5eb02c9a0d4a6c5 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * The tag name.
     ...
     */ constructor(attributes, t, val, rev, keq){
        super(attributes, $6f7aa7a716962086$export$5eb02c9a0d4a6c5.tagName);
        this.index = new Map();
        if (t != undefined) {
            this.index.set((0, $8677001474399221$export$971d5caa766a69d7).tagName, this.nodes.size);
            this.addNode(t);
        }
        if (val != undefined) {
            this.index.set($6f7aa7a716962086$export$38dfac6a73b2b45e.tagName, this.nodes.size);
            this.addNode(val);
        }
        if (rev != undefined) {
            this.index.set($6f7aa7a716962086$export$a292f79afb9ad235.tagName, this.nodes.size);
            this.addNode(rev);
        }
        if (keq != undefined) {
            this.index.set($6f7aa7a716962086$export$835b53a514d067b0.tagName, this.nodes.size);
            this.addNode(keq);
        }
    }
    /**
     ...
     */ getVal() {
        let i = this.index.get($6f7aa7a716962086$export$38dfac6a73b2b45e.tagName);
        if (i == undefined) return undefined;
        return this.nodes.get(i);
    }
    /**
     ...
     */ getRev() {
        let i = this.index.get($6f7aa7a716962086$export$a292f79afb9ad235.tagName);
        if (i == undefined) return undefined;
        return this.nodes.get(i);
    }
    /**
     ...
     */ getKeq() {
        let i = this.index.get($6f7aa7a716962086$export$835b53a514d067b0.tagName);
        if (i == undefined) return undefined;
        return this.nodes.get(i);
    }
    /**
...
class $6f7aa7a716962086$export$3f85289af9546f7e extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * The tag name.
     ...
     */ constructor(attributes, description, kinfs){
        super(attributes, $6f7aa7a716962086$export$3f85289af9546f7e.tagName);
        this.index = new Map();
...
class $6f7aa7a716962086$export$d2ae4167a30cf6bb extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, reactants, products, tunneling, transitionStates, mCRCMethod, excessReactantConc, canonicalRateList){
        ...
        if (canonicalRateList != undefined) {
            this.index.set($6f7aa7a716962086$export$3f85289af9546f7e.tagName, this.nodes.size);
     ...
     */ getCanonicalRateList() {
        let i = this.index.get($6f7aa7a716962086$export$3f85289af9546f7e.tagName);
        if (i == undefined) return undefined;
        return this.nodes.get(i);
    }
    /**
     ...
     */ getReactantsEnergy(retrieveMolecule, molecules) {
        ...
        }).reduce((a, b)=>a.add(b), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(0));
    }
    /**
...
class $991aea17c2d860ae$export$7587e661a05e5158 {
     ...
     */ parse(xml) {
        ...
        let xml_ml = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml, (0, $8677001474399221$export$19d70f3647dee606).tagName);
        ...
        */ // Process the XML "molecule" elements.
        let xml_ms = xml_ml.getElementsByTagName((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName);
        ...
        for(let i = 0; i < xml_msl; i++){
            ...
            let mID = attributes.get((0, $ef5b9341e5193b70$export$3da9759ad07746a3).s_id);
            //console.log("mID=" + mID);
            if (mID == undefined) throw new Error((0, $ef5b9341e5193b70$export$3da9759ad07746a3).s_id + " is undefined");
            ...
            let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(attributes, id);
            molecules.set(id, m);
            ...
            let xml_mls = xml_ms[i].getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
            if (xml_mls.length > 0) {
                if (xml_mls.length > 1) throw new Error("Expecting 1 or 0 " + (0, $288a4469bea65e97$export$3e18a603070a78a).tagName + " but finding " + xml_mls.length + "!");
                let ml = new (0, $288a4469bea65e97$export$3e18a603070a78a)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_mls[0]));
                m.setMetadataList(ml);
                let xml_ms = xml_mls[0].getElementsByTagName((0, $288a4469bea65e97$export$e7adebdc1ebd2fed).tagName);
                for(let j = 0; j < xml_ms.length; j++){
                    // Create a new Metadata.
                    let md = new (0, $288a4469bea65e97$export$e7adebdc1ebd2fed)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[j]));
                    ml.addMetadata(md);
                }
                moleculeTagNames.delete((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
            }
            // Init atoms.
            //console.log("Init atoms.");
            // There can be an individual atom not in an atom array, or an atom array.
            let xml_aas = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
            if (xml_aas.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName + " but finding " + xml_aas.length + "!");
            if (xml_aas.length == 1) {
                let xml_aa = xml_aas[0];
                let xml_as = xml_aa.getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
                if (xml_as.length == 0) throw new Error("Expecting 1 or more atoms in " + (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName + ", but finding 0!");
                let aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_aa));
                m.setAtoms(aa);
                for(let j = 0; j < xml_as.length; j++)aa.addAtom(new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m));
                moleculeTagNames.delete((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
            } else {
                let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
                if (xml_as.length == 1) {
                    let aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map());
                    aa.addAtom(new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[0]), m));
                    m.setAtoms(aa);
                } else if (xml_as.length > 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName + " but finding " + xml_as.length + ". Should these be in an " + (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName + "?");
            }
            ...
            let xml_bas = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
            if (xml_bas.length > 0) {
                if (xml_bas.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName + " but finding " + xml_bas.length + "!");
                let xml_bs = xml_bas[0].getElementsByTagName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
                let ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bas[0]));
                for(let j = 0; j < xml_bs.length; j++)ba.addBond(new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m));
                m.setBonds(ba);
                moleculeTagNames.delete((0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
            } else {
                let xml_bonds = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
                if (xml_bonds.length > 0) {
                    ...
                    let ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)(new Map());
                    ba.addBond(new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bonds[0]), m));
                    m.setBonds(ba);
                }
            }
            ...
            let xml_pls = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
            ...
            if (xml_pls.length == 1) {
                ...
                pl.setProperty(new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ps[j])));
                ...
                // Create a new PropertyList.
                let pl = new (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802)(new Map());
                m.setPropertyList(pl);
                let xml_ps = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName);
                ...
                pl.setProperty(new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ps[0])));
                moleculeTagNames.delete((0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName);
            }
            // Organise EnergyTransferModel.
            let xml_etms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
            ...
            // Organise DOSCMethod.
            let xml_dms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
            if (xml_dms.length > 0) {
                if (xml_dms.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + " but finding " + xml_dms.length + "!");
                let doscm = new (0, $ef5b9341e5193b70$export$bbdce6c921702068)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dms[0]));
            ...
            let xml_dcms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
            if (xml_dcms.length > 0) {
                if (xml_dcms.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName + " but finding " + xml_dcms.length + "!");
                let dcmAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dcms[0]);
                let dcm = new (0, $ef5b9341e5193b70$export$3f9657e7f71262a)(dcmAttributes);
                m.setDistributionCalcMethod(dcm);
                moleculeTagNames.delete((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
            }
            // Organise DensityOfStatesList. (Output only)
            let xml_dosl = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
            if (xml_dosl.length > 0) {
                if (xml_dosl.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName + " but finding " + xml_dosl.length + "!");
                let dosl = new (0, $ef5b9341e5193b70$export$dcce836c71a83df)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dosl[0]));
                m.setDensityOfStatesList(dosl);
                let xml_dos = xml_dosl[0].getElementsByTagName((0, $ef5b9341e5193b70$export$126b026a4280c589).tagName);
                // Organise Description.
                let xml_ds = xml_dosl[0].getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
                if (xml_ds.length > 0) {
                    if (xml_ds.length > 1) throw new Error("Expecting 1 or 0 " + (0, $8677001474399221$export$393edc798c47379d).tagName + " but finding " + xml_ds.length + "!");
                    let ds = new (0, $8677001474399221$export$393edc798c47379d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ds[0]), (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_ds[0])));
                    dosl.setDescription(ds);
                }
                // Organise DensityOfStates.
                //console.log("xml_dos.length=" + xml_dos.length);
                if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $ef5b9341e5193b70$export$126b026a4280c589).tagName + " but finding 0!");
                else for(let j = 0; j < xml_dos.length; j++){
                    //console.log("j=" + j);
                    let dos = new (0, $ef5b9341e5193b70$export$126b026a4280c589)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dos[j]));
                    dosl.addDensityOfStates(dos);
                    // T.
                    let xml_t = xml_dos[j].getElementsByTagName((0, $8677001474399221$export$971d5caa766a69d7).tagName);
                    if (xml_t.length != 1) throw new Error("Expecting 1 " + (0, $8677001474399221$export$971d5caa766a69d7).tagName + " but finding " + xml_t.length + "!");
                    else {
                        let t = new (0, $8677001474399221$export$971d5caa766a69d7)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_t[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_t[0]))));
                        dos.setT(t);
                    //dosDiv.appendChild(createLabel(t.value.toString(), boundary1));
                    }
                    // qtot.
                    let xml_qtot = xml_dos[j].getElementsByTagName((0, $ef5b9341e5193b70$export$656e8af5996be26).tagName);
                    if (xml_qtot.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$656e8af5996be26).tagName + " but finding " + xml_qtot.length + "!");
                    else {
                        let qtot = new (0, $ef5b9341e5193b70$export$656e8af5996be26)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_qtot[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_qtot[0]))));
                        dos.setQtot(qtot);
                    //dosDiv.appendChild(createLabel(Qtot.tagName + " " + qtot.value.toString(), boundary1));
                    }
                    // sumc.
                    let xml_sumc = xml_dos[j].getElementsByTagName((0, $ef5b9341e5193b70$export$c8de58561fc3a710).tagName);
                    if (xml_sumc.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$c8de58561fc3a710).tagName + " but finding " + xml_sumc.length + "!");
                    else {
                        let sumc = new (0, $ef5b9341e5193b70$export$c8de58561fc3a710)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_sumc[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_sumc[0]))));
                        dos.setSumc(sumc);
                    //dosDiv.appendChild(createLabel(sumc.value.toString(), boundary1));
                    }
                    // sumg.
                    let xml_sumg = xml_dos[j].getElementsByTagName((0, $ef5b9341e5193b70$export$159051b21d796f59).tagName);
                    if (xml_sumg.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$159051b21d796f59).tagName + " but finding " + xml_sumg.length + "!");
                    else {
                        let sumg = new (0, $ef5b9341e5193b70$export$159051b21d796f59)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_sumg[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_sumg[0]))));
                        dos.setSumg(sumg);
                    //dosDiv.appendChild(createLabel(sumg.value.toString(), boundary1));
                    }
                }
                moleculeTagNames.delete((0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
            }
...
let $89285527201fb7a3$var$mk_url = "https://github.com/MESMER-kinetics";
/**
 * MXG.
 */ let $89285527201fb7a3$var$mxg_url = $89285527201fb7a3$var$mk_url + "/mxg";
let $89285527201fb7a3$var$mxg_a = document.createElement("a");
$89285527201fb7a3$var$mxg_a.href = $89285527201fb7a3$var$mxg_url;
$89285527201fb7a3$var$mxg_a.textContent = $89285527201fb7a3$var$mxg_url;
/**
 * Example data.
 */ let $89285527201fb7a3$var$mxgDataExamples_url = $89285527201fb7a3$var$mxg_url + "/tree/main/data/examples";
let $89285527201fb7a3$var$mxgDataExamples_a = document.createElement("a");
$89285527201fb7a3$var$mxgDataExamples_a.href = $89285527201fb7a3$var$mxgDataExamples_url;
$89285527201fb7a3$var$mxgDataExamples_a.textContent = $89285527201fb7a3$var$mxgDataExamples_url;
/**
 * MESMER.
 */ let $89285527201fb7a3$var$mesmer_url = $89285527201fb7a3$var$mk_url + "/MESMER-code";
let $89285527201fb7a3$var$mesmer_a = document.createElement("a");
$89285527201fb7a3$var$mesmer_a.href = $89285527201fb7a3$var$mesmer_url;
$89285527201fb7a3$var$mesmer_a.textContent = $89285527201fb7a3$var$mesmer_url;
/**
 * EPSRC.
 */ let $89285527201fb7a3$var$epsrc_url = "https://epsrc.ukri.org/";
let $89285527201fb7a3$var$epsrc_a = document.createElement("a");
$89285527201fb7a3$var$epsrc_a.href = $89285527201fb7a3$var$epsrc_url;
$89285527201fb7a3$var$epsrc_a.textContent = "The UK Engineering and Physical Sciences Research Council (EPSRC)";
/**
 * University of Leeds
 */ let $89285527201fb7a3$var$uol_url = "https://www.leeds.ac.uk/";
let $89285527201fb7a3$var$uol_a = document.createElement("a");
$89285527201fb7a3$var$uol_a.href = $89285527201fb7a3$var$uol_url;
$89285527201fb7a3$var$uol_a.textContent = "The University of Leeds";
/**
 * 3DMol.
 */ let $89285527201fb7a3$var$t3Dmol_url = "https://github.com/3dmol/3Dmol.js";
let $89285527201fb7a3$var$t3Dmol_a = document.createElement("a");
$89285527201fb7a3$var$t3Dmol_a.href = $89285527201fb7a3$var$t3Dmol_url;
$89285527201fb7a3$var$t3Dmol_a.textContent = $89285527201fb7a3$var$t3Dmol_url;
let $89285527201fb7a3$var$t3Dmol_citation_url = "http://doi.org/10.1093/bioinformatics/btu829";
let $89285527201fb7a3$var$t3Dmol_citation_a = document.createElement("a");
$89285527201fb7a3$var$t3Dmol_citation_a.href = $89285527201fb7a3$var$t3Dmol_citation_url;
$89285527201fb7a3$var$t3Dmol_citation_a.textContent = "doi:10.1093/bioinformatics/btu829";
/**
 * Big.js.
 */ let $89285527201fb7a3$var$bigjs_url = "https://mikemcl.github.io/big.js/";
let $89285527201fb7a3$var$bigjs_a = document.createElement("a");
$89285527201fb7a3$var$bigjs_a.href = $89285527201fb7a3$var$bigjs_url;
$89285527201fb7a3$var$bigjs_a.textContent = $89285527201fb7a3$var$bigjs_url;
/**
 * Get a div with details about MXG.
 */ function $89285527201fb7a3$var$about(w) {
    if (w == null) return;
    ...
    p1.appendChild($89285527201fb7a3$var$mxg_a);
    ...
    p1.appendChild($89285527201fb7a3$var$mesmer_a);
    ...
    p2.appendChild($89285527201fb7a3$var$uol_a);
    p2.appendChild(w.document.createTextNode(" funded by "));
    p2.appendChild($89285527201fb7a3$var$epsrc_a);
    ...
    p3.appendChild($89285527201fb7a3$var$mxg_a.cloneNode(true));
    ...
    p7.appendChild($89285527201fb7a3$var$t3Dmol_a);
    ...
    p7.appendChild($89285527201fb7a3$var$t3Dmol_citation_a);
    ...
    p8.appendChild($89285527201fb7a3$var$bigjs_a);
    p8.appendChild(w.document.createTextNode("."));
}
function $89285527201fb7a3$export$c9a19c59161f09a0() {
    // Create Menu.
 ...
 */ // Symbols.
const $7e68913db756e51f$var$sy_edit = "\u270E"; // ✎
const $7e68913db756e51f$var$sy_add = "\uFF0B"; // ＋
const $7e68913db756e51f$var$sy_remove = "\u2715"; // ✕
//const sy_refresh: string = "\u27F3"; // ⟳
const $7e68913db756e51f$var$sy_selected = " \u2713"; // ✓
const $7e68913db756e51f$var$sy_deselected = " \u2717"; // ✗
// Strings.
const $7e68913db756e51f$var$s_Add_sy_add = "Add " + $7e68913db756e51f$var$sy_add;
const $7e68913db756e51f$var$s_Add_from_spreadsheet = "Add from spreadsheet " + $7e68913db756e51f$var$sy_add;
const $7e68913db756e51f$var$s_Add_from_library = "Add from library " + $7e68913db756e51f$var$sy_add;
const $7e68913db756e51f$var$s_analysis = "analysis";
const $7e68913db756e51f$var$s_conditions = "conditions";
const $7e68913db756e51f$var$s_container = "container";
const $7e68913db756e51f$var$s_control = "control";
const $7e68913db756e51f$var$s_description = "description";
...
const $7e68913db756e51f$var$s_molecules = "molecules";
const $7e68913db756e51f$var$s_input = "input";
const $7e68913db756e51f$var$s_optionOn = "optionOn";
const $7e68913db756e51f$var$s_optionOff = "optionOff";
const $7e68913db756e51f$var$s_reactions = "reactions";
const $7e68913db756e51f$var$s_reactionsDiagram = "reactionsDiagram";
const $7e68913db756e51f$var$s_Remove_sy_remove = "Remove " + $7e68913db756e51f$var$sy_remove;
const $7e68913db756e51f$var$s_save = "save";
//const s_select: string = "select";
const $7e68913db756e51f$var$s_selectOption = "Select an option (use keys to cycle through options)...";
const $7e68913db756e51f$var$s_table = "table";
const $7e68913db756e51f$var$s_title = "title";
const $7e68913db756e51f$var$s_textarea = "textarea";
const $7e68913db756e51f$var$s_undefined = "undefined";
const $7e68913db756e51f$var$s_units = "units";
 ...
 */ function $7e68913db756e51f$var$addRID(...parts) {
 ...
 */ function $7e68913db756e51f$var$remove(id) {
...
const $7e68913db756e51f$var$moleculesDivID = $7e68913db756e51f$export$39722580448f5a99($7e68913db756e51f$var$s_molecules);
const $7e68913db756e51f$var$reactionsDivID = $7e68913db756e51f$export$39722580448f5a99($7e68913db756e51f$var$s_reactions);
...
// Numbers
const $7e68913db756e51f$var$big0 = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(0);
/*
...
*/ /**
 * For ID management.
 */ class $7e68913db756e51f$var$IDManager {
    /**
     ...
     */ addID(iD, ...parts) {
        let id = $7e68913db756e51f$var$addRID(iD, ...parts);
 ...
 */ let $7e68913db756e51f$var$conditionsIDs = new $7e68913db756e51f$var$IDManager();
/**
 * For modelParameters ID management.
 */ let $7e68913db756e51f$var$modelParametersIDs = new $7e68913db756e51f$var$IDManager();
/**
 * For control ID management.
 */ let $7e68913db756e51f$var$controlIDs = new $7e68913db756e51f$var$IDManager();
/**
 * For mesmer.
 ...
 */ function $7e68913db756e51f$var$getMoleculeKeys(molecules) {
    let keys = new Set();
...
const $7e68913db756e51f$var$s_Reactions_Diagram = "Reactions Diagram";
const $7e68913db756e51f$var$rdDivID = $7e68913db756e51f$var$addRID($7e68913db756e51f$var$s_Reactions_Diagram);
const $7e68913db756e51f$var$rdcID = $7e68913db756e51f$var$addRID($7e68913db756e51f$var$rdDivID, "Canvas");
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    console.log("dark=" + dark);
    */ // Initialise mesmer.
    $7e68913db756e51f$var$mesmer = new (0, $8677001474399221$export$692079bb871c6039)(new Map());
    // Create the menu.
    (0, $89285527201fb7a3$export$c9a19c59161f09a0)();
    // Title.
    let title = "Replace with a title for the MESMER file you want to create.";
    let attributes = new Map();
    $7e68913db756e51f$var$createTitle(title, attributes);
    // Molecules.
    let mlDiv = document.getElementById($7e68913db756e51f$var$moleculesDivID);
    let mlDivID = $7e68913db756e51f$var$addRID((0, $8677001474399221$export$19d70f3647dee606).tagName);
    // Remove any existing mlDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(mlDivID);
    // Create collapsible content.
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, mlDiv, null, $7e68913db756e51f$var$processMoleculeList(xml), (0, $8677001474399221$export$19d70f3647dee606).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    document.body.appendChild(mlcDiv);
});
/**
 * Create the title input.
 */ function $7e68913db756e51f$var$createTitle(title, attributes) {
    let titleNode = new (0, $8677001474399221$export$f99233281efd08a0)(attributes, title);
    $7e68913db756e51f$var$mesmer.setTitle(titleNode);
    let titleDiv = document.getElementById($7e68913db756e51f$var$titleDivID);
    let lwiId = $7e68913db756e51f$var$addRID("titleDiv");
    // Remove any existing lwiId HTMLDivElement.
    $7e68913db756e51f$var$remove(lwiId);
    // Create input element.
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(lwiId, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
    ...
    }, title, (0, $8677001474399221$export$f99233281efd08a0).tagName);
    lwi.id = lwiId;
...
function $7e68913db756e51f$export$11e63f7b0f3d9900() {
    ...
    $7e68913db756e51f$var$rIDs.forEach((id)=>{
        $7e68913db756e51f$var$remove(id);
    });
            ...
            reader.onload = function(e) {
                ...
                if (file != null) {
                    if (start < file.size) {
                        ...
                        let parser = new DOMParser();
                        let xml1 = parser.parseFromString(contents, "text/xml");
                        $7e68913db756e51f$var$parse(xml1);
                    }
                }
            };
            // Read the first chunk
 ...
 * @param xml The XML.
 */ function $7e68913db756e51f$var$parse(xml1) {
    console.log("parse: " + xml1);
    // Process the XML.
    let xml_mesmer = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml1, (0, $8677001474399221$export$692079bb871c6039).tagName);
    ...
    // Title.
    let xml_title = xml1.getElementsByTagName((0, $8677001474399221$export$f99233281efd08a0).tagName);
    let title;
    let attributes;
    if (xml_title.length > 0) {
        if (xml_title.length > 1) console.warn("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found, using the first.");
        ...
        console.warn("No " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tag found, using the filename: " + $7e68913db756e51f$var$filename + " as the title.");
        attributes = new Map();
    }
    $7e68913db756e51f$var$createTitle(title, attributes);
    // Molecules.
    ...
    $7e68913db756e51f$var$remove(mlDivID);
    // Create collapsible content.
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, mlDiv, null, $7e68913db756e51f$var$processMoleculeList(xml1), (0, $8677001474399221$export$19d70f3647dee606).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    //document.body.appendChild(mlcDiv);
    // Reactions.
    let rlDiv = document.getElementById($7e68913db756e51f$var$reactionsDivID);
    let rlDivID = $7e68913db756e51f$var$addRID((0, $8677001474399221$export$44466a39ca846289).tagName);
    // Remove any existing rlDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(rlDivID);
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, rlDiv, null, $7e68913db756e51f$var$processReactionList(xml1), (0, $8677001474399221$export$44466a39ca846289).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Reactions Diagram.
    let rddDiv = document.getElementById($7e68913db756e51f$var$reactionsDiagramDivID);
    let rdDivID = $7e68913db756e51f$var$addRID($7e68913db756e51f$var$s_Reactions_Diagram);
    ...
    $7e68913db756e51f$var$remove(rdDivID);
    // Create collapsible content.
    let rdDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$level1);
    let rdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rdDivID, rddDiv, null, rdDiv, $7e68913db756e51f$var$s_Reactions_Diagram, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Create a pop diagram button in its own div.
    let bDivId = $7e68913db756e51f$var$addRID(rdDivID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e) + "s");
    //remove(popButtonDivId);
    let bDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(bDivId);
    rdDiv.appendChild(bDiv);
    let pbID = $7e68913db756e51f$var$addRID(bDivId, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    ...
    rdCanvas.id = $7e68913db756e51f$var$rdcID;
    rdDiv.appendChild(rdCanvas);
    //rd_canvas.width = rd_canvas_width;
    rdCanvas.height = $7e68913db756e51f$var$rdcHeight;
    ...
    pb.addEventListener("click", ()=>{
        ...
        if ($7e68913db756e51f$var$rdWindow == null) {
            ...
            popWindowRDCanvas.id = $7e68913db756e51f$var$rdcID;
            $7e68913db756e51f$var$rdWindow = window.open("", $7e68913db756e51f$var$s_Reactions_Diagram, "width=" + rdCanvas.width + ", height=" + rdCanvas.height);
            $7e68913db756e51f$var$rdWindow.document.body.appendChild(popWindowRDCanvas);
            ...
            $7e68913db756e51f$var$remove($7e68913db756e51f$var$rdcID);
    ...
    $7e68913db756e51f$var$addSaveAsPNGButton(rdCanvas, bDiv, null, $7e68913db756e51f$var$s_Reactions_Diagram);
    // Conditions.
    let cdlDiv = document.getElementById($7e68913db756e51f$var$conditionsDivID);
    let cdlDivID = $7e68913db756e51f$var$addRID((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName);
    // Remove any existing cdlDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(cdlDivID);
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, $7e68913db756e51f$var$processConditions(xml1), "ConditionsList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Model Parameters.
    let mplDiv = document.getElementById($7e68913db756e51f$var$modelParametersDivID);
    let mplDivID = $7e68913db756e51f$var$addRID((0, $8883b31bd809eb64$export$77f098867dc64198).tagName, "list");
    // Remove any existing mpDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(mplDivID);
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, $7e68913db756e51f$var$processModelParameters(xml1), "ModelParametersList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Control.
    let clDiv = document.getElementById($7e68913db756e51f$var$controlDivID);
    let clDivID = $7e68913db756e51f$var$addRID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName);
    // Remove any existing clDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(clDivID);
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, $7e68913db756e51f$var$processControl(xml1), "ControlList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // MetadataList.
    let mdDiv = document.getElementById($7e68913db756e51f$var$metadataListDivID);
    let mdDivID = $7e68913db756e51f$var$addRID((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    // Remove any existing mdDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(mdDivID);
    // Create collapsible content.
    let mdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mdDivID, mdDiv, null, $7e68913db756e51f$var$processMetadataList(xml1), (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // Analysis.
    let aDiv = document.getElementById($7e68913db756e51f$var$analysisDivID);
    let aDivID = $7e68913db756e51f$var$addRID((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    // Remove any existing aDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(aDivID);
    // Create collapsible content.
    let acDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aDivID, aDiv, null, $7e68913db756e51f$var$processAnalysis(xml1), (0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
}
/**
 * Parse XML and create HTMLDivElement for molecules.
 * @param xml The XML.
 * @returns The HTMLDivElement.
 */ function $7e68913db756e51f$var$processMoleculeList(xml1) {
    // Initialise molecules.
    $7e68913db756e51f$var$molecules = new Map();
    // Create div to contain the molecules list.
    let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    // Get the XML "moleculeList" element.
    let xml_ml = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml1, (0, $8677001474399221$export$19d70f3647dee606).tagName);
    // Check the XML "moleculeList" element has one or more "molecule" elements and no other elements.
    let mlTagNames = new Set();
    xml_ml.childNodes.forEach(function(node) {
        mlTagNames.add(node.nodeName);
    ...
    if (!mlTagNames.has((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName)) {
        console.warn('Expecting tags with "' + (0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName + '" tagName but there are none!');
        return mlDiv;
    }
    // Process the XML "molecule" elements.
    let xml_ms = xml_ml.getElementsByTagName((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName);
    ...
    for(let i = 0; i < xml_msl; i++){
        // Create a new Molecule.
        let mDivID = $7e68913db756e51f$var$addRID((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, i);
        let mDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mDivID);
        let attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[i]);
        let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(attributes, i);
        $7e68913db756e51f$export$ac55d333e780178c(m, $7e68913db756e51f$var$molecules);
        // Create collapsible Molecule HTMLDivElement.
        let mcDivID = $7e68913db756e51f$var$addRID(mDivID, $7e68913db756e51f$var$s_container);
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, null, mDiv, m.label, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Create a set of molecule tag names.
        let moleculeTagNames = new Set();
        let cns = xml_ms[i].childNodes;
        //console.log("cns.length=" + cns.length);
        ...
        $7e68913db756e51f$var$addEditIDButton(m, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), mDiv, $7e68913db756e51f$var$level1);
        // Description
        mDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(mDivID, $7e68913db756e51f$var$s_description), m.getDescription.bind(m), m.setDescription.bind(m), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        // Init metadataList.
        //console.log("Init metadataList.");
        let xml_mls = xml_ms[i].getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        if (xml_mls.length > 0) {
            if (xml_mls.length > 1) console.warn("Expecting 1 or 0 " + (0, $288a4469bea65e97$export$3e18a603070a78a).tagName + " but finding " + xml_mls.length + ". Loading the first of these...");
            // Create collapsible MetadataList HTMLDivElement.
            let mlDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
            let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mlDivID);
            let mlcDivID = $7e68913db756e51f$var$addRID(mlDivID, $7e68913db756e51f$var$s_container);
            let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlcDivID, mDiv, null, mlDiv, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            let xml_ml = xml_mls[0];
            let xml_ms = xml_ml.getElementsByTagName((0, $288a4469bea65e97$export$e7adebdc1ebd2fed).tagName);
            let ml = new (0, $288a4469bea65e97$export$3e18a603070a78a)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_mls[0]));
            m.setMetadataList(ml);
            for(let j = 0; j < xml_ms.length; j++){
                // Create a new Metadata.
                let md = new (0, $288a4469bea65e97$export$e7adebdc1ebd2fed)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[j]));
                mlDiv.appendChild($7e68913db756e51f$var$addMetadata(m, md, ml, $7e68913db756e51f$var$addRID(mlDivID, j), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            }
            moleculeTagNames.delete((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        }
        // Init atoms.
        ...
        let aaDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = $7e68913db756e51f$var$addRID(aaDivID, $7e68913db756e51f$var$s_container);
        let aacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aacDivID, mDiv, null, aaDiv, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        ...
        let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        for(let j = 0; j < xml_as.length; j++)aaDiv.appendChild($7e68913db756e51f$var$addAtom(m, aaDivID, aa, new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(m, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        moleculeTagNames.delete((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        // Init bonds.
        let xml_bas = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        // Create collapsible BondArray HTMLDivElement.
        let baDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = $7e68913db756e51f$var$addRID(baDivID, $7e68913db756e51f$var$s_container);
        let bacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bacDivID, mDiv, null, baDiv, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        ...
        let xml_bs = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
        for(let j = 0; j < xml_bs.length; j++){
            ...
            if (b_attributes.has((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_id)) baDiv.appendChild($7e68913db756e51f$var$addBond(m, baDivID, m.getAtoms().atoms, ba, new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        }
        ...
        baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(m, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        moleculeTagNames.delete((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
        // Add a viewer for the molecule.
        // Create collapsible viewer HTMLDivElement.
        let viewerDivID = $7e68913db756e51f$var$addRID(mDivID, "viewer");
        let viewerDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(viewerDivID);
        let viewercDivID = $7e68913db756e51f$var$addRID(viewerDivID, $7e68913db756e51f$var$s_container);
        let viewercDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(viewercDivID, mDiv, null, viewerDiv, "viewer", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$create3DViewer(m, viewerDiv, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Init properties.
        let xml_pls = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        // Create a new collapsible div for the PropertyList.
        let plDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
        let plcDivID = $7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_container);
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plcDivID, mDiv, null, plDiv, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        ...
        let pap = new Set((0, $ef5b9341e5193b70$export$9f93a3fdf2490572).propertyDictRefs);
        let xml_ps = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$41b04b3a73e7216d).tagName);
        for(let j = 0; j < xml_ps.length; j++){
            // Create a new Property.
            let p = $7e68913db756e51f$var$createProperty(pap, pl, xml_ps[j], plDiv, m, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            pl.setProperty(p);
        }
        ...
        */ // Organise EnergyTransferModel.
        ...
        if (xml_etms.length > 0) {
            if (xml_etms.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName + " but finding " + xml_etms.length + "!");
            let etm = new (0, $ef5b9341e5193b70$export$499950da20810ac9)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_etms[0]));
            $7e68913db756e51f$var$processEnergyTransferModel(etm, m, xml_etms[0], mDiv);
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
        }
        // Organise DOSCMethod.
        let xml_dms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
        if (xml_dms.length > 0) {
            if (xml_dms.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + " but finding " + xml_dms.length + "!");
            let doscm = new (0, $ef5b9341e5193b70$export$bbdce6c921702068)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dms[0]));
            mDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$bbdce6c921702068).xsi_typeOptions, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, doscm.getXsiType(), $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
        }
        // Organise DistributionCalcMethod. (Output only)
        let xml_dcms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
        if (xml_dcms.length > 0) {
            ...
            let dcm = new (0, $ef5b9341e5193b70$export$3f9657e7f71262a)(dcmAttributes);
            m.setDistributionCalcMethod(dcm);
            let dcmDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
            let dcmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(dcmDivID);
            mDiv.appendChild(dcmDiv);
            // Create label.
            dcmDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName + " " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(dcmAttributes), $7e68913db756e51f$var$level1));
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
        }
        // Organise DensityOfStatesList. (Output only)
        let xml_dosl = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
        if (xml_dosl.length > 0) {
            ...
            let doslDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
            let doslDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(doslDivID);
            let doslcDivID = $7e68913db756e51f$var$addRID(doslDivID, $7e68913db756e51f$var$s_container);
            let doslcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(doslcDivID, mDiv, null, doslDiv, (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            let xml_dos = xml_dosl[0].getElementsByTagName((0, $ef5b9341e5193b70$export$126b026a4280c589).tagName);
            // Organise Description.
            let xml_ds = xml_dosl[0].getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
            if (xml_ds.length > 0) {
            ...
            if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $ef5b9341e5193b70$export$126b026a4280c589).tagName + " but finding 0!");
                ...
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(doslDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
                (0, $f0396edd0a5c99f7$export$67d0e2fae00985e1)(t, (0, $ef5b9341e5193b70$export$126b026a4280c589).header);
                ...
                for(let j = 0; j < xml_dos.length; j++){
                    ...
                    let dos = new (0, $ef5b9341e5193b70$export$126b026a4280c589)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dos[j]));
                    dosl.addDensityOfStates(dos);
                    let dosDivID = $7e68913db756e51f$var$addRID(doslDivID, j);
                    let dosDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(dosDivID, $7e68913db756e51f$var$level1);
                ...
                $7e68913db756e51f$var$addSaveAsCSVButton(dosl.toCSV, doslDiv, t, m.getID() + "_" + (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName, $7e68913db756e51f$var$level1);
            }
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
        }
        // Organise ThermoTable. (Output only)
        let tttn = (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName;
        ...
        if (xml_tts.length > 0) {
            ...
            let tt = new (0, $ef5b9341e5193b70$export$96f29f03cf201f97)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_tts[0]));
            // Create collapsible div.
            let ttDivId = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName);
            let ttDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ttDivId);
            let ttcDivId = $7e68913db756e51f$var$addRID(ttDivId, $7e68913db756e51f$var$s_container);
            let ttcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ttcDivId, mDiv, null, ttDiv, tttn, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            let tvs;
            let tvtn = (0, $ef5b9341e5193b70$export$3ee0c201412b230).tagName;
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                tvs = [];
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(ttDivId, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
                (0, $f0396edd0a5c99f7$export$67d0e2fae00985e1)(t, tt.getHeader());
                for(let j = 0; j < xml_tvs.length; j++){
                    let tv = new (0, $ef5b9341e5193b70$export$3ee0c201412b230)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_tvs[j]));
                    tvs.push(tv);
                ...
                ttDiv.appendChild(t);
                tt.init(tvs);
                $7e68913db756e51f$var$addSaveAsCSVButton(tt.toCSV.bind(tt), ttDiv, t, m.getID() + "_" + (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName, $7e68913db756e51f$var$level1);
            }
            m.setThermoTable(tt);
        ...
        let xml_edms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName);
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            let edm = new (0, $ef5b9341e5193b70$export$ae98b7db6376163d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_edms[j]));
            // Create collapsible ExtraDOSCMethod HTMLDivElement.
            let edmDivID = $7e68913db756e51f$var$addRID(mDivID, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, j);
            let edmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(edmDivID);
            let edmcDivID = $7e68913db756e51f$var$addRID(edmDivID, $7e68913db756e51f$var$s_container);
            let edmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(edmcDivID, mDiv, null, edmDiv, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            // Read bondRef.
            let xml_brs = xml_edms[j].getElementsByTagName((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName);
            if (xml_brs.length > 0) {
                if (xml_brs.length != 1) throw new Error("Expecting only 1 bondRef, but there are " + xml_brs.length);
                let bids = m.getBonds().getBondIds();
                let br = new (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_brs[0]), (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_brs[0])));
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, bids, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, br.value, $7e68913db756e51f$var$addRID(edmDivID, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                let select = lws.getElementsByTagName("select")[0];
                select.classList.add((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
                edmDiv.appendChild(lws);
            }
            // Read hinderedRotorPotential.
            let xml_hrps = xml_edms[j].getElementsByTagName((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
            if (xml_hrps.length > 0) {
                ...
                let hrp = new (0, $ef5b9341e5193b70$export$9b8e857b9a081d2)(hrpAttributes);
                // Create collapsible HinderedRotorPotential HTMLDivElement.
                let hrpDivID = $7e68913db756e51f$var$addRID(edmDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName);
                let hrpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(hrpDivID);
                let hrpcDivID = $7e68913db756e51f$var$addRID(hrpDivID, $7e68913db756e51f$var$s_container);
                let hrpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(hrpcDivID, edmDiv, null, hrpDiv, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                // Format.
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, hrp.getFormat(), $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_format), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                hrpDiv.appendChild(lws);
                // Units.
                $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).energyUnits, hrpAttributes, hrpDiv, lws, $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_units), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                // ExpansionSize.
                let es = hrp.getExpansionSize() ?? $7e68913db756e51f$var$s_undefined;
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
                    // Check the input is a number.
                    try {
                        console.log("Setting " + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize + " to " + target.value);
                        ...
                        target.value = hrp.getExpansionSize() ?? $7e68913db756e51f$var$s_undefined;
                    }
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, es, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize));
                // Add useSineTerms.
                $7e68913db756e51f$var$processUseSineTerms(hrpDiv, hrp, $7e68913db756e51f$var$level1);
                // Load PotentialPoints.
                // Create collapsible HinderedRotorPotential PotentialPoint HTMLDivElement.
                let ppsDivID = $7e68913db756e51f$var$addRID(hrpDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName);
                let ppsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ppsDivID);
                let ppscDivID = $7e68913db756e51f$var$addRID(ppsDivID, $7e68913db756e51f$var$s_container);
                let ppscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ppscDivID, mDiv, null, ppsDiv, "PotentialPoints", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                hrpDiv.appendChild(ppscDiv);
                let pps = [];
                let xml_pps = xml_hrps[0].getElementsByTagName((0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName);
                for(let k = 0; k < xml_pps.length; k++){
                    let pp = new (0, $ef5b9341e5193b70$export$86ca5149fcde8feb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_pps[k]));
                    pps.push(pp);
                    let ppDivID = $7e68913db756e51f$var$addRID(ppsDivID, k);
                    let ppDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(ppDivID, $7e68913db756e51f$var$level1);
                    ppsDiv.appendChild(ppDiv);
                    let l = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName + " " + k, $7e68913db756e51f$export$d6befed1f1d5e56b);
                    ppDiv.appendChild(l);
                    // Process angle
                    let a = pp.getAngle() ?? $7e68913db756e51f$var$s_undefined;
                    let anglelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b, (event)=>{
                        let target = event.target;
                        // Check the input is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                            ...
                            target.value = pp.getAngle() ?? $7e68913db756e51f$var$s_undefined;
                        }
                        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                    }, a, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle);
                    ppDiv.appendChild(anglelwi);
                    // Create a new div element for the potential.
                    let potentialLabel = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_potential, $7e68913db756e51f$export$d6befed1f1d5e56b);
                    ppDiv.appendChild(potentialLabel);
                    let potentialInputElementId = $7e68913db756e51f$var$addRID(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_potential);
                    let potentialInputElement = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", potentialInputElementId, $7e68913db756e51f$export$d6befed1f1d5e56b);
                    ppDiv.appendChild(potentialInputElement);
                    let p = pp.getPotential() ?? $7e68913db756e51f$var$s_undefined;
                    potentialInputElement.addEventListener("change", (event)=>{
                        ...
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                            ...
                            potentialInputElement.value = pp.getPotential() ?? $7e68913db756e51f$var$s_undefined;
                        }
            ...
            // Read periodicities.
            let xml_periodicities = xml_edms[j].getElementsByTagName((0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName);
            if (xml_periodicities.length > 0) {
                ...
                let periodicity = new (0, $ef5b9341e5193b70$export$9513c16afdf7d852)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_periodicities[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(valueString));
                edm.setPeriodicity(periodicity);
                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(edmDivID, (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
        ...
        let xml_ReservoirSize = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName);
        if (xml_ReservoirSize.length > 0) {
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", m.getID() + "_" + (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
    ...
    let addMoleculeButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, $7e68913db756e51f$var$level1);
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        if (mid == null) mid = "";
        let id = $7e68913db756e51f$var$molecules.size;
        let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(new Map(), id);
        $7e68913db756e51f$export$ac55d333e780178c(m, $7e68913db756e51f$var$molecules);
        m.setAtoms(new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map()));
        m.setBonds(new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)(new Map()));
        let moleculeDivID = $7e68913db756e51f$var$addRID((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, id);
        let moleculeDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(moleculeDivID);
        // Create collapsible Molecule HTMLDivElement.
        let mcDivID = $7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_container);
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, mid + " " + id, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Add the molecule to the BathGas select elements.
        $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, mid + " " + id);
        // Add edit Name button.
        $7e68913db756e51f$var$addEditIDButton(m, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), moleculeDiv, $7e68913db756e51f$var$level1);
        // Description
        moleculeDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_description), m.getDescription.bind(m), m.setDescription.bind(m), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        // Create collapsible AtomArray HTMLDivElement.
        let aaDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = $7e68913db756e51f$var$addRID(aaDivID, $7e68913db756e51f$var$s_container);
        let aacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aacDivID, moleculeDiv, null, aaDiv, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(m, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        // Create collapsible BondArray HTMLDivElement.
        let baDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = $7e68913db756e51f$var$addRID(baDivID, $7e68913db756e51f$var$s_container);
        let bacDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bacDivID, moleculeDiv, null, baDiv, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(m, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
        $7e68913db756e51f$var$create3DViewer(m, moleculeDiv, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Create collapsible Properties HTMLDivElement.
        let plDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
        let plcDivID = $7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_container);
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plcDivID, moleculeDiv, null, plDiv, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
    // Add code to add propertyArray...
    });
    // Create add from library button.
    let addFromLibraryButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_from_library, undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let selectDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, "div");
        $7e68913db756e51f$var$remove(selectDivID);
        let selectDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(selectDivID), $7e68913db756e51f$var$level1);
        let options = Array.from($7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$export$7c97c73a2c729cf9));
        if (options.length == 0) {
            alert("There are no additional molecules to add, please load data...");
            return;
        }
        console.log("options.length=" + options.length);
        $7e68913db756e51f$var$addOrRemoveInstructions(options, true);
        let selectID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(selectDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191));
        $7e68913db756e51f$var$remove(selectID);
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Select molecule", $7e68913db756e51f$var$s_selectOption, $7e68913db756e51f$var$addRID(selectID), $7e68913db756e51f$export$d6befed1f1d5e56b);
        select.classList.add((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName);
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = $7e68913db756e51f$export$7577c09cb43cc206(label, $7e68913db756e51f$export$7c97c73a2c729cf9);
            $7e68913db756e51f$var$molecules.set($7e68913db756e51f$var$molecules.size, molecule);
            // Add molecule to the MoleculeList.
            let moleculeDivID = $7e68913db756e51f$var$addRID((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, $7e68913db756e51f$var$molecules.size);
            let moleculeDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(moleculeDivID);
            // Create collapsible Molecule HTMLDivElement.
            let mcDivID = $7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_container);
            let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, molecule.getLabel(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            // Add the molecule to the BathGas select elements.
            $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.getID());
            // Add edit Name button.
            $7e68913db756e51f$var$addEditIDButton(molecule, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), moleculeDiv, $7e68913db756e51f$var$level1);
            // Description
            moleculeDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_description), molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            // Create collapsible MetadataList HTMLDivElement.
            let mlistDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
            let mlistDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mlistDivID, $7e68913db756e51f$var$level1);
            let mlistcDivID = $7e68913db756e51f$var$addRID(mlistDivID, $7e68913db756e51f$var$s_container);
            let mlistcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlistcDivID, moleculeDiv, null, mlistDiv, (0, $288a4469bea65e97$export$3e18a603070a78a).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            // Add metadata.
            ...
            if (metadataList != undefined) metadataList.getMetadata().forEach((md)=>{
                ...
                mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(md.getLabelText(), $7e68913db756e51f$export$d6befed1f1d5e56b));
            });
            // Create collapsible AtomArray HTMLDivElement.
            let aaDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
            let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
            ...
            if (aa != undefined) aa.atoms.forEach((a)=>{
                aaDiv.appendChild($7e68913db756e51f$var$addAtom(molecule, aaDivID, molecule.getAtoms(), a, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            });
            aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            // Create collapsible BondArray HTMLDivElement.
            let baDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
            let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
            let bacDivID = $7e68913db756e51f$var$addRID(baDivID, $7e68913db756e51f$var$s_container);
            ...
            if (ba != undefined) molecule.getBonds().bonds.forEach((b)=>{
                ...
                baDiv.appendChild($7e68913db756e51f$var$addBond(molecule, baDivID, aa.atoms, molecule.getBonds(), b, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            });
            baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(molecule, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1));
            $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            // Create collapsible Properties HTMLDivElement.
            let plDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
            let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
            let plcDivID = $7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_container);
 ...
 * @param moleculeDiv 
 * @param level 
 */ function $7e68913db756e51f$var$addEditIDButton(molecule, button, moleculeDiv, level) {
    let s_editName = $7e68913db756e51f$var$sy_edit + " Edit id";
    let editNameButtonID = $7e68913db756e51f$var$addRID(moleculeDiv.id, s_editName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    ...
    editNameButton.addEventListener("click", ()=>{
        ...
        $7e68913db756e51f$var$removeOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.getID());
 ...
 */ function $7e68913db756e51f$var$processDescription(id, getter, setter, marginComponent, marginDiv) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, marginDiv);
    let buttonTextContentSelected = $7e68913db756e51f$var$s_description + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = $7e68913db756e51f$var$s_description + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), marginComponent);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let inputId = $7e68913db756e51f$var$addRID(id, $7e68913db756e51f$var$s_description, $7e68913db756e51f$var$s_input);
    let value = getter();
    if (value == undefined) {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
    } else {
        $7e68913db756e51f$var$addDescription(div, inputId, value, setter, marginComponent);
 ...
 */ function $7e68913db756e51f$var$addDescription(div, id, value, setter, boundary) {
    let valueString;
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, typeID, boundary, level) {
    // Create an add atom button.
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, $7e68913db756e51f$var$addRID(aaDiv.id, "Add" + typeID + "Button"), level);
    button.addEventListener("click", ()=>{
        let attributes = new Map();
        let a = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)(attributes, molecule);
        //let aID: string = molecule.getAtoms().addAtom(a);
        aaDiv.insertBefore($7e68913db756e51f$var$addAtom(molecule, aaDiv.id, molecule.getAtoms(), a, boundary, level), button);
    });
    return button;
}
function $7e68913db756e51f$var$addMetadata(m, md, ml, mdDivID, boundary, level) {
    ml.addMetadata(md);
    let mdDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(mdDivID, $7e68913db756e51f$var$level1);
    mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(m.getLabel(), $7e68913db756e51f$export$d6befed1f1d5e56b));
    return mdDiv;
}
/**
 * Adds an atom.
 ...
 */ function $7e68913db756e51f$var$addAtom(molecule, aaDivID, aa, a, boundary, level) {
    let aID = aa.addAtom(a, a.getID());
    let aDivID = $7e68913db756e51f$var$addRID(aaDivID, aID);
    ...
    let aIDs = new Set();
    // elementType.
    $7e68913db756e51f$var$processElementType(a, aDiv, aIDs, true, boundary);
    // Coordinates.
    $7e68913db756e51f$var$processCoordinates(a, aDiv, aIDs, boundary, boundary);
    $7e68913db756e51f$var$addRemoveButton(aDiv, boundary, $7e68913db756e51f$var$removeAtom, molecule, aID, aIDs);
    // Get elements with Bond.s_atomRefs2 className. These select elements are to be updated to include the new atom option.
    $7e68913db756e51f$var$addOptionByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, aID);
    return aDiv;
}
/**
 ...
 */ function $7e68913db756e51f$var$removeAtom(molecule, aID, aIDs) {
    molecule.getAtoms().removeAtom(aID);
    aIDs.forEach((x)=>{
        console.log("Removing " + x);
        $7e68913db756e51f$var$remove(x);
    });
    $7e68913db756e51f$var$removeOptionByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, aID);
    molecule.getBonds().bonds.forEach((bond)=>{
        ...
        if (atomRefs[0] == atomRefs[1]) {
            ...
            $7e68913db756e51f$var$removeOptionByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, bondId);
            // remove the bondDiv element.
            let bID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, molecule.id, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName, bondId);
 ...
 */ function $7e68913db756e51f$var$removeOptionByClassName(className, optionToRemove) {
 ...
 */ function $7e68913db756e51f$var$addOptionByClassName(className, optionToAdd) {
    let elements = document.getElementsByClassName(className);
 ...
 * @param level The margin for the div.
 * @returns The add bond button.
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, baDiv, typeID, boundary, level) {
    // Create an add button.
    let id = $7e68913db756e51f$var$addRID(baDiv.id, typeID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, id, level);
    button.addEventListener("click", ()=>{
        ...
        attributes.set((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, atomRefs2);
        let b = new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)(attributes, molecule);
        baDiv.insertBefore($7e68913db756e51f$var$addBond(molecule, baDiv.id, atoms, molecule.getBonds(), b, boundary, level), button);
    });
 ...
 */ function $7e68913db756e51f$var$addBond(molecule, baDivID, atoms, ba, b, boundary, level) {
    ...
    // atomRefs2.
    $7e68913db756e51f$var$processAtomRefs2(molecule, bDiv, b, boundary);
    // order.
    $7e68913db756e51f$var$processOrder(bDiv, b, boundary);
    ...
    $7e68913db756e51f$var$addRemoveButton(bDiv, boundary, removeBond, bID);
    // Get elements with Bond className. These select elements are to be updated to include the new bond option.
    $7e68913db756e51f$var$addOptionByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, bID);
    return bDiv;
}
/**
 ...
 */ function $7e68913db756e51f$var$processAtomRefs2(molecule, bDiv, bond, margin) {
    //let id = addRID(bDiv.id, Bond.s_atomRefs2);
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bDiv.id, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
    //bIDs.add(id);
    let atomRefs2 = bond.getAtomRefs2();
    let atomRefs = atomRefs2.split(" ");
    ...
    //bIDs.add(alwsID);
    let alws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + "[0]", atomRefOptions, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, atomRefs[0], alwsID, margin, margin);
    let aselect = alws.querySelector("select");
    aselect.classList.add((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
    aselect.addEventListener("change", (event)=>{
        let target = event.target;
        let atomRefs2 = target.value + " " + atomRefs[1];
        console.log((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + " changed to " + atomRefs2);
    ...
    //bIDs.add(blwsID);
    let blws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + "[1]", atomRefOptions, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, atomRefs[1], blwsID, margin, margin);
    let bselect = blws.querySelector("select");
    bselect.classList.add((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
...
function $7e68913db756e51f$var$addProperty(dictRef, ps, id, boundary, level) {
    ...
    let valueInputId = $7e68913db756e51f$var$addRID(id, $7e68913db756e51f$var$s_input);
...
function $7e68913db756e51f$var$addPropertyScalarNumber(attributes, iDs, value, units, pl, p, plDiv, boundary) {
    let ps = p.getProperty();
    ps.setValue = (function(value) {
        ps.value = value;
        if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) // Update the molecule energy diagram.
        $7e68913db756e51f$var$redrawReactionsDiagram();
    }).bind(ps);
    ps.value = value;
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) // Update the molecule energy diagram.
    $7e68913db756e51f$var$redrawReactionsDiagram();
    let id = $7e68913db756e51f$var$addRID(plDiv.id, p.dictRef);
    console.log("div ID " + id);
    let div = $7e68913db756e51f$var$processNumber(id, iDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
    console.log("unitsID " + $7e68913db756e51f$var$addRID(id, (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3).s_units));
    $7e68913db756e51f$var$addAnyUnits(units, attributes, div, div.querySelector($7e68913db756e51f$var$s_input), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3).s_units), p.dictRef, boundary, boundary);
 ...
 */ function $7e68913db756e51f$var$createProperty(pap, pl, xml1, plDiv, molecule, boundary, level) {
    let p = new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml1));
    pap.delete(p.dictRef);
    //console.log("p.dictRef " + p.dictRef);
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) // "me:ZPE", scalar, Mesmer.energyUnits.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$90bccbae54bb6d4f).dictRef) // "me:Hf0", scalar, Mesmer.energyUnits.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$a4fe62a56eafa45d).dictRef) // "me:HfAT0", scalar, Mesmer.energyUnits.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$e7df60530792b964).dictRef) // "me:Hf298", scalar, Mesmer.energyUnits.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) // "me:rotConsts", array, Mesmer.frequencyUnits.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$d1d1720eff14586a).dictRef) // "me:symmetryNumber", scalar, No units.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$886461cafebcdaed).dictRef) // "me:TSOpticalSymmetryNumber", scalar, No units.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$1288989e9be37590).dictRef) // "me:frequenciesScaleFactor", scalar, No units.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$2762c8fbc03043ca).dictRef) // "me:vibFreqs", array, cm-1.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$a3772f6eb527275b).dictRef) // "me:MW", scalar, amu.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$415ad1120b60f9f3).dictRef) // "me:spinMultiplicity", scalar, No units.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$cb998ac70542b2c3).dictRef) // "me:epsilon", scalar, K (fixed).
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$79e850ed2864d13d).dictRef) // "me:sigma", scalar, Å (fixed).
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$789e4dcdcb815c05).dictRef) // "me:hessian", matrix, kJ/mol/Å2 or kcal/mol/Å2 or Hartree/Å2.
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$f3e9ef5020c299b5).dictRef) // "me:EinsteinAij", array, s-1 (fixed).
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$25f02bc420569a7e).dictRef) // "me:EinsteinBij", array, m3/J/s2 (fixed).
    $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml1, plDiv, boundary, level);
    else $7e68913db756e51f$var$processPropertyScalarString(pl, p, molecule, xml1, plDiv, boundary, level);
    return p;
}
/**
 ...
 */ function $7e68913db756e51f$var$processElementType(a, aDiv, aIDs, first, margin) {
    let elementType = a.getElementType();
    //console.log("Atom.s_elementType " + elementType);
    let selectTypes = (0, $8677001474399221$export$692079bb871c6039).elementTypes;
    // Select.
    if (elementType == undefined) {
        elementType = $7e68913db756e51f$var$s_selectOption;
        $7e68913db756e51f$var$addOrRemoveInstructions(selectTypes, first);
    //console.log("Atom.s_elementTypes " + arrayToString(Atom.elementTypes));
    }
    let id = $7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType);
    aIDs.add(id);
    let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, selectTypes, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, elementType, id, margin, margin);
 ...
 */ function $7e68913db756e51f$var$addOrRemoveInstructions(options, add) {
    if (add) options.push($7e68913db756e51f$var$s_selectOption);
    else {
        // remove selectOption if present.
        let index = options.indexOf($7e68913db756e51f$var$s_selectOption);
 ...
 */ function $7e68913db756e51f$var$processCoordinates(a, aDiv, aIDs, marginComponent, margin) {
    let id;
    id = $7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3);
    aIDs.add(id);
    aDiv.appendChild($7e68913db756e51f$var$processNumber(id, aIDs, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, a.getX3.bind(a), a.setX3.bind(a), a.removeX3, marginComponent, margin));
    id = $7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3);
    aIDs.add(id);
    aDiv.appendChild($7e68913db756e51f$var$processNumber(id, aIDs, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, a.getY3.bind(a), a.setY3.bind(a), a.removeY3, marginComponent, margin));
    id = $7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3);
    aIDs.add(id);
    aDiv.appendChild($7e68913db756e51f$var$processNumber(id, aIDs, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, a.getZ3.bind(a), a.setZ3.bind(a), a.removeZ3, marginComponent, margin));
}
/**
 ...
 * @param margin The margin.
 */ function $7e68913db756e51f$var$processNumber(id, iDs, name, getter, setter, remover, marginComponent, margin) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, margin);
    let buttonTextContentSelected = name + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = name + $7e68913db756e51f$var$sy_deselected;
    let idb = $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    iDs.add(idb);
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, idb, marginComponent);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let inputId = $7e68913db756e51f$var$addRID(id, name, $7e68913db756e51f$var$s_input);
    iDs.add(inputId);
    let value = getter();
    if (value == undefined) {
        button.textContent = buttonTextContentDeselected;
 ...
 */ function $7e68913db756e51f$var$addRemoveButton(div, margin, removeFunction, ...args) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Remove_sy_remove, undefined, margin);
    div.appendChild(button);
    button.addEventListener("click", ()=>{
        removeFunction(...args);
        div.remove();
        $7e68913db756e51f$var$remove(div.id);
    });
    return button;
}
/**
 ...
 */ function $7e68913db756e51f$var$processOrder(bondDiv, bond, margin) {
    //let id = addRID(bondDiv.id, Bond.s_order);
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(bondDiv.id, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, margin);
    bondDiv.appendChild(div);
    let buttonTextContentSelected = (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order + $7e68913db756e51f$var$sy_deselected;
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addOrder(div, bond, id, value, margin);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
    }
    // Add event listener for the button.
 ...
 * @param margin The margin for components.
 */ function $7e68913db756e51f$var$processUseSineTerms(hrpDiv, hrp, margin) {
    let id = $7e68913db756e51f$var$addRID(hrpDiv.id, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_useSineTerms);
    let buttonTextContentSelected = (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_useSineTerms + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_useSineTerms + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, undefined, margin);
 ...
 */ function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    let viewerContainerDivID = $7e68913db756e51f$var$addRID(moleculeDiv.id, "viewerContainer");
    ...
    let viewerDivID = $7e68913db756e51f$var$addRID(moleculeDiv.id, "viewer");
    ...
    redrawButton.addEventListener("click", ()=>{
        $7e68913db756e51f$var$remove(viewerDivID);
    ...
    let atomLabelbutton = createLabelButton(s_Atom_Labels, $7e68913db756e51f$var$addRID(viewerDivID, s_Atom_Labels), showAtomLabels, (newState)=>showAtomLabels = newState);
    viewerContainerDiv.appendChild(atomLabelbutton);
    // Bond Labels.
    let s_Bond_Labels = "Bond Labels";
    let bondLabelbutton = createLabelButton(s_Bond_Labels, $7e68913db756e51f$var$addRID(viewerDivID, s_Bond_Labels), showBondLabels, (newState)=>showBondLabels = newState);
    viewerContainerDiv.appendChild(bondLabelbutton);
    // Add a save button to save the viewer as an image.
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", $7e68913db756e51f$var$addRID(viewerDivID, $7e68913db756e51f$var$s_save), $7e68913db756e51f$export$d6befed1f1d5e56b);
 ...
 */ function $7e68913db756e51f$var$displayXML(xmlFilename, xml1) {
    let xmlDiv = document.getElementById($7e68913db756e51f$var$xmlDivID);
    let xml2DivID = $7e68913db756e51f$var$addRID($7e68913db756e51f$var$xmlDivID, 2);
    // Remove any existing mlDivID HTMLDivElement.
    $7e68913db756e51f$var$remove(xml2DivID);
    // Create collapsible content.
    let xml2Div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(xml2DivID, $7e68913db756e51f$var$level1);
    let xmlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(xml2DivID, xmlDiv, null, xml2Div, xmlFilename, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    let xmlPre = document.createElement("pre");
    xmlPre.textContent = xml1;
 ...
 */ function $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, units, molecule, element, plDiv, boundary, level) {
    ...
    let pIDs = new Set();
    // PropertyScalar.
    let scalarNodes = element.getElementsByTagName((0, $ef5b9341e5193b70$export$742f9ce317ef8ba3).tagName);
    if (scalarNodes.length > 0) {
        if (scalarNodes.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3).tagName + " but finding " + scalarNodes.length + "!");
        ...
        let ps = new (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3)(psAttributes, value);
        p.setProperty(ps);
        ps.setValue = (function(value) {
            ps.value = value;
            if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) // Update the molecule energy diagram.
        ...
        let div = $7e68913db756e51f$var$processNumber($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), pIDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, div, div.querySelector($7e68913db756e51f$var$s_input), $7e68913db756e51f$var$addRID(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3).s_units), p.dictRef, boundary, boundary);
        plDiv.appendChild(div);
    } else {
        // PropertyArray.
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                p.setProperty(pa);
                let div = $7e68913db756e51f$var$processNumberArray($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                $7e68913db756e51f$var$addAnyUnits(units, paAttributes, div, div.querySelector($7e68913db756e51f$var$s_textarea), $7e68913db756e51f$var$addRID(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$9f93a3fdf2490572).s_units), p.dictRef, boundary, boundary);
                plDiv.appendChild(div);
            }
        } else {
            // PropertyMatrix.
            ...
            if (matrixNodes.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$60fee6710ef6fb16)($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), boundary, level, (event)=>{
                    let target = event.target;
                ...
                $7e68913db756e51f$var$addAnyUnits(units, pmAttributes, inputDiv, ta, $7e68913db756e51f$var$addRID(plDiv.id, p.dictRef, (0, $f0396edd0a5c99f7$export$8797b0c8298d191), "Units"), p.dictRef, boundary, boundary);
                plDiv.appendChild(inputDiv);
            } else throw new Error("Expecting " + (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3).tagName + ", " + (0, $ef5b9341e5193b70$export$9f93a3fdf2490572).tagName + " or " + (0, $ef5b9341e5193b70$export$a5a2be813176eb0e).tagName + " but finding none!");
        }
    }
}
/**
 ...
 * @param boundary The boundary to go around components.
 * @param level The level of the component.
 */ function $7e68913db756e51f$var$processPropertyScalarString(pl, p, molecule, element, plDiv, boundary, level) {
    // This is for storing the IDs of the components so that if property is removed and readded, the IDs are available and there is no confuion...
    let pIDs = new Set();
    // PropertyScalarString.
    let scalarNodes = element.getElementsByTagName((0, $ef5b9341e5193b70$export$eb6936faa5f138bb).tagName);
    if (scalarNodes.length > 0) {
        if (scalarNodes.length != 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$eb6936faa5f138bb).tagName + " but finding " + scalarNodes.length + "!");
        let inputString = (0, $cc8c7201a9bad777$export$433c819efd6b1ea5)(scalarNodes[0]);
        let psAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(scalarNodes[0]);
        // Add PropertyScalarNumber.
        let ps = new (0, $ef5b9341e5193b70$export$eb6936faa5f138bb)(psAttributes, inputString);
        p.setProperty(ps);
        ps.setValue = (function(value) {
            ps.value = value;
        ...
        let div = $7e68913db756e51f$var$processString($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), pIDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        plDiv.appendChild(div);
    } else console.log("Expecting " + (0, $ef5b9341e5193b70$export$eb6936faa5f138bb).tagName + " but finding none!");
}
/**
 ...
 * @param boundary The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addAnyUnits(units, attributes, divToAddTo, elementToInsertBefore, id, tagOrDictRef, boundary, level) {
    if (units != undefined) {
 ...
 * @param element The element.
 * @param moleculeDiv The molecule div.
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let etmdivID = $7e68913db756e51f$var$addRID(moleculeDiv.id, (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
        let etmDiv = document.createElement("div");
        let etmcDivID = $7e68913db756e51f$var$addRID(etmdivID, $7e68913db756e51f$var$s_container);
        let etmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(etmcDivID, moleculeDiv, null, etmDiv, (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        let deltaEDowns = [];
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            // Create a new div element for the input.
            let id = $7e68913db756e51f$var$addRID(etmdivID, (0, $ef5b9341e5193b70$export$16fc56ab40b12b45).tagName, k);
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml1) {
    // Initialise reactions.
    $7e68913db756e51f$var$reactions = new Map();
    // Create div to contain the reaction list.
    let reactionListDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    // Get the XML "reactionList" element.
    let xml_reactionList = (0, $cc8c7201a9bad777$export$b7531b8ff18dc588)(xml1, (0, $8677001474399221$export$44466a39ca846289).tagName);
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        let reactionDivID = $7e68913db756e51f$var$addRID((0, $6f7aa7a716962086$export$d2ae4167a30cf6bb).tagName, i);
        ...
        if (xml_reactants.length > 0) {
            ...
            let rsDivID = $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName);
            let rsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rsDivID);
            let rscDivID = $7e68913db756e51f$var$addRID(rsDivID, $7e68913db756e51f$var$s_container);
            let rscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rscDivID, reactionDiv, null, rsDiv, "Reactants", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            let reactants = [];
            for(let j = 0; j < xml_reactants.length; j++){
                let reactantDivID = $7e68913db756e51f$var$addRID(rsDivID, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName, j);
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.getRef() + " role", (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).roleOptions, "Role", molecule.getRole(), $7e68913db756e51f$var$addRID(reactantDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        ...
        if (xml_products.length > 0) {
            ...
            let psDivID = $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$264ad599d7cef668).tagName);
            let psDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(psDivID);
            let pscDivID = $7e68913db756e51f$var$addRID(psDivID, $7e68913db756e51f$var$s_container);
            let pscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pscDivID, reactionDiv, null, psDiv, "Products", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            let products = [];
            for(let j = 0; j < xml_products.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.getRef() + " role", (0, $6f7aa7a716962086$export$264ad599d7cef668).roleOptions, molecule.getRole(), molecule.getRef(), $7e68913db756e51f$var$addRID(psDivID, j, "Role"), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                let select = lws.querySelector("select");
        ...
        let reactioncDivID = $7e68913db756e51f$var$addRID(reactionDivID, $7e68913db756e51f$var$s_container);
        let reactioncDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactioncDivID, reactionListDiv, null, reactionDiv, reaction.id + " (" + reaction.getLabel() + ")", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Load tunneling.
        ...
        if (xml_tunneling.length > 0) {
            ...
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).options, "Tunneling", tunneling.getName(), $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            lws.querySelector("select")?.addEventListener("change", (event)=>{
                let target = event.target;
        ...
        if (xml_transitionStates.length > 0) {
            // Create collapsible div.
            let tsDivID = $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$145c1ed87b1a2216).tagName);
            let tsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(tsDivID);
            let tscDivID = $7e68913db756e51f$var$addRID(tsDivID, $7e68913db756e51f$var$s_container);
            let tscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(tscDivID, reactionDiv, null, tsDiv, "Transition States", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            ...
            for(let j = 0; j < xml_transitionStates.length; j++){
                ...
                let label = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(molecule.getRef() + " role transitionState", $7e68913db756e51f$var$level1);
        ...
        if (xml_MCRCMethod.length > 0) {
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                let mmDivId = $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName);
                ...
                if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                    ...
                    let mmcDivId = $7e68913db756e51f$var$addRID(mmDivId, $7e68913db756e51f$var$s_container);
                    let mmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mmcDivId, reactionDiv, null, mmDiv, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
                    reactionDiv.appendChild(mmcDiv);
                    //console.log(MCRCMethod.tagName + " name=" + name);
                    mm = new (0, $6f7aa7a716962086$export$191e95ebb11cc88)(mmAttributes);
                    //console.log(MCRCMethod.tagName + "xsi:type=" + type);
                    let xml_pe = xml_MCRCMethod[0].getElementsByTagName((0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName);
                    if (xml_pe != null) {
                        if (xml_pe[0] != null) {
                            ...
                            let pe = new (0, $6f7aa7a716962086$export$38ce90ac8b004d85)(peAttributes, value);
                            mm.setPreExponential(pe);
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                                $7e68913db756e51f$export$b1e4cbf5b56e0e21(pe, target);
                            }, inputString, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName);
                            ...
                            input.addEventListener("change", (event)=>{
                                ...
                                console.log((0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName + " changed to " + inputString);
                                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
                            });
                            $7e68913db756e51f$var$addAnyUnits(undefined, peAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName), (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b);
                            mmDiv.appendChild(lwi);
                        }
                    }
                    //console.log("preExponential " + preExponential);
                    let xml_ae = xml_MCRCMethod[0].getElementsByTagName((0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName);
                    if (xml_ae != null) {
                        if (xml_ae[0] != null) {
                            ...
                            let ae = new (0, $6f7aa7a716962086$export$1bdc69d2439d749d)(aeAttributes, value);
                            mm.setActivationEnergy(ae);
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                                $7e68913db756e51f$export$b1e4cbf5b56e0e21(ae, target);
                            }, inputString, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName);
                            let input = lwi.querySelector("input");
                            input.value = inputString;
                            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
                            input.addEventListener("change", (event)=>{
                                ...
                                console.log((0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName + " changed to " + inputString);
                                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
                            });
                            $7e68913db756e51f$var$addAnyUnits(undefined, aeAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName), (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b);
                            mmDiv.appendChild(lwi);
                        }
                    }
                    //console.log("activationEnergy " + activationEnergy);
                    let xml_ti = xml_MCRCMethod[0].getElementsByTagName((0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName);
                    if (xml_ti != null) {
                        if (xml_ti[0] != null) {
                            ...
                            let ti = new (0, $6f7aa7a716962086$export$8d95dd32819bc86c)(tiAttributes, value);
                            mm.setTInfinity(ti);
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                                $7e68913db756e51f$export$b1e4cbf5b56e0e21(ti, target);
                            }, inputString, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName);
                            let input = lwi.querySelector("input");
                            input.value = inputString;
                            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
                            input.addEventListener("change", (event)=>{
                                ...
                                console.log((0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName + " changed to " + inputString);
                                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
                            });
                            $7e68913db756e51f$var$addAnyUnits(undefined, tiAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName), (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b);
                            mmDiv.appendChild(lwi);
                        }
                    }
                    //console.log("tInfinity " + tInfinity);
                    let xml_ni = xml_MCRCMethod[0].getElementsByTagName((0, $6f7aa7a716962086$export$d08982dd841d496f).tagName);
                    if (xml_ni != null) {
                        if (xml_ni[0] != null) {
                            ...
                            let ni = new (0, $6f7aa7a716962086$export$d08982dd841d496f)(niAttributes, value);
                            mm.setNInfinity(ni);
                            // Create a new div element for the input.
                            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                                let target = event.target;
                                $7e68913db756e51f$export$b1e4cbf5b56e0e21(ni, target);
                            }, inputString, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName);
                            mmDiv.appendChild(lwi);
                            ...
                            inputElement.addEventListener("change", (event)=>{
                                ...
                                console.log((0, $6f7aa7a716962086$export$d08982dd841d496f).tagName + " set to " + inputString);
                                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputElement);
                            });
                            $7e68913db756e51f$var$addAnyUnits(undefined, niAttributes, lwi, null, $7e68913db756e51f$var$addRID(mmDivId, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName), (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b);
                            mmDiv.appendChild(lwi);
                        }
                    }
                } else {
                    mm = new (0, $6f7aa7a716962086$export$6fa70ee10f356b6)(mmAttributes);
                    let mCRCMethodLabel = document.createElement("label");
                    mCRCMethodLabel.textContent = (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + ": " + type;
                    Object.assign(mCRCMethodLabel.style, $7e68913db756e51f$var$level1);
        ...
        let xml_erc = xml_reactions[i].getElementsByTagName((0, $6f7aa7a716962086$export$284227145ed02b04).tagName);
        //console.log("n_me:excessReactantConc=" + xml_erc.length);
        if (xml_erc.length > 0) {
            if (xml_erc.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$284227145ed02b04).tagName + " but finding " + xml_erc.length + "!");
            ...
            let erc = new (0, $6f7aa7a716962086$export$284227145ed02b04)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_erc[0]), value);
            reaction.setExcessReactantConc(erc);
            let id = $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$284227145ed02b04).tagName);
            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
                $7e68913db756e51f$export$b1e4cbf5b56e0e21(erc, target);
            }, value.toExponential(), (0, $6f7aa7a716962086$export$284227145ed02b04).tagName);
            reactionDiv.appendChild(lwi);
        }
        // me:canonicalRateList
        let xml_crl = xml_reactions[i].getElementsByTagName((0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName);
        //console.log("n_me:canonicalRateList=" + xml_crl.length);
        if (xml_crl.length > 0) {
            if (xml_crl.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName + " but finding " + xml_crl.length + "!");
            let clr_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_crl[0]);
            let crl = new (0, $6f7aa7a716962086$export$3f85289af9546f7e)(clr_attributes);
            reaction.setCanonicalRateList(crl);
            // Create a new collapsible div for the canonicalRateList.
            let crlDivID = $7e68913db756e51f$var$addRID(reactionDivID, (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName);
            let crlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(crlDivID);
            let crlcDivID = $7e68913db756e51f$var$addRID(crlDivID, $7e68913db756e51f$var$s_container);
            let crlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(crlcDivID, reactionDiv, null, crlDiv, (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
            reactionDiv.appendChild(crlcDiv);
            //let id = addID(reaction.id, CanonicalRateList.tagName);
            // me:description.
            let xml_d = xml_crl[0].getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
            //console.log("xml_d.length=" + xml_d.length);
            if (xml_d.length > 0) {
                if (xml_d.length > 1) throw new Error("Expecting 1 " + (0, $8677001474399221$export$393edc798c47379d).tagName + " but finding " + xml_d.length + "!");
                let description = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_d[0]));
                //console.log("description=" + description);
                crl.setDescription(new (0, $8677001474399221$export$393edc798c47379d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_d[0]), description));
                let l = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(description + " (" + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(clr_attributes) + ")", $7e68913db756e51f$export$d6befed1f1d5e56b);
                let ldiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$level1);
                ldiv.appendChild(l);
                crlDiv.appendChild(ldiv);
            }
            // me:kinf.
            let xml_k = xml_crl[0].getElementsByTagName((0, $6f7aa7a716962086$export$5eb02c9a0d4a6c5).tagName);
            //console.log("xml_k.length=" + xml_k.length);
            if (xml_k.length > 0) {
                // Create a table for the kinf.
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(crlDivID, (0, $6f7aa7a716962086$export$5eb02c9a0d4a6c5).tagName, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
                crlDiv.appendChild(t);
                for(let j = 0; j < xml_k.length; j++){
                    let k = new (0, $6f7aa7a716962086$export$5eb02c9a0d4a6c5)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_k[j]));
                    crl.addKinf(k);
                    // T.
                    let xml_T = xml_k[j].getElementsByTagName((0, $8677001474399221$export$971d5caa766a69d7).tagName);
                    ...
                    if (xml_T.length > 0) {
                        ...
                        k.setT(new (0, $8677001474399221$export$971d5caa766a69d7)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_T[0]), value));
                    }
                    // Val.
                    let xml_Val = xml_k[j].getElementsByTagName((0, $6f7aa7a716962086$export$38dfac6a73b2b45e).tagName);
                    //console.log("xml_Val.length=" + xml_Val.length);
                    if (xml_Val.length > 0) {
                        if (xml_Val.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$38dfac6a73b2b45e).tagName + " but finding " + xml_Val.length + "!");
                        ...
                        k.setVal(new (0, $6f7aa7a716962086$export$38dfac6a73b2b45e)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_Val[0]), value));
                    }
                    // Rev.
                    let xml_Rev = xml_k[j].getElementsByTagName((0, $6f7aa7a716962086$export$a292f79afb9ad235).tagName);
                    //console.log("xml_Rev.length=" + xml_Rev.length);
                    if (xml_Rev.length > 0) {
                        if (xml_Rev.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$a292f79afb9ad235).tagName + " but finding " + xml_Rev.length + "!");
                        ...
                        k.setRev(new (0, $6f7aa7a716962086$export$a292f79afb9ad235)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_Rev[0]), value));
                    }
                    // Keq.
                    let xml_Keq = xml_k[j].getElementsByTagName((0, $6f7aa7a716962086$export$835b53a514d067b0).tagName);
                    //console.log("xml_Keq.length=" + xml_Keq.length);
                    if (xml_Keq.length > 0) {
                        if (xml_Keq.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$835b53a514d067b0).tagName + " but finding " + xml_Keq.length + "!");
                        ...
                        k.setKeq(new (0, $6f7aa7a716962086$export$835b53a514d067b0)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_Keq[0]), value));
                    }
                ...
                $7e68913db756e51f$var$addSaveAsCSVButton(crl.toCSV.bind(crl), crlDiv, t, reaction.id + "_" + (0, $6f7aa7a716962086$export$3f85289af9546f7e).tagName, $7e68913db756e51f$var$level1);
            }
        }
    }
 ...
 */ function $7e68913db756e51f$var$processConditions(xml1) {
    console.log((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName);
    // Create a div for the conditionss.
    let conditionssDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    // Get the XML "me:conditions" element.
    let xml_conditionss = xml1.getElementsByTagName((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName);
    for(let i = 0; i < xml_conditionss.length; i++){
        let xml_conditions = xml_conditionss[i];
        // Create a collapsible div for each conditions.
        let cDivID = $7e68913db756e51f$var$addRID((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, i.toString());
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
        let ccDivID = $7e68913db756e51f$var$addRID(cDivID, $7e68913db756e51f$var$s_container);
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, conditionssDiv, null, cDiv, (0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName + " " + i.toString(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        let conditions = $7e68913db756e51f$var$addConditions((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_conditions), i);
        $7e68913db756e51f$var$handleBathGases(conditions, cDiv, xml_conditions);
        $7e68913db756e51f$var$handlePTs(conditions, cDiv, xml_conditions);
        // Add a remove conditions button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(cDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeConditions.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the conditions.
            $7e68913db756e51f$var$remove(ccDivID);
            $7e68913db756e51f$var$conditionsIDs.removeIDs(cDivID);
        });
    }
    // Create an add button to add a conditions.
    $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv);
 ...
 */ function $7e68913db756e51f$var$handleBathGases(conditions, cDiv, xml_conditions) {
    // Bath Gases
    // Create a collapsible div.
    let bsDivID = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    let bsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(bsDivID);
    let bscDivID = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$s_container);
    let bscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(bscDivID, cDiv, null, bsDiv, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
    // Add add button.
    let addBathGasButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$level1);
    bsDiv.appendChild(addBathGasButton);
    addBathGasButton.addEventListener("click", ()=>{
        let bathGas = new (0, $ae74a7b44a6504a1$export$b33a132661f4be58)(new Map(), $7e68913db756e51f$var$s_selectOption);
        ...
        let id = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, bathGasIndex.toString());
        let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from($7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$var$molecules)), bathGas, true, id);
        select.classList.add((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
        div.appendChild(select);
        $7e68913db756e51f$var$addRemoveButton(div, $7e68913db756e51f$export$d6befed1f1d5e56b, (bathGas)=>{
            bsDiv.removeChild(div);
            $7e68913db756e51f$var$conditionsIDs.removeID(id), conditions.removeBathGas(bathGas);
        });
    ...
    if (xml_conditions != null) {
        ...
        if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
            ...
            let bathGasIndex = conditions.addBathGas(bathGas);
            let id = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, bathGasIndex.toString());
            let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, $7e68913db756e51f$var$level1);
            div.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from($7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$var$molecules)), bathGas, false, id));
            $7e68913db756e51f$var$addRemoveButton(div, $7e68913db756e51f$export$d6befed1f1d5e56b, (bathGas)=>{
                bsDiv.removeChild(div);
                $7e68913db756e51f$var$conditionsIDs.removeID(id);
            ...
            let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$level1);
            let id = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, 0);
            div.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from($7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$var$molecules)), undefined, false, id));
            $7e68913db756e51f$var$addRemoveButton(div, $7e68913db756e51f$export$d6befed1f1d5e56b, (bathGas)=>{
                bsDiv.removeChild(div);
                $7e68913db756e51f$var$conditionsIDs.removeID(id);
                conditions.removeBathGas(bathGas);
 ...
 * @param level 
 * @param nextLevel 
 */ function $7e68913db756e51f$var$handlePTs(conditions, cDiv, xml_conditions) {
    // PTs
    let moleculeKeys = $7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$var$molecules);
    // Create collapsible div.
    let pTsDivId = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName);
    let pTsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(pTsDivId);
    let pTscDivId = $7e68913db756e51f$var$conditionsIDs.addID(cDiv.id, pTsDivId, $7e68913db756e51f$var$s_container);
    let pTscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pTscDivId, cDiv, null, pTsDiv, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
    let pTs;
    if (xml_conditions) {
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    if (xml_bathGass.length > 0) {
                        ...
                        pTpair.setBathGas(new (0, $ae74a7b44a6504a1$export$b33a132661f4be58)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bathGass[0]), (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_bathGass[0]))));
                    }
                    // ExperimentRate.
                    let xml_ers = xml_PTpairs[i].getElementsByTagName((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName);
                    if (xml_ers.length > 0) {
                        if (xml_ers.length > 1) console.warn("xml_experimentRates.length=" + xml_ers.length);
                        pTpair.setExperimentalRate(new (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ers[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_ers[0])).trim())));
                    }
                    // ExperimentalYield.
                    let xml_eys = xml_PTpairs[i].getElementsByTagName((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName);
                    if (xml_eys.length > 0) {
                        if (xml_eys.length > 1) console.warn("xml_experimentalYields.length=" + xml_eys.length);
                        pTpair.setExperimentalYield(new (0, $ae74a7b44a6504a1$export$c291f4faacd745a6)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_eys[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_eys[0])).trim())));
                    }
                    // ExperimentalEigenvalue.
                    let xml_ees = xml_PTpairs[i].getElementsByTagName((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName);
                    if (xml_ees.length > 0) {
                        if (xml_ees.length > 1) console.warn("xml_experimentalEigenvalues.length=" + xml_ees.length);
                        pTpair.setExperimentalEigenvalue(new (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ees[0]), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_ees[0])).trim())));
                    }
                    // Create pTpairDiv.
                    pTsDiv.appendChild($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, cDiv.id, i, moleculeKeys, $7e68913db756e51f$var$level1));
                }
            }
    ...
    let pTsButtonsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$level1);
    pTsDiv.appendChild(pTsButtonsDiv);
    // Create an add button to add a new PTpair.
    let addButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    ...
    addButton.addEventListener("click", ()=>{
        ...
        pTsDiv.insertBefore($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, cDiv.id, pTpairIndex, moleculeKeys, $7e68913db756e51f$var$level1), pTsButtonsDiv);
    });
    // Create an add from spreadsheet button to add multiple PTPairs.
    let addMultipleButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_from_spreadsheet, undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    ...
    addMultipleButton.addEventListener("click", ()=>{
        ...
        let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$level1);
        let addFromSpreadsheetId = $7e68913db756e51f$var$addRID((0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName, "addFromSpreadsheet");
        let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", addFromSpreadsheetId, $7e68913db756e51f$var$level1);
        div.appendChild(input);
            ...
            if (input.value.length > 0) {
                ...
                for(let i = 1; i < pTpairsArray.length; i++){
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName)) {
                        let eri = index.get((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName);
                        let er = pTpairArray[eri];
                        if (er.length > 0) {
                            pTpairAttributes.set((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName, er);
                            pTpair.setExperimentalRate(new (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b)(new Map(), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(er)));
                            // Set the attributes of the experimentalRate.
                            // ref1.
                            let err1i = index.get((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + "_" + (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).s_ref1);
                            let err1 = pTpairArray[err1i];
                            pTpair.getExperimentalRate()?.setRef1(err1);
                            // ref2.
                            let err2i = index.get((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + "_" + (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).s_ref2);
                            let err2 = pTpairArray[err2i];
                            pTpair.getExperimentalRate()?.setRef2(err2);
                            // refReaction.
                            let errri = index.get((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + "_" + (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).s_refReaction);
                            let errr = pTpairArray[errri];
                            pTpair.getExperimentalRate()?.setRefReaction(errr);
                            // error.
                            let erei = index.get((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + "_" + (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).s_error);
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName)) {
                        let eyi = index.get((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName);
                        let ey = pTpairArray[eyi];
                        if (ey.length > 0) {
                            pTpair.setExperimentalYield(new (0, $ae74a7b44a6504a1$export$c291f4faacd745a6)(new Map(), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(ey)));
                            // Set the attributes of the experimentalYield.
                            // ref.
                            let eyri = index.get((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName + "_" + (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).s_ref);
                            let eyr = pTpairArray[eyri];
                            pTpair.getExperimentalYield()?.setRef(eyr);
                            // yieldTime.
                            let eyyti = index.get((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName + "_" + (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).s_yieldTime);
                            ...
                            // error.
                            let eyei = index.get((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName + "_" + (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).s_error);
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName)) {
                        let eei = index.get((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName);
                        let ee = pTpairArray[eei];
                        if (ee.length > 0) {
                            pTpair.setExperimentalEigenvalue(new (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1)(new Map(), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(ee)));
                            // Set the attributes of the experimentalEigenvalue.
                            // EigenvalueID.
                            let eeeidi = index.get((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName + "_" + (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).s_EigenvalueID);
                            let eeeid = pTpairArray[eeeidi];
                            pTpair.getExperimentalEigenvalue()?.setEigenvalueID(eeeid);
                            // error.
                            let eeei = index.get((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName + "_" + (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).s_error);
    ...
    let removeAllButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Remove All", undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
 ...
 * @param level The level.
 * @returns A button.
 */ function $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, $7e68913db756e51f$var$level1);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (i > 0) {
            let aboveElement = document.getElementById((0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, (i - 1).toString(), $7e68913db756e51f$var$s_container));
        ...
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, conditionssDiv, elementToInsertBefore, cDiv, (0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName + " " + i.toString(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Add the conditions
        let conditions = $7e68913db756e51f$var$addConditions(new Map(), i);
        $7e68913db756e51f$var$handleBathGases(conditions, cDiv, null);
        $7e68913db756e51f$var$handlePTs(conditions, cDiv, null);
        // Add a remove conditions button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(cDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeConditions.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the conditions.
 ...
 */ function $7e68913db756e51f$var$addConditions(attributes, i) {
 ...
 * @param level The level.
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, cDivID, pTIndex, moleculeKeys, level) {
    let pTpairDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$addRID(pTsDiv.id, pTIndex), level);
    ...
    $7e68913db756e51f$var$addAnyUnits((0, $8677001474399221$export$692079bb871c6039).pressureUnits, pTpair.attributes, pTpairDiv, null, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
    ...
    $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_excessReactantConc, $7e68913db756e51f$var$createExcessReactantConcInputElement);
    ...
    $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_precision, $7e68913db756e51f$var$createPrecisionSelectElement);
    ...
    $7e68913db756e51f$var$addBathGas(pTpairDiv, pTpair, moleculeKeys);
    /*
    ...
    */ // ExperimentalRate.
    ...
    $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, pTIndex, (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName, (pTpair)=>pTpair.getExperimentalRate(), $7e68913db756e51f$var$createExperimentalRateDetails);
    // ExperimentalYield.
    ...
    $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, pTIndex, (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName, (pTpair)=>pTpair.getExperimentalYield(), $7e68913db756e51f$var$createExperimentalYieldDetails);
    // ExperimentalEigenvalue.
    ...
    $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, pTIndex, (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName, (pTpair)=>pTpair.getExperimentalEigenvalue(), $7e68913db756e51f$var$createExperimentalEigenvalueDetails);
    ...
    $7e68913db756e51f$var$addRemoveButton(pTpairDiv, $7e68913db756e51f$export$d6befed1f1d5e56b, removePTpair, pTpairDiv, pTIndex, pTpair);
    return pTpairDiv;
}
/**
 * @param pTpairDiv The pTpair div.
 ...
 */ function $7e68913db756e51f$var$addPorT(pTpairDiv, name, getter, setter) {
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + name, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        try {
            setter(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value));
            ...
            input.value = $7e68913db756e51f$var$getValue(getter);
        }
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, $7e68913db756e51f$var$getValue(getter), name);
    let input = lwi.querySelector("input");
    input.value = $7e68913db756e51f$var$getValue(getter);
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    pTpairDiv.appendChild(lwi);
}
function $7e68913db756e51f$var$getValue(getter) {
    let value = getter();
 ...
 */ function $7e68913db756e51f$var$addPercentExcessReactantConc(pTpairDiv, pTpair) {
    let id = $7e68913db756e51f$var$addRID(pTpairDiv.id, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_percentExcessReactantConc);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    pTpairDiv.appendChild(div);
    let attribute = (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_percentExcessReactantConc;
    let buttonTextContentSelected = attribute + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = attribute + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
 ...
 */ function $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, attribute, createInputElement) {
    let id = $7e68913db756e51f$var$addRID(pTpairDiv.id, attribute);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    pTpairDiv.appendChild(div);
    let buttonTextContentSelected = attribute + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = attribute + $7e68913db756e51f$var$sy_deselected;
    ...
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let iid = $7e68913db756e51f$var$addRID(id, $7e68913db756e51f$var$s_input);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (button.textContent === buttonTextContentDeselected) {
            ...
            $7e68913db756e51f$var$remove(iid);
        }
    });
}
/**
 ...
 * @param i The index.
 * @param moleculeKeys The molecule keys.
 */ function $7e68913db756e51f$var$addBathGas(pTpairDiv, pTpair, moleculeKeys) {
    let id = $7e68913db756e51f$var$addRID(pTpairDiv.id, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    pTpairDiv.appendChild(div);
    let tagName = (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName;
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    ...
    if (bathGas == undefined) {
        ...
        div.appendChild($7e68913db756e51f$var$createBathGasSelectElement(iid, pTpair, bathGas, false));
    }
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
 ...
 * @param getAttribute 
 * @param createElement 
 */ function $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, pTIndex, tagName, getAttribute, createElement) {
    let id = $7e68913db756e51f$var$addRID(pTpairDiv.id, tagName);
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    pTpairDiv.appendChild(div);
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
 ...
 */ function $7e68913db756e51f$var$createPrecisionSelectElement(id, pTpair) {
    ...
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)((0, $8677001474399221$export$692079bb871c6039).precisionOptions, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).s_precision, value, id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    select.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 */ function $7e68913db756e51f$var$createExcessReactantConcInputElement(id, pTpair) {
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    let value;
 ...
 */ function $7e68913db756e51f$var$createBathGasSelectElement(id, pTpair, bathGas, first) {
    ...
    let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from($7e68913db756e51f$var$getMoleculeKeys($7e68913db756e51f$var$molecules)), bathGas, first, id);
    //select.id = id;
    select.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas, first, id) {
    let value;
    if (first) options.push($7e68913db756e51f$var$s_selectOption);
    else {
    ...
    if (bathGas == undefined) {
        bathGas = new (0, $ae74a7b44a6504a1$export$b33a132661f4be58)(new Map(), $7e68913db756e51f$var$s_selectOption);
        value = $7e68913db756e51f$var$s_selectOption;
    } else value = bathGas.value;
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, value, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), $7e68913db756e51f$export$d6befed1f1d5e56b);
    select.classList.add((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    $7e68913db756e51f$var$selectAnotherOptionEventListener(options, select);
    // Add event listener to selectElement.
    select.addEventListener("change", (event)=>{
        ...
        console.log("Added " + target.value + " as " + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
        (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(target);
    });
    select.value = value;
    (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(select);
...
function $7e68913db756e51f$var$createExperimentalRateDetails(id, pTpair) {
    return $7e68913db756e51f$var$addExperimentalDetails(pTpair, id, (pTpair)=>pTpair.getExperimentalRate(), (pTpair, value)=>pTpair.setExperimentalRate(value), (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b), [
        {
...
function $7e68913db756e51f$var$createExperimentalYieldDetails(id, pTpair) {
    return $7e68913db756e51f$var$addExperimentalDetails(pTpair, id, (pTpair)=>pTpair.getExperimentalYield(), (pTpair, value)=>pTpair.setExperimentalYield(value), (0, $ae74a7b44a6504a1$export$c291f4faacd745a6), [
        {
...
function $7e68913db756e51f$var$createExperimentalEigenvalueDetails(id, pTpair) {
    return $7e68913db756e51f$var$addExperimentalDetails(pTpair, id, (pTpair)=>pTpair.getExperimentalEigenvalue(), (pTpair, value)=>pTpair.setExperimentalEigenvalue(value), (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1), [
        {
 ...
 */ function $7e68913db756e51f$var$addExperimentalDetails(pTpair, id, getExperimental, setExperimental, ExperimentalClass, details) {
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.id = id;
    let experimental = getExperimental(pTpair);
    if (experimental == undefined) {
        experimental = new ExperimentalClass(new Map(), $7e68913db756e51f$var$big0);
        setExperimental(pTpair, experimental);
    }
    for (let detail of details){
        let detailId = id + "_" + detail.tagName;
        div.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)(detail.type, detailId, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
            let target = event.target;
 ...
 * @param xml The XML document.
 */ function $7e68913db756e51f$var$processModelParameters(xml1) {
    console.log((0, $8883b31bd809eb64$export$77f098867dc64198).tagName);
    // Create a div for the modelParameterss.
    let mpsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    let xml_mps = xml1.getElementsByTagName((0, $8883b31bd809eb64$export$77f098867dc64198).tagName);
    for(let i = 0; i < xml_mps.length; i++){
        // Create a collapsible div for the model parameters.
        let mpDivID = $7e68913db756e51f$var$addRID((0, $8883b31bd809eb64$export$77f098867dc64198).tagName, i.toString());
        let mpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mpDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
        let mpcDivID = $7e68913db756e51f$var$addRID(mpDivID, $7e68913db756e51f$var$s_container);
        let mpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mpcDivID, mpsDiv, null, mpDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + " " + i.toString(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        let mp = $7e68913db756e51f$var$addModelParameters((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_mps[i]), i);
        $7e68913db756e51f$var$processGrainSize(mp, xml_mps[i], mpDiv);
        //setGrainSize(mp, xml_mps[i], mpDiv);
        $7e68913db756e51f$var$processModelParametersN(mp, xml_mps[i], mpDiv, (0, $b6873406fb778c0b$export$576b56ca6e34780b), mp.setAutomaticallySetMaxEne, mp.removeAutomaticallySetMaxEne.bind(mp));
        $7e68913db756e51f$var$processModelParametersN(mp, xml_mps[i], mpDiv, (0, $8883b31bd809eb64$export$aa73446724166cdb), mp.setEnergyAboveTheTopHill, mp.removeEnergyAboveTheTopHill.bind(mp));
        $7e68913db756e51f$var$processModelParametersN(mp, xml_mps[i], mpDiv, (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e), mp.setMaxTemperature, mp.removeMaxTemperature.bind(mp));
        // Add a remove modelParameters button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(mpDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeModelParameters.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the modelParameters.
            $7e68913db756e51f$var$remove(mpcDivID);
            $7e68913db756e51f$var$modelParametersIDs.removeIDs(mpDivID);
        });
    }
    // Create an add button to add a modelParameters.
    $7e68913db756e51f$var$createAddModelParametersButton(mpsDiv);
    return mpsDiv;
}
/**
 * Add and return a new modelParameters.
 */ function $7e68913db756e51f$var$addModelParameters(attributes, i) {
    let mp = new (0, $8883b31bd809eb64$export$77f098867dc64198)(attributes, i);
    $7e68913db756e51f$var$mesmer.addModelParameters(mp);
    return mp;
}
/**
 ...
 */ function $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv) {
    let tagName = (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName;
    let id = $7e68913db756e51f$var$modelParametersIDs.addID(mpsDiv.id, tagName);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, $7e68913db756e51f$var$level1);
    mpsDiv.appendChild(div);
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, $7e68913db756e51f$var$modelParametersIDs.addID(mpsDiv.id, tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$export$d6befed1f1d5e56b);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    div.appendChild(button);
    let idi = $7e68913db756e51f$var$modelParametersIDs.addID(mpsDiv.id, tagName, $7e68913db756e51f$var$s_input);
    let gs;
    let valueString;
    if (xml_mps != null) {
        let xml1 = xml_mps.getElementsByTagName(tagName);
        if (xml1.length == 1) {
            valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml1[0]));
            let value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(valueString);
            gs = new (0, $8883b31bd809eb64$export$26e33f0df9ce919d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml1[0]), value);
            button.textContent = buttonTextContentSelected;
            $7e68913db756e51f$var$createInputModelParameters(mps, div, gs, idi, valueString, mps.setGrainSize, (0, $8677001474399221$export$692079bb871c6039).energyUnits);
            button.classList.toggle($7e68913db756e51f$var$s_optionOff);
        } else {
            gs = $7e68913db756e51f$var$getDefaultGrainsize(tagName);
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        }
    } else {
    ...
    button.addEventListener("click", ()=>{
        ...
        if (!mps.index.has((0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName)) {
            $7e68913db756e51f$var$createInputModelParameters(mps, div, gs, idi, valueString, mps.setGrainSize, (0, $8677001474399221$export$692079bb871c6039).energyUnits);
            button.textContent = buttonTextContentSelected;
        } else {
            mps.removeGrainSize();
            document.getElementById(idi)?.remove();
            document.getElementById((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(idi, $7e68913db756e51f$var$s_units))?.remove();
            button.textContent = buttonTextContentDeselected;
        }
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
 ...
 * @param xml_mps The XML model parameters.
 * @param mpsDiv The model parameters div.
 */ function $7e68913db756e51f$var$setGrainSize(mps, xml_mps, mpsDiv) {
    let tagName = (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName;
    let div = $7e68913db756e51f$var$addGrainSize(mps, mpsDiv);
    ...
    let xml1 = xml_mps.getElementsByTagName(tagName);
    if (xml1.length > 0) {
        if (xml1.length > 1) console.warn("More than one GrainSize found in XML. The first is used!");
        let valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml1[0]));
        let value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(valueString);
 ...
 * @param xml_mps The XML model parameters.
 * @param mpsDiv The model parameters div.
 */ function $7e68913db756e51f$var$addGrainSize(mps, mpsDiv) {
    let tagName = (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName;
    let id = $7e68913db756e51f$var$modelParametersIDs.addID(mpsDiv.id, tagName);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, $7e68913db756e51f$var$level1);
    mpsDiv.appendChild(div);
    ...
    button.addEventListener("click", ()=>{
        ...
        if (!mps.index.has((0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName)) {
            ...
            gs = $7e68913db756e51f$var$getDefaultGrainsize(tagName);
            mps.setGrainSize(gs);
            $7e68913db756e51f$var$createInputModelParameters(mps, div, gs, idi, gs.value.toString(), mps.setGrainSize, (0, $8677001474399221$export$692079bb871c6039).energyUnits);
            button.textContent = buttonTextContentSelected;
        } else {
...
function $7e68913db756e51f$var$getDefaultGrainsize(tagName) {
    let value;
    let attributes;
    if ($7e68913db756e51f$export$ebe90cb607ad99e != undefined) {
        let valueString = $7e68913db756e51f$export$ebe90cb607ad99e.values.get(tagName) ?? "";
        if (valueString == "") value = $7e68913db756e51f$var$big0;
        else value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(valueString);
        attributes = $7e68913db756e51f$export$ebe90cb607ad99e.attributess.get(tagName) ?? new Map();
    } else {
        console.log(tagName + " set using hardcoded default.");
        value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(101);
        attributes = new Map();
        attributes.set($7e68913db756e51f$var$s_units, "cm-1");
    }
    return new (0, $8883b31bd809eb64$export$26e33f0df9ce919d)(attributes, value);
}
/**
 ...
 */ function $7e68913db756e51f$var$processModelParametersN(mps, xml_mps, mpsDiv, mpt, setModelParameter, removeModelParameter) {
    ...
    if (xml_mps != null) {
        ...
        if (xml1.length == 1) {
            valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml1[0]));
            let value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(valueString);
            mp = new mpt((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml1[0]), value);
            button.textContent = buttonTextContentSelected;
            $7e68913db756e51f$var$createInputModelParameters(mps, div, mp, idi, valueString, setModelParameter, undefined);
            button.classList.toggle($7e68913db756e51f$var$s_optionOff);
        } else {
            valueString = "";
            mp = new mpt(new Map(), $7e68913db756e51f$var$big0);
            button.textContent = buttonTextContentDeselected;
            button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        }
    } else {
    ...
    button.addEventListener("click", ()=>{
        ...
        if (!mps.index.has(tagName)) {
            ...
            $7e68913db756e51f$var$remove(idi);
            $7e68913db756e51f$var$modelParametersIDs.removeID(idi);
            button.textContent = buttonTextContentDeselected;
        }
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
 ...
 * @param units The units.
 */ function $7e68913db756e51f$var$createInputModelParameters(mps, div, element, id, valueString, setElementMethod, units) {
    setElementMethod.call(mps, element);
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", id, $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.appendChild(input);
    input.addEventListener("change", (event)=>{
        let target = event.target;
    ...
    input.value = valueString;
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    $7e68913db756e51f$var$addAnyUnits(units, element.attributes, div, input, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_units), element.constructor.tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b);
}
/**
 * @param controlsDiv 
 * @param level The level.
 * @returns A button.
 */ function $7e68913db756e51f$var$createAddModelParametersButton(mpsDiv) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, $7e68913db756e51f$var$level1);
    let tn = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName;
    mpsDiv.appendChild(button);
    button.addEventListener("click", (event)=>{
        let i = $7e68913db756e51f$var$mesmer.getNextModelParametersID();
        console.log("Add " + tn + i.toString());
        // Create collapsible div.
        let mpDivID = $7e68913db756e51f$var$addRID(tn, i.toString());
        let mpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mpDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
        let mpcDivID = $7e68913db756e51f$var$addRID(mpDivID, $7e68913db756e51f$var$s_container);
        // ElementToInsert before is element after the conditions div with the previous index.
        let elementToInsertBefore;
        if (i > 0) {
            let aboveElement = document.getElementById((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(tn, (i - 1).toString(), $7e68913db756e51f$var$s_container));
            let nextElementSibling = aboveElement.nextElementSibling;
            // If nextElementSibling is not a child of conditionssDiv the element.
            if (nextElementSibling != null) {
        ...
        let mpcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mpcDivID, mpsDiv, elementToInsertBefore, mpDiv, tn + " " + i.toString(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Add the modelParameters.
        let mp = $7e68913db756e51f$var$addModelParameters(new Map(), i);
        $7e68913db756e51f$var$addGrainSize(mp, mpDiv);
        $7e68913db756e51f$var$processModelParametersN(mp, null, mpDiv, (0, $b6873406fb778c0b$export$576b56ca6e34780b), mp.setAutomaticallySetMaxEne, mp.removeAutomaticallySetMaxEne);
        $7e68913db756e51f$var$processModelParametersN(mp, null, mpDiv, (0, $8883b31bd809eb64$export$aa73446724166cdb), mp.setEnergyAboveTheTopHill, mp.removeEnergyAboveTheTopHill);
        $7e68913db756e51f$var$processModelParametersN(mp, null, mpDiv, (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e), mp.setMaxTemperature, mp.removeMaxTemperature);
        // Add a remove modelParameters button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(mpDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeModelParameters.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the modelParameters.
 ...
 */ function $7e68913db756e51f$var$processControl(xml1) {
    console.log((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName);
    // Create a div for the controls.
    let controlsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    // Get the XML "me:control" element.
    let xml_controls = xml1.getElementsByTagName((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName);
    for(let i = 0; i < xml_controls.length; i++){
        //console.log("Control " + i);
        let xml_control = xml_controls[i];
        // Create a collapsible divfor the control.
        let cDivID = $7e68913db756e51f$var$addRID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, i.toString());
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
        controlsDiv.appendChild(cDiv);
        let ccDivID = $7e68913db756e51f$var$addRID(cDivID, $7e68913db756e51f$var$s_container);
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, controlsDiv, null, cDiv, (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + " " + i.toString(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        let control = $7e68913db756e51f$var$addControl((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_control), i);
        ...
        $7e68913db756e51f$var$getControlOptionsSimple(control).forEach((option)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, onOffControls, xml_control, null, option.class, option.setMethod, option.removeMethod);
        });
        // Create a div for the on/off controls.
        let onOffControlsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, $7e68913db756e51f$var$level1);
        ...
        $7e68913db756e51f$var$handleTestMicroRates(control, cDiv, null, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$handleCalcMethod(control, cDiv, xml_control, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, onOffControls, xml_control, $7e68913db756e51f$var$level1, item.class, item.setMethod, item.removeMethod, true);
        });
        // me:ForceMacroDetailedBalance
        let xml_fdb = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName);
        if (xml_fdb.length == 1) {
            ...
            let fdb = new (0, $b6873406fb778c0b$export$6ffea14bdffd427f)(fdb_attributes, s);
            control.setForceMacroDetailedBalance(fdb);
            let fdbDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$controlIDs.addID(cDivID, (0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName), $7e68913db756e51f$var$level1);
            cDiv.appendChild(fdbDiv);
            let fdbl = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName + " " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(fdb_attributes) + " " + s, $7e68913db756e51f$export$d6befed1f1d5e56b);
            fdbDiv.appendChild(fdbl);
        }
        // Add a remove control button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(cDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeControl.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the control.
            $7e68913db756e51f$var$remove(ccDivID);
            $7e68913db756e51f$var$controlIDs.removeIDs(cDivID);
        });
    }
    // Create an add button to add a control.
    $7e68913db756e51f$var$createAddControlButton(controlsDiv, $7e68913db756e51f$var$level1);
    return controlsDiv;
}
/**
 * @param control The control.
 ...
 */ function $7e68913db756e51f$var$createAddControlButton(controlsDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        let elementToInsertBefore;
        if (i > 0) {
            let aboveElement = document.getElementById((0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, (i - 1).toString(), $7e68913db756e51f$var$s_container));
            let nextElementSibling = aboveElement.nextElementSibling;
        ...
        // Create a collapsible div for each conditions.
        let ccDivID = $7e68913db756e51f$var$addRID(cDivID, $7e68913db756e51f$var$s_container);
        let ccDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ccDivID, controlsDiv, elementToInsertBefore, cDiv, (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + " " + i.toString(), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        // Add the control
        let control = $7e68913db756e51f$var$addControl(new Map(), i);
        // Create a map of the on/off control options. The keys are the tag names and the values are the buttons.
        let onOffControls = new Map();
        $7e68913db756e51f$var$getControlOptionsSimple(control).forEach((option)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, onOffControls, null, null, option.class, option.setMethod, option.removeMethod);
        });
        // Create a div for the on/off controls.
        ...
        cDiv.appendChild(onOffControlsDiv);
        // Controls with additional things to set.
        $7e68913db756e51f$var$handleTestMicroRates(control, cDiv, null, level);
        $7e68913db756e51f$var$handleCalcMethod(control, cDiv, null, level);
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, cDiv, onOffControls, null, level, item.class, item.setMethod, item.removeMethod, true);
        });
        // Add a remove control button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(cDiv, $7e68913db756e51f$var$level1, $7e68913db756e51f$var$mesmer.removeControl.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
 ...
 */ function $7e68913db756e51f$var$addControl(attributes, i) {
 ...
 */ function $7e68913db756e51f$var$handleControl(control, cDiv, onOffControls, xml_control, level, ControlClass, setControlMethod, removeControlMethod, handleInput = false) {
    let tagName = ControlClass.tagName;
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    ...
    let id;
    if (level) {
        id = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName);
        div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, level);
        cDiv.appendChild(div);
        div.appendChild(button);
        id = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, id, $7e68913db756e51f$var$s_input);
    }
    if (xml_control) {
        let xml1 = xml_control.getElementsByTagName(tagName);
        if (xml1.length == 1) {
            if (handleInput) {
                let valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml1[0]));
                let value;
                ...
                controlInstance = new ControlClass((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml1[0]), value);
                $7e68913db756e51f$var$createInputControlItem(control, div, controlInstance, setControlMethod, id, valueString);
            } else {
                controlInstance = new ControlClass((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml1[0]));
    ...
    button.addEventListener("click", (event)=>{
        if (!control.index.has(tagName)) {
            ...
            if (handleInput) $7e68913db756e51f$var$remove(id);
 ...
 * @param xml_control The xml control. 
 * @param level The level.
 */ function $7e68913db756e51f$var$handleCalcMethod(control, cDiv, xml_control, level) {
    ...
    let divCmId = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName);
    let divCm = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divCmId, $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.appendChild(divCm);
    let options = (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).options;
    let divCmDetailsId = $7e68913db756e51f$var$controlIDs.addID(divCmId, "details");
    let divCmDetailsSelectId = $7e68913db756e51f$var$controlIDs.addID(divCmDetailsId, "select");
    let cm;
    let first = true;
    if (xml_control != null) {
        ...
        if (xml1.length > 0) {
            if (xml1.length > 1) throw new Error("More than one CalcMethod element.");
            let attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml1[0]);
            let xsi_type = attributes.get("xsi:type");
            cm = $7e68913db756e51f$var$getCalcMethod(control, divCm, xml1, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has(tagName)) {
            if (first) {
                if (options[options.length - 1] != $7e68913db756e51f$var$s_selectOption) options.push($7e68913db756e51f$var$s_selectOption);
            }
            // Remove select.
            //remove(divCmId);
            $7e68913db756e51f$var$remove(divCmDetailsId);
            $7e68913db756e51f$var$remove(divCmDetailsSelectId);
            // Create the select element.
            let select = $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, options, tagName, $7e68913db756e51f$var$s_selectOption, divCmDetailsId, divCmDetailsSelectId);
 ...
 * @param xml_control The xml control.
 * @param level The level.
 */ function $7e68913db756e51f$var$handleTestMicroRates(control, cDiv, xml_control, level) {
    let tagName = (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName;
    let divID = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divID, level);
    cDiv.appendChild(div);
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let idTmax = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName, (0, $b6873406fb778c0b$export$58c8f4b7ec654137).tagName);
    let idTmin = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName, (0, $b6873406fb778c0b$export$7be1a36e1f74dbc7).tagName);
    let idTstep = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, tagName, (0, $b6873406fb778c0b$export$7b8cfe3a6a460886).tagName);
    if (xml_control) {
        let xml1 = xml_control.getElementsByTagName(tagName);
        if (xml1.length == 1) {
            $7e68913db756e51f$var$createTestMicroRates(control, div, xml1, idTmax, idTmin, idTstep);
            button.classList.toggle($7e68913db756e51f$var$s_optionOff);
            button.textContent = buttonTextContentSelected;
        } else {
            button.classList.toggle($7e68913db756e51f$var$s_optionOn);
 ...
 */ function $7e68913db756e51f$var$createTestMicroRates(control, div, xml_tmr, idTmax, idTmin, idTstep) {
    ...
    let tMaxlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idTmax + "_input", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
    ...
    let tMinlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idTmin + "_input", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
    ...
    let tSteplwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", idTstep + "_input", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
 ...
 */ function $7e68913db756e51f$var$getCalcMethod(control, divCm, xml1, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId) {
    ...
    divCm.appendChild(select);
    // Add the details div.
    let divCmDetails = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divCmDetailsId, $7e68913db756e51f$export$d6befed1f1d5e56b);
    divCm.appendChild(divCmDetails);
    if (xsi_type == (0, $b6873406fb778c0b$export$afd374542f6f3da6).xsi_type || xsi_type == (0, $b6873406fb778c0b$export$afd374542f6f3da6).xsi_type2) //console.log("CalcMethodSimpleCalc");
    cm = new (0, $b6873406fb778c0b$export$afd374542f6f3da6)(attributes);
        ...
        cm = cmf;
        // FittingIterations.
        let fi_xml = xml1[0].getElementsByTagName((0, $b6873406fb778c0b$export$830a50cd13af6e84).tagName);
        if (fi_xml.length > 0) {
            if (fi_xml.length == 1) {
        ...
        cm = cmm;
        function processElement(xml1, ClassConstructor, setterMethod) {
            let tagName = (0, $b6873406fb778c0b$export$9f699e98369d9591).tagName;
            let elementXml = xml1[0].getElementsByTagName(tagName);
        ...
        processElement(xml1, (0, $b6873406fb778c0b$export$9f699e98369d9591), cmm.setMarquardtIterations.bind(cmm));
        processElement(xml1, (0, $b6873406fb778c0b$export$ca1e6c3ff9fd3627), cmm.setMarquardtTolerance.bind(cmm));
        processElement(xml1, (0, $b6873406fb778c0b$export$d3887b529debf19d), cmm.setMarquardtDerivDelta.bind(cmm));
        ...
        cm = cmar;
        function processElement(xml1, ClassConstructor, setterMethod, isNumber) {
        ...
        processElement(xml1, (0, $b6873406fb778c0b$export$93514d28bd18d75a), cmar.setFormat.bind(cmar), false);
        processElement(xml1, (0, $b6873406fb778c0b$export$be201676156f3e60), cmar.setPrecision.bind(cmar), false);
        processElement(xml1, (0, $b6873406fb778c0b$export$19d20f3642d82681), cmar.setChebNumTemp.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$906be0805438fd80), cmar.setChebNumConc.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$6ab4fe1621c91452), cmar.setChebMaxTemp.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$e9853d49316ae9ae), cmar.setChebMinTemp.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$39eacc768d7e9bb), cmar.setChebMaxConc.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$78194e57ce26d99a), cmar.setChebMinConc.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$96094ac7e31a750e), cmar.setChebTExSize.bind(cmar), true);
        processElement(xml1, (0, $b6873406fb778c0b$export$ae695595d3952700), cmar.setChebPExSize.bind(cmar), true);
        ...
        processElement(xml1, (0, $b6873406fb778c0b$export$7be1a36e1f74dbc7), cmtt.setTmin.bind(cmtt));
        processElement(xml1, (0, $b6873406fb778c0b$export$ac2eb7df727f506d), cmtt.setTmid.bind(cmtt));
        processElement(xml1, (0, $b6873406fb778c0b$export$58c8f4b7ec654137), cmtt.setTmax.bind(cmtt));
        processElement(xml1, (0, $b6873406fb778c0b$export$7b8cfe3a6a460886), cmtt.setTstep.bind(cmtt));
        ...
        processElement(xml1, (0, $b6873406fb778c0b$export$37d0520a9fac7849), cmsa.setSensitivityAnalysisSamples.bind(cmsa));
        processElement(xml1, (0, $b6873406fb778c0b$export$9a832710e54827ea), cmsa.setSensitivityAnalysisOrder.bind(cmsa));
        processElement(xml1, (0, $b6873406fb778c0b$export$b43b57458ce8fb96), cmsa.setSensitivityNumVarRedIters.bind(cmsa));
        processElement(xml1, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09), cmsa.setSensitivityVarRedMethod.bind(cmsa));
        ...
        if (name != undefined && name !== xsi_type) {
            ...
            return $7e68913db756e51f$var$getCalcMethod(control, divCm, xml1, options, attributes, tagName, name, divCmDetailsId, divCmDetailsSelectId);
 ...
 */ function $7e68913db756e51f$var$processCalcMethodFitting(divCmDetails, cm) {
    // FittingIterations.
    let fi = cm.getFittingIterations() || new (0, $b6873406fb778c0b$export$830a50cd13af6e84)(new Map(), $7e68913db756e51f$var$big0);
    cm.setFittingIterations(fi);
    divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, (0, $b6873406fb778c0b$export$830a50cd13af6e84).tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
        ...
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, fi.value.toString(), (0, $b6873406fb778c0b$export$830a50cd13af6e84).tagName));
}
/**
 * @param divCmDetails The details div.
 ...
 */ function $7e68913db756e51f$var$processCalcMethodMarquardt(divCmDetails, cm) {
    function createLabelWithInputForObject(obj, divCmDetails, boundary, level) {
        let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, obj.tagName, $7e68913db756e51f$var$s_input);
    ...
    // MarquardtIterations.
    let mi = cm.getMarquardtIterations() || new (0, $b6873406fb778c0b$export$9f699e98369d9591)(new Map(), $7e68913db756e51f$var$big0);
    cm.setMarquardtIterations(mi);
    createLabelWithInputForObject(mi, divCmDetails, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // MarquardtTolerance.
    let mt = cm.getMarquardtTolerance() || new (0, $b6873406fb778c0b$export$ca1e6c3ff9fd3627)(new Map(), $7e68913db756e51f$var$big0);
    cm.setMarquardtTolerance(mt);
    createLabelWithInputForObject(mt, divCmDetails, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
    // MarquardtDerivDelta.
    let mdd = cm.getMarquardtDerivDelta() || new (0, $b6873406fb778c0b$export$d3887b529debf19d)(new Map(), $7e68913db756e51f$var$big0);
    cm.setMarquardtDerivDelta(mdd);
    createLabelWithInputForObject(mdd, divCmDetails, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
}
/**
 * @param divCmDetails The details div.
 ...
 */ function $7e68913db756e51f$var$processCalcMethodAnalyticalRepresentation(divCmDetails, cm) {
    ...
    function processSelectElement(ClassConstructor, getter, setter, tagName, options) {
        ...
        setter(element);
        let lwsElement = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(tagName, options, tagName, element.value, divCmDetails.id, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b);
    ...
    function processElement(ClassConstructor, getter, setter, tagName) {
        ...
        setter(element);
        divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", divCmDetails.id + `_${tagName}_input`, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, $7e68913db756e51f$var$handleEvent(element, tagName), element.value.toString(), tagName));
    }
    processElement((0, $b6873406fb778c0b$export$19d20f3642d82681), cm.getChebNumTemp.bind(cm), cm.setChebNumTemp.bind(cm), (0, $b6873406fb778c0b$export$19d20f3642d82681).tagName);
...
function $7e68913db756e51f$var$handleEvent(element, tagName) {
    return (event)=>{
        let target = event.target;
        try {
 ...
 */ function $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(divCmDetails, cm) {
    ...
    function processNumberElement(ClassConstructor, getter, setter, tagName) {
        let element = getter() || new ClassConstructor(new Map(), NaN);
        setter(element);
        divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0, $7e68913db756e51f$var$handleEvent(element, tagName), element.value.toString(), tagName));
    }
    ...
    let tagName = (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).tagName;
    divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options, tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options[0], (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, tagName, "select"), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$d6befed1f1d5e56b));
 ...
 */ function $7e68913db756e51f$var$selectAnotherOptionEventListener(options, select) {
    select.addEventListener("click", (event)=>{
        if (options[options.length - 1] == $7e68913db756e51f$var$s_selectOption) options.pop();
        let lastIndex = select.options.length - 1;
        if (select.options[lastIndex].value == $7e68913db756e51f$var$s_selectOption) select.remove(lastIndex);
    });
}
/**
 * @param control The control.
 ...
 */ function $7e68913db756e51f$var$createSelectElementCalcMethod(control, div, options, tagName, value, divCmDetailsId, divCmDetailsSelectId) {
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, tagName, value, divCmDetailsSelectId, $7e68913db756e51f$export$d6befed1f1d5e56b);
    div.appendChild(select);
    $7e68913db756e51f$var$selectAnotherOptionEventListener(options, select);
    select.addEventListener("change", (event)=>{
        // Remove any existing div.
        ...
        divCmDetails = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divCmDetailsId, $7e68913db756e51f$export$d6befed1f1d5e56b);
 ...
 * @param xml The XML document.
 */ function $7e68913db756e51f$var$processMetadataList(xml1) {
    console.log((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID((0, $288a4469bea65e97$export$3e18a603070a78a).tagName, 0), $7e68913db756e51f$export$d6befed1f1d5e56b);
    let xml_mls = xml1.getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
    if (xml_mls.length > 0) {
        if (xml_mls.length > 1) throw new Error("More than one MetadataList element.");
        let ml = new (0, $288a4469bea65e97$export$3e18a603070a78a)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_mls[0]));
        $7e68913db756e51f$var$mesmer.setMetadataList(ml);
        function handleElement(tagName, constructor, setter) {
            ...
            if (xml_elements.length > 0) {
                if (xml_elements.length == 1) {
                    ...
                    let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$level1);
        ...
        handleElement((0, $288a4469bea65e97$export$c78a95f4a27bad68).tagName, (0, $288a4469bea65e97$export$c78a95f4a27bad68), ml.setSource);
        handleElement((0, $288a4469bea65e97$export$61180682f135a7f2).tagName, (0, $288a4469bea65e97$export$61180682f135a7f2), ml.setCreator);
        handleElement((0, $288a4469bea65e97$export$bf6d63a1cea4a33c).tagName, (0, $288a4469bea65e97$export$bf6d63a1cea4a33c), ml.setDate);
        handleElement((0, $288a4469bea65e97$export$2b747e617c849cca).tagName, (0, $288a4469bea65e97$export$2b747e617c849cca), ml.setContributor);
    }
    return mlDiv;
}
/**
 ...
 * @param xml The XML document.
 */ function $7e68913db756e51f$var$processAnalysis(xml1) {
    console.log((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    let aDivID = $7e68913db756e51f$var$addRID((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName, 0);
    let aDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
    let xml_as = xml1.getElementsByTagName((0, $49b337e689138e29$export$c4c153dc94cc96b4).tagName);
    if (xml_as.length > 0) {
        if (xml_as.length > 1) throw new Error("More than one Analysis element.");
        let a = new (0, $49b337e689138e29$export$c4c153dc94cc96b4)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[0]));
        $7e68913db756e51f$var$mesmer.setAnalysis(a);
        // "me:description".
        let xml_d = xml_as[0].getElementsByTagName((0, $8677001474399221$export$393edc798c47379d).tagName);
        if (xml_d.length > 0) {
            if (xml_d.length == 1) {
                let s = (0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_d[0])?.nodeValue ?? "";
                let d = new (0, $8677001474399221$export$393edc798c47379d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_d[0]), s);
                let dDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(aDivID, (0, $8677001474399221$export$393edc798c47379d).tagName), $7e68913db756e51f$var$level1);
        ...
        // "me:eigenvalueList".
        let xml_el = xml_as[0].getElementsByTagName((0, $49b337e689138e29$export$f681829d43cbf50e).tagName);
        // Create a new collapsible div for the EigenvalueLists.
        let elDivID = $7e68913db756e51f$var$addRID(aDivID, (0, $49b337e689138e29$export$f681829d43cbf50e).tagName);
        let elDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(elDivID, $7e68913db756e51f$var$level1);
        let elcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(elDivID, aDiv, null, elDiv, (0, $49b337e689138e29$export$f681829d43cbf50e).tagName + "s", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        if (xml_el.length > 0) for(let i = 0; i < xml_el.length; i++){
            let el_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_el[i]);
            let el = new (0, $49b337e689138e29$export$f681829d43cbf50e)(el_attributes);
            ...
            let eDivID = $7e68913db756e51f$var$addRID(elDiv.id, i.toString());
            let eDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(elDivID, $7e68913db756e51f$var$level1);
            let ecDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(eDivID, elDiv, null, eDiv, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
            //eDiv.appendChild(createLabel(labelText, boundary1));
            a.addEigenvalueList(el);
            // "me:eigenvalue".
            let evs = [];
            let xml_ei = xml_el[i].getElementsByTagName((0, $49b337e689138e29$export$877cee35188549c7).tagName);
            if (xml_ei.length > 0) for(let j = 0; j < xml_ei.length; j++){
                ...
                evs.push(ev);
                el.addEigenvalue(new (0, $49b337e689138e29$export$877cee35188549c7)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ei[j]), ev));
            }
        ...
        // "me:populationList".
        let xml_pl = xml_as[0].getElementsByTagName((0, $49b337e689138e29$export$8f9a53be9a409418).tagName);
        // Create a new collapsible div for the PopulationLists.
        let plDivID = $7e68913db756e51f$var$addRID(aDivID, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName);
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID, $7e68913db756e51f$var$level1);
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plDivID, aDiv, null, plDiv, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName + "s", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        ...
        for(let i = 0; i < xml_pl.length; i++){
            ...
            let T = pl_attributes.get("T") != undefined ? new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(pl_attributes.get("T")) : $7e68913db756e51f$var$big0;
            let conc = pl_attributes.get("conc") != undefined ? new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(pl_attributes.get("conc")) : $7e68913db756e51f$var$big0;
            let pl = new (0, $49b337e689138e29$export$8f9a53be9a409418)(pl_attributes);
            let labelText = pl.tagName + " " + i.toString() + " " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(pl_attributes);
            let plDivID = $7e68913db756e51f$var$addRID(aDiv.id, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName, i.toString());
            // Create a new collapsible div for the EigenvalueList.
            let pDivID = $7e68913db756e51f$var$addRID(plDivID, i.toString());
            let pDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID, $7e68913db756e51f$var$level1);
            let pcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pDivID, plDiv, null, pDiv, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level0);
            ...
            let refs = [];
            refs.push("time");
            let xml_pn = xml_pl[i].getElementsByTagName((0, $49b337e689138e29$export$9764fff2991ff94a).tagName);
            if (xml_pn.length > 0) for(let j = 0; j < xml_pn.length; j++){
                let pn_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_pn[j]);
                let population = new (0, $49b337e689138e29$export$9764fff2991ff94a)(pn_attributes, []);
                pl.addPopulation(population);
                let t = pn_attributes.get("time") != undefined ? new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(pn_attributes.get("time")) : $7e68913db756e51f$var$big0;
                ...
                let xml_pop = xml_pn[j].getElementsByTagName((0, $49b337e689138e29$export$910c21a5819ebc2e).tagName);
                if (xml_pop.length > 0) for(let k = 0; k < xml_pop.length; k++){
                    ...
                    let pop = new (0, $49b337e689138e29$export$910c21a5819ebc2e)(pop_attributes, p);
                    population.addPop(pop);
                    ref_pop.set(ref, p);
                }
            }
            // Create graph.
            let graphDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(pDivID, $7e68913db756e51f$var$s_graph), $7e68913db756e51f$export$d6befed1f1d5e56b);
            ...
            $7e68913db756e51f$var$addSaveAsPNGButton(canvas, pDiv, graphDiv, labelText);
            // Create Table.
            let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(pDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$export$d6befed1f1d5e56b);
            pDiv.appendChild(tableDiv);
            let tab = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(plDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$export$d6befed1f1d5e56b);
            ...
            $7e68913db756e51f$var$addSaveAsCSVButton(()=>$7e68913db756e51f$var$tableToCSV(tab), pDiv, tableDiv, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b);
        }
        // me:rateList.
        let xml_rl = xml_as[0].getElementsByTagName((0, $49b337e689138e29$export$9cdf0fcb7c05190f).tagName);
        // Create a new collapsible div for the RateLists.
        let rlDivID = $7e68913db756e51f$var$addRID(aDivID, (0, $49b337e689138e29$export$9cdf0fcb7c05190f).tagName);
        let rlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rlDivID, $7e68913db756e51f$var$level1);
        let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, aDiv, null, rlDiv, (0, $49b337e689138e29$export$9cdf0fcb7c05190f).tagName + "s", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$var$level1);
        if (xml_rl.length > 0) {
            // Create Table.
            let tableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$addRID(rlDivID, $7e68913db756e51f$var$s_table), $7e68913db756e51f$export$d6befed1f1d5e56b);
            ...
            for(let i = 0; i < xml_rl.length; i++){
                ...
                }*/ let rl = new (0, $49b337e689138e29$export$9cdf0fcb7c05190f)(rl_attributes);
                a.addRateList(rl);
                /*
                ...
                */ // "me:firstOrderRate".
                let xml_for = xml_rl[i].getElementsByTagName((0, $49b337e689138e29$export$984142e8329468e6).tagName);
                ...
                for(let j = 0; j < xml_for.length; j++){
                    ...
                    values.push(s);
                    let forate = new (0, $49b337e689138e29$export$984142e8329468e6)(forate_attributes, new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(s));
                    rl.addFirstOrderRate(forate);
                }
                // "me:firstOrderLoss".
                let xml_fol = xml_rl[i].getElementsByTagName((0, $49b337e689138e29$export$2450ca15ad4d2ed0).tagName);
                ...
                for(let j = 0; j < xml_fol.length; j++){
                    ...
                    values.push(s);
                    let fol = new (0, $49b337e689138e29$export$2450ca15ad4d2ed0)(fol_attributes, new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(s));
            ...
            tableDiv.appendChild(tab);
            // Insert a save as csv button.
            $7e68913db756e51f$var$addSaveAsCSVButton(()=>$7e68913db756e51f$var$tableToCSV(tab), rlDiv, tableDiv, "Bartis-Widom Phenomenological Rate Coefficients", $7e68913db756e51f$export$d6befed1f1d5e56b);
        }
    }
    return aDiv;
}
    ...
    if (canvas != null) {
        ...
        $7e68913db756e51f$var$reactions.forEach(function(reaction, id) {
            ...
            if (reactantsLabel != undefined) {
                ...
                let energy = reaction.getReactantsEnergy($7e68913db756e51f$export$7577c09cb43cc206, $7e68913db756e51f$var$molecules);
            ...
            if (productsLabel != undefined) {
                ...
                let energy = reaction.getProductsEnergy($7e68913db756e51f$export$7577c09cb43cc206, $7e68913db756e51f$var$molecules);
                energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
                ...
                if (orders.has(productsLabel)) {
                    ...
                    if (reactionTransitionStates != undefined) {
                        reactionTransitionStates.forEach(function(ts) {
                            ...
                            orders.set(ref, i);
                            energy = $7e68913db756e51f$export$7577c09cb43cc206(ref, $7e68913db756e51f$var$molecules).getEnergy() ?? $7e68913db756e51f$var$big0;
                            energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                            energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
        ...
        reorders.forEach(function(value) {
            ...
            let energyRescaled = (0, $134d19e749bf0414$export$bd2782c820638828)(energyMin.toNumber(), energyRange, 0, $7e68913db756e51f$var$rdcHeight, energy);
            // Get text width.
        ...
        let canvasHeightWithBorder = $7e68913db756e51f$var$rdcHeight + 4 * th + 2 * lw;
        //console.log("canvasHeightWithBorder=" + canvasHeightWithBorder);
        let originalCanvasHeight = $7e68913db756e51f$var$rdcHeight;
...
function $7e68913db756e51f$export$cffb3d6135ce44ec() {
    if ($7e68913db756e51f$var$mesmer == null) {
         ...
         * metadataList
         * analysis
         */ let mesmerOrdered = new (0, $8677001474399221$export$692079bb871c6039)($7e68913db756e51f$var$mesmer.attributes);
        mesmerOrdered.setTitle($7e68913db756e51f$var$mesmer.getTitle());
        mesmerOrdered.setMoleculeList(new (0, $8677001474399221$export$19d70f3647dee606)(new Map(), Array.from($7e68913db756e51f$var$molecules.values())));
        mesmerOrdered.setReactionList(new (0, $8677001474399221$export$44466a39ca846289)(new Map(), Array.from($7e68913db756e51f$var$reactions.values())));
        mesmerOrdered.setConditionss($7e68913db756e51f$var$mesmer.getConditionss());
        mesmerOrdered.setModelParameterss($7e68913db756e51f$var$mesmer.getModelParameterss());
        mesmerOrdered.setControls($7e68913db756e51f$var$mesmer.getControls());
        let mdl = $7e68913db756e51f$var$mesmer.getMetadataList();
        if (mdl != undefined) mesmerOrdered.setMetadataList(mdl);
        let analysis = $7e68913db756e51f$var$mesmer.getAnalysis();
        if (analysis != undefined) mesmerOrdered.setAnalysis(analysis);
        console.log("saveXML");
        const pad = "  ";
        let xmlData = (0, $8677001474399221$export$692079bb871c6039).header + mesmerOrdered.toXML(pad, "");
 ...
 */ function $7e68913db756e51f$var$addSaveAsPNGButton(canvas, divToAddTo, elementToInsertBefore, name) {
    // Add a save button to save the canvas as an image.
    let saveButtonID = $7e68913db756e51f$var$addRID(divToAddTo.id, "saveButton");
 ...
 * @param elementToInsertBefore The element to insert before.
 * @param name The name to be appended to the file.
 */ function $7e68913db756e51f$var$addSaveAsCSVButton(toCSV, divToAddTo, elementToInsertBefore, name, margin) {
    let bID = $7e68913db756e51f$var$addRID(divToAddTo.id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e), $7e68913db756e51f$var$s_save);
...
//# sourceMappingURL=index.1f896889.js.map
