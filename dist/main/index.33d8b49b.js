...
class $49b337e689138e29$export$c4c153dc94cc96b4 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ getEigenvalueList() {
        if (this.index.has($49b337e689138e29$export$f681829d43cbf50e.tagName)) {
            let i = this.index.get($49b337e689138e29$export$f681829d43cbf50e.tagName);
            return this.nodes.get(i);
        }
    }
    /**
     ...
     */ getPopulationList() {
        if (this.index.has($49b337e689138e29$export$8f9a53be9a409418.tagName)) {
            let i = this.index.get($49b337e689138e29$export$8f9a53be9a409418.tagName);
            return this.nodes.get(i);
        }
    }
    /**
     ...
     * Get the rate list.
     */ getRateList() {
        if (this.index.has($49b337e689138e29$export$9cdf0fcb7c05190f.tagName)) {
            let i = this.index.get($49b337e689138e29$export$9cdf0fcb7c05190f.tagName);
            return this.nodes.get(i);
        }
    }
    /**
...
const $7e68913db756e51f$var$metadataListDivID = "metadataList";
    ...
    function handleElement(tagName, constructor, setter) {
        ...
        if (xml_elements.length > 0) {
            if (xml_elements.length == 1) {
                ...
                let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    let aDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$var$boundary1);
...
//# sourceMappingURL=index.33d8b49b.js.map
