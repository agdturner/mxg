...
function $174b37a7f81f9b54$export$b7771d60d308862f(dictRef, values) {
    ...
    for(let i1 = 0; i1 < n; i1++)values.push((0, $7e68913db756e51f$export$a94c859b6fc3ec52));
}
        ...
        select.addEventListener("change", (event)=>{
            ...
            */ // Organise States.
            ...
            if (states != undefined) states.getStates().forEach((s)=>{
                ...
                // Add state.
                let sDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ssDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName, i);
                ...
                else sDiv.appendChild((0, $7e68913db756e51f$export$17d48ee8ddbf2d44)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(sDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy), mIDM, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy, ()=>energy, (value)=>s.setEnergy(value), ()=>s.removeEnergy(), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
                // Add degeneracy.
                let degeneracy = s.getDegeneracy();
                if (degeneracy == undefined) throw new Error("Degeneracy is undefined for state " + s.toString());
                else sDiv.appendChild((0, $7e68913db756e51f$export$17d48ee8ddbf2d44)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(sDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy), mIDM, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy, ()=>degeneracy, (value)=>s.setDegeneracy(value), ()=>s.removeDegeneracy(), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b)));
...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    for(let i1 = 0; i1 < xml_msl; i1++){
        // Create a new Molecule.
        let mDivID = mIDM.addID((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName, i1);
        let mDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mDivID);
        let attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[i1]);
        ...
        let xml_mls = xml_ms[i1].getElementsByTagName((0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName);
        if (xml_mls.length > 0) {
        ...
        // Init atoms.
        let xml_aas = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$9cea715eceba39a0).tagName);
        // Create collapsible AtomArray HTMLDivElement.
        let aaDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = mIDM.addID(aaDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        let xml_as = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$80986e6afdd7e0cb).tagName);
        ...
        // Init bonds.
        let xml_bas = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$746fba2e30d93fe6).tagName);
        // Create collapsible BondArray HTMLDivElement.
        let baDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = mIDM.addID(baDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        let xml_bs = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$153327fc99ac0c53).tagName);
        ...
        // Init properties.
        let xml_pls = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName);
        ...
        let xml_etms = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$499950da20810ac9).tagName);
        ...
        // Organise DOSCMethod.
        let xml_dms = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$bbdce6c921702068).tagName);
        if (xml_dms.length > 0) {
        ...
        let xml_dcms = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$3f9657e7f71262a).tagName);
        ...
        let xml_dosl = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$dcce836c71a83df).tagName);
        ...
        let xml_tts = xml_ms[i1].getElementsByTagName(tttn);
        if (xml_tts.length > 0) {
        ...
        let xml_edms = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$ae98b7db6376163d).tagName);
        ...
        let xml_ReservoirSize = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$97850fe2f2906f00).tagName);
        ...
        // Organise States.
        let xml_states = xml_ms[i1].getElementsByTagName((0, $01410cda1eef5011$export$47283907dceba392).tagName);
        let ssDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName);
        let ssDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ssDivID);
        let sscDivID = mIDM.addID(ssDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
...
//# sourceMappingURL=index.3909079f.js.map
