            ...
            for(let i = 0; i < xml_rl.length; i++){
                ...
                */ // "me:firstOrderLoss".
                ...
                for(let j = 0; j < xml_for.length; j++){
                    ...
                    values.push(s);
                    let forate = new (0, $6bf90154944bce56$export$984142e8329468e6)(forate_attributes, new (0, $a227f0f1258db640$exports.Big)(s));
                    rl.addFirstOrderRate(forate);
                }
                // "me:secondOrderRate".
                let xml_sor = xml_rl[i].getElementsByTagName((0, $6bf90154944bce56$export$f449a9e759d0ecf8).tagName);
                if (xml_sor.length > 0) //console.log("me:secondOrderRate length " + xml_for.length);
                for(let j = 0; j < xml_for.length; j++){
                    let sorate_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_for[j]);
                    if (i == 0) {
                        let fromRef = sorate_attributes.get("fromRef");
                        let toRef = sorate_attributes.get("toRef");
                        th.push(fromRef + "->" + toRef);
                    }
                    let s = ((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_for[j])?.nodeValue ?? "").trim();
                    values.push(s);
                    let forate = new (0, $6bf90154944bce56$export$984142e8329468e6)(sorate_attributes, new (0, $a227f0f1258db640$exports.Big)(s));
                    rl.addSecondOrderRate(forate);
                }
                if (i == 0) (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(tab, th);
...
//# sourceMappingURL=index.bd9931ae.js.map
