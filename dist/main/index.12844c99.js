 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    ...
    if (xml.length == 1) {
        ...
        button.textContent = buttonTextContentSelected;
        first = $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, value);
        button.classList.toggle("optionOff");
    } else {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName)) {
            ...
            first = $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, valueString);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
 ...
 * @param id The id.
 * @param valueString The value string. 
 */ function $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, valueString) {
...
//# sourceMappingURL=index.12844c99.js.map
