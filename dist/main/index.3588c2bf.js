     ...
     */ parse(xml) {
        ...
        */ // Process the XML "molecule" elements.
        ...
        for(let i = 0; i < xml_msl; i++){
            ...
            let id = (0, $174b37a7f81f9b54$export$194bfe7da61d65)(false, mid, undefined, molecules);
...
function $7e68913db756e51f$export$ac55d333e780178c(ask, m, ms) {
    let mid = (0, $174b37a7f81f9b54$export$194bfe7da61d65)(ask, m.getID(), m, ms);
    ms.set(mid, m);
}
/**
 ...
 */ function $7e68913db756e51f$var$addNumber(div, id, name, value, getter, setter, boundary) {
    ...
    input.addEventListener("change", (event)=>{
        let target = event.target;
        try {
            setter(new (0, $a227f0f1258db640$exports.Big)(target.value));
...
//# sourceMappingURL=index.3588c2bf.js.map
