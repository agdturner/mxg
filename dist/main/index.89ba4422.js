...
let $7e68913db756e51f$var$selected = "\u2713 [SELECTED] Action to deselect";
let $7e68913db756e51f$var$deselected = "\u2717 [DESELECTED] Action to select";
 ...
 */ function $7e68913db756e51f$var$processCalculateRateCoefficientsOnly(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = $7e68913db756e51f$var$selected;
        button.classList.toggle("optionOff");
    } else {
        button.textContent = $7e68913db756e51f$var$deselected;
        button.classList.toggle("optionOn");
    }
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
 ...
 */ function $7e68913db756e51f$var$processPrintCellDOS(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$60b233651e162b60).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintCellTransitionStateFlux(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintReactionOperatorColumnSums(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$a915db169f144f37).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainBoltzmann(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$e7fff349901f700d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainDOS(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$d23243bda4dfae2b).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainkbE(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$55888ef4e813a34d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainkfE(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$f8d814a406a0ff5b).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintTSsos(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainedSpeciesProfile(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintGrainTransitionStateFlux(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintReactionOperatorSize(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$8420ab6988728a65).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintSpeciesProfile(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintPhenomenologicalEvolution(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintTunnelingCoefficients(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processPrintCrossingCoefficients(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processTestDOS(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$a3d7e677521f681f).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processTestRateConstants(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processUseTheSameCellNumberForAllConditions(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processHideInactive(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processForceMacroDetailedBalance(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processTestMicroRates(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    ...
    if (xml.length == 1) {
        ...
        button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedLoadedText2;
    ...
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
        let infoButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$selectedLoadedText1, $7e68913db756e51f$var$boundary1);
        div.appendChild(infoButton);
 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processEigenvalues(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processShortestTimeOfInterest(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$421603058c6718db).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processMaximumEvolutionTime(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$b51d7314540831ed).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
 ...
 */ function $7e68913db756e51f$var$processDiagramEnergyOffset(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$e9d85a17345c2f11)((0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
...
//# sourceMappingURL=index.89ba4422.js.map
