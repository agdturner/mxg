 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        let moleculeDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, i);
        ...
        let moleculecDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, $7e68913db756e51f$var$s_container);
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(moleculecDivID, moleculeListDiv, null, moleculeDiv, moleculeId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        let aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map()); // To be reinitialised if there is an AtomArray.
        // There can be an individual atom not in an atom array, or an atom array.
        let xml_aas = xml_molecules[i].getElementsByTagName((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        ...
        if (xml_aas.length == 1) {
            ...
            aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_aa));
            molecule.setAtoms(aa);
            for(let j = 0; j < xml_as.length; j++){
                //console.log("j=" + j);
                // Create a new Atom.
                let a = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), molecule);
                ...
                // coordinates.
                $7e68913db756e51f$var$processCoordinates(a, aDiv, $7e68913db756e51f$var$boundary1);
                $7e68913db756e51f$var$addRemoveButton(aDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$removeAtom, molecule, aID);
            }
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        } else {
            let xml_as = xml_molecules[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
            if (xml_as.length == 1) {
                aa = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)(new Map());
                aa.addAtom(new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[0]), molecule));
                molecule.setAtoms(aa);
        ...
        let xml_bas = xml_molecules[i].getElementsByTagName((0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        ...
        if (xml_bas.length > 0) {
            ...
            for(let j = 0; j < xml_bs.length; j++){
                // Create a new Bond.
                let b = new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), molecule);
                ...
                // atomRefs2.
                $7e68913db756e51f$var$processAtomRefs2(molecule, bDiv, b, $7e68913db756e51f$var$boundary1);
                // order.
            ...
            if (xml_bonds.length > 0) {
                ...
                ba.addBond(new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bonds[0]), molecule));
                molecule.setBonds(ba);
            }
        }
        ...
        let viewerDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, "viewer");
        ...
        let viewercDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(viewercDivID, moleculeDiv, null, viewerDiv, "viewer", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        $7e68913db756e51f$var$create3DViewer(molecule, viewerDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_pls.length == 1) {
            ...
            for(let j = 0; j < xml_ps.length; j++){
                ...
                let p = $7e68913db756e51f$var$createProperty(xml_ps[j], plDiv, molecule, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                pl.setProperty(p);
            }
            ...
            // Create a new Property.
            let p = $7e68913db756e51f$var$createProperty(xml_ps[0], moleculeDiv, molecule, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        if (xml_etms.length > 0) {
            ...
            $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, xml_etms[0], moleculeDiv);
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
        }
        // Organise DOSCMethod.
        let xml_dms = xml_molecules[i].getElementsByTagName((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
        if (xml_dms.length > 0) {
            ...
            moleculeDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$bbdce6c921702068).xsi_typeOptions, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, doscm.getXsiType(), molecule.getID(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
        }
        // Organise ExtraDOSCMethod.
        let xml_edms = xml_molecules[i].getElementsByTagName((0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName);
        if (xml_edms.length > 0) {
            ...
            let edmDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName);
            ...
            let edmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(edmcDivID, moleculeDiv, null, edmDiv, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Read bondRef.
            ...
            if (xml_brs.length > 0) {
                ...
                let bids = molecule.getBonds().getBondIds();
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, bids, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, br.value, molecule.getID(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            ...
            if (xml_hrps.length > 0) {
                ...
                let ppsDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName);
                ...
                let ppscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(ppscDivID, moleculeDiv, null, ppsDiv, "PotentialPoints", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            ...
            if (xml_periodicities.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", molecule.getID() + "_" + (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
        ...
        if (xml_ReservoirSize.length > 0) {
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", molecule.getID() + "_" + (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                let target = event.target;
        ...
        molstarDiv.id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), "molstar");
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, moleculeListDiv, addMoleculeButton, moleculeDiv, moleculeId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        // Coordinates.
        $7e68913db756e51f$var$processCoordinates(a, aDiv, boundary);
 ...
 */ function $7e68913db756e51f$var$createProperty(xml, plDiv, molecule, boundary, level) {
    let p = new (0, $ef5b9341e5193b70$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml));
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml, plDiv, false, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml, plDiv, false, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$2762c8fbc03043ca).dictRef) {
        console.log("VibFreqs");
        $7e68913db756e51f$var$processProperty(p, undefined, molecule, xml, plDiv, true, boundary, level);
    } else $7e68913db756e51f$var$processProperty(p, undefined, molecule, xml, plDiv, false, boundary, level);
    return p;
}
/**
 ...
 */ function $7e68913db756e51f$var$processCoordinates(a, aDiv, margin) {
    aDiv.appendChild($7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, a.getX3.bind(a), a.setX3.bind(a), margin));
    aDiv.appendChild($7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, a.getY3.bind(a), a.setY3.bind(a), margin));
    aDiv.appendChild($7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, a.getZ3.bind(a), a.setZ3.bind(a), margin));
}
/**
 ...
 * @param margin The margin.
 */ function $7e68913db756e51f$var$processNumber(id, name, getter, setter, margin) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), margin);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addNumber(div, inputId, name, value, setter, margin);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
    }
    // Add event listener for the button.
 ...
 */ function $7e68913db756e51f$var$processProperty(p, units, molecule, element, plDiv, textArea, boundary, level) {
    // PropertyScalar.
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = $7e68913db756e51f$var$processNumber((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), p.dictRef, ps.getValue.bind(ps), ps.setValue, boundary);
        /*
...
//# sourceMappingURL=index.cff4be29.js.map
