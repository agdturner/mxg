...
function $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, mIDM, molecules) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            let mlistcDivID = mIDM.addID(mlistDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            ...
            if (aa != undefined) aa.atoms.forEach((a)=>{
                aaDiv.appendChild($174b37a7f81f9b54$var$addAtom(mIDM, molecule, aaDivID, molecule.getAtoms(), a, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            });
            ...
            if (ba != undefined) molecule.getBonds().bonds.forEach((b)=>{
                ...
                baDiv.appendChild($174b37a7f81f9b54$var$addBond(mIDM, molecule, baDivID, aa.atoms, molecule.getBonds(), b, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            });
 ...
 */ function $174b37a7f81f9b54$var$getAddAtomButton(mIDM, molecule, aaDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        aaDiv.insertBefore($174b37a7f81f9b54$var$addAtom(mIDM, molecule, aaDiv.id, molecule.getAtoms(), a, boundary, level), button);
    });
    return button;
}
 ...
 */ function $174b37a7f81f9b54$var$addAtom(mIDM, molecule, aaDivID, aa, a, boundary, level) {
 ...
 */ function $174b37a7f81f9b54$var$getAddBondButton(mIDM, molecule, baDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        baDiv.insertBefore($174b37a7f81f9b54$var$addBond(mIDM, molecule, baDiv.id, atoms, molecule.getBonds(), b, boundary, level), button);
    });
 ...
 */ function $174b37a7f81f9b54$var$addBond(mIDM, molecule, baDivID, atoms, ba, b, boundary, level) {
...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        for(let j = 0; j < xml_as.length; j++)aaDiv.appendChild($174b37a7f81f9b54$var$addAtom(mIDM, m, aaDivID, aa, new (0, $01410cda1eef5011$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        aaDiv.appendChild($174b37a7f81f9b54$var$getAddAtomButton(mIDM, m, aaDiv, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        ...
        for(let j = 0; j < xml_bs.length; j++){
            ...
            if (b_attributes.has((0, $01410cda1eef5011$export$153327fc99ac0c53).s_id)) baDiv.appendChild($174b37a7f81f9b54$var$addBond(mIDM, m, baDivID, m.getAtoms().atoms, ba, new (0, $01410cda1eef5011$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        }
...
function $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, name, pa, getter, setter, remover, marginComponent, margin) {
    ...
    let idb = mIDM.addID(divID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, idb, marginComponent);
    div.appendChild(button);
    button.classList.add((0, $7e68913db756e51f$export$50cc31b59b02e033));
    button.classList.add((0, $7e68913db756e51f$export$d52efe23389358db));
    let inputId = mIDM.addID(divID, (0, $7e68913db756e51f$export$58785e0018b77d4a));
    let values = getter();
    if (values == undefined) {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle((0, $7e68913db756e51f$export$50cc31b59b02e033));
...
function $cbb1ac0a822ffab5$export$b12ef0e3d99deb64(rIDM, rlDiv, reactions, molecules) {
    ...
    rb.addEventListener("click", ()=>{
        ...
        let mm = new (0, $28e4a0fe6fb3e45e$export$191e95ebb11cc88)(new Map());
        r.setMCRCMethod(mm);
        let inputString;
        let value;
        {
...
//# sourceMappingURL=index.4f2bba16.js.map
