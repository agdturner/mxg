 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    if (xml_as.length > 0) {
        ...
        if (xml_rl.length > 0) for(let i = 0; i < xml_rl.length; i++){
            ...
            rl.setTemperature(new (0, $a227f0f1258db640$exports.Big)(t));
            let conc = rle_attributes.get("conc");
            rl.setConcentration(new (0, $a227f0f1258db640$exports.Big)(conc));
...
//# sourceMappingURL=index.15f70915.js.map
