...
class $ef5b9341e5193b70$export$80986e6afdd7e0cb extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ constructor(attributes){
        ...
        if (id == undefined) console.warn("id is undefined");
        let elementType = attributes.get("elementType");
        if (elementType == undefined) console.warn("elementType is undefined");
    }
    /**
...
class $ef5b9341e5193b70$export$aef8e5ad5552fd72 extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
    static{
        /**
     * The tag name.
...
class $6f7aa7a716962086$export$d2ae4167a30cf6bb extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, id, reactants, products, transitionStates, mCRCMethod, tunneling, excessReactantConc){
        super(attributes, $6f7aa7a716962086$export$d2ae4167a30cf6bb.tagName);
        this.index = new Map();
        this.reactants = reactants;
        if (reactants instanceof Map) reactants.forEach((reactant)=>{
            this.addNode(reactant);
            this.addToIndex($6f7aa7a716962086$export$dcfd4302d04b7fb6.tagName, reactant);
        });
        else if (reactants != undefined) {
        ...
        if (products instanceof Map) products.forEach((product)=>{
        ...
        if (transitionStates instanceof Map) transitionStates.forEach((transitionState)=>{
     ...
     */ getMCRCMethod() {
        ...
        if (i == undefined) return undefined;
        console.log(i);
        let v = this.nodes.get(i);
        if (!(v instanceof $6f7aa7a716962086$export$6fa70ee10f356b6)) console.log("v is not MCRCMethod!!!");
        return this.nodes.get(i);
    }
    /**
...
class $ae74a7b44a6504a1$export$3fe97ecb6b172244 extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
    static{
        /**
     * The tag name.
 ...
 */ function $7e68913db756e51f$var$initMolecules(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        let molecule = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(attributes, atomsNode, bondsNode, propertiesNode, energyTransferModel, dOSCMethod);
    ...
    for(let i = 0; i < xml_reactions_length; i++){
        ...
        if (reactionID != null) {
            ...
            if (xml_transitionState.length > 0) {
                if (xml_transitionState.length > 1) {
            ...
            if (xml_MCRCMethod.length > 0) {
                ...
                console.log((0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " name=" + name);
                if (name == undefined) {
                    let type = mCRCMethodAttributes.get("xsi:type");
                    console.log((0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + "xsi:type=" + type);
                    if (type != undefined) {
                        if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType) {
                            let preExponential;
            ...
            // Create reaction.
            let reaction = new (0, $6f7aa7a716962086$export$d2ae4167a30cf6bb)(attributes, reactionID, reactants, products, transitionStates, mCRCMethod, tunneling, excessReactantConc);
...
//# sourceMappingURL=index.a97f2725.js.map
