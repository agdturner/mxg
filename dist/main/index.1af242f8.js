 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let canvas = document.getElementById($7e68913db756e51f$var$rd_canvas_Id);
    if (canvas != null) {
        canvas.remove();
        canvas.parentNode?.removeChild(canvas);
    }
    // If the reactionsDiagramDiv already exists, remove it.
    let reactionsDiagramDiv = document.getElementById($7e68913db756e51f$var$reactionsDiagramId);
    if (reactionsDiagramDiv != null) reactionsDiagramDiv.parentNode?.removeChild(reactionsDiagramDiv);
    // Create a new reactionsDiagramDiv and append it.
    reactionsDiagramDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$boundary1);
    ...
    popButton.addEventListener("click", ()=>{
        if ($7e68913db756e51f$var$popWindow == null) {
             ...
             */ let c = $7e68913db756e51f$var$rd_canvas.cloneNode(true);
...
//# sourceMappingURL=index.1af242f8.js.map
