 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    lmlb.addEventListener("click", (event)=>{
        ...
        if ($7e68913db756e51f$var$libraryMolecules == null) $7e68913db756e51f$var$libraryMolecules = lm.molecules;
        else lm.molecules.forEach((molecule)=>{
            let mID = molecule.getID();
            console.log("mID=" + mID);
            $7e68913db756e51f$var$libraryMolecules.set(mID, molecule);
...
//# sourceMappingURL=index.8db43d16.js.map
