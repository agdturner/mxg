 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv);
...
function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv) {
    // Add a 3Dmol.js viewer.
    // Create a new div for the viewer.
    let viewerContainerDivID = $7e68913db756e51f$var$addID(molecule.id, "viewerContainer");
    ...
    let viewerDivID = $7e68913db756e51f$var$addID(molecule.id, "viewer");
...
//# sourceMappingURL=index.b161a58f.js.map
