 ...
 */ // Symbols.
let $7e68913db756e51f$var$downTriangle = "\u25BC"; // ▼
let $7e68913db756e51f$var$upTriangle = "\u25B2"; // ▲
let $7e68913db756e51f$var$editSymbol = "\u270E"; // ✎
...
let $7e68913db756e51f$var$renameString = "Rename";
let $7e68913db756e51f$var$s_Add_from_spreadsheet = "Add from spreadsheet " + $7e68913db756e51f$var$addSymbol;
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        // Add a rename button.
        let renameButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$renameString, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$renameString), $7e68913db756e51f$var$level1);
        renameButton.addEventListener("click", ()=>{
            ...
            if (newMoleculeId != null) {
                ...
                button.textContent = molecule.getLabel() + " " + $7e68913db756e51f$var$upTriangle;
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, atomArrayDiv, typeID, boundary, level) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$addString, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, "Add" + typeID + "Button"), level);
...
function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    redrawButton.addEventListener("click", ()=>{
        ...
        createViewer(//undefined, undefined, undefined, 
        showAtomLabels, showBondLabels);
    });
    viewerContainerDiv.appendChild(redrawButton);
    // Helper function to create a label button for hiding or showing lables on the viewer.
    function createLabelButton(label, id, showState, updateState) {
        ...
        button.addEventListener("click", ()=>{
            ...
            */ updateState(showState);
            (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(viewerDivID, $7e68913db756e51f$var$ids);
            createViewer(//cameraPosition, cameraOrientation, zoomLevel,
            showAtomLabels, showBondLabels);
        });
        return button;
    }
 ...
 */ function $7e68913db756e51f$var$handleCalcMethod(control, controlDiv, i, xml_control, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has(tagName)) {
            if (first) {
                if (options[options.length - 1] != $7e68913db756e51f$var$selectOption) options.push($7e68913db756e51f$var$selectOption);
            }
            // Remove select.
            //remove(divCmId);
...
//# sourceMappingURL=index.44c5d719.js.map
