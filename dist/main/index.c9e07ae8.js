...
function $f0396edd0a5c99f7$export$8b2cd46c11844202(id, divToAddTo, elementToInsertBefore, content, button, buttonLabel, componentMargin, margin) {
    ...
    if (button == undefined) {
        ...
        button = $f0396edd0a5c99f7$export$9b6d6ca62970729f(buttonLabel + " " + $f0396edd0a5c99f7$export$38aa1ab9c2935930, buttonId, componentMargin);
    }
...
function $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        let mid = $174b37a7f81f9b54$var$setMoleculeID(undefined, undefined, molecules);
        console.log("mid=" + mid);
...
function $cbb1ac0a822ffab5$export$b12ef0e3d99deb64(rIDM, rlDiv, reactions, molecules) {
    ...
    rb.addEventListener("click", ()=>{
        ...
        $cbb1ac0a822ffab5$var$addAddReactantButton(r, rb, rIDM, rDivID, rsDiv, molecules, reactants);
        ...
        $cbb1ac0a822ffab5$var$addAddProductButton(r, rb, rIDM, rDivID, psDiv, molecules, products);
 ...
 */ function $cbb1ac0a822ffab5$var$addAddReactantButton(r, rb, rIDM, rDivID, rsDiv, molecules, reactants) {
    ...
    addReactantButton.addEventListener("click", ()=>{
        ...
        selectReactant.addEventListener("change", (event)=>{
            ...
            let mid = molecule.getID();
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName, mid);
 ...
 */ function $cbb1ac0a822ffab5$var$addAddProductButton(r, rb, rIDM, rDivID, psDiv, molecules, products) {
...
function $cbb1ac0a822ffab5$export$ef4959ac45646090(xml, rIDM, rb, reactions, molecules) {
    ...
    if (reactionListTagNames.size > 0) {
        ...
        for(let i = 0; i < xml_reactions.length; i++){
            ...
            $cbb1ac0a822ffab5$var$addAddReactantButton(reaction, rb, rIDM, reactionDivID, rsDiv, molecules, reactants);
            // Load products.
            ...
            $cbb1ac0a822ffab5$var$addAddProductButton(reaction, rb, rIDM, reactionDivID, psDiv, molecules, products);
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Initialise mesmer.
    ...
    // Create collapsible content.
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, moleculesDiv, null, mlDiv, undefined, (0, $69ecbdaa96f3962d$export$19d70f3647dee606).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Add add molecule button.
    ...
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, reactionsDiv, null, rlDiv, undefined, (0, $69ecbdaa96f3962d$export$44466a39ca846289).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    ...
    // Create collapsible content.
    let rdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)($7e68913db756e51f$var$rdDivID, rddDiv, null, rdDiv, undefined, $7e68913db756e51f$export$196db41cc586e1c, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    ...
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, conditionssDiv, undefined, "ConditionsList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Model Parameters.
    ...
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, modelParameterssDiv, undefined, "ModelParametersList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Control.
    ...
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, controlsDiv, undefined, "ControlList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
/*
    // MetadataList.
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // Create collapsible content.
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, mlDiv, null, (0, $174b37a7f81f9b54$export$ce852d72abd87240)(xml, $7e68913db756e51f$var$mIDM, $7e68913db756e51f$var$molecules), undefined, (0, $69ecbdaa96f3962d$export$19d70f3647dee606).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    ...
    let buttonId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rlDivID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $f0396edd0a5c99f7$export$38aa1ab9c2935930), buttonId, $7e68913db756e51f$export$d6befed1f1d5e56b);
    // Create collapsible content.
    let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, rlDiv, null, (0, $cbb1ac0a822ffab5$export$ef4959ac45646090)(xml, $7e68913db756e51f$var$rIDM, button, $7e68913db756e51f$var$reactions, $7e68913db756e51f$var$molecules), button, (0, $69ecbdaa96f3962d$export$44466a39ca846289).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Reactions Diagram.
    let rddDiv = document.getElementById($7e68913db756e51f$var$reactionsDiagramDivID);
    ...
    // Create collapsible content.
    let rdDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$39c84188a71202f7);
    let rdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rdDivID, rddDiv, null, rdDiv, undefined, $7e68913db756e51f$export$196db41cc586e1c, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    (0, $42d9507eaeb955b6$export$f1b90a337037b551)(rdDiv, $7e68913db756e51f$var$rdcID, $7e68913db756e51f$var$rdcHeight, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc, $7e68913db756e51f$var$rdWindow, $7e68913db756e51f$var$molecules, $7e68913db756e51f$var$reactions, true);
    // Conditions.
    ...
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, (0, $589572943861997b$export$120facc5efd57974)(xml, $7e68913db756e51f$var$conditionsIDM, $7e68913db756e51f$var$molecules), undefined, "ConditionsList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Model Parameters.
    ...
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, (0, $dde1c59fe054f706$export$7502110c3a5d7b36)(xml, $7e68913db756e51f$var$mpIDM), undefined, "ModelParametersList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Control.
    ...
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, (0, $180486e70a03b1bd$export$76caf53413cf3464)(xml, $7e68913db756e51f$var$controlIDM), undefined, "ControlList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // MetadataList.
    ...
    if (xml.getElementsByTagName((0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName).length > 0) {
        ...
        // Create collapsible content.
        let mdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mdDivID, mdDiv, null, $7e68913db756e51f$var$processMetadataList(xml), undefined, (0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    }
    // Analysis.
    ...
    if (xml.getElementsByTagName((0, $6bf90154944bce56$export$c4c153dc94cc96b4).tagName).length > 0) {
        ...
        // Create collapsible content.
        let acDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(aDivID, aDiv, null, $7e68913db756e51f$var$processAnalysis(xml), undefined, (0, $6bf90154944bce56$export$c4c153dc94cc96b4).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    }
}
 ...
 */ function $7e68913db756e51f$var$displayXML(xmlFilename, xml) {
    ...
    let xmlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(xml2DivID, xmlDiv, null, xml2Div, undefined, xmlFilename, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    if (xml_as.length > 0) {
        ...
        let elcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(elDivID, aDiv, null, elDiv, undefined, (0, $6bf90154944bce56$export$f681829d43cbf50e).tagName + "s", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
        if (xml_el.length > 0) for(let i = 0; i < xml_el.length; i++){
            ...
            let ecDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(eDivID, elDiv, null, eDiv, undefined, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
        ...
        let plcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(plDivID, aDiv, null, plDiv, undefined, (0, $6bf90154944bce56$export$8f9a53be9a409418).tagName + "s", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
        ...
        for(let i = 0; i < xml_pl.length; i++){
            ...
            let pcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pDivID, plDiv, null, pDiv, undefined, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
        ...
        let rlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rlDivID, aDiv, null, rlDiv, undefined, (0, $6bf90154944bce56$export$9cdf0fcb7c05190f).tagName + "s", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
        if (xml_rl.length > 0) {
            // Create Table.
...
//# sourceMappingURL=index.c9e07ae8.js.map
