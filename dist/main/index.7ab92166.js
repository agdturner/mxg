 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    if (xml_as.length > 0) {
        ...
        if (xml_rl.length > 0) for(let i = 0; i < xml_rl.length; i++){
            ...
            let rlecDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rleDivID, rleDiv, null, rlDiv, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
            let values0;
            let values;
            // "me:firstOrderLoss".
            let xml_fol = xml_rl[i].getElementsByTagName((0, $6bf90154944bce56$export$2450ca15ad4d2ed0).tagName);
            let folTable = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$export$bea69a603fae01a6(rleDivID, (0, $6bf90154944bce56$export$2450ca15ad4d2ed0).tagName), $7e68913db756e51f$export$d6befed1f1d5e56b);
            let folTableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$export$bea69a603fae01a6(rleDivID, (0, $6bf90154944bce56$export$2450ca15ad4d2ed0).tagName, $7e68913db756e51f$export$7a850709da5c4f5b), $7e68913db756e51f$export$d6befed1f1d5e56b);
            for(let j = 0; j < xml_fol.length; j++){
                let fol_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_fol[j]);
                if (j == 0) {
                    (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(folTable, [
                        "ref",
                        "value"
                    ]);
                    values0 = Array.from(fol_attributes.keys());
                    (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(folTable, values0);
                } else values = Array.from(fol_attributes.keys());
                ...
                // Check lengths.
                if (values0.length != values.length) console.error("FirstOrderLoss values0!.length != values!.length");
                for(let k = 0; k < values0.length; k++)// Check reference.
                if (values0[k] == values[k]) values.push(fol_attributes.get(values[k]));
                rl.addFirstOrderLoss(fol);
                (0, $f0396edd0a5c99f7$export$67d0e2fae00985e1)(folTable, values);
            }
            // Insert a save as csv button.
            $7e68913db756e51f$export$dd526fb3a2a9c049(()=>$7e68913db756e51f$var$tableToCSV(folTable), rleDiv, folTableDiv, "Bartis-Widom Phenomenological Rate Coefficients", $7e68913db756e51f$export$d6befed1f1d5e56b);
        /*
                // "me:firstOrderRate".
...
//# sourceMappingURL=index.7ab92166.js.map
