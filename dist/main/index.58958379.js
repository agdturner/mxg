...
function $f0396edd0a5c99f7$export$cc4306e505fa54b1(textContent, options, name, id, boundary) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_PLs.length == 1) {
            ...
            for(let j = 0; j < xml_Ps.length; j++){
                ...
                pl.setProperty(p);
                molecule.setProperties(pl);
                if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsEnergy, molecule, xml_Ps[j], plDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3);
                else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsRotConsts, molecule, xml_Ps[j], plDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level3);
            ...
            if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsEnergy, molecule, xml_Ps[0], moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2);
            else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsRotConsts, molecule, xml_Ps[0], moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2);
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_products.length > 0) {
            ...
            for(let j = 0; j < xml_products.length; j++){
                ...
                let container = (0, $f0396edd0a5c99f7$export$cc4306e505fa54b1)(molecule.ref + " role:", options, molecule.ref + "_" + "Select_Role", "Role", $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    if (xml_grainSizes.length > 0) {
        ...
        let grainSizeInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", grainSizeId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, grainSizeAttributes, grainSizeDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, $7e68913db756e51f$var$boundary1);
    ...
    if (xml_automaticallySetMaxEnes.length > 0) {
        ...
        let automaticallySetMaxEneInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", automaticallySetMaxEneId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        Object.assign(automaticallySetMaxEneInputDiv.style, $7e68913db756e51f$var$level1);
        modelParametersDiv.appendChild(automaticallySetMaxEneInputDiv);
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, automaticallySetMaxEneAttributes, modelParametersDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, $7e68913db756e51f$var$boundary1);
    }
    ...
    if (xml_energyAboveTheTopHills.length > 0) {
        ...
        let energyAboveTheTopHillInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", energyAboveTheTopHillId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level2, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, energyAboveTheTopHillAttributes, modelParametersDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, $7e68913db756e51f$var$boundary1);
    }
    ...
    if (xml_maxTemperatures.length > 0) {
        ...
        let maxTemperatureInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", maxTemperatureId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, maxTemperatureAttributes, modelParametersDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, $7e68913db756e51f$var$boundary1);
    }
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    if (xml_calculateRateCoefficientsOnly.length == 1) {
        ...
        control.setCalculateRateCoefficientsOnly(new (0, $b6873406fb778c0b$export$7d9247c9879133fb)());
    ...
    if (xml_printCellDOS.length == 1) {
        ...
        control.setPrintCellDOS(new (0, $b6873406fb778c0b$export$60b233651e162b60)());
    ...
    if (xml_printCellTransitionStateFlux.length == 1) {
        ...
        control.setPrintCellTransitionStateFlux(new (0, $b6873406fb778c0b$export$7e63e5104be309ff)());
    ...
    if (xml_printReactionOperatorColumnSums.length == 1) {
        ...
        control.setPrintReactionOperatorColumnSums(new (0, $b6873406fb778c0b$export$a915db169f144f37)());
    ...
    if (xml_printGrainBoltzmann.length == 1) {
        ...
        control.setPrintGrainBoltzmann(new (0, $b6873406fb778c0b$export$e7fff349901f700d)());
    ...
    if (xml_printGrainDOS.length == 1) {
        ...
        control.setPrintGrainDOS(new (0, $b6873406fb778c0b$export$d23243bda4dfae2b)());
    ...
    if (xml_printGrainkbE.length == 1) {
        ...
        control.setPrintGrainkbE(new (0, $b6873406fb778c0b$export$55888ef4e813a34d)());
    ...
    if (xml_printGrainkfE.length == 1) {
        ...
        control.setPrintGrainkfE(new (0, $b6873406fb778c0b$export$f8d814a406a0ff5b)());
    ...
    if (xml_printTSsos.length == 1) {
        ...
        control.setPrintTSsos(new (0, $b6873406fb778c0b$export$3627f2b606ffd3cb)());
    ...
    if (xml_printGrainedSpeciesProfile.length == 1) {
        ...
        control.setPrintGrainedSpeciesProfile(new (0, $b6873406fb778c0b$export$c5481d114fddc81c)());
    ...
    if (xml_printGrainTransitionStateFlux.length == 1) {
        ...
        control.setPrintGrainTransitionStateFlux(new (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab)());
    ...
    if (xml_printReactionOperatorSize.length == 1) {
        ...
        control.setPrintReactionOperatorSize(new (0, $b6873406fb778c0b$export$8420ab6988728a65)());
    ...
    if (xml_printSpeciesProfile.length == 1) {
        ...
        control.setPrintSpeciesProfile(new (0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1)());
    ...
    if (xml_printPhenomenologicalEvolution.length == 1) {
        ...
        control.setPrintPhenomenologicalEvolution(new (0, $b6873406fb778c0b$export$9f7939759d8efd9f)());
    ...
    if (xml_printTunnelingCoefficients.length == 1) {
        ...
        control.setPrintTunnelingCoefficients(new (0, $b6873406fb778c0b$export$fc99460819e23ac5)());
    ...
    if (xml_printCrossingCoefficients.length == 1) {
        ...
        control.setPrintCrossingCoefficients(new (0, $b6873406fb778c0b$export$2f2eaac8983031ef)());
    ...
    if (xml_testDOS.length == 1) {
        ...
        control.setTestDOS(new (0, $b6873406fb778c0b$export$a3d7e677521f681f)());
    ...
    if (xml_testRateConstants.length == 1) {
        ...
        control.setTestRateConstants(new (0, $b6873406fb778c0b$export$724a5a49739f4b4a)());
    ...
    if (xml_useTheSameCellNumberForAllConditions.length == 1) {
        ...
        control.setUseTheSameCellNumberForAllConditions(new (0, $b6873406fb778c0b$export$5d7dbeba4bf49655)());
    ...
    if (xml_hideInactive.length == 1) {
        ...
        control.setHideInactive(new (0, $b6873406fb778c0b$export$9d51752a8549e2d6)());
    ...
    if (xml_forceMacroDetailedBalance.length == 1) {
        ...
        control.setForceMacroDetailedBalance(new (0, $b6873406fb778c0b$export$6ffea14bdffd427f)());
    ...
    testMicroRatesInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                ...
                let tMaxInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idTmax + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                ...
                let tMinInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idTmin + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
                ...
                let tStepInputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", idTstep + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
    ...
    calcMethodInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                ...
                let selectElement = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).options, value, id, $7e68913db756e51f$var$boundary1);
                selectElement.addEventListener("change", (event)=>{
                    if (event.target instanceof HTMLSelectElement) {
    ...
    if (xml_eigenvalues.length == 1) {
        ...
        let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
            if (event.target instanceof HTMLInputElement) {
    ...
    if (xml_shortestTimeOfInterest.length == 1) {
        ...
        let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id + "_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
...
//# sourceMappingURL=index.58958379.js.map
