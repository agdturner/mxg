 ...
 */ function $7e68913db756e51f$var$addMolecule(m, ms) {
    let id = m.getID();
    for (let [key, v] of $7e68913db756e51f$var$molecules)if (id == v.getID()) {
        id += " " + v.id.toString();
        m.label = id;
...
function $7e68913db756e51f$export$7577c09cb43cc206(label) {
    for (let [key, value] of $7e68913db756e51f$var$molecules){
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = $7e68913db756e51f$var$libmols.get(parseInt(mID.split("-")[1]));
 ...
 */ function $7e68913db756e51f$var$handleCalcMethod(control, cDiv, xml_control, level) {
    ...
    let divCmDetailsId = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, divCmId, "details");
    let divCmDetailsSelectId = $7e68913db756e51f$var$controlIDs.addID(cDiv.id, divCmDetailsId, "select");
    let cm;
    let first = true;
    if (xml_control != null) {
 ...
 */ function $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(divCmDetails, cm) {
    ...
    function processNumberElement(ClassConstructor, getter, setter, tagName) {
        let element = getter() || new ClassConstructor(new Map(), NaN);
        setter(element);
        divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", $7e68913db756e51f$var$addRID(divCmDetails.id, tagName, $7e68913db756e51f$var$s_input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, $7e68913db756e51f$var$handleEvent(element, tagName), element.value.toString(), tagName));
    }
    ...
    divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options, tagName, (0, $b6873406fb778c0b$export$e98aeac6c6b1df09).options[0], $7e68913db756e51f$var$addRID(divCmDetails.id, tagName, "select"), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1));
    ...
    if (canvas != null) {
        ...
        $7e68913db756e51f$var$reactions.forEach(function(reaction, id) {
            ...
            if (reactantsLabel != undefined) {
                ...
                let energy = reaction.getReactantsEnergy($7e68913db756e51f$export$7577c09cb43cc206);
            ...
            if (productsLabel != undefined) {
                ...
                let energy = reaction.getProductsEnergy($7e68913db756e51f$export$7577c09cb43cc206);
                energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
                ...
                if (orders.has(productsLabel)) {
                    ...
                    if (reactionTransitionStates != undefined) {
                        reactionTransitionStates.forEach(function(ts) {
                            ...
                            orders.set(ref, i);
                            energy = $7e68913db756e51f$export$7577c09cb43cc206(ref).getEnergy() ?? $7e68913db756e51f$var$big0;
                            energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                            energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
...
//# sourceMappingURL=index.f4a99835.js.map
