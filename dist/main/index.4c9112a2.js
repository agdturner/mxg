    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_PLs.length == 1) {
            ...
            for(let j = 0; j < xml_Ps.length; j++){
                ...
                pl.setProperty(p);
                molecule.setProperties(pl);
                if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsEnergy, molecule, xml_Ps[j], plDiv, $7e68913db756e51f$var$margin4);
                else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsRotConsts, molecule, xml_Ps[j], plDiv, $7e68913db756e51f$var$margin4);
                else $7e68913db756e51f$var$processProperty(p, undefined, molecule, xml_Ps[j], plDiv, $7e68913db756e51f$var$margin4);
            }
            ...
            if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsEnergy, molecule, xml_Ps[0], moleculeDiv, $7e68913db756e51f$var$margin4);
            else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, $7e68913db756e51f$var$unitsRotConsts, molecule, xml_Ps[0], moleculeDiv, $7e68913db756e51f$var$margin4);
            else $7e68913db756e51f$var$processProperty(p, undefined, molecule, xml_Ps[0], moleculeDiv, $7e68913db756e51f$var$margin4);
        ...
        if (xml_ExtraDOSCMethod.length > 0) {
            ...
            let collapsibleDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(extraDOSCMethodDiv, (0, $ef5b9341e5193b70$export$ae98b7db6376163d).tagName, buttonId, $7e68913db756e51f$var$fontSize3, $7e68913db756e51f$var$margin3, $7e68913db756e51f$var$marginTop, $7e68913db756e51f$var$marginBottom, contentDivId);
            moleculeDiv.appendChild(collapsibleDiv);
            // Read bondRef.
 ...
 */ function $7e68913db756e51f$var$processProperty(p, units, molecule, element, moleculeDiv, margin) {
    ...
    if (scalarNodes.length > 0) {
        ...
        inputDiv.style.marginTop = $7e68913db756e51f$var$marginTop;
        inputDiv.style.marginBottom = $7e68913db756e51f$var$marginBottom;
        ...
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, inputDiv, molecule.id + "_" + p.dictRef + "_Select_Units", p.dictRef);
        ...
        if (arrayNodes.length > 0) {
            ...
            $7e68913db756e51f$var$addAnyUnits(units, paAttributes, inputDiv, molecule.id + "_" + p.dictRef + "_Select_Units", p.dictRef);
            moleculeDiv.appendChild(inputDiv);
 ...
 */ function $7e68913db756e51f$var$addAnyUnits(units, attributes, inputDiv, id, tagOrDictRef) {
    if (units != undefined) {
 ...
 */ function $7e68913db756e51f$var$processDOSCMethod(dOSCMethod, molecule, margin, moleculeDiv) {
    ...
    container.style.marginTop = $7e68913db756e51f$var$marginTop;
    container.style.marginBottom = $7e68913db756e51f$var$marginBottom;
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_transitionStates.length > 0) {
            ...
            for(let j = 0; j < xml_transitionStates.length; j++){
                ...
                label.style.marginLeft = $7e68913db756e51f$var$margin4;
                label.style.marginTop = $7e68913db756e51f$var$marginTop;
                label.style.marginBottom = $7e68913db756e51f$var$marginBottom;
        ...
        if (xml_MCRCMethod.length > 0) {
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                if (name == undefined || name == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                    ...
                    if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                        ...
                        if (xml_preExponential != null) {
                            if (xml_preExponential[0] != null) {
                                ...
                                inputDiv.style.marginLeft = $7e68913db756e51f$var$margin4;
                                inputDiv.style.marginTop = $7e68913db756e51f$var$marginTop;
                                inputDiv.style.marginBottom = $7e68913db756e51f$var$marginBottom;
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, preExponentialAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName, (0, $6f7aa7a716962086$export$38ce90ac8b004d85).tagName);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
                        ...
                        if (xml_activationEnergy != null) {
                            if (xml_activationEnergy[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, activationEnergyAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName, (0, $6f7aa7a716962086$export$1bdc69d2439d749d).tagName);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
                        ...
                        if (xml_tInfinity != null) {
                            if (xml_tInfinity[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, tInfinityAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName, (0, $6f7aa7a716962086$export$8d95dd32819bc86c).tagName);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
                        ...
                        if (xml_nInfinity != null) {
                            if (xml_nInfinity[0] != null) {
                                ...
                                $7e68913db756e51f$var$addAnyUnits(undefined, nInfinityAttributes, inputDiv, reaction.id + "_" + (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType + "_" + (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName, (0, $6f7aa7a716962086$export$d08982dd841d496f).tagName);
                                mCRCMethodDiv.appendChild(inputDiv);
                            }
                        }
                    ...
                    mCRCMethodLabel.style.marginTop = $7e68913db756e51f$var$marginTop;
                    mCRCMethodLabel.style.marginBottom = $7e68913db756e51f$var$marginBottom;
...
//# sourceMappingURL=index.4c9112a2.js.map
