import {existsSync as $ibJ1H$existsSync} from "fs";
...
class $cccccb2a0a919d2e$export$79d0bd4671c1fc67 {
    static{
        /**
     * TagName.
     */ this.tagName = "me:defaults";
    }
    /**
     * @param defaults The defaults.
     */ constructor(){
        let path = "data/defaults.xml";
        if ((0, $ibJ1H$existsSync)(path)) console.log("File exists");
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_aas.length == 1) {
            ...
            if (xml_as.length < 2) throw new Error("Expecting 2 or more atoms in " + (0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName + ", but finding " + xml_as.length + "!");
...
//# sourceMappingURL=index.de523d40.js.map
