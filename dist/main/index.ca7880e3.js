...
function $f0396edd0a5c99f7$export$cc4306e505fa54b1(textContent, options, name, id, componentMargin, divMargin) {
...
function $f0396edd0a5c99f7$export$f2839682b8c07f35(textContent, margin, fontsize) {
...
/**
 * The repository URL.
 */ let $7e68913db756e51f$var$gitHubRepositoryURL = "https://github.com/agdturner/mxg-pwa";
/**
...
let $7e68913db756e51f$var$selected = "\u2713 [SELECTED] Action to unselect.";
let $7e68913db756e51f$var$notSelected = "\u2717 [NOT SELECTED] Action to select.";
let $7e68913db756e51f$var$selectedLoadedValueText = " Change the specification if desired:";
let $7e68913db756e51f$var$unselectedText = " Then specify using input(s) that appear.";
let $7e68913db756e51f$var$selectedValueText = " Or specify using input(s):";
let $7e68913db756e51f$var$selectAnotherOption = "Action/select another option...";
let $7e68913db756e51f$var$specifyNumberText = "Click then specify a number in the input that will appear.";
/**
 * For mesmer.
 ...
 */ function $7e68913db756e51f$var$load() {
    ...
    inputElement.onchange = function() {
        if (inputElement.files) {
            ...
            (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(urlButtonId);
            let urlButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Open a new Web browser loading the MXG GitHub repository: " + $7e68913db756e51f$var$gitHubRepositoryURL, $7e68913db756e51f$var$boundary1);
            urlButton.id = urlButtonId;
            urlButton.addEventListener("click", ()=>{
                window.open($7e68913db756e51f$var$gitHubRepositoryURL, "_blank");
            });
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    if (xml_title.length != 1) throw new Error("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found");
        ...
        }, titleString, (0, $8677001474399221$export$f99233281efd08a0).tagName, $7e68913db756e51f$var$fontSize1);
        titleDiv.id = titleId;
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    if (xml_energyAboveTheTopHills.length > 0) {
        ...
        $7e68913db756e51f$var$addAnyUnits([
            "kT"
        ], energyAboveTheTopHillAttributes, lwi, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, $7e68913db756e51f$var$boundary1);
        modelParametersDiv.appendChild(lwi);
    }
 ...
 */ function $7e68913db756e51f$var$processGrainSize(modelParameters, xml_modelParameters, modelParametersDiv) {
    ...
    let id = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName + "_checkbox";
    let idI = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName + "_input";
    let idS = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName + "_SelectUnits";
    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("checkbox", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$createGrainSizeInput(modelParameters, div, gs, idI, idS, valueString);
            else {
    ...
    }, "", (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName);
    div.appendChild(lwi);
    if ($7e68913db756e51f$var$setCheck(lwi, xml)) $7e68913db756e51f$var$createGrainSizeInput(modelParameters, div, gs, idI, idS, valueString);
}
/**
 * @param modelParameters The model parameters.
 * @param div The div.
 ...
 */ function $7e68913db756e51f$var$processCalcMethod(control, controlsDiv, xml_control) {
    ...
    */ let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(div);
    let xml = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName);
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    ...
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName + "_input";
    let cm;
    let first = true;
    if (xml.length == 1) {
        let value = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
        cm = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml[0]), value);
        button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedLoadedValueText;
        first = $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, value, first);
        button.classList.toggle("optionOff");
    } else {
        cm = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)(new Map(), $7e68913db756e51f$var$selectAnotherOption);
        button.textContent = $7e68913db756e51f$var$notSelected + $7e68913db756e51f$var$unselectedText;
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName)) {
            ...
            first = $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, valueString, first);
            button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedValueText;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
 ...
 * @param id The id.
 * @param valueString The value string. 
 */ function $7e68913db756e51f$var$createCalcMethodInput(control, options, div, cm, id, valueString, first) {
    let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, valueString, id, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processEigenvalues(control, controlsDiv, xml_control) {
    ...
    */ let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName + "_input";
    let eigenvalues;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
    ...
    button.addEventListener("click", (event)=>{
        ...
        let infoButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$specifyNumberText, $7e68913db756e51f$var$boundary1);
        //infoButton.id = idIB;
 ...
 */ function $7e68913db756e51f$var$processShortestTimeOfInterest(control, controlsDiv, xml_control) {
    ...
    */ let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$421603058c6718db).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$421603058c6718db).tagName + "_input";
    let stoi;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
 ...
 */ function $7e68913db756e51f$var$processMaximumEvolutionTime(control, controlsDiv, xml_control) {
    ...
    */ let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$b51d7314540831ed).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName + "_input";
    let met;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
 ...
 */ function $7e68913db756e51f$var$processAutomaticallySetMaxEne(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName + "_input";
    let asme;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
        ...
        button.textContent = $7e68913db756e51f$var$selected + $7e68913db756e51f$var$selectedLoadedValueText;
        $7e68913db756e51f$var$createAutomaticallySetMaxEneInput(control, div, asme, id, valueString);
        button.classList.toggle("optionOff");
    } else {
        valueString = "";
 ...
 */ function $7e68913db756e51f$var$processDiagramEnergyOffset(control, controlsDiv, xml_control) {
    ...
    let lwb = (0, $f0396edd0a5c99f7$export$717b1c3df34dc89e)((0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName, "", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
    let button = lwb.querySelector("button");
    button.classList.add("optionOn");
    button.classList.add("optionOff");
    div.appendChild(lwb);
    let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName + "_input";
    let deo;
    let valueString;
    if (xml.length == 1) {
        valueString = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml[0]));
...
//# sourceMappingURL=index.ca7880e3.js.map
