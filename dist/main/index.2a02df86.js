    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            if (aa != undefined) aa.atoms.forEach((a)=>{
                aa.removeAtom(a.getID());
                aaDiv.appendChild($174b37a7f81f9b54$var$addAtom(false, mIDM, molecule, aaDivID, molecule.getAtoms(), a, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            });
            ...
            if (ba != undefined) molecule.getBonds().bonds.forEach((b)=>{
                ...
                //ba.removeBond(b.getID()!);
                baDiv.appendChild($174b37a7f81f9b54$var$addBond(false, mIDM, molecule, baDivID, aa.atoms, molecule.getBonds(), b, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            });
...
//# sourceMappingURL=index.2a02df86.js.map
