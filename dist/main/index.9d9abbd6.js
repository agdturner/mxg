...
class $01410cda1eef5011$export$3da9759ad07746a3 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ getEnergy() {
        ...
        if (p == undefined) return (0, $a227f0f1258db640$exports.Big)(0);
            ...
            if (p instanceof $01410cda1eef5011$export$742f9ce317ef8ba3) return p.value;
 ...
 */ function $174b37a7f81f9b54$var$addPropertyArray(setSize, m, mIDM, plDiv, pl, dictRef, units) {
    ...
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv.id, mIDM, dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
 ...
 */ function $174b37a7f81f9b54$var$addPropertyMatrix(setSize, m, mIDM, plDiv, pl, dictRef, units) {
    ...
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv.id, mIDM, dictRef, pm, pm.getValues.bind(pm), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, pm, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            if (!dictRefs.has((0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
                ...
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv.id, mIDM, p.dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            if (!dictRefs.has((0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef)) $174b37a7f81f9b54$var$addPropertyMatrix(false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).hessianUnits);
                ...
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv.id, mIDM, p.dictRef, pm, pm.getValues.bind(pm), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pm, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
...
function $174b37a7f81f9b54$export$183579040c2dd680(pl, p, units, molecule, mIDM, element, plDiv, boundary, level) {
    ...
    //button.click();
        ...
        if (arrayNodes.length > 0) {
            ...
            p.setProperty(pa);
            div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(pID, mIDM, p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
...
function $174b37a7f81f9b54$export$e5600fc4ea245d6d(id, mIDM, name, pa, getter, setter, remover, marginComponent, margin) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, margin);
    ...
    let idb = mIDM.addID(id, name, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, idb, marginComponent);
    div.appendChild(button);
    button.classList.add((0, $7e68913db756e51f$export$50cc31b59b02e033));
    button.classList.add((0, $7e68913db756e51f$export$d52efe23389358db));
    let inputId = mIDM.addID(id, name, (0, $7e68913db756e51f$export$58785e0018b77d4a));
    let values = getter();
    if (values == undefined) {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle((0, $7e68913db756e51f$export$50cc31b59b02e033));
 ...
 */ function $0ed86fc7e748b547$var$about(w) {
    ...
    wDiv.appendChild(p4);
    p4.appendChild(w.document.createTextNode("The Menu contains 6 buttons:         The About button displays the about text in a new Window.         The Start Afresh button reinitialises the interface.         The Load Molecules button is for loading molecule data that can then be selected.         The Load Defaults button is for loading default values from a file.         The Load From File button is for loading a MESMER XML data file.         The Save To File button is for saving a new MESMER XML data file."));
    /* 
...
function $0ed86fc7e748b547$export$c9a19c59161f09a0() {
    ...
    // Add Load Library Molecules button.
    let s_Load_Library_Molecules = "Load Library Molecules";
    let llmb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_Library_Molecules, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Load_Library_Molecules), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    ...
    llmb.addEventListener("click", async (event)=>{
        ...
        if ((0, $7e68913db756e51f$export$7c97c73a2c729cf9).size == undefined) (0, $7e68913db756e51f$export$4802e08cda112391)(new Map());
        ms.forEach((v, k)=>{
            (0, $7e68913db756e51f$export$ac55d333e780178c)(false, v, (0, $7e68913db756e51f$export$7c97c73a2c729cf9));
        });
    });
    // Add Clear Library Molecules button.
    let s_Clear_Library_Molecules = "Clear Library Molecules";
    let clmb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Clear_Library_Molecules, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Clear_Library_Molecules), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    ...
    let lb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_From_File, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Load_From_File), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    ...
    */ // Add Save To MESMER File button.
    ...
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Save_To_File, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Save_To_File), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
...
//# sourceMappingURL=index.9d9abbd6.js.map
