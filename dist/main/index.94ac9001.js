...
function $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(mcDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
...
function $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, molecules) {
...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, moleculeDivIDs, molecules) {
    ...
    if (!mlTagNames.has((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName)) {
        ...
        let amb = mlDiv.appendChild($174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, moleculeDivIDs, molecules));
        // Add add from library button.
        mlDiv.appendChild($174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, molecules));
        return mlDiv;
    }
    // Process the XML "molecule" elements.
    let xml_ms = xml_ml.getElementsByTagName((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName);
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        */ // Organise EnergyTransferModel.
        ...
        // Add a remove molecule button.
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(mDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
            mlDiv.removeChild(mDiv);
            moleculeDivIDs.removeIDs(mDivID);
            molecules.delete(m.getID());
        });
    }
    // Create an add molecule button.
    let mb = $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, moleculeDivIDs, molecules);
...
//# sourceMappingURL=index.94ac9001.js.map
