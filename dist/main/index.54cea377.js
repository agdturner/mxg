...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        // "me:Hf0", scalar, Mesmer.energyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef);
        ...
        // "me:HfAT0", scalar, Mesmer.energyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef);
...
function $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml, plDiv, molecule, mIDM, boundary, level) {
    ...
    if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef) {
        // "me:ZPE", scalar, Mesmer.energyUnits.
        let pid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef);
        //mIDM.removeIDs(pid);
...
function $174b37a7f81f9b54$export$183579040c2dd680(pl, p, units, molecule, mIDM, element, plDiv, boundary, level) {
    ...
    let pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef);
    // PropertyScalar.
    ...
    if (scalarNodes.length > 0) {
        ...
        if (arrayNodes.length > 0) {
            ...
            p.setProperty(pa);
            let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(pID, mIDM, p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
...
function $0ed86fc7e748b547$export$c9a19c59161f09a0() {
    ...
    let sab = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_StartAfresh, (0, $7e68913db756e51f$export$39722580448f5a99)(s_StartAfresh), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
 ...
 */ function $7e68913db756e51f$var$initialise() {
    ...
    $7e68913db756e51f$export$7c97c73a2c729cf9 = new Map();
...
function $7e68913db756e51f$export$17d48ee8ddbf2d44(id, tIDM, name, getter, setter, remover, marginComponent, margin) {
    ...
    let idb = tIDM.addID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, idb, marginComponent);
    div.appendChild(button);
    ...
    let inputId = tIDM.addID(id, $7e68913db756e51f$export$58785e0018b77d4a);
    let value = getter();
    if (value == undefined) {
        button.textContent = buttonTextContentDeselected;
...
//# sourceMappingURL=index.54cea377.js.map
