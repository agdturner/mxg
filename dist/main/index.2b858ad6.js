 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_mls.length > 0) {
            ...
            for(let j = 0; j < xml_ms.length; j++){
                ...
                ml.addMetadata(md);
                let mdID = m.getID();
                let mdDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mlDivID, j);
                let mdDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(mdDivID, $7e68913db756e51f$var$level1);
                mlDiv.appendChild(mdDiv);
                mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(mdID, $7e68913db756e51f$var$boundary1));
            }
            moleculeTagNames.delete((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        }
        // Init atoms.
        ...
        if (xml_aas.length == 1) {
            ...
            for(let j = 0; j < xml_as.length; j++){
                //console.log("j=" + j);
                // Create a new Atom.
                let a = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m);
                let aID = aa.addAtom(a);
                let aDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aaDivID, j);
                let aDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(aDivID, $7e68913db756e51f$var$level1);
                aaDiv.appendChild(aDiv);
                aDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(aID, $7e68913db756e51f$var$boundary1));
                // elementType.
                $7e68913db756e51f$var$processElementType(a, aDiv, false, $7e68913db756e51f$var$boundary1);
                // coordinates.
                $7e68913db756e51f$var$processCoordinates(a, aDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
                $7e68913db756e51f$var$addRemoveButton(aDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$removeAtom, m, aID);
            }
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$9cea715eceba39a0).tagName);
        } else {
            let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        ...
        moleculeTagNames.delete((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        // Init bonds.
        let ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)(new Map()); // This will be replaced if there is an BondArray.=
        ...
        if (xml_bas.length > 0) {
            if (xml_bas.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName + " but finding " + xml_bas.length + "!");
            let xml_bs = xml_bas[0].getElementsByTagName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
            ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bas[0]));
            for(let j = 0; j < xml_bs.length; j++){
                // Create a new Bond.
                let b = new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m);
                let bID = ba.addBond(b);
                let bdivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(baDivID, j);
                let bDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(bdivID, $7e68913db756e51f$var$level1);
                baDiv.appendChild(bDiv);
                bDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(bID, $7e68913db756e51f$var$boundary1));
                // atomRefs2.
                $7e68913db756e51f$var$processAtomRefs2(m, bDiv, b, $7e68913db756e51f$var$boundary1);
                // order.
                $7e68913db756e51f$var$processOrder(bDiv, b, $7e68913db756e51f$var$boundary1);
                $7e68913db756e51f$var$addRemoveButton(bDiv, $7e68913db756e51f$var$boundary1, removeBond, bID);
            }
            m.setBonds(ba);
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
        } else {
            ...
            if (xml_bonds.length > 0) {
                if (xml_bonds.length > 1) throw new Error("Expecting 1 " + (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName + " but finding " + xml_bonds.length + ". Should these be in a " + (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName + "?");
                ba = new (0, $ef5b9341e5193b70$export$746fba2e30d93fe6)(new Map());
                ba.addBond(new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bonds[0]), m));
                m.setBonds(ba);
            }
        }
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        // Add event listeners for the select element.
        select.addEventListener("click", (event)=>{
            $7e68913db756e51f$var$addOrRemoveInstructions(options, false);
        });
        select.addEventListener("change", (event)=>{
            ...
            atoms.forEach((a)=>{
                aaDiv.append($7e68913db756e51f$var$addAtom(molecule, a, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
            aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            // Create collapsible BondArray HTMLDivElement.
            let baDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
            ...
            molecule.getBonds().bonds.forEach((b)=>{
                baDiv.append($7e68913db756e51f$var$addBond(molecule, atoms, b, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        aaDiv.insertBefore($7e68913db756e51f$var$addAtom(molecule, a, boundary, level), button);
    });
    return button;
}
/**
 ...
 */ function $7e68913db756e51f$var$addAtom(molecule, a, boundary, level) {
    let aID = a.getID();
 ...
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, baDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        baDiv.insertBefore($7e68913db756e51f$var$addBond(molecule, atoms, b, boundary, level), button);
    });
 ...
 */ function $7e68913db756e51f$var$addBond(molecule, atoms, b, boundary, level) {
    let bID = b.getID();
...
//# sourceMappingURL=index.2b858ad6.js.map
