...
const $f0396edd0a5c99f7$var$s_button = "button";
...
function $f0396edd0a5c99f7$export$8b2cd46c11844202(id, divToAddTo, elementToInsertBefore, content, buttonLabel, componentMargin, margin) {
    ...
    let buttonId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $f0396edd0a5c99f7$var$s_button);
    let button = $f0396edd0a5c99f7$export$9b6d6ca62970729f(`${buttonLabel} \u{25BC}`, buttonId, componentMargin);
...
let $7e68913db756e51f$var$level0 = {
    marginLeft: $7e68913db756e51f$var$margin0,
    marginTop: $7e68913db756e51f$var$margin1,
    marginBottom: $7e68913db756e51f$var$margin1,
    marginRight: $7e68913db756e51f$var$margin0
};
 ...
 */ // Symbols.
const $7e68913db756e51f$var$sy_downTriangle = "\u25BC"; // ▼
const $7e68913db756e51f$var$sy_upTriangle = "\u25B2"; // ▲
const $7e68913db756e51f$var$sy_edit = "\u270E"; // ✎
const $7e68913db756e51f$var$sy_add = "\uFF0B"; // ＋
const $7e68913db756e51f$var$sy_remove = "\u2715"; // ✕
const $7e68913db756e51f$var$sy_refresh = "\u27F3"; // ⟳
...
const $7e68913db756e51f$var$s_button = "button";
const $7e68913db756e51f$var$s_container = "s_container";
const $7e68913db756e51f$var$s_Edit_sy_edit = "Edit " + $7e68913db756e51f$var$sy_edit;
...
const $7e68913db756e51f$var$s_Refresh_sy_refresh = "Refresh " + $7e68913db756e51f$var$sy_refresh;
const $7e68913db756e51f$var$s_Remove_sy_remove = "Remove " + $7e68913db756e51f$var$sy_remove;
const $7e68913db756e51f$var$s_Rename = "Rename";
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    wDiv.appendChild(p1);
    p1.textContent = "Welcome to MXG - a Graphical User Interface (GUI) program to assist MESMER program users in creating, editing         and visualising MESMER data. Details of MESMER - the Master Equation Solver for Multi Energy-well Reactions can be found at: ";
    ...
    wDiv.appendChild(p3);
    p3.textContent = "There should be a Menu above containing buttons. The Load button can be actioned to select and load a file         the contents of which will not be modified. The file is expected to be in MESMER format. The data in the file should be         presented below the menu. Users can make changes to the data using the GUI and save a new MESMER file using the Menu Save         button. The saved file should have the same content as was loaded except it will contain no comments or blank lines, values         will be trimmed of white space, and some numbers may be output differently. The saved file will also reflect any changes         made to the data through use of the GUI.";
    let p4 = document.createElement("p");
    wDiv.appendChild(p4);
    p4.textContent = "Between the Menu Load and Save buttons are buttons to increase or decrease the font size and to change between a         light and dark theme. Changing the font size will redraw diagrams using a larger fontsize as well as changing the size of text         in the GUI.";
    let p5 = document.createElement("p");
    p5.textContent += "MXG is not yet recommended for general use. A community release to be supported by the MESMER community is     scheduled for the end of April 2024. MXG is free and open source software based on free and open source software. The main     development GitHub repository is: ";
    ...
    p9.textContent = 'The "moleculeList", "reactionList", "me:conditions", "me:modelParameters", and "me:control" details         are presented below the "me:title" in a series of buttons. There is also a Reactions Diagram button and a button         with text which is the filename of the file loaded. These buttons contain a triangular symbol which indicate a         collapsed (triangle orientated with a point down: \u25BC) or expanded (triangle with a point up: \u25B2) state. Actioning these         buttons will either expand or collapse content that should appear or be present below the button.';
    let p10 = document.createElement("p");
    instructionsDiv.appendChild(p10);
    p10.textContent = ' Actioning the Reaction Diagram button should reveal a well diagram for the reactions. This diagram     should redraw if the user edits any "me:ZPE" property value of a molecule. The diagram can opened in a new Window and saved     to a PNG format file.';
    let p11 = document.createElement("p");
    instructionsDiv.appendChild(p11);
    p10.textContent = "MXG supports the rendering of molecules with coordinates via 3DMol.js which is licensed under a     BSD-3-Clause license. For details of 3DMol.js please see the GitHub repository: ";
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let popButtonID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(popButtonDivId, $7e68913db756e51f$var$s_button);
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_dms.length > 0) {
            ...
            moleculeDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$bbdce6c921702068).xsi_typeOptions, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, doscm.getXsiType(), molecule.id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        ...
        if (xml_edms.length > 0) {
            ...
            if (xml_brs.length > 0) {
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, bids, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, br.value, molecule.id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        molstarDiv.id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, "molstar");
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.id);
        let moleculeDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)();
        ...
        let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.tagName, moleculeId);
        let buttonId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_button);
        // Create collapsible Molecule HTMLDivElement.
        let mcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeDivID, $7e68913db756e51f$var$s_container);
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, moleculeListDiv, null, moleculeDiv, (0, $ef5b9341e5193b70$export$3da9759ad07746a3).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        /*
                ...
                */ // Add edit ID button.
        let s_editID = $7e68913db756e51f$var$sy_edit + " ID";
        let editIDButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_editID, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, s_editID), $7e68913db756e51f$var$level1);
        /*
        //editIDButton.classList.add('edit-button');
        editIDButton.addEventListener('click', () => {
        //document.body.addEventListener('click', (event) => {
        //    if ((event.target as Element).classList.contains('edit-button')) {
                let newMoleculeId: string | null = prompt("Please enter molecule ID:");
                if (newMoleculeId != null) {
                    ...
                    let newEditIDButtonID = getID(contentDivId, s_editID);
                    editIDButton.id = newEditIDButtonID;
                    //editIDButton = document.getElementById(newEditIDButtonID) as HTMLButtonElement;
                }
          //  }
        });
        ...
        */ // Create a Map to store the data associated with each button.
        ...
        // Store the initial data in the Map.
        buttonData.set(editIDButton.id, {
            moleculeId: molecule.id,
            contentDivId: contentDivId
        });
        editIDButton.addEventListener("click", ()=>{
            // Look up the current data based on the button's ID.
            let data = buttonData.get(editIDButton.id);
            let newMoleculeId = prompt("Please enter molecule ID:");
            if (newMoleculeId != null) {
                ...
                $7e68913db756e51f$var$removeOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, data.moleculeId);
                molecule.id = mid;
                moleculeDiv.id = mid;
                let button = document.getElementById(buttonId);
                button.textContent = molecule.getLabel() + " " + $7e68913db756e51f$var$sy_upTriangle;
                contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.tagName, mid);
                //div.id = contentDivId;
                button.id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, $7e68913db756e51f$var$s_button);
        ...
        let clickHandler = function() {
            ...
            if (newMoleculeId != null) {
                ...
                editIDButton.removeEventListener('click', clickHandler);
                // Change the ID of the editIDButton.
                editIDButton.id = newEditIDButtonID;
                // Add a new event listener to the editIDButton with the new ID.
                editIDButton.addEventListener('click', clickHandler);
            }
        };
        ...
        */ moleculeDiv.appendChild(editIDButton);
        // Add edit description button.
        let s_editDescription = $7e68913db756e51f$var$sy_edit + " Description";
        let editDescriptionButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_editDescription, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(contentDivId, s_editDescription), $7e68913db756e51f$var$level1);
        editDescriptionButton.addEventListener("click", ()=>{
            let newDescription = prompt("Please enter molecule description:");
            if (newDescription != null) {
                molecule.setDescription(newDescription);
                let button = document.getElementById(buttonId);
                button.textContent = molecule.getLabel() + " " + $7e68913db756e51f$var$sy_upTriangle;
            }
        });
        moleculeDiv.appendChild(editDescriptionButton);
    /*
        // Atoms.
        let atomArrayDiv: HTMLDivElement = getCollapsibleDiv(moleculeId!, moleculeDiv, null, AtomArray.tagName, AtomArray.tagName,
            boundary1, level1);
        atomArrayDiv.appendChild(getAddAtomButton(molecule, atomArrayDiv, Atom.tagName, boundary1, level2));
        // Bonds.
        let bondArrayDiv: HTMLDivElement = getCollapsibleDiv(moleculeId!, moleculeDiv, null, BondArray.tagName, BondArray.tagName,
            level1);
        ...
        // Properties.
        let propertiesDiv: HTMLDivElement = getCollapsibleDiv(moleculeId!, moleculeDiv, null, Property.tagName, Property.tagName,
            level1);
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, typeID, boundary, level) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, "Add" + typeID + "Button"), level);
    button.addEventListener("click", ()=>{
        let attributes = new Map();
        let a = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)(attributes, molecule);
        let aID = molecule.getAtoms().addAtom(a);
        let aDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, aID);
 ...
 */ function $7e68913db756e51f$var$createProperty(xml, plDiv, molecule, boundary, level) {
    ...
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processProperty(p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processProperty(p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml, plDiv, boundary, level);
    else $7e68913db756e51f$var$processProperty(p, undefined, molecule, xml, plDiv, boundary, level);
    return p;
}
/**
 ...
 */ function $7e68913db756e51f$var$processElementType(a, aDiv, first, margin) {
    ...
    if (elementType == undefined) {
        ...
        selectTypes = $7e68913db756e51f$var$doSelectOption((0, $8677001474399221$export$692079bb871c6039).elementTypes, first);
 ...
 */ function $7e68913db756e51f$var$processCoordinates(a, aDiv, boundary) {
    $7e68913db756e51f$var$processCoordinate(aDiv, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, a.getX3.bind(a), a.setX3.bind(a), boundary);
    $7e68913db756e51f$var$processCoordinate(aDiv, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, a.getY3.bind(a), a.setY3.bind(a), boundary);
    $7e68913db756e51f$var$processCoordinate(aDiv, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, a.getZ3.bind(a), a.setZ3.bind(a), boundary);
}
/**
 ...
 * @param boundary The boundary.
 */ function $7e68913db756e51f$var$processCoordinate(aDiv, id, coordinate, getter, setter, boundary) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, boundary);
    aDiv.appendChild(div);
    let buttonTextContentSelected = coordinate + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = coordinate + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_button), boundary);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    let inputId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, coordinate, "Input");
    let value = getter();
    if (value == undefined) {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
    } else {
        $7e68913db756e51f$var$addCoordinate(div, inputId, value, setter, boundary);
 ...
 * @param boundary The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addCoordinate(div, id, value, setter, boundary) {
    let valueString;
 ...
 */ function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    let atomLabelbutton = createLabelButton(s_Atom_Labels, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, s_Atom_Labels), showAtomLabels, (newState)=>showAtomLabels = newState);
    viewerContainerDiv.appendChild(atomLabelbutton);
    // Bond Labels.
    let s_Bond_Labels = "Bond Labels";
    let bondLabelbutton = createLabelButton(s_Bond_Labels, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, s_Bond_Labels), showBondLabels, (newState)=>showBondLabels = newState);
    viewerContainerDiv.appendChild(bondLabelbutton);
    // Add a save button to save the viewer as an image.
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, $7e68913db756e51f$var$s_save), $7e68913db756e51f$var$boundary1);
    saveButton.addEventListener("click", ()=>{
 ...
 */ function $7e68913db756e51f$var$processProperty(p, units, molecule, element, plDiv, boundary, level) {
    // PropertyScalar.
    ...
    if (scalarNodes.length > 0) {
        ...
        p.setProperty(ps);
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), $7e68913db756e51f$var$boundary1, level, (event)=>{
            let target = event.target;
        ...
        input.addEventListener("change", (event)=>{
            ...
            ps = p.getProperty();
            ps.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
        ...
        $7e68913db756e51f$var$addAnyUnits(units, psAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
        ...
        if (arrayNodes.length > 0) {
            ...
            if (matrixNodes.length > 0) {
                ...
                /*
                let inputElement: HTMLTextAreaInputElement = inputDiv.querySelector('t') as HTMLInputElement;
                inputElement.value = inputString;
                ...
                */ let ta = inputDiv.querySelector("textarea");
                ...
                $7e68913db756e51f$var$addAnyUnits(units, pmAttributes, inputDiv, molecule.id + "_" + p.dictRef + "_Select_Units", p.dictRef, boundary, boundary);
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv, margin) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
        /*
        getCollapsibleDiv({
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$dcfd4302d04b7fb6).tagName);
        /*
            getCollapsibleDiv({
        ...
        if (xml_products.length > 0) {
            ...
            let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$264ad599d7cef668).tagName);
        /*
            getCollapsibleDiv({
                divToAddTo: reactionDiv,
                elementToInsertBefore: null,
        ...
        if (xml_transitionStates.length > 0) {
            ...
            let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$145c1ed87b1a2216).tagName);
        /*
            getCollapsibleDiv({
                divToAddTo: reactionDiv,
                elementToInsertBefore: null,
            ...
            if (xml_MCRCMethod.length > 1) throw new Error("Expecting 1 " + (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName + " but finding " + xml_MCRCMethod.length + "!");
                ...
                if (name == undefined || name == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                    ...
                    if (type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType || type == (0, $6f7aa7a716962086$export$191e95ebb11cc88).xsiType2) {
                        ...
                        let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(reaction.id, (0, $6f7aa7a716962086$export$6fa70ee10f356b6).tagName);
                    /*
                        getCollapsibleDiv({
                            divToAddTo: reactionDiv,
                            elementToInsertBefore: null,
        ...
        let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $6f7aa7a716962086$export$d2ae4167a30cf6bb).tagName, reaction.id);
    /*
        getCollapsibleDiv({
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    for(let i = 0; i < xml_conditionss.length; i++){
        ...
        $7e68913db756e51f$var$handleBathGases(conditions, conditionsDiv, i, xml_conditions, level, nextLevel);
        $7e68913db756e51f$var$handlePTs(conditions, conditionsDiv, i, xml_conditions, level, nextLevel);
...
function $7e68913db756e51f$var$handleBathGases(conditions, conditionsDiv, conditionsIndex, xml_conditions, level, nextLevel) {
    // Bath Gases
    let bathGasesDiv = document.createElement("div");
    conditionsDiv.appendChild(bathGasesDiv);
    let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    // Add collapsible div.
    /*
    getCollapsibleDiv({
    ...
    */ // Add add button.
    let addBathGasButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, undefined, nextLevel);
    ...
    addBathGasButton.addEventListener("click", ()=>{
        ...
        let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, bathGasIndex.toString());
    ...
    if (xml_conditions != null) {
        ...
        if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
            ...
            let bathGasIndex = conditions.addBathGas(bathGas);
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, bathGasIndex.toString());
            let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, nextLevel);
            let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas, false, id);
            div.appendChild(select);
            $7e68913db756e51f$var$addRemoveButton(div, $7e68913db756e51f$var$boundary1, (bathGas)=>{
                bathGasesDiv.removeChild(div);
                conditions.removeBathGas(bathGas);
            ...
            let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, nextLevel);
            let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, "0");
 ...
 * @param level 
 * @param nextLevel 
 */ function $7e68913db756e51f$var$handlePTs(conditions, conditionsDiv, conditionsIndex, xml_conditions, level, nextLevel) {
    // PTs
        ...
        if (xml_PTss.length > 0) {
            ...
            if (xml_PTpairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
                ...
                for(let i = 0; i < xml_PTpairs.length; i++){
                    ...
                    // Create pTpairDiv.
                    pTsDiv.append($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, conditionsIndex, i, moleculeKeys, nextLevel));
                }
            }
    ...
    // Add collapsible div.
    let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName);
    /*
    getCollapsibleDiv({
        divToAddTo: conditionsDiv,
        elementToInsertBefore: null,
    ...
    */ // Create a buttons div for the add, add from spreadsheet and remove all buttons.
    ...
    addButton.addEventListener("click", ()=>{
        ...
        pTsDiv.insertBefore($7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDiv.id, conditionsIndex, pTpairIndex, moleculeKeys, nextLevel), pTsButtonsDiv);
    });
            ...
            if (input.value.length > 0) {
                ...
                for(let i = 1; i < pTpairsArray.length; i++){
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName)) {
                        ...
                        pTpair.setExperimentalRate(new (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b)(new Map(), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(experimentalRate)));
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName)) {
                        ...
                        pTpair.setExperimentalYield(new (0, $ae74a7b44a6504a1$export$c291f4faacd745a6)(new Map(), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(experimentalYield)));
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName)) {
                        ...
                        pTpair.setExperimentalEigenvalue(new (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1)(new Map(), new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(experimentalEigenvalue)));
 ...
 */ function $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv, level, nextLevel) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        $7e68913db756e51f$var$handleBathGases(conditions, conditionsDiv, i, null, level, nextLevel);
        $7e68913db756e51f$var$handlePTs(conditions, conditionsDiv, i, null, level, nextLevel);
        // Add a remove conditions button.
 ...
 */ function $7e68913db756e51f$var$addConditions(attributes, conditionsDiv, elementToInsertBefore, conditionssDiv, i) {
    ...
    let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, i.toString());
    /*
    getCollapsibleDiv({
 ...
 */ function $7e68913db756e51f$var$addPercentExcessReactantConc(pTpairDiv, pTpair, conditionsIndex, pTIndex) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $7e68913db756e51f$var$s_button), $7e68913db756e51f$var$boundary1);
    div.appendChild(button);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
 ...
 */ function $7e68913db756e51f$var$addControl(attributes, controlDiv, elementToInsertBefore, controlsDiv, i) {
    ...
    let contentDivId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, i.toString());
    /*
    getCollapsibleDiv({
...
//# sourceMappingURL=index.df280865.js.map
