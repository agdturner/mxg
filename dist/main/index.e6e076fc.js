...
function $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, mIDM, molecules) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            // Property scalar number.
            (0, $01410cda1eef5011$export$742f9ce317ef8ba3).propertyDictRefs.forEach(function(dictRef) {
                console.log("dictRef=" + dictRef);
                $174b37a7f81f9b54$var$addPropertyScalar(molecule, mIDM, plDiv, pl, dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            });
            // Property array .
            (0, $01410cda1eef5011$export$9f93a3fdf2490572).propertyDictRefs.forEach(function(dictRef) {
                console.log("dictRef=" + dictRef);
                $174b37a7f81f9b54$var$addPropertyArray(false, molecule, mIDM, plDiv, pl, dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
            });
            // Property matrix.
            (0, $01410cda1eef5011$export$a5a2be813176eb0e).propertyDictRefs.forEach(function(dictRef) {
                console.log("dictRef=" + dictRef);
                $174b37a7f81f9b54$var$addPropertyMatrix(false, molecule, mIDM, plDiv, pl, dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).hessianUnits);
            });
            // Update properties from XML.
            let zpe = pl.getProperty((0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef);
            let zpeValue = zpe.getProperty();
            console.log("ZPE=" + zpeValue.getValue());
...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        for(let j = 0; j < xml_ps.length; j++){
            ...
            let p = $174b37a7f81f9b54$var$createProperty(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        //pl.setProperty(p);
        }
 ...
 */ function $174b37a7f81f9b54$var$createProperty(pl, xml, plDiv, molecule, mIDM, boundary, level) {
...
function $7e68913db756e51f$export$17d48ee8ddbf2d44(id, tIDM, name, getter, setter, remover, marginComponent, margin) {
    ...
    let tid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, name);
    let idb = tIDM.addID(tid, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, idb, marginComponent);
    div.appendChild(button);
    ...
    let inputId = tIDM.addID(tid, $7e68913db756e51f$export$58785e0018b77d4a);
    let value = getter();
    if (value == undefined) {
        button.textContent = buttonTextContentDeselected;
...
//# sourceMappingURL=index.e6e076fc.js.map
