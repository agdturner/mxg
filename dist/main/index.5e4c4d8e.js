     ...
     */ parse(xml) {
        ...
        */ // Process the XML "molecule" elements.
        ...
        for(let i = 0; i < xml_msl; i++){
            ...
            let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(attributes, mID);
            molecules.set(mID, m);
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    lmb.addEventListener("click", async (event)=>{
        ...
        ms.forEach((v, k)=>{
            $7e68913db756e51f$var$libmols.set(k, v);
        });
    });
 ...
 */ function $7e68913db756e51f$var$processMoleculeList(xml) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (mID == undefined) throw new Error((0, $ef5b9341e5193b70$export$3da9759ad07746a3).s_id + " is undefined");
        let m = new (0, $ef5b9341e5193b70$export$3da9759ad07746a3)(attributes, mID);
        $7e68913db756e51f$var$molecules.set(mID, m);
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, null, mDiv, mID, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        // Create a set of molecule tag names.
        let moleculeTagNames = new Set();
        let cns = xml_ms[i].childNodes;
        //console.log("cns.length=" + cns.length);
        ...
        // Description
        mDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(m.getID(), $7e68913db756e51f$var$s_description), m.getDescription.bind(m), m.setDescription.bind(m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Init metadataList.
        //console.log("Init metadataList.");
        let xml_mls = xml_ms[i].getElementsByTagName((0, $288a4469bea65e97$export$3e18a603070a78a).tagName);
        if (xml_mls.length > 0) {
        ...
        let xml_as = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName);
        for(let j = 0; j < xml_as.length; j++)aaDiv.appendChild($7e68913db756e51f$var$addAtom(m, aa, new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        ...
        for(let j = 0; j < xml_bs.length; j++){
            ...
            if (b_attributes.has((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_id)) baDiv.appendChild($7e68913db756e51f$var$addBond(m, m.getAtoms().atoms, ba, new (0, $ef5b9341e5193b70$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        }
        ...
        baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(m, mID, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        moleculeTagNames.delete((0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName);
        ...
        pap.forEach(function(dictRef) {
            ...
            let attributes = new Map();
            attributes.set((0, $ef5b9341e5193b70$export$41b04b3a73e7216d).s_dictRef, dictRef);
            if (dictRef == "me:Hf0") {
                let vs = "";
                if ($7e68913db756e51f$var$defaults != undefined) vs = $7e68913db756e51f$var$defaults.values.get(dictRef) ?? "";
                let value;
                try {
                    value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(vs);
                } catch (e) {
                    value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))("0");
                }
                let s_attributes = new Map();
                s_attributes.set("units", "kJ/mol");
                let ps = new (0, $ef5b9341e5193b70$export$742f9ce317ef8ba3)(s_attributes, value);
                let p = new (0, $ef5b9341e5193b70$export$90bccbae54bb6d4f)(attributes, ps);
                let iDs = new Set();
                //attributes.set(Hf0.s_units, "kJ/mol");
                $7e68913db756e51f$var$addPropertyScalarNumber(s_attributes, iDs, value, (0, $8677001474399221$export$692079bb871c6039).energyUnits, pl, p, plDiv, $7e68913db756e51f$var$boundary1);
                pl.setProperty(p);
            /*
        ...
        if (xml_dms.length > 0) {
            if (xml_dms.length > 1) throw new Error("Expecting 1 or 0 " + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + " but finding " + xml_dms.length + "!");
            let doscm = new (0, $ef5b9341e5193b70$export$bbdce6c921702068)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_dms[0]));
            mDiv.appendChild((0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, (0, $ef5b9341e5193b70$export$bbdce6c921702068).xsi_typeOptions, (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName, doscm.getXsiType(), m.getID(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName);
        }
        // Organise DistributionCalcMethod. (Output only)
        let xml_dcms = xml_ms[i].getElementsByTagName((0, $ef5b9341e5193b70$export$3f9657e7f71262a).tagName);
        ...
        if (xml_dosl.length > 0) {
            ...
            if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $ef5b9341e5193b70$export$126b026a4280c589).tagName + " but finding 0!");
                ...
                $7e68913db756e51f$var$addSaveAsCSVButton(dosl.toCSV, doslDiv, t, mID + "_" + (0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName, $7e68913db756e51f$var$level1);
            }
            moleculeTagNames.delete((0, $ef5b9341e5193b70$export$dcce836c71a83df).tagName);
        }
        ...
        if (xml_tts.length > 0) {
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                ttDiv.appendChild(t);
                tt.init(tvs);
                $7e68913db756e51f$var$addSaveAsCSVButton(tt.toCSV.bind(tt), ttDiv, t, mID + "_" + (0, $ef5b9341e5193b70$export$96f29f03cf201f97).tagName, $7e68913db756e51f$var$level1);
            }
            m.setThermoTable(tt);
        ...
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            ...
            if (xml_brs.length > 0) {
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, bids, (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, br.value, m.getID(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, moleculeId, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
        ...
        // Description
        moleculeDiv.appendChild($7e68913db756e51f$var$processDescription($7e68913db756e51f$var$addRID(molecule.getID(), $7e68913db756e51f$var$s_description), molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
        // Create collapsible AtomArray HTMLDivElement.
        ...
        baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let options = Array.from($7e68913db756e51f$var$libmols.keys());
        if (options.length == 0) {
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = $7e68913db756e51f$var$libmols.get(mID);
            ...
            // Create collapsible Molecule HTMLDivElement.
            let mcDivID = $7e68913db756e51f$var$addRID(moleculeDivID, $7e68913db756e51f$var$s_container);
            let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, moleculeDiv, molecule.getID(), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Add the molecule to the BathGas select elements.
            $7e68913db756e51f$var$addOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, molecule.getID());
            // Add edit Name button.
            $7e68913db756e51f$var$addEditIDButton(molecule, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), moleculeDiv, $7e68913db756e51f$var$level1);
            ...
            if (aa != undefined) aa.atoms.forEach((a)=>{
                aaDiv.appendChild($7e68913db756e51f$var$addAtom(molecule, molecule.getAtoms(), a, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
            aaDiv.appendChild($7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            // Create collapsible BondArray HTMLDivElement.
            let baDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$746fba2e30d93fe6).tagName);
            ...
            if (ba != undefined) molecule.getBonds().bonds.forEach((b)=>{
                ...
                baDiv.appendChild($7e68913db756e51f$var$addBond(molecule, aa.atoms, molecule.getBonds(), b, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            });
            baDiv.appendChild($7e68913db756e51f$var$getAddBondButton(molecule, molecule.getID(), baDiv, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1));
            $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            // Create collapsible Properties HTMLDivElement.
            let plDivID = $7e68913db756e51f$var$addRID(moleculeDivID, (0, $ef5b9341e5193b70$export$4e0d1ad7ad6a0802).tagName);
            let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
 ...
 */ function $7e68913db756e51f$var$addEditIDButton(molecule, button, moleculeDiv, level) {
    ...
    editNameButton.addEventListener("click", ()=>{
        ...
        if (newMoleculeId != null) {
            let mid = $7e68913db756e51f$var$addRID(newMoleculeId) // This ensures that all special chars are handled.
            ;
            ...
            $7e68913db756e51f$var$removeOptionByClassName((0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, omid);
            $7e68913db756e51f$var$molecules.set(mid, molecule);
            $7e68913db756e51f$var$molecules.delete(molecule.getID());
            molecule.setID(mid);
            moleculeDiv.id = mid;
            button.textContent = newMoleculeId + " " + (0, $f0396edd0a5c99f7$export$e5e81646ee331a9e);
        }
    //}
    });
}
 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, aaDiv, typeID, boundary, level) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, $7e68913db756e51f$var$addRID(molecule.getID(), "Add" + typeID + "Button"), level);
    button.addEventListener("click", ()=>{
        let attributes = new Map();
        let a = new (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb)(attributes, molecule);
        //let aID: string = molecule.getAtoms().addAtom(a);
        aaDiv.insertBefore($7e68913db756e51f$var$addAtom(molecule, molecule.getAtoms(), a, boundary, level), button);
    });
    return button;
}
function $7e68913db756e51f$var$addMetadata(m, md, ml, mdDivID, boundary, level) {
    ...
    mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(m.getID(), $7e68913db756e51f$var$boundary1));
    return mdDiv;
}
/**
 * Adds an atom.
 ...
 */ function $7e68913db756e51f$var$addAtom(molecule, aa, a, boundary, level) {
    let aID = aa.addAtom(a, a.getID());
    let aDivID = $7e68913db756e51f$var$addRID(molecule.getID(), aID);
 ...
 */ function $7e68913db756e51f$var$removeAtom(molecule, id, aIDs) {
    ...
    $7e68913db756e51f$var$removeOptionByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2, id);
}
/**
 ...
 * @param level The margin for the div.
 * @returns The add bond button.
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, baDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        baDiv.insertBefore($7e68913db756e51f$var$addBond(molecule, atoms, molecule.getBonds(), b, boundary, level), button);
    });
 ...
 */ function $7e68913db756e51f$var$addBond(molecule, atoms, ba, b, boundary, level) {
    let bID = ba.addBond(b, b.getID());
    let bDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.getID(), bID);
 ...
 */ function $7e68913db756e51f$var$processNumber(id, iDs, name, getter, setter, remover, marginComponent, margin) {
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addNumber(div, inputId, name, value, setter, marginComponent);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
    }
    // Add event listener for the button.
 ...
 * @param boundary The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addNumber(div, id, name, value, setter, boundary) {
    let valueString;
    if (value == undefined) valueString = "";
 ...
 */ function $7e68913db756e51f$var$create3DViewer(molecule, moleculeDiv, boundary, level) {
    ...
    let viewerContainerDivID = $7e68913db756e51f$var$addRID(molecule.getID(), "viewerContainer");
    ...
    let viewerDivID = $7e68913db756e51f$var$addRID(molecule.getID(), "viewer");
    ...
    let atomLabelbutton = createLabelButton(s_Atom_Labels, $7e68913db756e51f$var$addRID(molecule.getID(), s_Atom_Labels), showAtomLabels, (newState)=>showAtomLabels = newState);
    viewerContainerDiv.appendChild(atomLabelbutton);
    // Bond Labels.
    let s_Bond_Labels = "Bond Labels";
    let bondLabelbutton = createLabelButton(s_Bond_Labels, $7e68913db756e51f$var$addRID(molecule.getID(), s_Bond_Labels), showBondLabels, (newState)=>showBondLabels = newState);
    viewerContainerDiv.appendChild(bondLabelbutton);
    // Add a save button to save the viewer as an image.
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", $7e68913db756e51f$var$addRID(molecule.getID(), $7e68913db756e51f$var$s_save), $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let etmdivID = $7e68913db756e51f$var$addRID(molecule.getID(), (0, $ef5b9341e5193b70$export$499950da20810ac9).tagName);
 ...
 */ function $7e68913db756e51f$var$processReactionList(xml) {
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_tunneling.length > 0) {
            ...
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).options, "Tunneling", tunneling.getName(), $7e68913db756e51f$var$addID(reactionDivID, (0, $6f7aa7a716962086$export$c3cf6f96dac11421).tagName), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
            lws.querySelector("select")?.addEventListener("change", (event)=>{
                let target = event.target;
 ...
 */ function $7e68913db756e51f$var$handleBathGases(conditions, cDiv, xml_conditions) {
    ...
    addBathGasButton.addEventListener("click", ()=>{
        ...
        let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas, true, id);
    ...
    if (xml_conditions != null) {
        ...
        if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
            ...
            div.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas, false, id));
            $7e68913db756e51f$var$addRemoveButton(div, $7e68913db756e51f$var$boundary1, (bathGas)=>{
                bsDiv.removeChild(div);
            ...
            div.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), undefined, false, id));
            $7e68913db756e51f$var$addRemoveButton(div, $7e68913db756e51f$var$boundary1, (bathGas)=>{
                bsDiv.removeChild(div);
                $7e68913db756e51f$var$conditionsIDs.removeID(id);
                conditions.removeBathGas(bathGas);
 ...
 */ function $7e68913db756e51f$var$createBathGasSelectElement(id, pTpair, bathGas, first) {
    ...
    let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas, first, id);
    //select.id = id;
    select.addEventListener("change", (event)=>{
        let target = event.target;
 ...
 */ function $7e68913db756e51f$var$processGrainSize(mps, xml_mps, mpsDiv) {
    ...
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, $7e68913db756e51f$var$addID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    div.appendChild(button);
                ...
                if (orders.has(productsLabel)) {
                    ...
                    if (reactionTransitionStates != undefined) {
                        reactionTransitionStates.forEach(function(ts) {
                            ...
                            orders.set(ref, i);
                            energy = $7e68913db756e51f$var$molecules.get(ref)?.getEnergy() ?? $7e68913db756e51f$var$big0;
                            energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                            energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
...
export {$7e68913db756e51f$export$819b5ff7dff3652c as setNumberArrayNode, $7e68913db756e51f$export$b1e4cbf5b56e0e21 as setNumberNode};
//# sourceMappingURL=index.5e4c4d8e.js.map
