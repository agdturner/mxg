...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_mls.length > 0) {
            ...
            // Create collapsible MetadataList HTMLDivElement.
            let mlDivID = mIDM.addID(mDivID, (0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName);
            let mlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mlDivID);
            let mlcDivID = mIDM.addID(mlDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            ...
            for(let j = 0; j < xml_ms.length; j++){
                // Create a new Metadata.
                let md = new (0, $97ed023cfe5af5b8$export$e7adebdc1ebd2fed)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ms[j]));
                mlDiv.appendChild($174b37a7f81f9b54$var$addMetadata(m, md, ml, mIDM.addID(mlDivID, j), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            }
            moleculeTagNames.delete((0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName);
        }
        // Init atoms.
...
//# sourceMappingURL=index.c22d8ea2.js.map
