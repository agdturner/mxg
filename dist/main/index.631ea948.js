 ...
 */ function $f0396edd0a5c99f7$export$cd7f480d6b8286c3(id) {
    ...
    else console.warn("remove: id=" + id + " not found.");
}
function $f0396edd0a5c99f7$export$8b2cd46c11844202({ content: content, buttonLabel: buttonLabel, buttonFontSize: buttonFontSize = "", level: level = {
    marginLeft: "",
    marginTop: "",
    marginBottom: ""
...
function $f0396edd0a5c99f7$export$d80fffb1deb3b97e(type, id, boundary, func, value, labelText) {
...
function $f0396edd0a5c99f7$export$9dd922ab8346623d(type, id, boundary, onchange, inputString, label) {
    let inputDiv = $f0396edd0a5c99f7$export$d80fffb1deb3b97e(type, id, boundary, onchange, inputString, label);
    let inputElement = inputDiv.querySelector("input");
    inputElement.value = inputString;
    $f0396edd0a5c99f7$export$d43d96a9a8ad3e51(inputElement);
    return inputDiv;
}
...
function $f0396edd0a5c99f7$export$16861bfc2f6300b2(options, name, id, boundary) {
...
function $f0396edd0a5c99f7$export$78253536c0178a32(boundary) {
...
class $ae74a7b44a6504a1$export$3fe97ecb6b172244 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ getExcessReactantConc() {
        if (this.attributes != undefined) return this.attributes.get("excessReactantConc");
    }
    /**
     * this.attributes.set("excessReactantConc", excessReactantConc).
     */ setExcessReactantConc(excessReactantConc) {
        if (this.attributes != undefined) this.attributes.set("excessReactantConc", excessReactantConc);
    }
    /**
     * @returns this.attributes.get("percentExcessReactantConc").
     */ getPercentExcessReactantConc() {
        if (this.attributes != undefined) return this.attributes.get("percentExcessReactantConc");
    }
    /**
     ...
     */ setPercentExcessReactantConc(percentExcessReactantConc) {
        if (this.attributes != undefined) this.attributes.set("percentExcessReactantConc", percentExcessReactantConc);
    }
}
...
class $b6873406fb778c0b$export$f0bfd84d03c3a22d extends (0, $cc8c7201a9bad777$export$8f67221c6fb2ad09) {
    static{
        /**
     * The tag name.
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $b6873406fb778c0b$export$f0bfd84d03c3a22d.tagName, value);
    }
}
...
let $7e68913db756e51f$var$addFromSpreadsheetString = "Add from spreadsheet";
/**
...
let $7e68913db756e51f$var$unitsPressure = [
    "Torr",
    "PPCC",
    "atm",
    "mbar",
 ...
 */ document.addEventListener("DOMContentLoaded", (event)=>{
    ...
    loadButton.addEventListener("click", $7e68913db756e51f$var$loadXML);
    // Create save button
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    if (xml_title.length != 1) throw new Error("Multiple " + (0, $8677001474399221$export$f99233281efd08a0).tagName + " tags found");
        ...
        (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(titleId);
        // Create input element.
        let titleDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", titleId, $7e68913db756e51f$var$boundary1, (event)=>{
        ...
        input.style.fontSize = $7e68913db756e51f$var$fontSize1;
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input, 0);
        // Insert.
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(moleculesDivId);
    if (moleculesElement == null) ;
    else {
        let moleculesDiv = $7e68913db756e51f$var$processMoleculeList(xml);
        moleculesDiv.id = moleculesDivId;
        moleculesElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
        ...
        $7e68913db756e51f$var$mesmer.setMoleculeList(new (0, $8677001474399221$export$19d70f3647dee606)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(moleculesDiv), Array.from($7e68913db756e51f$var$molecules.values())));
    }
    // Reactions.
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(reactionsDivId);
    if (reactionsElement == null) ;
    else {
        let reactionsDiv = $7e68913db756e51f$var$processReactionList(xml);
        reactionsDiv.id = reactionsDivId;
        reactionsElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(conditionsDivId);
    if (conditionsElement == null) ;
    else {
        let conditionsDiv = $7e68913db756e51f$var$processConditions(xml);
        conditionsDiv.id = conditionsDivId;
        conditionsElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(modelParametersDivId);
    if (modelParametersElement == null) ;
    else {
        let modelParametersDiv = $7e68913db756e51f$var$processModelParameters(xml);
        modelParametersDiv.id = modelParametersDivId;
        modelParametersElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
    ...
    (0, $f0396edd0a5c99f7$export$cd7f480d6b8286c3)(controlDivId);
    if (controlElement == null) ;
    else {
        let controlDiv = $7e68913db756e51f$var$processControl(xml);
        controlDiv.id = controlDivId;
        controlElement.appendChild((0, $f0396edd0a5c99f7$export$8b2cd46c11844202)({
            content: controlDiv,
            buttonLabel: "Control",
            buttonFontSize: $7e68913db756e51f$var$fontSize1,
            level: $7e68913db756e51f$var$level0,
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_ExtraDOSCMethod.length > 0) {
            ...
            if (xml_bondRefs.length > 0) {
                ...
                let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(bondIds, bondRef.value, molecule.id + "_" + (0, $ef5b9341e5193b70$export$aef8e5ad5552fd72).tagName, $7e68913db756e51f$var$boundary1);
                selectElement.addEventListener("change", (event)=>{
                    if (event.target instanceof HTMLSelectElement) {
                        bondRef.value = event.target.value;
                        (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(event.target);
                    }
                });
            ...
            if (xml_hinderedRotorPotentials.length > 0) {
                ...
                hinderedRotorPotentialCollapsibleDiv.style.marginTop = $7e68913db756e51f$var$margin1;
                hinderedRotorPotentialCollapsibleDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
                extraDOSCMethodDiv.appendChild(hinderedRotorPotentialCollapsibleDiv);
                // Formats
                let formatLabel = document.createElement("label");
                formatLabel.style.marginLeft = $7e68913db756e51f$var$margin100;
                formatLabel.style.marginTop = $7e68913db756e51f$var$margin1;
                formatLabel.style.marginBottom = $7e68913db756e51f$var$margin1;
                formatLabel.textContent = "Format: ";
                hinderedRotorPotentialDiv.appendChild(formatLabel);
                let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).formats, hinderedRotorPotential.format, molecule.id + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$boundary1);
                selectElement.addEventListener("change", (event)=>{
                    if (event.target instanceof HTMLSelectElement) {
                ...
                unitsLabel.style.marginLeft = $7e68913db756e51f$var$margin2;
                unitsLabel.style.marginTop = $7e68913db756e51f$var$margin1;
                unitsLabel.style.marginBottom = $7e68913db756e51f$var$margin1;
                hinderedRotorPotentialDiv.appendChild(unitsLabel);
                $7e68913db756e51f$var$addAnyUnits((0, $ef5b9341e5193b70$export$9b8e857b9a081d2).units, hinderedRotorPotentialAttributes, hinderedRotorPotentialDiv, molecule.id + "_" + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
                // Add expansionSize.
                let expansionSizeLabel = document.createElement("label");
                expansionSizeLabel.style.marginLeft = $7e68913db756e51f$var$margin2;
                expansionSizeLabel.style.marginTop = $7e68913db756e51f$var$margin1;
                expansionSizeLabel.style.marginBottom = $7e68913db756e51f$var$margin1;
                ...
                expansionSizeInputElement.style.marginLeft = $7e68913db756e51f$var$margin2;
                expansionSizeInputElement.style.marginTop = $7e68913db756e51f$var$margin1;
                expansionSizeInputElement.style.marginBottom = $7e68913db756e51f$var$margin1;
                expansionSizeInputElement.id = molecule.id + "_" + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName + "_expansionSize";
                expansionSizeInputElement.addEventListener("change", (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        // Check the input is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) hinderedRotorPotential.setExpansionSize(parseInt(event.target.value));
                        else {
                ...
                useSineTermsLabel.style.marginLeft = $7e68913db756e51f$var$margin2;
                useSineTermsLabel.style.marginTop = $7e68913db756e51f$var$margin1;
                useSineTermsLabel.style.marginBottom = $7e68913db756e51f$var$margin1;
                ...
                useSineTermsInput.style.marginLeft = $7e68913db756e51f$var$margin2;
                useSineTermsInput.style.marginTop = $7e68913db756e51f$var$margin1;
                useSineTermsInput.style.marginBottom = $7e68913db756e51f$var$margin1;
                useSineTermsInput.id = molecule.id + "_" + (0, $ef5b9341e5193b70$export$bbdce6c921702068).tagName + "_" + (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).tagName + "_useSineTerms";
                ...
                for(let k = 0; k < xml_potentialPoints.length; k++){
                    ...
                    let potentialPointDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)({
                        marginLeft: $7e68913db756e51f$var$margin125,
                        marginTop: $7e68913db756e51f$var$margin1,
                        marginBottom: $7e68913db756e51f$var$margin1
                    });
                    ...
                    angleInputElement.style.marginLeft = $7e68913db756e51f$var$margin2;
                    angleInputElement.style.marginTop = $7e68913db756e51f$var$margin1;
                    angleInputElement.style.marginBottom = $7e68913db756e51f$var$margin1;
                    angleInputElement.id = molecule.id + "_" + (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName + "_angle";
                    angleInputElement.addEventListener("change", (event)=>{
                        if (event.target instanceof HTMLInputElement) {
                            // Check the input is a number.
                            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) potentialPoint.setAngle(parseFloat(event.target.value));
                            else {
                                // Reset the input to the current value.
                    ...
                    potentialLabel.style.marginLeft = $7e68913db756e51f$var$margin2;
                    potentialLabel.style.marginTop = $7e68913db756e51f$var$margin1;
                    potentialLabel.style.marginBottom = $7e68913db756e51f$var$margin1;
                    ...
                    potentialInputElement.style.marginLeft = $7e68913db756e51f$var$margin2;
                    potentialInputElement.style.marginTop = $7e68913db756e51f$var$margin1;
                    potentialInputElement.style.marginBottom = $7e68913db756e51f$var$margin1;
                    potentialInputElement.type = "number";
                    potentialInputElement.id = molecule.id + "_" + (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).tagName + "_potential";
                    potentialInputElement.addEventListener("change", (event)=>{
                        if (event.target instanceof HTMLInputElement) {
                            // Check the input is a number.
                            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) potentialPoint.setPotential(parseFloat(event.target.value));
                            else {
                                // Reset the input to the current value.
            ...
            if (xml_periodicities.length > 0) {
                ...
                container.style.marginBottom = $7e68913db756e51f$var$margin1;
                let label = document.createElement("label");
                label.textContent = (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName + ": ";
                container.appendChild(label);
                // Create a new div element for the input.
                let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", molecule.id + "_" + (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName, $7e68913db756e51f$var$boundary1, (event)=>{
        ...
        if (xml_ReservoirSize.length > 0) {
            ...
            container.style.marginBottom = $7e68913db756e51f$var$margin1;
            let label = document.createElement("label");
            label.textContent = (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName + ": ";
            container.appendChild(label);
            // Create a new div element for the input.
            let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", molecule.id + "_" + (0, $ef5b9341e5193b70$export$97850fe2f2906f00).tagName, $7e68913db756e51f$var$boundary1, (event)=>{
                if (event.target instanceof HTMLInputElement) {
 ...
 */ function $7e68913db756e51f$var$processProperty(p, units, molecule, element, moleculeDiv, margin) {
    ...
    if (scalarNodes.length > 0) {
        ...
        let label = p.dictRef;
        // Create a new div element for the input.
        let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", molecule.id + "_" + p.dictRef, $7e68913db756e51f$var$boundary1, (event)=>{
        ...
        if (arrayNodes.length > 0) {
            ...
            let label = p.dictRef;
            // Create a new div element for the input.
            let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", molecule.id + "_" + p.dictRef, $7e68913db756e51f$var$boundary1, (event)=>{
 ...
 */ function $7e68913db756e51f$var$getUnitsSelectElement(units, attributes, id, tagOrDictRef) {
    ...
    if (psUnits != undefined) {
        ...
        let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(units, "Units", id, $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processDOSCMethod(dOSCMethod, molecule, margin, moleculeDiv) {
    ...
    let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(options, "DOSCMethod", molecule.id + "_" + "Select_DOSCMethod", $7e68913db756e51f$var$boundary1);
 ...
 */ function $7e68913db756e51f$var$processEnergyTransferModel(etm, molecule, element, moleculeDiv, margin) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1, (event)=>{
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_reactants.length > 0) {
            ...
            for(let j = 0; j < xml_reactants.length; j++){
                ...
                let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(options, "Role", molecule.ref + "_" + "Select_Role", $7e68913db756e51f$var$boundary1);
        ...
        if (xml_tunneling.length > 0) {
            ...
            let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(options, "Tunneling", reaction.id + "_" + "Select_Tunneling", $7e68913db756e51f$var$boundary1);
            // Set the initial value.
 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    addBathGasButton.addEventListener("click", ()=>{
        ...
        $7e68913db756e51f$var$conditions.addBathGas(bathGas);
        let containerDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)({
            marginLeft: $7e68913db756e51f$var$margin50,
            marginTop: $7e68913db756e51f$var$margin1,
            marginBottom: $7e68913db756e51f$var$margin1
        });
        ...
        let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(Array.from(moleculeIDs), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$boundary1);
        // Set the initial value.
        ...
        selectElement.addEventListener("change", (event)=>{
            if (event.target instanceof HTMLSelectElement) {
                ...
                console.log("Added " + event.target.value + " as a " + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
                (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(event.target);
            }
        });
        ...
        removeButton.addEventListener("click", ()=>{
            ...
            $7e68913db756e51f$var$conditions.removeBathGas(bathGas);
        });
    ...
    if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
        ...
        selectElement.addEventListener("change", (event)=>{
            if (event.target instanceof HTMLSelectElement) {
                bathGas.value = event.target.value;
                console.log("Set " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName + " to " + event.target.value);
                (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(event.target);
            }
        });
        (0, $f0396edd0a5c99f7$export$fdd146df37959fe8)(selectElement);
        containerDiv.style.marginLeft = $7e68913db756e51f$var$margin50;
        containerDiv.style.marginTop = $7e68913db756e51f$var$margin1;
        containerDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
        containerDiv.appendChild(selectElement);
        // Add a remove button.
        let removeButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$removeString, $7e68913db756e51f$var$boundary1);
        removeButton.addEventListener("click", ()=>{
    ...
    addButton.addEventListener("click", ()=>{
        ...
        let pTPairDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)({
            marginLeft: $7e68913db756e51f$var$margin50,
            marginTop: $7e68913db756e51f$var$margin1,
            marginBottom: $7e68913db756e51f$var$margin1
        });
        ...
        $7e68913db756e51f$var$addAnyUnits(undefined, pTPairAttributes, pTPairDiv, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    ...
    let addMultipleButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$addFromSpreadsheetString, $7e68913db756e51f$var$boundary1);
    ...
    addMultipleButton.addEventListener("click", ()=>{
        ...
        let inputDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)({
            marginLeft: $7e68913db756e51f$var$margin50,
            marginTop: $7e68913db756e51f$var$margin1,
            marginBottom: $7e68913db756e51f$var$margin1
        });
        ...
        inputElement.style.marginLeft = $7e68913db756e51f$var$margin50;
        inputElement.style.marginTop = $7e68913db756e51f$var$margin1;
        inputElement.style.marginBottom = $7e68913db756e51f$var$margin1;
        ...
        if (xml_PTPairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
            ...
            for(let i = 0; i < xml_PTPairs.length; i++){
                ...
                if (xml_bathGass.length > 0) {
                    ...
                    // Get the ids of all the molecules.
                    let moleculeIDs = new Set($7e68913db756e51f$var$molecules.keys());
                    let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(Array.from(moleculeIDs), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$boundary1);
                    // Set the initial value.
                    selectElement.value = bathGas.value;
                    // Add event listener to selectElement.
                    selectElement.addEventListener("change", (event)=>{
                ...
                $7e68913db756e51f$var$addP(pTPairDiv, pTPair);
                $7e68913db756e51f$var$addT(pTPairDiv, pTPair);
                $7e68913db756e51f$var$addAnyUnits(undefined, (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_PTPairs[i]), pTPairDiv, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
                $7e68913db756e51f$var$addExcessReactantConc(pTPairDiv, pTPair);
                $7e68913db756e51f$var$addPercentExcessReactantConc(pTPairDiv, pTPair);
                $7e68913db756e51f$var$addPrecision(pTPairDiv, pTPair);
                $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair);
 ...
 */ function $7e68913db756e51f$var$addP(containerDiv, pTPair) {
    let pInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + "P", $7e68913db756e51f$var$boundary1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
 ...
 */ function $7e68913db756e51f$var$addT(containerDiv, pTPair) {
    let tInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + "T", $7e68913db756e51f$var$boundary1, (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
 ...
 */ function $7e68913db756e51f$var$addExcessReactantConc(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", ()=>{
        ...
        excessReactantConcInput.style.marginLeft = $7e68913db756e51f$var$margin2;
        excessReactantConcInput.style.marginTop = $7e68913db756e51f$var$margin1;
        excessReactantConcInput.style.marginBottom = $7e68913db756e51f$var$margin1;
 ...
 */ function $7e68913db756e51f$var$addPercentExcessReactantConc(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", ()=>{
        ...
        percentExcessReactantConcInput.style.marginLeft = $7e68913db756e51f$var$margin2;
        percentExcessReactantConcInput.style.marginTop = $7e68913db756e51f$var$margin1;
        percentExcessReactantConcInput.style.marginBottom = $7e68913db756e51f$var$margin1;
 ...
 */ function $7e68913db756e51f$var$addPrecision(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", ()=>{
        ...
        precisionInput.style.marginLeft = $7e68913db756e51f$var$margin2;
        precisionInput.style.marginTop = $7e68913db756e51f$var$margin1;
        precisionInput.style.marginBottom = $7e68913db756e51f$var$margin1;
 ...
 */ function $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", ()=>{
        ...
        // Get the ids of all the molecules.
        let moleculeIDs = new Set($7e68913db756e51f$var$molecules.keys());
        let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)(Array.from(moleculeIDs), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName + "_" + (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName, $7e68913db756e51f$var$boundary1);
        // Set the initial value.
        selectElement.value = bathGas.value;
        // Add event listener to selectElement.
        selectElement.addEventListener("change", (event)=>{
 ...
 */ function $7e68913db756e51f$var$addExperimentRateButton(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", ()=>{
        ...
        experimentRateLabel.textContent = (0, $ae74a7b44a6504a1$export$ea088383ce76fc5a).tagName + ": ";
        experimentRateDiv.appendChild(experimentRateLabel);
        // Create a new div element for the input.
        let id = (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + (0, $ae74a7b44a6504a1$export$ea088383ce76fc5a).tagName;
        let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id, $7e68913db756e51f$var$boundary1, (event)=>{
 ...
 */ function $7e68913db756e51f$var$processModelParameters(xml) {
    ...
    let xml_grainSizes = xml_modelParameters.getElementsByTagName((0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName);
    if (xml_grainSizes.length > 0) {
        if (xml_grainSizes.length > 1) throw new Error("Expecting 1 " + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName + " but finding " + xml_grainSizes.length + "!");
        let grainSizeAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_grainSizes[0]);
        let value = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_grainSizes[0])));
        let grainSize = new (0, $8883b31bd809eb64$export$26e33f0df9ce919d)(grainSizeAttributes, value);
        $7e68913db756e51f$var$modelParameters.setGrainSize(grainSize);
        let grainSizeDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
        // Create a new div for the grainSize.
        let grainSizeId = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName;
        let grainSizeInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", grainSizeId, $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(grainSizeInputDiv.querySelector("input"));
        grainSizeDiv.appendChild(grainSizeInputDiv);
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, grainSizeAttributes, grainSizeDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
        modelParametersDiv.appendChild(grainSizeDiv);
    }
    // Process any "me:automaticallySetMaxEne" element.
    let xml_automaticallySetMaxEnes = xml_modelParameters.getElementsByTagName((0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName);
    if (xml_automaticallySetMaxEnes.length > 0) {
        if (xml_automaticallySetMaxEnes.length > 1) throw new Error("Expecting 1 " + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName + " but finding " + xml_automaticallySetMaxEnes.length + "!");
        let automaticallySetMaxEneAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_automaticallySetMaxEnes[0]);
        let value = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_automaticallySetMaxEnes[0])));
        let automaticallySetMaxEne = new (0, $b6873406fb778c0b$export$576b56ca6e34780b)(automaticallySetMaxEneAttributes, value);
        $7e68913db756e51f$var$modelParameters.setAutomaticallySetMaxEne(automaticallySetMaxEne);
        // Create a new div for the automaticallySetMaxEne.
        let automaticallySetMaxEneId = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName;
        let automaticallySetMaxEneInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", automaticallySetMaxEneId, $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
                $7e68913db756e51f$export$b1e4cbf5b56e0e21(automaticallySetMaxEne, event.target);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
            }
        }, value.toString(), (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(automaticallySetMaxEneInputDiv.querySelector("input"));
        automaticallySetMaxEneInputDiv.style.marginLeft = $7e68913db756e51f$var$margin25;
        automaticallySetMaxEneInputDiv.style.marginTop = $7e68913db756e51f$var$margin1;
        automaticallySetMaxEneInputDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
        modelParametersDiv.appendChild(automaticallySetMaxEneInputDiv);
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, automaticallySetMaxEneAttributes, modelParametersDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    }
    // Process any "me:energyAboveTheTopHill" element.
    let xml_energyAboveTheTopHills = xml_modelParameters.getElementsByTagName((0, $8883b31bd809eb64$export$aa73446724166cdb).tagName);
    if (xml_energyAboveTheTopHills.length > 0) {
        if (xml_energyAboveTheTopHills.length > 1) throw new Error("Expecting 1 " + (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName + " but finding " + xml_energyAboveTheTopHills.length + "!");
        let energyAboveTheTopHillAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_energyAboveTheTopHills[0]);
        let energyAboveTheTopHillValue = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_energyAboveTheTopHills[0])));
        let energyAboveTheTopHill = new (0, $8883b31bd809eb64$export$aa73446724166cdb)(energyAboveTheTopHillAttributes, energyAboveTheTopHillValue);
        ...
        let energyAboveTheTopHillId = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName;
        let energyAboveTheTopHillInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", energyAboveTheTopHillId, $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(energyAboveTheTopHillInputDiv.querySelector("input"));
        energyAboveTheTopHillInputDiv.style.marginLeft = $7e68913db756e51f$var$margin25;
        energyAboveTheTopHillInputDiv.style.marginTop = $7e68913db756e51f$var$margin1;
        energyAboveTheTopHillInputDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
        modelParametersDiv.appendChild(energyAboveTheTopHillInputDiv);
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, energyAboveTheTopHillAttributes, modelParametersDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, (0, $8883b31bd809eb64$export$aa73446724166cdb).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    }
    // Process any "me:maxTemperature" element.
    let xml_maxTemperatures = xml_modelParameters.getElementsByTagName((0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName);
    if (xml_maxTemperatures.length > 0) {
        if (xml_maxTemperatures.length > 1) throw new Error("Expecting 1 " + (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName + " but finding " + xml_maxTemperatures.length + "!");
        let maxTemperatureAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_maxTemperatures[0]);
        let maxTemperatureValue = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_maxTemperatures[0])));
        let maxTemperature = new (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e)(maxTemperatureAttributes, maxTemperatureValue);
        $7e68913db756e51f$var$modelParameters.setMaxTemperature(maxTemperature);
        // Create a new div for the maxTemperature.
        let maxTemperatureId = (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName;
        let maxTemperatureInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", maxTemperatureId, $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
                $7e68913db756e51f$export$b1e4cbf5b56e0e21(maxTemperature, event.target);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
            }
        }, maxTemperature.value.toString(), (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(maxTemperatureInputDiv.querySelector("input"));
        maxTemperatureInputDiv.style.marginLeft = $7e68913db756e51f$var$margin25;
        maxTemperatureInputDiv.style.marginTop = $7e68913db756e51f$var$margin1;
        maxTemperatureInputDiv.style.marginBottom = $7e68913db756e51f$var$margin1;
        modelParametersDiv.appendChild(maxTemperatureInputDiv);
        // Add any units
        $7e68913db756e51f$var$addAnyUnits(undefined, maxTemperatureAttributes, modelParametersDiv, (0, $8883b31bd809eb64$export$77f098867dc64198).tagName + "_" + (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, (0, $8883b31bd809eb64$export$f9c72965e4ddfc8e).tagName, $7e68913db756e51f$var$margin2, $7e68913db756e51f$var$margin1, $7e68913db756e51f$var$margin1);
    }
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    // me:calculateRateCoefficientsOnly
    let calculateRateCoefficientsOnlyDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(calculateRateCoefficientsOnlyDiv);
    let xml_calculateRateCoefficientsOnly = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName);
    ...
    calculateRateCoefficientsOnlyLabel.textContent = (0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName;
    ...
    calculateRateCoefficientsOnlyInput.id = (0, $b6873406fb778c0b$export$7d9247c9879133fb).tagName;
    if (xml_calculateRateCoefficientsOnly.length == 1) {
        calculateRateCoefficientsOnlyInput.checked = true;
        $7e68913db756e51f$var$control.setCalculateRateCoefficientsOnly(new (0, $b6873406fb778c0b$export$7d9247c9879133fb)());
    ...
    calculateRateCoefficientsOnlyInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setCalculateRateCoefficientsOnly(new (0, $b6873406fb778c0b$export$7d9247c9879133fb)());
            else $7e68913db756e51f$var$control.removeCalculateRateCoefficientsOnly();
        }
    });
    // me:printCellDOS
    let printCellDOSDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    // me:printCellTransitionStateFlux
    let printCellTransitionStateFluxDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printCellTransitionStateFluxDiv);
    let xml_printCellTransitionStateFlux = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName);
    ...
    printCellTransitionStateFluxLabel.textContent = (0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName;
    ...
    printCellTransitionStateFluxInput.id = (0, $b6873406fb778c0b$export$7e63e5104be309ff).tagName;
    if (xml_printCellTransitionStateFlux.length == 1) {
        printCellTransitionStateFluxInput.checked = true;
        $7e68913db756e51f$var$control.setPrintCellTransitionStateFlux(new (0, $b6873406fb778c0b$export$7e63e5104be309ff)());
    ...
    printCellTransitionStateFluxInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintCellTransitionStateFlux(new (0, $b6873406fb778c0b$export$7e63e5104be309ff)());
            else $7e68913db756e51f$var$control.removePrintCellTransitionStateFlux();
        }
    });
    // me:printReactionOperatorColumnSums
    let printReactionOperatorColumnSumsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    // me:printGrainBoltzmann
    let printGrainBoltzmannDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml_printGrainBoltzmann.length == 1) {
        ...
        $7e68913db756e51f$var$control.setPrintGrainBoltzmann(new (0, $b6873406fb778c0b$export$e7fff349901f700d)());
    ...
    // me:printGrainDOS
    let printGrainDOSDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    // me:printGrainkbE
    let printGrainkbEDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml_printGrainkbE.length == 1) {
        ...
        $7e68913db756e51f$var$control.setPrintGrainkbE(new (0, $b6873406fb778c0b$export$55888ef4e813a34d)());
    ...
    // me:printGrainkfE
    let printGrainkfEDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml_printGrainkfE.length == 1) {
        ...
        $7e68913db756e51f$var$control.setPrintGrainkfE(new (0, $b6873406fb778c0b$export$f8d814a406a0ff5b)());
    ...
    // me:printTSsos
    let printTSsosDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printTSsosDiv);
    let xml_printTSsos = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName);
    ...
    printTSsosLabel.textContent = (0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName;
    let printTSsosInput = document.createElement("input");
    printTSsosDiv.appendChild(printTSsosInput);
    printTSsosInput.type = "checkbox";
    printTSsosInput.id = (0, $b6873406fb778c0b$export$3627f2b606ffd3cb).tagName;
    if (xml_printTSsos.length == 1) {
        printTSsosInput.checked = true;
        $7e68913db756e51f$var$control.setPrintTSsos(new (0, $b6873406fb778c0b$export$3627f2b606ffd3cb)());
    ...
    printTSsosInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintTSsos(new (0, $b6873406fb778c0b$export$3627f2b606ffd3cb)());
            else $7e68913db756e51f$var$control.removePrintTSsos();
        }
    });
    // me:printGrainedSpeciesProfile
    let printGrainedSpeciesProfileDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printGrainedSpeciesProfileDiv);
    let xml_printGrainedSpeciesProfile = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName);
    ...
    printGrainedSpeciesProfileLabel.textContent = (0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName;
    ...
    printGrainedSpeciesProfileInput.id = (0, $b6873406fb778c0b$export$c5481d114fddc81c).tagName;
    if (xml_printGrainedSpeciesProfile.length == 1) {
        printGrainedSpeciesProfileInput.checked = true;
        $7e68913db756e51f$var$control.setPrintGrainedSpeciesProfile(new (0, $b6873406fb778c0b$export$c5481d114fddc81c)());
    ...
    printGrainedSpeciesProfileInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintGrainedSpeciesProfile(new (0, $b6873406fb778c0b$export$c5481d114fddc81c)());
            else $7e68913db756e51f$var$control.removePrintGrainedSpeciesProfile();
        }
    });
    // me:printGrainTransitionStateFlux
    let printGrainTransitionStateFluxDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printGrainTransitionStateFluxDiv);
    let xml_printGrainTransitionStateFlux = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName);
    ...
    printGrainTransitionStateFluxLabel.textContent = (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName;
    ...
    printGrainTransitionStateFluxInput.id = (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab).tagName;
    if (xml_printGrainTransitionStateFlux.length == 1) {
        printGrainTransitionStateFluxInput.checked = true;
        $7e68913db756e51f$var$control.setPrintGrainTransitionStateFlux(new (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab)());
    ...
    printGrainTransitionStateFluxInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintGrainTransitionStateFlux(new (0, $b6873406fb778c0b$export$ec7c00ae1b17b2ab)());
            else $7e68913db756e51f$var$control.removePrintGrainTransitionStateFlux();
        }
    });
    // me:printReactionOperatorSize
    let printReactionOperatorSizeDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printReactionOperatorSizeDiv);
    let xml_printReactionOperatorSize = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$8420ab6988728a65).tagName);
    ...
    printReactionOperatorSizeLabel.textContent = (0, $b6873406fb778c0b$export$8420ab6988728a65).tagName;
    ...
    printReactionOperatorSizeInput.id = (0, $b6873406fb778c0b$export$8420ab6988728a65).tagName;
    if (xml_printReactionOperatorSize.length == 1) {
        printReactionOperatorSizeInput.checked = true;
        $7e68913db756e51f$var$control.setPrintReactionOperatorSize(new (0, $b6873406fb778c0b$export$8420ab6988728a65)());
    ...
    printReactionOperatorSizeInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintReactionOperatorSize(new (0, $b6873406fb778c0b$export$8420ab6988728a65)());
            else $7e68913db756e51f$var$control.removePrintReactionOperatorSize();
        }
    });
    // me:printSpeciesProfile
    let printSpeciesProfileDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml_printSpeciesProfile.length == 1) {
        ...
        $7e68913db756e51f$var$control.setPrintSpeciesProfile(new (0, $b6873406fb778c0b$export$ed9b9e07e51c2ac1)());
    ...
    // me:printPhenomenologicalEvolution
    let printPhenomenologicalEvolutionDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printPhenomenologicalEvolutionDiv);
    let xml_printPhenomenologicalEvolution = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName);
    ...
    printPhenomenologicalEvolutionLabel.textContent = (0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName;
    ...
    printPhenomenologicalEvolutionInput.id = (0, $b6873406fb778c0b$export$9f7939759d8efd9f).tagName;
    if (xml_printPhenomenologicalEvolution.length == 1) {
        printPhenomenologicalEvolutionInput.checked = true;
        $7e68913db756e51f$var$control.setPrintPhenomenologicalEvolution(new (0, $b6873406fb778c0b$export$9f7939759d8efd9f)());
    ...
    printPhenomenologicalEvolutionInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintPhenomenologicalEvolution(new (0, $b6873406fb778c0b$export$9f7939759d8efd9f)());
            else $7e68913db756e51f$var$control.removePrintPhenomenologicalEvolution();
        }
    });
    // me:printTunnelingCoefficients
    let printTunnelingCoefficientsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printTunnelingCoefficientsDiv);
    let xml_printTunnelingCoefficients = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName);
    ...
    printTunnelingCoefficientsLabel.textContent = (0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName;
    ...
    printTunnelingCoefficientsInput.id = (0, $b6873406fb778c0b$export$fc99460819e23ac5).tagName;
    if (xml_printTunnelingCoefficients.length == 1) {
        printTunnelingCoefficientsInput.checked = true;
        $7e68913db756e51f$var$control.setPrintTunnelingCoefficients(new (0, $b6873406fb778c0b$export$fc99460819e23ac5)());
    ...
    printTunnelingCoefficientsInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintTunnelingCoefficients(new (0, $b6873406fb778c0b$export$fc99460819e23ac5)());
            else $7e68913db756e51f$var$control.removePrintTunnelingCoefficients();
        }
    });
    // me:printCrossingCoefficients
    let printCrossingCoefficientsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(printCrossingCoefficientsDiv);
    let xml_printCrossingCoefficients = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName);
    ...
    printCrossingCoefficientsLabel.textContent = (0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName;
    ...
    printCrossingCoefficientsInput.id = (0, $b6873406fb778c0b$export$2f2eaac8983031ef).tagName;
    if (xml_printCrossingCoefficients.length == 1) {
        printCrossingCoefficientsInput.checked = true;
        $7e68913db756e51f$var$control.setPrintCrossingCoefficients(new (0, $b6873406fb778c0b$export$2f2eaac8983031ef)());
    ...
    printCrossingCoefficientsInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setPrintCrossingCoefficients(new (0, $b6873406fb778c0b$export$2f2eaac8983031ef)());
            else $7e68913db756e51f$var$control.removePrintCrossingCoefficients();
        }
    });
    // me:testDOS
    let testDOSDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    // me:testRateConstants
    let testRateConstantsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(testRateConstantsDiv);
    let xml_testRateConstants = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName);
    ...
    testRateConstantsLabel.textContent = (0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName;
    ...
    testRateConstantsInput.id = (0, $b6873406fb778c0b$export$724a5a49739f4b4a).tagName;
    if (xml_testRateConstants.length == 1) {
        testRateConstantsInput.checked = true;
        $7e68913db756e51f$var$control.setTestRateConstants(new (0, $b6873406fb778c0b$export$724a5a49739f4b4a)());
    ...
    testRateConstantsInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setTestRateConstants(new (0, $b6873406fb778c0b$export$724a5a49739f4b4a)());
            else $7e68913db756e51f$var$control.removeTestRateConstants();
        }
    });
    // me:useTheSameCellNumberForAllConditions
    let useTheSameCellNumberForAllConditionsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(useTheSameCellNumberForAllConditionsDiv);
    let xml_useTheSameCellNumberForAllConditions = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName);
    ...
    useTheSameCellNumberForAllConditionsLabel.textContent = (0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName;
    ...
    useTheSameCellNumberForAllConditionsInput.id = (0, $b6873406fb778c0b$export$5d7dbeba4bf49655).tagName;
    if (xml_useTheSameCellNumberForAllConditions.length == 1) {
        useTheSameCellNumberForAllConditionsInput.checked = true;
        $7e68913db756e51f$var$control.setUseTheSameCellNumberForAllConditions(new (0, $b6873406fb778c0b$export$5d7dbeba4bf49655)());
    ...
    useTheSameCellNumberForAllConditionsInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setUseTheSameCellNumberForAllConditions(new (0, $b6873406fb778c0b$export$5d7dbeba4bf49655)());
            else $7e68913db756e51f$var$control.removeUseTheSameCellNumberForAllConditions();
        }
    });
    // me:hideInactive
    let hideInactiveDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    hideInactiveLabel.textContent = (0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName;
    ...
    hideInactiveInput.id = (0, $b6873406fb778c0b$export$9d51752a8549e2d6).tagName;
    if (xml_hideInactive.length == 1) {
        hideInactiveInput.checked = true;
        $7e68913db756e51f$var$control.setHideInactive(new (0, $b6873406fb778c0b$export$9d51752a8549e2d6)());
    ...
    hideInactiveInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setHideInactive(new (0, $b6873406fb778c0b$export$9d51752a8549e2d6)());
            else $7e68913db756e51f$var$control.removeHideInactive();
        }
    });
    // me:ForceMacroDetailedBalance
    let forceMacroDetailedBalanceDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(forceMacroDetailedBalanceDiv);
    let xml_forceMacroDetailedBalance = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName);
    ...
    forceMacroDetailedBalanceLabel.textContent = (0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName;
    ...
    forceMacroDetailedBalanceInput.id = (0, $b6873406fb778c0b$export$6ffea14bdffd427f).tagName;
    if (xml_forceMacroDetailedBalance.length == 1) {
        forceMacroDetailedBalanceInput.checked = true;
        $7e68913db756e51f$var$control.setForceMacroDetailedBalance(new (0, $b6873406fb778c0b$export$6ffea14bdffd427f)());
    ...
    forceMacroDetailedBalanceInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) $7e68913db756e51f$var$control.setForceMacroDetailedBalance(new (0, $b6873406fb778c0b$export$6ffea14bdffd427f)());
            else $7e68913db756e51f$var$control.removeForceMacroDetailedBalance();
        }
    });
    // me:testMicroRates
    let testMicroRatesDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    if (xml_testMicroRates.length == 1) {
        ...
        testMicroRatesAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_testMicroRates[0]);
        testMicroRates = new (0, $b6873406fb778c0b$export$1f37c7c73e401f31)(testMicroRatesAttributes);
        $7e68913db756e51f$var$control.setTestMicroRates(testMicroRates);
    } else {
    ...
    testMicroRatesInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                $7e68913db756e51f$var$control.setTestMicroRates(testMicroRates);
                // Tmax.
                let idTmax = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName + "_Tmax";
                ...
                let tMaxInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", idTmax + "_input", $7e68913db756e51f$var$boundary1, (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                ...
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(tMaxInputDiv.querySelector("input"));
                testMicroRatesDiv.appendChild(tMaxInputDiv);
                // Tmin.
                let idTmin = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName + "_tMin";
                ...
                let tMinInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", idTmin + "_input", $7e68913db756e51f$var$boundary1, (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
                ...
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(tMinInputDiv.querySelector("input"));
                testMicroRatesDiv.appendChild(tMinInputDiv);
                // Tstep.
                let idTstep = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName + "_tStep";
                ...
                let tStepInputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", idTstep + "_input", $7e68913db756e51f$var$boundary1, (event)=>{
                    if (event.target instanceof HTMLInputElement) {
                        // Check the value is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(event.target.value)) {
                ...
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(tStepInputDiv.querySelector("input"));
                testMicroRatesDiv.appendChild(tStepInputDiv);
            } else {
                $7e68913db756e51f$var$control.removeTestMicroRates();
                // Tmax.
                let idTmax = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$1f37c7c73e401f31).tagName + "_Tmax";
                // Remove any exising div for tMax.
                let existingTmaxDiv = document.getElementById(idTmax);
    ...
    // me:calcMethod
    let calcMethodDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(calcMethodDiv);
    let xml_calcMethod = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName);
    ...
    calcMethodLabel.textContent = (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName;
    let calcMethodInput = document.createElement("input");
    calcMethodDiv.appendChild(calcMethodInput);
    calcMethodInput.type = "checkbox";
    calcMethodInput.id = (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName;
    let calcMethodAttributes;
    let calcMethod;
    if (xml_calcMethod.length == 1) {
        calcMethodInput.checked = true;
        calcMethodAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_calcMethod[0]);
        let value = (0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_calcMethod[0]));
        calcMethod = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)(calcMethodAttributes, value);
        $7e68913db756e51f$var$control.setCalcMethod(calcMethod);
    } else {
        calcMethodInput.checked = false;
        calcMethodAttributes = new Map();
        calcMethod = new (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d)(calcMethodAttributes, "");
    }
    calcMethodInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                $7e68913db756e51f$var$control.setCalcMethod(calcMethod);
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName + "_select";
                ...
                let selectElement = (0, $f0396edd0a5c99f7$export$16861bfc2f6300b2)((0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).options, value, id, $7e68913db756e51f$var$boundary1);
                selectElement.addEventListener("change", (event)=>{
                    if (event.target instanceof HTMLSelectElement) {
                ...
                $7e68913db756e51f$var$control.removeCalcMethod();
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$f0bfd84d03c3a22d).tagName + "_select";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
    ...
    // me:eigenvalues
    let eigenvaluesDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    eigenvaluesLabel.textContent = (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName;
    ...
    eigenvaluesInput.id = (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName;
    let eigenvalues;
    let eigenvaluesAttributes;
    if (xml_eigenvalues.length == 1) {
        eigenvaluesInput.checked = true;
        let value = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_eigenvalues[0])));
        eigenvaluesAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_eigenvalues[0]);
        eigenvalues = new (0, $b6873406fb778c0b$export$2453e311f702d9c7)(eigenvaluesAttributes, value);
        $7e68913db756e51f$var$control.setEigenvalues(eigenvalues);
        let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName + "_number";
        // Create a new div for the eigenvalues.
        let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id + "_input", $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
        ...
        eigenvalues = new (0, $b6873406fb778c0b$export$2453e311f702d9c7)(eigenvaluesAttributes, NaN);
    }
    eigenvaluesInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                ...
                $7e68913db756e51f$var$control.removeEigenvalues();
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$2453e311f702d9c7).tagName + "_number";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
    ...
    // me:shortestTimeOfInterest
    let shortestTimeOfInterestDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(shortestTimeOfInterestDiv);
    let xml_shortestTimeOfInterest = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$421603058c6718db).tagName);
    ...
    shortestTimeOfInterestLabel.textContent = (0, $b6873406fb778c0b$export$421603058c6718db).tagName;
    ...
    shortestTimeOfInterestInput.id = (0, $b6873406fb778c0b$export$421603058c6718db).tagName;
    ...
    if (xml_shortestTimeOfInterest.length == 1) {
        ...
        let value = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_shortestTimeOfInterest[0])));
        shortestTimeOfInterestAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_shortestTimeOfInterest[0]);
        shortestTimeOfInterest = new (0, $b6873406fb778c0b$export$421603058c6718db)(shortestTimeOfInterestAttributes, value);
        $7e68913db756e51f$var$control.setShortestTimeOfInterest(shortestTimeOfInterest);
        let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$421603058c6718db).tagName + "_number";
        // Create a new div for the shortestTimeOfInterest.
        let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id + "_input", $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
                $7e68913db756e51f$export$b1e4cbf5b56e0e21(shortestTimeOfInterest, event.target);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
            }
        }, shortestTimeOfInterest.value.toString(), (0, $b6873406fb778c0b$export$421603058c6718db).tagName);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputDiv.querySelector("input"));
        inputDiv.id = id;
        ...
        shortestTimeOfInterest = new (0, $b6873406fb778c0b$export$421603058c6718db)(shortestTimeOfInterestAttributes, NaN);
    }
    shortestTimeOfInterestInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                ...
                $7e68913db756e51f$var$control.removeShortestTimeOfInterest();
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$421603058c6718db).tagName + "_number";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
    ...
    // me:MaximumEvolutionTime
    let maximumEvolutionTimeDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(maximumEvolutionTimeDiv);
    let xml_maximumEvolutionTime = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$b51d7314540831ed).tagName);
    ...
    maximumEvolutionTimeLabel.textContent = (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName;
    ...
    maximumEvolutionTimeInput.id = (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName;
    ...
    if (xml_maximumEvolutionTime.length == 1) {
        ...
        let value = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_maximumEvolutionTime[0])));
        maximumEvolutionTimeAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_maximumEvolutionTime[0]);
        maximumEvolutionTime = new (0, $b6873406fb778c0b$export$b51d7314540831ed)(maximumEvolutionTimeAttributes, value);
        $7e68913db756e51f$var$control.setMaximumEvolutionTime(maximumEvolutionTime);
        let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName + "_number";
        // Create a new div for the maximumEvolutionTime.
        let inputDiv = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("number", id + "_input", $7e68913db756e51f$var$boundary1, (event)=>{
            if (event.target instanceof HTMLInputElement) {
                $7e68913db756e51f$export$b1e4cbf5b56e0e21(maximumEvolutionTime, event.target);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(event.target);
            }
        }, maximumEvolutionTime.value.toString(), (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputDiv.querySelector("input"));
        inputDiv.id = id;
        ...
        maximumEvolutionTime = new (0, $b6873406fb778c0b$export$b51d7314540831ed)(maximumEvolutionTimeAttributes, NaN);
    }
    maximumEvolutionTimeInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                ...
                $7e68913db756e51f$var$control.removeMaximumEvolutionTime();
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$b51d7314540831ed).tagName + "_number";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
    ...
    // me:automaticallySetMaxEne
    let automaticallySetMaxEneDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    controlsDiv.appendChild(automaticallySetMaxEneDiv);
    let xml_automaticallySetMaxEne = xml_control.getElementsByTagName((0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName);
    ...
    automaticallySetMaxEneLabel.textContent = (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName;
    ...
    automaticallySetMaxEneInput.id = (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName;
    ...
    if (xml_automaticallySetMaxEne.length == 1) {
        ...
        let value = parseFloat((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_automaticallySetMaxEne[0])));
        automaticallySetMaxEneAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_automaticallySetMaxEne[0]);
        automaticallySetMaxEne = new (0, $b6873406fb778c0b$export$576b56ca6e34780b)(automaticallySetMaxEneAttributes, value);
        $7e68913db756e51f$var$control.setAutomaticallySetMaxEne(automaticallySetMaxEne);
    } else {
        automaticallySetMaxEneInput.checked = false;
        automaticallySetMaxEneAttributes = new Map();
        automaticallySetMaxEne = new (0, $b6873406fb778c0b$export$576b56ca6e34780b)(automaticallySetMaxEneAttributes, NaN);
    }
    automaticallySetMaxEneInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                $7e68913db756e51f$var$control.setAutomaticallySetMaxEne(automaticallySetMaxEne);
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName + "_number";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
                // Create a new div for the automaticallySetMaxEne.
                ...
                }, automaticallySetMaxEne.value.toString(), (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName);
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputDiv.querySelector("input"));
                inputDiv.id = id;
                automaticallySetMaxEneDiv.appendChild(inputDiv);
            } else {
                $7e68913db756e51f$var$control.removeAutomaticallySetMaxEne();
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$576b56ca6e34780b).tagName + "_number";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
    ...
    // me:diagramEnergyOffset
    let diagramEnergyOffsetDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$level1);
    ...
    diagramEnergyOffsetLabel.textContent = (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName;
    ...
    diagramEnergyOffsetInput.id = (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName;
    ...
    if (xml_diagramEnergyOffset.length == 1) {
        ...
        diagramEnergyOffsetAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_diagramEnergyOffset[0]);
        diagramEnergyOffset = new (0, $b6873406fb778c0b$export$159b5d3263f1049a)(diagramEnergyOffsetAttributes, value);
        $7e68913db756e51f$var$control.setDiagramEnergyOffset(diagramEnergyOffset);
        let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName + "_number";
        ...
        }, diagramEnergyOffset.value.toString(), (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName);
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(inputDiv.querySelector("input"));
        inputDiv.id = id;
        ...
        diagramEnergyOffset = new (0, $b6873406fb778c0b$export$159b5d3263f1049a)(diagramEnergyOffsetAttributes, NaN);
    }
    diagramEnergyOffsetInput.addEventListener("change", (event)=>{
        if (event.target instanceof HTMLInputElement) {
            if (event.target.checked) {
                ...
                $7e68913db756e51f$var$control.removeDiagramEnergyOffset();
                let id = (0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName + "_" + (0, $b6873406fb778c0b$export$159b5d3263f1049a).tagName + "_number";
                // Remove any existing div.
                let existingDiv = document.getElementById(id);
                if (existingDiv != null) existingDiv.remove();
 ...
 */ window.saveXML = function() {
    ...
    a.href = url;
    a.download = $7e68913db756e51f$var$input_xml_filename; // Replace with the desired filename...
...
//# sourceMappingURL=index.631ea948.js.map
