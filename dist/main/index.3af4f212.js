...
function $f0396edd0a5c99f7$export$8b2cd46c11844202(id, divToAddTo, elementToInsertBefore, content, buttonLabel, componentMargin, margin) {
    ...
    let bid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, $f0396edd0a5c99f7$export$25280bc3a7ce098e);
    let b = $f0396edd0a5c99f7$export$9b6d6ca62970729f(buttonLabel + " " + $f0396edd0a5c99f7$export$38aa1ab9c2935930, bid, componentMargin);
    b.className = $f0396edd0a5c99f7$export$5117a7844205b9ac;
    ...
    $f0396edd0a5c99f7$var$setCollapsibleEventListener(b);
    return div;
}
/**
...
function $f0396edd0a5c99f7$export$9b6d6ca62970729f(textContent, id, margin) {
...
function $f0396edd0a5c99f7$export$6c1065e21382520d(table, content) {
...
class $6bf90154944bce56$export$984142e8329468e6 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $6bf90154944bce56$export$984142e8329468e6.tagName, value);
    }
}
class $6bf90154944bce56$export$f449a9e759d0ecf8 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
    static{
        /**
     * Tag name.
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $6bf90154944bce56$export$f449a9e759d0ecf8.tagName, value);
    }
}
class $6bf90154944bce56$export$9cdf0fcb7c05190f extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, firstOrderLosses, firstOrderRates, secondOrderRates){
        ...
        if (secondOrderRates) {
            ...
            secondOrderRates.forEach((sor)=>{
                this.index.set($6bf90154944bce56$export$f449a9e759d0ecf8.tagName + i.toString(), this.nodes.size);
     ...
     */ addSecondOrderRate(s) {
        this.sorIndex.set(this.sorIndex.size, this.nodes.size);
        this.index.set($6bf90154944bce56$export$f449a9e759d0ecf8.tagName + this.sorIndex.size.toString(), this.nodes.size);
        this.sors.push(s);
        this.addNode(s);
    }
}
class $6bf90154944bce56$export$c4c153dc94cc96b4 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, description, els, pls, rls){
        super(attributes, $6bf90154944bce56$export$9cdf0fcb7c05190f.tagName);
        this.index = new Map();
        if (description) {
...
class $08d0a8a73bf11acb$export$6ffea14bdffd427f extends (0, $cc8c7201a9bad777$export$3288d34c523a1192) {
    static{
        /**
     * The tag name.
    ...
    constructor(){
        super($08d0a8a73bf11acb$export$6ffea14bdffd427f.tagName);
    }
}
...
class $08d0a8a73bf11acb$export$7b8cfe3a6a460886 extends (0, $cc8c7201a9bad777$export$82583fad49645fc9) {
     ...
     * @param value The value.
     */ constructor(attributes, value){
        super(attributes, $08d0a8a73bf11acb$export$7b8cfe3a6a460886.tagName, value);
    }
}
...
class $08d0a8a73bf11acb$export$1f37c7c73e401f31 extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ constructor(attributes){
        ...
        this.tMin = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(attributes.get($08d0a8a73bf11acb$export$1f37c7c73e401f31.s_Tmin));
        this.tMax = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(attributes.get($08d0a8a73bf11acb$export$1f37c7c73e401f31.s_Tmax));
        this.tStep = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(attributes.get($08d0a8a73bf11acb$export$1f37c7c73e401f31.s_Tstep));
    }
    /**
...
<?xml-stylesheet type='text/xsl' href='../../mesmer1.xsl' media='screen'?>`;
     ...
     */ getMoleculeList() {
        ...
        if (i != undefined) return this.nodes.get(i);
            ...
            let moleculeList = new $69ecbdaa96f3962d$export$19d70f3647dee606(new Map());
            this.index.set($69ecbdaa96f3962d$export$19d70f3647dee606.tagName, this.nodes.size);
            this.addNode(moleculeList);
            return moleculeList;
        }
     ...
     */ getReactionList() {
        ...
        if (i != undefined) return this.nodes.get(i);
            ...
            let reactionList = new $69ecbdaa96f3962d$export$44466a39ca846289(new Map());
            this.index.set($69ecbdaa96f3962d$export$44466a39ca846289.tagName, this.nodes.size);
            this.addNode(reactionList);
            return reactionList;
        }
...
class $01410cda1eef5011$export$9f93a3fdf2490572 extends (0, $cc8c7201a9bad777$export$38d8ebe2767f8865) {
     ...
     */ setSize(size) {
        let values = [];
        for(let i = 0; i < size; i++)values.push(new (0, $a227f0f1258db640$exports.Big)(0));
...
class $01410cda1eef5011$export$a5a2be813176eb0e extends (0, $cc8c7201a9bad777$export$38d8ebe2767f8865) {
     ...
     */ setSize(rows, columns) {
        let values = [];
        for(let i = 0; i < rows; i++)for(let j = 0; j < columns; j++)values.push(new (0, $a227f0f1258db640$exports.Big)(0));
        this.setValues(values);
    }
}
...
class $01410cda1eef5011$export$2e66a7dc5ebae8a1 extends $01410cda1eef5011$export$41b04b3a73e7216d {
    static{
        /**
     * The dictionary reference.
...
class $01410cda1eef5011$export$47283907dceba392 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    static{
        /**
     * The tag name.
     ...
     */ constructor(attributes, states){
        super(attributes, $01410cda1eef5011$export$47283907dceba392.tagName);
        this.index = new Map();
        if (states) {
            let i = 0;
...
class $01410cda1eef5011$export$7254cc27399e90bd extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
    static{
        /**
     * The tag name.
     ...
     * @param id The index.
     */ constructor(attributes, id){
        super(attributes, $01410cda1eef5011$export$7254cc27399e90bd.tagName);
        this.id = id;
    }
    /**
     * @returns The energy of the state.
     */ getEnergy() {
        return new (0, $a227f0f1258db640$exports.Big)(this.attributes.get($01410cda1eef5011$export$7254cc27399e90bd.s_energy));
    }
    /**
     * @param energy The energy of the state.
     */ setEnergy(energy) {
        this.attributes.set($01410cda1eef5011$export$7254cc27399e90bd.s_energy, energy.toString());
    }
    /**
     * Remove the energy attribute. 
     */ removeEnergy() {
        this.attributes.delete($01410cda1eef5011$export$7254cc27399e90bd.s_energy);
    }
    /**
     * @returns The degeneracy of the state.
     */ getDegeneracy() {
        return new (0, $a227f0f1258db640$exports.Big)(this.attributes.get($01410cda1eef5011$export$7254cc27399e90bd.s_degeneracy));
    }
    /**
     * @param degeneracy The degeneracy of the state.
     */ setDegeneracy(degeneracy) {
        this.attributes.set($01410cda1eef5011$export$7254cc27399e90bd.s_degeneracy, degeneracy.toString());
    }
    /**
     * Remove the degeneracy attribute. 
     */ removeDegeneracy() {
        this.attributes.delete($01410cda1eef5011$export$7254cc27399e90bd.s_degeneracy);
    }
}
class $01410cda1eef5011$export$3da9759ad07746a3 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ constructor(attributes, id, metadataList, atoms, bonds, properties, energyTransferModel, dOSCMethod, distributionCalcMethod, extraDOSCMethods, reservoirSize, tt, states){
        ...
        if (states) {
            ...
            this.index.set($01410cda1eef5011$export$47283907dceba392.tagName, i);
        }
    }
    /**
     ...
     */ getStates() {
        let i = this.index.get($01410cda1eef5011$export$47283907dceba392.tagName);
        if (i == undefined) return undefined;
        else return this.nodes.get(i);
    }
    /**
     ...
     */ setStates(states) {
        let i = this.index.get($01410cda1eef5011$export$47283907dceba392.tagName);
        if (i == undefined) {
            this.index.set($01410cda1eef5011$export$47283907dceba392.tagName, this.nodes.size);
            this.addNode(states);
...
function $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        let mid = $174b37a7f81f9b54$export$194bfe7da61d65(true, undefined, undefined, molecules);
        ...
        let mDivID = mIDM.addID((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName, mid);
        let mDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mDivID);
        // Create collapsible Molecule HTMLDivElement.
        let mcDivID = mIDM.addID(mDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, addMoleculeButton, mDiv, mid, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        ...
        // Add Edit ID button.
        $174b37a7f81f9b54$var$addEditIDButton(m, molecules, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), mIDM, mDiv, (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Add description.
        mDiv.appendChild($174b37a7f81f9b54$var$processDescription(mIDM.addID(mDivID, (0, $7e68913db756e51f$export$666359451816b0e7)), mIDM, m.getDescription.bind(m), m.setDescription.bind(m), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        // Add atomArray.
        let aaDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$9cea715eceba39a0).tagName);
        let aaDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(aaDivID);
        let aacDivID = mIDM.addID(aaDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        aaDiv.appendChild($174b37a7f81f9b54$var$getAddAtomButton(mIDM, m, aaDiv, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        // Add bondArray.
        let baDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$746fba2e30d93fe6).tagName);
        let baDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(baDivID);
        let bacDivID = mIDM.addID(baDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        baDiv.appendChild($174b37a7f81f9b54$var$getAddBondButton(mIDM, m, baDiv, (0, $01410cda1eef5011$export$153327fc99ac0c53).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        $174b37a7f81f9b54$export$7aad7e61c4f49964(mIDM, m, mDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Add properties.
        let plDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName);
        let plDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(plDivID);
        let plcDivID = mIDM.addID(plDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        if (pl == undefined) {
            ...
            pl = new (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802)(new Map());
            m.setPropertyList(pl);
        }
        console.log("pl.index.size" + pl.index.size);
        $174b37a7f81f9b54$export$3ec2b56b5fdfd561(true, m, mIDM, plDiv, pl);
        // Add me:EnergyTransferModel.
        let etmDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$499950da20810ac9).tagName);
        let etmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(etmDivID);
        let etmcDivID = mIDM.addID(etmDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let etmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(etmcDivID, mDiv, null, etmDiv, (0, $01410cda1eef5011$export$499950da20810ac9).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        let etm = m.getEnergyTransferModel();
        if (etm == undefined) {
            etm = new (0, $01410cda1eef5011$export$499950da20810ac9)(new Map());
            m.setEnergyTransferModel(etm);
        }
        console.log("etm.index.size" + etm.nodes.size);
        // Add an add me.deltaEDown button.
        let addDeltaEDownButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(etmDivID, (0, $01410cda1eef5011$export$16fc56ab40b12b45).tagName, (0, $7e68913db756e51f$export$1bb8965d05fbf467), (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
        etmDiv.appendChild(addDeltaEDownButton);
        addDeltaEDownButton.addEventListener("click", ()=>{
            let value = (0, $7e68913db756e51f$export$a94c859b6fc3ec52);
            let ded = new (0, $01410cda1eef5011$export$16fc56ab40b12b45)(new Map(), value);
            let index = etm.addDeltaEDown(ded);
            let dedDivID = mIDM.addID(etmDivID, (0, $01410cda1eef5011$export$16fc56ab40b12b45).tagName, etm.nodes.size);
            let dedDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(dedDivID);
            etmDiv.insertBefore(dedDiv, addDeltaEDownButton);
            let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)((0, $01410cda1eef5011$export$16fc56ab40b12b45).tagName, dedDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7), (event)=>{
                let target = event.target;
                // Check the input is a number.
                if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value);
                    ded.setValue(value);
                } else {
                    // Reset.
                    alert("Input is not a number, resetting...");
                    target.value = ded.value.toString() ?? (0, $7e68913db756e51f$export$2f2abd8810196a7);
                }
                (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
            }, ded.value.toString(), (0, $01410cda1eef5011$export$16fc56ab40b12b45).tagName);
            dedDiv.appendChild(lwi);
            // Add a remove me.deltaEDown button.
            (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(dedDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
        ...
        */ // Add me:States
        let statesDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$47283907dceba392).tagName);
        let statesDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(statesDivID);
        let statescDivID = mIDM.addID(statesDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let statescDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(statescDivID, mDiv, null, statesDiv, (0, $01410cda1eef5011$export$47283907dceba392).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        let states = m.getStates();
        if (states == undefined) {
            states = new (0, $01410cda1eef5011$export$47283907dceba392)(new Map());
            m.setStates(states);
        }
        console.log("states.index.size" + states.nodes.size);
        // Add an add me:State button.
        $174b37a7f81f9b54$var$addAddStateButton(mIDM, statesDiv, states, statesDivID, (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Add a remove molecule button.
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(mDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), ()=>{
            $174b37a7f81f9b54$var$removeMolecule(mlDiv, mcDiv, mIDM, molecules, mDivID, m);
        });
    });
 ...
 */ function $174b37a7f81f9b54$var$addAddStateButton(mIDM, statesDiv, states, statesDivID, margin) {
    let addStateButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(statesDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName, (0, $7e68913db756e51f$export$1bb8965d05fbf467), (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), margin);
    statesDiv.appendChild(addStateButton);
    addStateButton.addEventListener("click", ()=>{
        let stateAttributes = new Map();
        stateAttributes.set((0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy, "0");
        stateAttributes.set((0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy, "0");
        let stateId = states.getNextId();
        let state = new (0, $01410cda1eef5011$export$7254cc27399e90bd)(stateAttributes, stateId);
        console.log("stateId=" + stateId);
        let index = states.addState(state);
        let stateDivID = mIDM.addID(statesDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName, state.id);
        let stateDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(stateDivID);
        statesDiv.insertBefore(stateDiv, addStateButton);
        // Add energy.
        let energyDivID = mIDM.addID(stateDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy);
        let energyDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(energyDivID);
        stateDiv.appendChild(energyDiv);
        let energyValue = state.getEnergy();
        let elwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)((0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy, energyDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7), (event)=>{
            let target = event.target;
            // Check the input is a number.
            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                energyValue = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value);
                state.setEnergy(energyValue);
            } else {
                // Reset.
                alert("Input is not a number, resetting...");
                target.value = energyValue.toString() ?? (0, $7e68913db756e51f$export$2f2abd8810196a7);
            }
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
        }, energyValue.toString(), (0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy);
        energyDiv.appendChild(elwi);
        // Add degeneracy.
        let degeneracyDivID = mIDM.addID(stateDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy);
        let degeneracyDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(degeneracyDivID);
        stateDiv.appendChild(degeneracyDiv);
        let degeneracyValue = state.getDegeneracy();
        let dlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)((0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy, degeneracyDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (event)=>{
            let target = event.target;
            // Check the input is a number.
            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                degeneracyValue = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value);
                state.setDegeneracy(degeneracyValue);
            } else {
                // Reset.
                alert("Input is not a number, resetting...");
                target.value = degeneracyValue.toString() ?? (0, $7e68913db756e51f$export$2f2abd8810196a7);
            }
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
        }, degeneracyValue.toString(), (0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy);
        degeneracyDiv.appendChild(dlwi);
        // Add a remove me:State button.
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(stateDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
            states.removeState(index);
            statesDiv.removeChild(stateDiv);
        });
    });
}
function $174b37a7f81f9b54$export$3ec2b56b5fdfd561(deselect, m, mIDM, plDiv, pl) {
    // "me:ZPE", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    //console.log("pl.index.size" + pl.index.size);
    //console.log("Property " + m.getPropertyList()!.getProperty(ZPE.dictRef)?.toString);
    // "me:Hf0", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    // "me:HfAT0", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    // "me:Hf298", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$e7df60530792b964).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    // "me:rotConsts", array, Mesmer.frequencyUnits.
    $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
    // "me:symmetryNumber", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef, undefined);
    // "me:TSOpticalSymmetryNumber", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$886461cafebcdaed).dictRef, undefined);
    // "me:frequenciesScaleFactor", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$1288989e9be37590).dictRef, undefined);
    // "me:vibFreqs", array, cm-1.
    $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
    // "me:MW", scalar, amu.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).massUnits);
    // "me:spinMultiplicity", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef, undefined);
    // "me:epsilon", scalar, K (fixed).
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).temperatureUnits);
    // "me:sigma", scalar, Å (fixed).
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).lengthUnits);
    // "me:hessian", matrix, kJ/mol/Å2 or kcal/mol/Å2 or Hartree/Å2.
    $174b37a7f81f9b54$var$addPropertyMatrix(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).hessianUnits);
    // "me:EinsteinAij", array, s-1 (fixed).
    $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinAUnits);
    // "me:EinsteinBij", array, m3/J/s2 (fixed).
    $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinBUnits);
    // "me:electronicExcitation">, scalar, cm-1.
    $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
}
/**
 ...
 * @param units The units. 
 */ function $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, dictRef, units) {
    let pAttributes;
    let psAttributes;
    let ps;
    let p;
    let div;
    pAttributes = new Map();
    pAttributes.set((0, $01410cda1eef5011$export$41b04b3a73e7216d).s_dictRef, dictRef);
    psAttributes = new Map();
    if (units != undefined) psAttributes.set((0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units, units[0]);
    ps = new (0, $01410cda1eef5011$export$742f9ce317ef8ba3)(psAttributes, (0, $7e68913db756e51f$export$a94c859b6fc3ec52));
    p = new (0, $01410cda1eef5011$export$41b04b3a73e7216d)(pAttributes, ps);
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(plDiv.id, mIDM, dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
    (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, psAttributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, dictRef, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    plDiv.appendChild(div);
    // Deselect
    if (deselect) {
        let b = div.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
        b.click();
        pl.removeProperty(dictRef);
    }
    return div;
}
function $174b37a7f81f9b54$export$c1dce3e534360efd(dictRef, pl, ps, value) {
    ...
    if (dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef || dictRef == (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef || dictRef == (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef || dictRef == (0, $01410cda1eef5011$export$e7df60530792b964).dictRef) (0, $7e68913db756e51f$export$e7cd7bead34ef747)();
//console.log("Value " + ps.getValue());
}
/**
 * @param deselect If true the button is clicked and the propert removed.
 ...
 * @param dictRef The dictRef.
 * @param units The units. 
 */ function $174b37a7f81f9b54$var$addPropertyArray(deselect, setSize, m, mIDM, plDiv, pl, dictRef, units) {
    let pAttributes;
    let paAttributes;
    let pa;
    let p;
    ...
    if (units != undefined) paAttributes.set((0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units, units[0]);
    // Init values.
    let values = [];
    if (setSize) $174b37a7f81f9b54$export$b7771d60d308862f(dictRef, values);
    pa = new (0, $01410cda1eef5011$export$9f93a3fdf2490572)(paAttributes, values);
    p = new (0, $01410cda1eef5011$export$41b04b3a73e7216d)(pAttributes, pa);
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
    (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, paAttributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, dictRef, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    plDiv.appendChild(div);
    // Deselect
    if (deselect) {
        let b = div.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
...
function $174b37a7f81f9b54$export$b7771d60d308862f(dictRef, values) {
    let n = (0, $7e68913db756e51f$export$88ed5e596ed31b40)("Please enter the number of elements in the " + dictRef + " array");
    for(let i = 0; i < n; i++)values.push((0, $7e68913db756e51f$export$a94c859b6fc3ec52));
}
function $174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, paom, values) {
    if (pl.getProperty(dictRef) == undefined) {
        let pAttributes;
        let p;
        pAttributes = new Map();
        pAttributes.set((0, $01410cda1eef5011$export$41b04b3a73e7216d).s_dictRef, dictRef);
        p = new (0, $01410cda1eef5011$export$41b04b3a73e7216d)(pAttributes, paom);
 ...
 * @param dictRef The dictRef.
 * @param units The units. 
 */ function $174b37a7f81f9b54$var$addPropertyMatrix(deselect, setSize, m, mIDM, plDiv, pl, dictRef, units) {
    let pAttributes;
    let pmAttributes;
    let pm;
    let p;
    ...
    if (units != undefined) pmAttributes.set((0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units, units[0]);
    // Init values.
    let values = [];
    if (setSize) $174b37a7f81f9b54$export$b7771d60d308862f(dictRef, values);
    pm = new (0, $01410cda1eef5011$export$a5a2be813176eb0e)(pmAttributes, values);
    p = new (0, $01410cda1eef5011$export$41b04b3a73e7216d)(pAttributes, pm);
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, dictRef, pm, pm.getValues.bind(pm), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, pm, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
    (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, pmAttributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, dictRef, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    plDiv.appendChild(div);
    // Deselect
    if (deselect) {
        let b = div.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
...
function $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, mIDM, molecules) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        let selectDivID = mIDM.addID((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName, "div");
        (0, $7e68913db756e51f$export$cd7f480d6b8286c3)(selectDivID);
        let selectDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(selectDivID, (0, $7e68913db756e51f$export$39c84188a71202f7));
        if ((0, $7e68913db756e51f$export$7c97c73a2c729cf9) == undefined) {
        ...
        let selectID = mIDM.addID(selectDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191));
        (0, $7e68913db756e51f$export$cd7f480d6b8286c3)(selectID);
        let select = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)(options, "Select molecule", (0, $7e68913db756e51f$export$d8b8827abc8ab7e7), selectID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        ...
        select.addEventListener("change", (event)=>{
            ...
            let molecule = (0, $7e68913db756e51f$export$7c97c73a2c729cf9).get(label);
            //let molecule: Molecule = getMolecule(label, libmols)!;
            let mid = molecule.getID();
            while(true){
                mid = $174b37a7f81f9b54$export$194bfe7da61d65(true, mid, molecule, molecules);
                if (mid != undefined) break;
            }
            molecules.set(mid, molecule);
            // Add molecule to the MoleculeList.
            let mDivID = mIDM.addID((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName, molecules.size);
            let moleculeDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mDivID);
            // Create collapsible Molecule HTMLDivElement.
            let mcDivID = mIDM.addID(mDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, amb, moleculeDiv, molecule.getLabel(), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            // Add the molecule to the BathGas select elements.
            ...
            $174b37a7f81f9b54$var$addEditIDButton(molecule, molecules, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), mIDM, moleculeDiv, (0, $7e68913db756e51f$export$39c84188a71202f7));
            // Description
            moleculeDiv.appendChild($174b37a7f81f9b54$var$processDescription(mIDM.addID(mDivID, (0, $7e68913db756e51f$export$666359451816b0e7)), mIDM, molecule.getDescription.bind(molecule), molecule.setDescription.bind(molecule), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            // Create collapsible MetadataList HTMLDivElement.
            let mlistDivID = mIDM.addID(mDivID, (0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName);
            ...
            let mlistcDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mlistDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            ...
            if (aa != undefined) aa.atoms.forEach((a)=>{
                aaDiv.appendChild($174b37a7f81f9b54$var$addAtom(false, mIDM, molecule, aaDivID, aa, a, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            });
            aaDiv.appendChild($174b37a7f81f9b54$var$getAddAtomButton(mIDM, molecule, aaDiv, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            ...
            if (ba != undefined) ba.bonds.forEach((b)=>{
                ...
                baDiv.appendChild($174b37a7f81f9b54$var$addBond(false, mIDM, molecule, baDivID, aa.atoms, ba, b, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            });
            baDiv.appendChild($174b37a7f81f9b54$var$getAddBondButton(mIDM, molecule, baDiv, (0, $01410cda1eef5011$export$153327fc99ac0c53).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            $174b37a7f81f9b54$export$7aad7e61c4f49964(mIDM, molecule, moleculeDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            let deselect = true;
            // "me:ZPE", scalar, Mesmer.energyUnits.
            if (!dictRefs.has((0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits, ps.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            // "me:Hf0", scalar, Mesmer.energyUnits.
            if (!dictRefs.has((0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits, ps.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            ...
            // "me:HfAT0", scalar, Mesmer.energyUnits.
            if (!dictRefs.has((0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits, ps.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            ...
            // "me:Hf298", scalar, Mesmer.energyUnits.
            if (!dictRefs.has((0, $01410cda1eef5011$export$e7df60530792b964).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$e7df60530792b964).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$e7df60530792b964).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$e7df60530792b964).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits, ps.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            ...
            // "me:rotConsts", array, Mesmer.frequencyUnits.
            if (!dictRefs.has((0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef);
                let pa = p.getProperty();
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, p.dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits, pa.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            // "me:symmetryNumber", scalar, No units.
            if (!dictRefs.has((0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef, undefined);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                plDiv.appendChild(div);
            }
            // "me:TSOpticalSymmetryNumber", scalar, No units.
            if (!dictRefs.has((0, $01410cda1eef5011$export$886461cafebcdaed).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$886461cafebcdaed).dictRef, undefined);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$886461cafebcdaed).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$886461cafebcdaed).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                plDiv.appendChild(div);
            }
            // "me:frequenciesScaleFactor", scalar, No units.
            if (!dictRefs.has((0, $01410cda1eef5011$export$1288989e9be37590).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$1288989e9be37590).dictRef, undefined);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$1288989e9be37590).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$1288989e9be37590).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                plDiv.appendChild(div);
            }
            // "me:vibFreqs", array, cm-1.
            if (!dictRefs.has((0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef);
                let pa = p.getProperty();
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, p.dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits, pa.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            ...
            // "me:MW", scalar, amu.
            if (!dictRefs.has((0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).massUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).massUnits, ps.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            // "me:spinMultiplicity", scalar, No units.
            if (!dictRefs.has((0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef, undefined);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                plDiv.appendChild(div);
            }
            // "me:epsilon", scalar, K (fixed).
            if (!dictRefs.has((0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).temperatureUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                plDiv.appendChild(div);
            }
            // "me:sigma", scalar, Å (fixed).
            if (!dictRefs.has((0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).lengthUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                plDiv.appendChild(div);
            }
            // "me:hessian", matrix, kJ/mol/Å2 or kcal/mol/Å2 or Hartree/Å2.
            if (!dictRefs.has((0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef)) $174b37a7f81f9b54$var$addPropertyMatrix(deselect, false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).hessianUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef);
                let pm = p.getProperty();
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, p.dictRef, pm, pm.getValues.bind(pm), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pm, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).hessianUnits, pm.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            // "me:EinsteinAij", array, s-1 (fixed).
            if (!dictRefs.has((0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinAUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef);
                let pa = p.getProperty();
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, p.dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinAUnits, pa.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            // "me:EinsteinBij", array, m3/J/s2 (fixed).
            if (!dictRefs.has((0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinBUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef);
                let pa = p.getProperty();
                let div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, p.dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(p.dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinBUnits, pa.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            // "me:ElectronicExcitation", scalar, cm-1.
            if (!dictRefs.has((0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, molecule, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
            else {
                pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef);
                let p = pl.getProperty((0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef);
                let ps = p.getProperty();
                let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits, ps.attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
                plDiv.appendChild(div);
            }
            /*
            // Add me:DOSCMethod.
            ...
            moleculeDiv.appendChild(
                ...
                doscm.getXsiType(), mIDM.addID(mDivID, DOSCMethod.tagName), boundary1, level1));
            */ // Organise States.
            let ssDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName);
            let ssDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ssDivID);
            let sscDivID = mIDM.addID(ssDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            let sscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(sscDivID, moleculeDiv, null, ssDiv, (0, $01410cda1eef5011$export$47283907dceba392).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            // Add states.
            let states = molecule.getStates();
            if (states != undefined) states.getStates().forEach((s)=>{
                console.log(s.toString());
                // Add state.
                let sDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ssDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName, s.id);
                let sDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(sDivID);
                ssDiv.appendChild(sDiv);
                // Add energy.
                let energyDivID = mIDM.addID(sDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy);
                let energy = s.getEnergy();
                let elwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)((0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy, energyDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7), (event)=>{
                    let target = event.target;
                    // Check the input is a number.
                    if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                        energy = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value);
                        s.setEnergy(energy);
                    } else {
                        // Reset.
                        alert("Input is not a number, resetting...");
                        target.value = energy.toString() ?? (0, $7e68913db756e51f$export$2f2abd8810196a7);
                    }
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, energy.toString(), (0, $01410cda1eef5011$export$7254cc27399e90bd).s_energy);
                sDiv.appendChild(elwi);
                // Add degeneracy.
                let degeneracyDivID = mIDM.addID(sDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy);
                let degeneracy = s.getDegeneracy();
                let dlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)((0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy, degeneracyDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (event)=>{
                    let target = event.target;
                    // Check the input is a number.
                    if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                        degeneracy = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value);
                        s.setDegeneracy(degeneracy);
                    } else {
                        // Reset.
                        alert("Input is not a number, resetting...");
                        target.value = degeneracy.toString() ?? (0, $7e68913db756e51f$export$2f2abd8810196a7);
                    }
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, degeneracy.toString(), (0, $01410cda1eef5011$export$7254cc27399e90bd).s_degeneracy);
                sDiv.appendChild(dlwi);
                // Add a remove state button.
                (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(sDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
            ...
            selectDiv.remove();
            // Add a remove molecule button.
            (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(moleculeDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), ()=>{
                $174b37a7f81f9b54$var$removeMolecule(mlDiv, mcDiv, mIDM, molecules, mDivID, molecule);
            });
        });
    });
    return addFromLibraryButton;
}
function $174b37a7f81f9b54$export$194bfe7da61d65(ask, mid, molecule, molecules) {
    let mid2;
    while(true){
 ...
 * @param mDiv 
 * @param level 
 */ function $174b37a7f81f9b54$var$addEditIDButton(molecule, molecules, button, mIDM, mDiv, level) {
    let s_editName = (0, $7e68913db756e51f$export$96d8a15ea1620cf4) + " Edit id";
    let editNameButtonID = mIDM.addID(mDiv.id, s_editName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
 ...
 */ function $174b37a7f81f9b54$var$processDescription(id, mIDM, getter, setter, marginComponent, marginDiv) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, mIDM.addID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), marginComponent);
    ...
    let inputId = mIDM.addID(id, (0, $7e68913db756e51f$export$666359451816b0e7), (0, $7e68913db756e51f$export$58785e0018b77d4a));
    let value = getter();
    if (value == undefined) {
 ...
 * @param setter The setter function to call.
 * @param margin The margin.
 */ function $174b37a7f81f9b54$var$addDescription(div, id, value, setter, margin) {
    let valueString;
    if (value == undefined) valueString = "";
    else valueString = value;
    let input = (0, $f0396edd0a5c99f7$export$d80fffb1deb3b97e)("text", id, margin);
 ...
 */ function $174b37a7f81f9b54$var$getAddAtomButton(mIDM, molecule, aaDiv, typeID, boundary, level) {
    // Create an add atom button.
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), mIDM.addID(aaDiv.id, "Add" + typeID + "Button"), level);
    button.addEventListener("click", ()=>{
        let attributes = new Map();
        let a = new (0, $01410cda1eef5011$export$80986e6afdd7e0cb)(attributes, molecule);
        //let aID: string = molecule.getAtoms().addAtom(a);
        aaDiv.insertBefore($174b37a7f81f9b54$var$addAtom(true, mIDM, molecule, aaDiv.id, molecule.getAtoms(), a, boundary, level), button);
    });
    return button;
}
/**
 ...
 */ function $174b37a7f81f9b54$var$addMetadata(m, md, ml, mdDivID, boundary, level) {
    ml.addMetadata(md);
    let mdDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(mdDivID, level);
    mdDiv.appendChild((0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(m.getLabel(), boundary));
    return mdDiv;
}
/**
 * Adds an atom.
 ...
 */ function $174b37a7f81f9b54$var$addAtom(addToArray, mIDM, molecule, aaDivID, aa, a, boundary, level) {
    let aID;
    if (addToArray) aID = aa.addAtom(a, a.getID());
    else aID = a.getID();
    //let aDivID: string = mIDM.addID(aaDivID, aID);
    let aDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aaDivID, aID);
    ...
    // elementType.
    $174b37a7f81f9b54$var$processElementType(mIDM, a, aDiv, true, boundary);
    // Coordinates.
    $174b37a7f81f9b54$var$processCoordinates(mIDM, a, aDiv, boundary, boundary);
    (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(aDiv, boundary, $174b37a7f81f9b54$var$removeAtom, molecule, aID, mIDM);
 ...
 */ function $174b37a7f81f9b54$var$processElementType(mIDM, a, aDiv, first, margin) {
    ...
    let id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_elementType);
 ...
 * @param margin The margin.
 */ function $174b37a7f81f9b54$var$processCoordinates(mIDM, a, aDiv, marginComponent, margin) {
    let id;
    //id = mIDM.addID(aDiv.id, Atom.s_x3);
    id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_x3);
    aDiv.appendChild((0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(id, mIDM, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_x3, a.getX3.bind(a), a.setX3.bind(a), a.removeX3, marginComponent, margin));
    //id = mIDM.addID(aDiv.id, Atom.s_y3);
    id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_y3);
    aDiv.appendChild((0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(id, mIDM, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_y3, a.getY3.bind(a), a.setY3.bind(a), a.removeY3, marginComponent, margin));
    //id = mIDM.addID(aDiv.id, Atom.s_z3);
    id = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(aDiv.id, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_z3);
    aDiv.appendChild((0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(id, mIDM, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).s_z3, a.getZ3.bind(a), a.setZ3.bind(a), a.removeZ3, marginComponent, margin));
}
/**
 ...
 * @param level The margin for the div.
 * @returns The add bond button.
 */ function $174b37a7f81f9b54$var$getAddBondButton(mIDM, molecule, baDiv, typeID, boundary, level) {
    // Create an add button.
    let id = mIDM.addID(baDiv.id, typeID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    ...
    button.addEventListener("click", ()=>{
        ...
        baDiv.insertBefore($174b37a7f81f9b54$var$addBond(true, mIDM, molecule, baDiv.id, atoms, molecule.getBonds(), b, boundary, level), button);
    });
 ...
 */ function $174b37a7f81f9b54$var$addBond(addToArray, mIDM, molecule, baDivID, atoms, ba, b, boundary, level) {
    let bID;
    ...
    // atomRefs2.
    $174b37a7f81f9b54$var$processAtomRefs2(mIDM, molecule, bDiv, b, boundary);
    // order.
    $174b37a7f81f9b54$var$processOrder(mIDM, bDiv, b, boundary);
 ...
 * @param margin The margin for the components.
 */ function $174b37a7f81f9b54$var$processAtomRefs2(mIDM, molecule, bDiv, bond, margin) {
 ...
 */ function $174b37a7f81f9b54$var$processOrder(mIDM, bondDiv, bond, margin) {
 ...
 * @param margin The margin for components.
 */ function $174b37a7f81f9b54$var$processUseSineTerms(mIDM, hrpDiv, hrp, margin) {
    let id = mIDM.addID(hrpDiv.id, (0, $01410cda1eef5011$export$9b8e857b9a081d2).s_useSineTerms);
...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    if (!mlTagNames.has((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName)) {
        console.warn('Expecting tags with "' + (0, $01410cda1eef5011$export$3da9759ad07746a3).tagName + '" tagName but there are none! Please add molecules to the moleculeList.');
        // Add add molecule button.
        let amb = mlDiv.appendChild($174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules));
        // Add add from library button.
        mlDiv.appendChild($174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, mIDM, molecules));
        return mlDiv;
    }
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        let mDivID = mIDM.addID((0, $01410cda1eef5011$export$3da9759ad07746a3).tagName, i);
        let mDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mDivID);
        ...
        (0, $7e68913db756e51f$export$ac55d333e780178c)(false, m, molecules);
        // Create collapsible Molecule HTMLDivElement.
        let mcDivID = mIDM.addID(mDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let mcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mcDivID, mlDiv, null, mDiv, m.getLabel(), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        ...
        if (xml_mls.length > 0) {
            ...
            // Create collapsible MetadataList HTMLDivElement.
            let mdlDivID = mIDM.addID(mDivID, (0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName);
            let mdlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mdlDivID);
            let mdlcDivID = mIDM.addID(mdlDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            let mdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mdlcDivID, mDiv, null, mdlDiv, (0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            for(let j = 0; j < xml_ms.length; j++){
                ...
                mdlDiv.appendChild($174b37a7f81f9b54$var$addMetadata(m, md, ml, mIDM.addID(mdlDivID, j), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
            }
        ...
        for(let j = 0; j < xml_as.length; j++)aaDiv.appendChild($174b37a7f81f9b54$var$addAtom(true, mIDM, m, aaDivID, aa, new (0, $01410cda1eef5011$export$80986e6afdd7e0cb)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_as[j]), m), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        aaDiv.appendChild($174b37a7f81f9b54$var$getAddAtomButton(mIDM, m, aaDiv, (0, $01410cda1eef5011$export$80986e6afdd7e0cb).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        ...
        for(let j = 0; j < xml_bs.length; j++){
            ...
            if (b_attributes.has((0, $01410cda1eef5011$export$153327fc99ac0c53).s_id)) baDiv.appendChild($174b37a7f81f9b54$var$addBond(true, mIDM, m, baDivID, m.getAtoms().atoms, ba, new (0, $01410cda1eef5011$export$153327fc99ac0c53)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_bs[j]), m), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7)));
        }
        ...
        let viewerDivID = mIDM.addID(mDivID, (0, $7e68913db756e51f$export$a59b122474df8e10));
        let viewerDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(viewerDivID);
        let viewercDivID = mIDM.addID(viewerDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let viewercDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(viewercDivID, mDiv, null, viewerDiv, (0, $7e68913db756e51f$export$a59b122474df8e10), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        $174b37a7f81f9b54$export$7aad7e61c4f49964(mIDM, m, viewerDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Init properties.
        ...
        if (xml_pls.length > 1) console.warn("Expecting 1 or 0 " + (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName + " but finding " + xml_pls.length + ". Loading the first of these...");
        let dictRefs = new Set();
        let dictRefMap = new Map();
        let pl;
        let xml_ps;
        if (xml_pls.length > 0) {
            pl = new (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_pls[0]));
            xml_ps = xml_pls[0].getElementsByTagName((0, $01410cda1eef5011$export$41b04b3a73e7216d).tagName);
            // Init dictRefs
            for(let j = 0; j < xml_ps.length; j++){
                let p = new (0, $01410cda1eef5011$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ps[j]));
                dictRefs.add(p.dictRef);
                dictRefMap.set(p.dictRef, j);
            }
        } else pl = new (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802)(new Map());
        m.setPropertyList(pl);
        moleculeTagNames.delete((0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName);
        let pID;
        let deselect = false;
        // "me:ZPE", scalar, Mesmer.energyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        ...
        /*
            ...
            */ }
        // "me:Hf0", scalar, Mesmer.energyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef)) {
            let div = $174b37a7f81f9b54$var$addPropertyScalar(true, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
        // Click the button.
        ...
        //pl.removeProperty(SpinMultiplicity.dictRef);
            ...
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            ...
            */ }
        // "me:HfAT0", scalar, Mesmer.energyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:Hf298", scalar, Mesmer.energyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$e7df60530792b964).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$e7df60530792b964).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$e7df60530792b964).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$e7df60530792b964).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:rotConsts", array, Mesmer.frequencyUnits.
        if (!dictRefs.has((0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$984abe26ded13ee0).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            ...
            */ }
        // "me:symmetryNumber", scalar, No units.
        if (!dictRefs.has((0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef, undefined);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:TSOpticalSymmetryNumber", scalar, No units.
        if (!dictRefs.has((0, $01410cda1eef5011$export$886461cafebcdaed).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$886461cafebcdaed).dictRef, undefined);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$886461cafebcdaed).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$886461cafebcdaed).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:frequenciesScaleFactor", scalar, No units.
        if (!dictRefs.has((0, $01410cda1eef5011$export$1288989e9be37590).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$1288989e9be37590).dictRef, undefined);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$1288989e9be37590).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$1288989e9be37590).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:vibFreqs", array, cm-1.
        if (!dictRefs.has((0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$2762c8fbc03043ca).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let pa: PropertyArray = p.getProperty() as PropertyArray;
            let div: HTMLDivElement = processNumberArrayOrMatrix(plDiv.id, mIDM, p.dictRef, pa, pa.getValues.bind(pa),
            ...
            */ }
        // "me:MW", scalar, amu.
        if (!dictRefs.has((0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).massUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:spinMultiplicity", scalar, No units.
        if (!dictRefs.has((0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef)) {
            let div = $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef, undefined);
            // Click the button.
            let b = div.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
            b.click();
            pl.removeProperty((0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef);
        } else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:epsilon", scalar, K (fixed).
        if (!dictRefs.has((0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).temperatureUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:sigma", scalar, Å (fixed).
        if (!dictRefs.has((0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).lengthUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
            ...
            */ }
        // "me:hessian", matrix, kJ/mol/Å2 or kcal/mol/Å2 or Hartree/Å2.
        if (!dictRefs.has((0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef)) $174b37a7f81f9b54$var$addPropertyMatrix(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).hessianUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$789e4dcdcb815c05).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            ...
            */ }
        // "me:EinsteinAij", array, s-1 (fixed).
        if (!dictRefs.has((0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinAUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$f3e9ef5020c299b5).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let pa: PropertyArray = p.getProperty() as PropertyArray;
            let div: HTMLDivElement = processNumberArrayOrMatrix(plDiv.id, mIDM, p.dictRef, pa, pa.getValues.bind(pa),
            ...
            */ }
        // "me:EinsteinBij", array, m3/J/s2 (fixed).
        if (!dictRefs.has((0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef)) $174b37a7f81f9b54$var$addPropertyArray(deselect, false, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).EinsteinBUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$25f02bc420569a7e).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let pa: PropertyArray = p.getProperty() as PropertyArray;
            let div: HTMLDivElement = processNumberArrayOrMatrix(plDiv.id, mIDM, p.dictRef, pa, pa.getValues.bind(pa),
            ...
            */ }
        // "me:electronicExcitation", scalar, cm-1.
        if (!dictRefs.has((0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef)) $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits);
        else {
            pID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, (0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef);
            let j = dictRefMap.get((0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef);
            let p = $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml_ps[j], plDiv, m, mIDM, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        /*
            let ps: PropertyScalarNumber = p.getProperty() as PropertyScalarNumber;
            let div: HTMLDivElement = processNumber(pID, mIDM, p.dictRef, ps.getValue.bind(ps),
        ...
        if (xml_etms.length > 0) {
            ...
            $174b37a7f81f9b54$var$processEnergyTransferModel(mIDM, etm, m, xml_etms[0], mDiv);
        ...
        if (xml_dcms.length > 0) {
            ...
            let dcmDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$3f9657e7f71262a).tagName);
        ...
        if (xml_dosl.length > 0) {
            ...
            let doslDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$dcce836c71a83df).tagName);
            let doslDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(doslDivID);
            let doslcDivID = mIDM.addID(doslDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            ...
            if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $01410cda1eef5011$export$126b026a4280c589).tagName + " but finding 0!");
                ...
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)(mIDM.addID(doslDivID, (0, $7e68913db756e51f$export$7a850709da5c4f5b)), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(t, (0, $01410cda1eef5011$export$126b026a4280c589).header);
        ...
        if (xml_tts.length > 0) {
            ...
            // Create collapsible div.
            let ttDivId = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$96f29f03cf201f97).tagName);
            let ttDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ttDivId);
            let ttcDivId = mIDM.addID(ttDivId, (0, $7e68913db756e51f$export$7295f538b9762c5));
            ...
            if (xml_tvs.length == 0) throw new Error("Expecting 1 or more " + tvtn + " but finding 0!");
                ...
                tvs = [];
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)(mIDM.addID(ttDivId, (0, $7e68913db756e51f$export$7a850709da5c4f5b)), (0, $7e68913db756e51f$export$39c84188a71202f7));
                (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(t, tt.getHeader());
                ...
                ttDiv.appendChild(t);
                tt.init(tvs);
                (0, $7e68913db756e51f$export$dd526fb3a2a9c049)(tt.toCSV.bind(tt), ttDiv, t, mIDM.addID(m.getID(), (0, $01410cda1eef5011$export$96f29f03cf201f97).tagName), (0, $7e68913db756e51f$export$39c84188a71202f7));
            }
            m.setThermoTable(tt);
        ...
        if (xml_edms.length > 0) for(let j = 0; j < xml_edms.length; j++){
            ...
            let edmDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$ae98b7db6376163d).tagName, j);
            let edmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(edmDivID);
            let edmcDivID = mIDM.addID(edmDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            ...
            if (xml_hrps.length > 0) {
                ...
                let hrpDivID = mIDM.addID(edmDivID, (0, $01410cda1eef5011$export$9b8e857b9a081d2).tagName);
                let hrpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(hrpDivID);
                let hrpcDivID = mIDM.addID(hrpDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
                ...
                // Format.
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $01410cda1eef5011$export$9b8e857b9a081d2).s_format, (0, $01410cda1eef5011$export$9b8e857b9a081d2).formats, (0, $01410cda1eef5011$export$9b8e857b9a081d2).tagName, hrp.getFormat(), mIDM.addID(hrpDivID, (0, $01410cda1eef5011$export$9b8e857b9a081d2).s_format), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                hrpDiv.appendChild(lws);
                // Units.
                (0, $7e68913db756e51f$export$2b2254f82abcc900)((0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits, hrpAttributes, hrpDiv, lws, mIDM.addID(hrpDivID, (0, $01410cda1eef5011$export$9b8e857b9a081d2).s_units), (0, $01410cda1eef5011$export$9b8e857b9a081d2).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                // ExpansionSize.
                let es = hrp.getExpansionSize() ?? (0, $7e68913db756e51f$export$2f2abd8810196a7);
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", mIDM.addID(hrpDivID, (0, $01410cda1eef5011$export$9b8e857b9a081d2).s_expansionSize), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7), (event)=>{
                    let target = event.target;
                    // Check the input is a number.
                    try {
                ...
                // Add useSineTerms.
                $174b37a7f81f9b54$var$processUseSineTerms(mIDM, hrpDiv, hrp, (0, $7e68913db756e51f$export$39c84188a71202f7));
                // Load PotentialPoints.
                // Create collapsible HinderedRotorPotential PotentialPoint HTMLDivElement.
                let ppsDivID = mIDM.addID(hrpDivID, (0, $01410cda1eef5011$export$86ca5149fcde8feb).tagName);
                let ppsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ppsDivID);
                let ppscDivID = mIDM.addID(ppsDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    let anglelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", mIDM.addID(ppDivID, (0, $01410cda1eef5011$export$86ca5149fcde8feb).s_angle), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (event)=>{
                        let target = event.target;
                        // Check the input is a number.
                        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                    ...
                    let potentialInputElementId = mIDM.addID(ppDivID, (0, $01410cda1eef5011$export$86ca5149fcde8feb).s_potential);
            ...
            if (xml_periodicities.length > 0) {
                ...
                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", mIDM.addID(edmDivID, (0, $01410cda1eef5011$export$9513c16afdf7d852).tagName), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7), (event)=>{
                    let target = event.target;
        ...
        // Organise States.
        let xml_states = xml_ms[i].getElementsByTagName((0, $01410cda1eef5011$export$47283907dceba392).tagName);
        let ssDivID = mIDM.addID(mDivID, (0, $01410cda1eef5011$export$7254cc27399e90bd).tagName);
        let ssDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ssDivID);
        let sscDivID = mIDM.addID(ssDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let sscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(sscDivID, mDiv, null, ssDiv, (0, $01410cda1eef5011$export$47283907dceba392).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        if (xml_states.length > 0) {
            if (xml_states.length > 1) throw new Error("Expecting 1 or 0 " + (0, $01410cda1eef5011$export$47283907dceba392).tagName + " but finding " + xml_states.length + "!");
            let ss = new (0, $01410cda1eef5011$export$47283907dceba392)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_states[0]));
            //let state: State[] = [];
            let xml_ss = xml_states[0].getElementsByTagName((0, $01410cda1eef5011$export$7254cc27399e90bd).tagName);
            for(let j = 0; j < xml_ss.length; j++){
                let s = new (0, $01410cda1eef5011$export$7254cc27399e90bd)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_ss[j]), j);
                //state.push(s);
                ss.addState(s);
            ...
            m.setStates(ss);
            moleculeTagNames.delete((0, $01410cda1eef5011$export$7254cc27399e90bd).tagName);
        }
    ...
    let mb = $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules);
    // Create add from library button.
    let lb = $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, mb, mIDM, molecules);
    return mlDiv;
}
/**
 * Remove a molecule.
 ...
 * @param m The molecule.
 */ function $174b37a7f81f9b54$var$removeMolecule(mlDiv, mcDiv, mIDM, molecules, mDivID, m) {
    mlDiv.removeChild(mcDiv);
    //mlDiv.removeChild(mDiv);
    mIDM.removeIDs(mDivID);
    mIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $7e68913db756e51f$export$666359451816b0e7)));
    mIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $01410cda1eef5011$export$9cea715eceba39a0).tagName));
    mIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $01410cda1eef5011$export$746fba2e30d93fe6).tagName));
    mIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $7e68913db756e51f$export$a59b122474df8e10)));
    mIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(mDivID, (0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName));
    molecules.delete(m.getID());
}
function $174b37a7f81f9b54$export$60ca070fb6dca2f6(pl, xml, plDiv, molecule, mIDM, boundary, level) {
    ...
    $174b37a7f81f9b54$export$183579040c2dd680(pl, p, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits, molecule, mIDM, xml, plDiv, boundary, level);
    ...
    $174b37a7f81f9b54$export$183579040c2dd680(pl, p, (0, $69ecbdaa96f3962d$export$692079bb871c6039).frequencyUnits, molecule, mIDM, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef) // "me:symmetryNumber", scalar, No units.
    $174b37a7f81f9b54$export$183579040c2dd680(pl, p, undefined, molecule, mIDM, xml, plDiv, boundary, level);
    ...
    $174b37a7f81f9b54$export$183579040c2dd680(pl, p, undefined, molecule, mIDM, xml, plDiv, boundary, level);
    else $174b37a7f81f9b54$export$cbd171726dbc631c(pl, p, molecule, xml, plDiv, boundary, level);
    pl.setProperty(p);
    return p;
}
function $174b37a7f81f9b54$export$183579040c2dd680(pl, p, units, molecule, mIDM, element, plDiv, boundary, level) {
    let pID = mIDM.addID((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef));
    let div;
    // PropertyScalar.
    ...
    if (scalarNodes.length > 0) {
        ...
        ps.setValue = (function(value) {
            ps.value = value;
            if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef || p.dictRef == (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef || p.dictRef == (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef || p.dictRef == (0, $01410cda1eef5011$export$e7df60530792b964).dictRef) // Update the molecule energy diagram.
            (0, $7e68913db756e51f$export$e7cd7bead34ef747)();
        }).bind(ps);
        div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(pID, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, psAttributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), mIDM.addID(pID, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, boundary, boundary);
        plDiv.appendChild(div);
    // click
    ...
    //button.click();
        ...
        if (arrayNodes.length > 0) {
            ...
            p.setProperty(pa);
            div = $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, paAttributes, div, div.querySelector((0, $7e68913db756e51f$export$de72b11c4a138de9)), mIDM.addID(pID, (0, $01410cda1eef5011$export$9f93a3fdf2490572).s_units), p.dictRef, boundary, boundary);
            plDiv.appendChild(div);
        } else {
            // PropertyMatrix.
            ...
            if (matrixNodes.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$60fee6710ef6fb16)(pID, boundary, level, (event)=>{
                    let target = event.target;
                    $174b37a7f81f9b54$export$819b5ff7dff3652c(false, p.dictRef, pm, target);
                }, inputString, label);
                ...
                (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, pmAttributes, inputDiv, ta, mIDM.addID(pID, (0, $01410cda1eef5011$export$9f93a3fdf2490572).s_units), p.dictRef, boundary, boundary);
...
function $174b37a7f81f9b54$export$cbd171726dbc631c(pl, p, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = (0, $7e68913db756e51f$export$edf19e7acee859e6)((0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef), pIDs, p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        plDiv.appendChild(div);
 ...
 */ function $174b37a7f81f9b54$var$processEnergyTransferModel(mIDM, etm, molecule, element, moleculeDiv) {
    ...
    if (xml_deltaEDowns.length > 0) {
        ...
        let etmdivID = mIDM.addID(moleculeDiv.id, (0, $01410cda1eef5011$export$499950da20810ac9).tagName);
        ...
        for(let k = 0; k < xml_deltaEDowns.length; k++){
            ...
            // Create a new div element for the input.
            let id = mIDM.addID(etmdivID, (0, $01410cda1eef5011$export$16fc56ab40b12b45).tagName, k);
...
function $174b37a7f81f9b54$export$7aad7e61c4f49964(mIDM, molecule, moleculeDiv, boundary, level) {
    // Add a 3Dmol.js viewer.
    // Create a new div for the viewer.
    let viewerContainerDivID = mIDM.addID(moleculeDiv.id, (0, $7e68913db756e51f$export$a59b122474df8e10), (0, $7e68913db756e51f$export$7295f538b9762c5));
    ...
    let viewerDivID = mIDM.addID(moleculeDiv.id, (0, $7e68913db756e51f$export$a59b122474df8e10));
    ...
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)("Save as PNG", mIDM.addID(viewerDivID, (0, $7e68913db756e51f$export$c1dfed4ad865f0b6)), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
...
function $174b37a7f81f9b54$export$3c6ba217df5e6b83(dictRef, ps, id, boundary, level) {
    ...
    let valueInputId = (0, $7e68913db756e51f$export$bea69a603fae01a6)(id, (0, $7e68913db756e51f$export$58785e0018b77d4a));
...
function $174b37a7f81f9b54$export$8f5eeb1aadb49400(attributes, mIDM, value, units, pl, p, plDiv, boundary) {
    let ps = p.getProperty();
    ps.setValue = (function(value) {
        ps.value = value;
        if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef || p.dictRef == (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef || p.dictRef == (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef || p.dictRef == (0, $01410cda1eef5011$export$e7df60530792b964).dictRef) // Update the molecule energy diagram.
    ...
    if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef || p.dictRef == (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef || p.dictRef == (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef || p.dictRef == (0, $01410cda1eef5011$export$e7df60530792b964).dictRef) // Update the molecule energy diagram.
    (0, $7e68913db756e51f$export$e7cd7bead34ef747)();
    let id = (0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef);
    console.log("div ID " + id);
    let div = (0, $7e68913db756e51f$export$17d48ee8ddbf2d44)(id, mIDM, p.dictRef, ps.getValue.bind(ps), (value)=>$174b37a7f81f9b54$export$c1dce3e534360efd(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
    console.log("unitsID " + (0, $7e68913db756e51f$export$bea69a603fae01a6)(id, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units));
    (0, $7e68913db756e51f$export$2b2254f82abcc900)(units, attributes, div, div.querySelector((0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, (0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units), p.dictRef, boundary, boundary);
    plDiv.appendChild(div);
}
function $174b37a7f81f9b54$export$e5600fc4ea245d6d(plDiv, mIDM, name, pa, getter, setter, remover, marginComponent, margin) {
    let divID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, name);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(divID, margin);
    let buttonTextContentSelected = name + (0, $7e68913db756e51f$export$f0fb6e9d3fd6cf72);
    let buttonTextContentDeselected = name + (0, $7e68913db756e51f$export$b758aa9bd161846e);
    //let id: string = mIDM.addID(plDiv.id, name);
    //let idb = mIDM.addID(divID, s_button);
    let idb = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    ...
    let inputId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divID, (0, $7e68913db756e51f$export$58785e0018b77d4a));
    let values = getter();
    if (values == undefined) {
        button.textContent = buttonTextContentDeselected;
        button.classList.toggle((0, $7e68913db756e51f$export$50cc31b59b02e033));
    } else {
        $174b37a7f81f9b54$var$addNumberArray(div, inputId, name, values, pa, getter, setter, marginComponent);
        //plDiv.appendChild(div);
        button.textContent = buttonTextContentSelected;
        button.classList.toggle((0, $7e68913db756e51f$export$d52efe23389358db));
    }
 ...
 */ function $174b37a7f81f9b54$var$addNumberArray(div, id, name, values, paom, getter, setter, boundary) {
    let valueString;
    ...
    ta.addEventListener("change", (event)=>{
        let target = event.target;
        let values = $174b37a7f81f9b54$export$819b5ff7dff3652c(true, name, paom, ta);
        try {
            setter(values);
 ...
 */ function $174b37a7f81f9b54$var$toBigArray(inputString, defaultValues) {
...
function $174b37a7f81f9b54$export$819b5ff7dff3652c(setSize, dictRef, node, ta) {
    ...
    let values = $174b37a7f81f9b54$var$toBigArray(inputString, node.values);
     ...
     */ parse(xml) {
        ...
        */ // Process the XML "molecule" elements.
        ...
        for(let i = 0; i < xml_msl; i++){
            ...
            let id;
            while(true){
                id = (0, $174b37a7f81f9b54$export$194bfe7da61d65)(false, mid, undefined, molecules);
            ...
            if (xml_pls.length == 1) {
                ...
                pl.setProperty($991aea17c2d860ae$var$createProperty(xml_ps[j]));
                moleculeTagNames.delete((0, $01410cda1eef5011$export$4e0d1ad7ad6a0802).tagName);
            } else {
                ...
                pl.setProperty($991aea17c2d860ae$var$createProperty(xml_ps[0]));
                moleculeTagNames.delete((0, $01410cda1eef5011$export$41b04b3a73e7216d).tagName);
            }
            // Organise EnergyTransferModel.
            let xml_etms = xml_ms[i].getElementsByTagName((0, $01410cda1eef5011$export$499950da20810ac9).tagName);
            ...
            if (xml_dosl.length > 0) {
                ...
                if (xml_dos.length == 0) throw new Error("Expecting 1 or more " + (0, $01410cda1eef5011$export$126b026a4280c589).tagName + " but finding 0!");
                    ...
                    if (xml_t.length != 1) throw new Error("Expecting 1 " + (0, $69ecbdaa96f3962d$export$971d5caa766a69d7).tagName + " but finding " + xml_t.length + "!");
                        ...
                        let t = new (0, $69ecbdaa96f3962d$export$971d5caa766a69d7)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_t[0]), new (0, $a227f0f1258db640$exports.Big)((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_t[0]))));
                        dos.setT(t);
                    //dosDiv.appendChild(createLabel(t.value.toString(), boundary1));
                    }
                    // qtot.
                    ...
                    if (xml_qtot.length != 1) throw new Error("Expecting 1 " + (0, $01410cda1eef5011$export$656e8af5996be26).tagName + " but finding " + xml_qtot.length + "!");
                        ...
                        let qtot = new (0, $01410cda1eef5011$export$656e8af5996be26)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_qtot[0]), new (0, $a227f0f1258db640$exports.Big)((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_qtot[0]))));
                        dos.setQtot(qtot);
                    //dosDiv.appendChild(createLabel(Qtot.tagName + " " + qtot.value.toString(), boundary1));
                    }
                    // sumc.
                    ...
                    if (xml_sumc.length != 1) throw new Error("Expecting 1 " + (0, $01410cda1eef5011$export$c8de58561fc3a710).tagName + " but finding " + xml_sumc.length + "!");
                        ...
                        let sumc = new (0, $01410cda1eef5011$export$c8de58561fc3a710)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_sumc[0]), new (0, $a227f0f1258db640$exports.Big)((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_sumc[0]))));
                        dos.setSumc(sumc);
                    //dosDiv.appendChild(createLabel(sumc.value.toString(), boundary1));
                    }
                    // sumg.
                    ...
                    if (xml_sumg.length != 1) throw new Error("Expecting 1 " + (0, $01410cda1eef5011$export$159051b21d796f59).tagName + " but finding " + xml_sumg.length + "!");
                        ...
                        let sumg = new (0, $01410cda1eef5011$export$159051b21d796f59)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_sumg[0]), new (0, $a227f0f1258db640$exports.Big)((0, $cc8c7201a9bad777$export$13cb40e9b656ab9e)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_sumg[0]))));
                        dos.setSumg(sumg);
                    //dosDiv.appendChild(createLabel(sumg.value.toString(), boundary1));
                    }
                }
            ...
            if (xml_states.length > 0) {
                ...
                m.setStates(ss);
                moleculeTagNames.delete((0, $01410cda1eef5011$export$47283907dceba392).tagName);
            }
            // Check for unexpected tags.
            moleculeTagNames.delete("#text");
            if (moleculeTagNames.size > 0) {
 ...
 * @returns The property.
 */ function $991aea17c2d860ae$var$createProperty(xml) {
    let p = new (0, $01410cda1eef5011$export$41b04b3a73e7216d)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml));
    //console.log("p.dictRef " + p.dictRef);
    if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef) // "me:ZPE", scalar, Mesmer.energyUnits.
    $991aea17c2d860ae$var$processProperty(p, xml);
    else if (p.dictRef == (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef) // "me:Hf0", scalar, Mesmer.energyUnits.
    $991aea17c2d860ae$var$processProperty(p, xml);
    else if (p.dictRef == (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef) // "me:HfAT0", scalar, Mesmer.energyUnits.
    $991aea17c2d860ae$var$processProperty(p, xml);
    ...
    $991aea17c2d860ae$var$processProperty(p, xml);
    else if (p.dictRef == (0, $01410cda1eef5011$export$2e66a7dc5ebae8a1).dictRef) // "me:electronicExcitation", scalar, cm-1.
    $991aea17c2d860ae$var$processProperty(p, xml);
    else $991aea17c2d860ae$export$cbd171726dbc631c(p, xml);
    return p;
}
/**
 * Process a property.
 * @param p The property.
 * @param element The element.
 */ function $991aea17c2d860ae$var$processProperty(p, element) {
    // PropertyScalar.
    let scalarNodes = element.getElementsByTagName((0, $01410cda1eef5011$export$742f9ce317ef8ba3).tagName);
    if (scalarNodes.length > 0) {
        if (scalarNodes.length != 1) throw new Error("Expecting 1 " + (0, $01410cda1eef5011$export$742f9ce317ef8ba3).tagName + " but finding " + scalarNodes.length + "!");
        let inputString = (0, $cc8c7201a9bad777$export$433c819efd6b1ea5)(scalarNodes[0]);
        let value = new (0, $a227f0f1258db640$exports.Big)(inputString);
        let psAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(scalarNodes[0]);
        // Add PropertyScalarNumber.
        let ps = new (0, $01410cda1eef5011$export$742f9ce317ef8ba3)(psAttributes, value);
        p.setProperty(ps);
...
function $991aea17c2d860ae$export$cbd171726dbc631c(p, element) {
    // PropertyScalarString.
    let scalarNodes = element.getElementsByTagName((0, $01410cda1eef5011$export$eb6936faa5f138bb).tagName);
    if (scalarNodes.length > 0) {
        if (scalarNodes.length != 1) throw new Error("Expecting 1 " + (0, $01410cda1eef5011$export$eb6936faa5f138bb).tagName + " but finding " + scalarNodes.length + "!");
...
function $0ed86fc7e748b547$export$c9a19c59161f09a0() {
    ...
    let lb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_MESMER_File, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Load_MESMER_File), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    lb.addEventListener("click", (event)=>{
        // Alert the user that any changes will be lost unless saved, giving the option to save.
        if (confirm("Any unsaved changes will be lost. Select OK to continue loading or Cancel to cancel.")) (0, $7e68913db756e51f$export$11e63f7b0f3d9900)();
        else return;
    });
    menuDiv.appendChild(lb);
    // Add Load Into Library button.
    let s_Load_Into_Library = "Load Into Library";
    let llmb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Load_Into_Library, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Load_Into_Library), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    menuDiv.appendChild(llmb);
    let lms = new (0, $991aea17c2d860ae$export$7587e661a05e5158)();
    llmb.addEventListener("click", async (event)=>{
        let ms = await lms.readFile();
        // Add the molecules to the libmols map.
        if ((0, $7e68913db756e51f$export$7c97c73a2c729cf9) == undefined) (0, $7e68913db756e51f$export$4802e08cda112391)(new Map());
        ms.forEach((v, k)=>{
            (0, $7e68913db756e51f$export$ac55d333e780178c)(false, v, (0, $7e68913db756e51f$export$7c97c73a2c729cf9));
        });
    });
    // Add Clear Library button.
    let s_Clear_Library = "Clear Library";
    let clmb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Clear_Library, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Clear_Library), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    menuDiv.appendChild(clmb);
    clmb.addEventListener("click", async (event)=>{
        (0, $7e68913db756e51f$export$4802e08cda112391)(new Map());
    });
    ...
    let s_Save = "Save";
    let saveButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Save, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Save), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    ...
    let sab = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(s_Restart, (0, $7e68913db756e51f$export$39722580448f5a99)(s_Restart), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    menuDiv.appendChild(sab);
    sab.addEventListener("click", (event)=>{
        // Alert the user that any changes will be lost unless saved, giving the option to save.
        if (confirm("Any unsaved changes will be lost. Select OK to continue loading or Cancel to cancel.")) (0, $7e68913db756e51f$export$2f77af1e417942e1)();
        else return;
    });
...
class $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba extends (0, $cc8c7201a9bad777$export$ca4ceee82ec565dc) {
     ...
     */ constructor(attributes){
        ...
        this.ref = attributes.get($28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba.s_ref);
        this.role = attributes.get($28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba.s_role);
    }
    /**
...
class $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    ...
    static{
        this.roleOptions = [
            $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6.s_deficientReactant,
            $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6.s_excessReactant,
            $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6.s_modelled
        ];
    }
    /**
     * @param attributes The attributes.
     ...
     */ getTotalEnergy(retrieveMolecule, molecules, items) {
        return Array.from(items.values()).map((item)=>{
            ...
            if (molecule == undefined) {
                ...
                return 0, $7e68913db756e51f$export$a94c859b6fc3ec52;
            }
     ...
     */ getEnergyUnits(retrieveMolecule, molecules, items) {
        ...
        Array.from(items.values()).map((item)=>{
            ...
            if (molecule == undefined) {
                ...
                let units = pZPE?.attributes.get((0, $01410cda1eef5011$export$742f9ce317ef8ba3).s_units);
...
function $cbb1ac0a822ffab5$export$b12ef0e3d99deb64(rIDM, rlDiv, reactions, molecules) {
    let rb = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), (0, $7e68913db756e51f$export$bea69a603fae01a6)((0, $28e4a0fe6fb3e45e$export$d2ae4167a30cf6bb).tagName, "add", (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
    rlDiv.appendChild(rb);
    rb.addEventListener("click", ()=>{
        let reactionAttributes = new Map();
        // Get Reaction ID.
        let rl = (0, $7e68913db756e51f$export$3bb92be1f57fd129).getReactionList();
        let i = rl.getNextReactionID();
        console.log("Next Reaction ID=" + i);
        reactionAttributes.set((0, $28e4a0fe6fb3e45e$export$d2ae4167a30cf6bb).s_id, "R" + i);
        let r = new (0, $28e4a0fe6fb3e45e$export$d2ae4167a30cf6bb)(reactionAttributes);
        reactions.set(r.id, r);
        // Add to mesmer.
        rl.addReaction(r);
        let rDivID = rIDM.addID((0, $28e4a0fe6fb3e45e$export$d2ae4167a30cf6bb).tagName, r.id);
        let rDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rDivID);
        rlDiv.appendChild(rDiv);
        // Create collapsible content.
        let rcDivID = rIDM.addID(rDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        let rsDivID = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName);
        let rsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rsDivID);
        let rscDivID = rIDM.addID(rsDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let rscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rscDivID, rDiv, null, rsDiv, (0, $7e68913db756e51f$export$ae4e72e6b8ac1d64), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        let reactants = new Map();
        r.setReactants(reactants);
        $cbb1ac0a822ffab5$var$addAddReactantButton(r, rcb, rIDM, rDivID, rsDiv, molecules, reactants);
        // Create collapsible content for products.
        let psDivID = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).tagName);
        let psDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(psDivID);
        let pscDivID = rIDM.addID(psDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let pscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pscDivID, rDiv, null, psDiv, (0, $7e68913db756e51f$export$2a0edc6caa2454db), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        let products = new Map();
        r.setProducts(products);
        $cbb1ac0a822ffab5$var$addAddProductButton(r, rcb, rIDM, rDivID, psDiv, molecules, products);
        // Create collapsible content for transition states.
        let tsDivID = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).tagName);
        let tsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(tsDivID);
        let tscDivID = rIDM.addID(tsDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let tscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(tscDivID, rDiv, null, tsDiv, (0, $7e68913db756e51f$export$f6270d42dca30dc6), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        let transitionStates = new Map();
        r.setTransitionStates(transitionStates);
        $cbb1ac0a822ffab5$var$addAddTransitionStateButton(rIDM, rDivID, tsDiv, molecules, transitionStates);
        // Create collapsible content for MCRCMethod.
        let mmDivId = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$6fa70ee10f356b6).tagName);
        let mmDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mmDivId);
        let mmcDivId = rIDM.addID(mmDivId, (0, $7e68913db756e51f$export$7295f538b9762c5));
        let mmcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mmcDivId, rDiv, null, mmDiv, (0, $28e4a0fe6fb3e45e$export$6fa70ee10f356b6).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
        //rDiv.appendChild(mmcDiv);
        let mmAttributes = new Map();
        mmAttributes.set("xsi:type", (0, $28e4a0fe6fb3e45e$export$191e95ebb11cc88).xsiType);
        let mm = new (0, $28e4a0fe6fb3e45e$export$191e95ebb11cc88)(mmAttributes);
        r.setMCRCMethod(mm);
        let inputString;
        let value;
        {
            ...
            if ((0, $7e68913db756e51f$export$ebe90cb607ad99e) != undefined) {
                inputString = (0, $7e68913db756e51f$export$ebe90cb607ad99e).values.get((0, $28e4a0fe6fb3e45e$export$38ce90ac8b004d85).tagName) ?? "";
                if (inputString == "") inputString = "6.00e-12";
            } else inputString = "6.00e-12";
            value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
        ...
        }
        {
            // Get value from defaults.
            if ((0, $7e68913db756e51f$export$ebe90cb607ad99e) != undefined) {
                inputString = (0, $7e68913db756e51f$export$ebe90cb607ad99e).values.get((0, $28e4a0fe6fb3e45e$export$1bdc69d2439d749d).tagName) ?? "";
        ...
        }
        {
            // Get value from defaults.
            if ((0, $7e68913db756e51f$export$ebe90cb607ad99e) != undefined) {
                inputString = (0, $7e68913db756e51f$export$ebe90cb607ad99e).values.get((0, $28e4a0fe6fb3e45e$export$8d95dd32819bc86c).tagName) ?? "";
        ...
        }
        {
            // Get value from defaults.
            if ((0, $7e68913db756e51f$export$ebe90cb607ad99e) != undefined) {
                inputString = (0, $7e68913db756e51f$export$ebe90cb607ad99e).values.get((0, $28e4a0fe6fb3e45e$export$d08982dd841d496f).tagName) ?? "";
        ...
        // ExcessReactantConc.
        let ercDivId = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName);
        let ercDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(ercDivId);
        // Get default value.
        if ((0, $7e68913db756e51f$export$ebe90cb607ad99e) != undefined) {
            inputString = (0, $7e68913db756e51f$export$ebe90cb607ad99e).values.get((0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName) ?? "";
            if (inputString == "") inputString = "2.25e+16";
        } else inputString = "2.25e+16";
        value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
        let erc = new (0, $28e4a0fe6fb3e45e$export$284227145ed02b04)(new Map(), value);
        r.setExcessReactantConc(erc);
        // Create a new div element for the input.
        let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $7e68913db756e51f$export$bea69a603fae01a6)(ercDivId, (0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName, (0, $7e68913db756e51f$export$58785e0018b77d4a)), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7), (event)=>{
            let target = event.target;
            (0, $7e68913db756e51f$export$b1e4cbf5b56e0e21)(erc, target);
        }, inputString, (0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName);
        let input = lwi.querySelector("input");
        input.value = inputString;
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
        input.addEventListener("change", (event)=>{
            ...
            erc.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(inputString);
            console.log((0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName + " changed to " + inputString);
            (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
        });
        (0, $7e68913db756e51f$export$2b2254f82abcc900)(undefined, new Map(), lwi, null, (0, $7e68913db756e51f$export$bea69a603fae01a6)(ercDivId, (0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName), (0, $28e4a0fe6fb3e45e$export$284227145ed02b04).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        ercDiv.appendChild(lwi);
        rDiv.appendChild(ercDiv);
        // Add a remove reaction button.
        (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(rDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), ()=>{
            $cbb1ac0a822ffab5$var$removeReaction(rlDiv, rcDiv, rIDM, rDivID, reactions, r);
        });
    });
    return rb;
}
 ...
 */ function $cbb1ac0a822ffab5$var$addAddReactantButton(r, rcb, rIDM, rDivID, rsDiv, molecules, reactants) {
    // Add an add button to add a reactant.
    let addReactantButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    addReactantButton.addEventListener("click", ()=>{
        ...
        selectReactant.addEventListener("change", (event)=>{
            ...
            reactantDiv.id = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName, mid);
            rmAttributes.set((0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba).s_ref, mid);
            let rm = new (0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba)(rmAttributes);
            let reactant = new (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6)(new Map(), rm);
            ...
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(rm.getRef() + " role", (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).roleOptions, "Role", rm.getRole(), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            let select = lws.querySelector("select");
            select?.addEventListener("change", (event)=>{
                let target = event.target;
            ...
            let rrb = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(reactantDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
 ...
 */ function $cbb1ac0a822ffab5$var$addAddProductButton(r, rcb, rIDM, rDivID, psDiv, molecules, products) {
    // Add an add button to add a product.
    let addProductButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    addProductButton.addEventListener("click", ()=>{
        ...
        let productDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined);
        psDiv.insertBefore(productDiv, addProductButton);
        // Create a selector to select a molecule as a product.
        let selectProduct = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)((0, $7e68913db756e51f$export$5ac38056c0103baa)(molecules), (0, $f0396edd0a5c99f7$export$8797b0c8298d191), "", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).tagName, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Have the select element update options if new molecules are added.
        selectProduct.classList.add((0, $754b7c8446bbe616$export$b33a132661f4be58).tagName);
        ...
        selectProduct.addEventListener("change", (event)=>{
            ...
            productDiv.id = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).tagName, mid);
            rmAttributes.set((0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba).s_ref, mid);
            let rm = new (0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba)(rmAttributes);
            let product = new (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668)(new Map(), rm);
            ...
            console.log("ReactionLabel=" + r.getLabel());
            // Create a new div for the role selector.
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(rm.getRef() + " role", (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).roleOptions, "Role", rm.getRole(), (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            let select = lws.querySelector("select");
            select?.addEventListener("change", (event)=>{
                let target = event.target;
                rm.setRole(target.value);
            ...
            let prb = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(productDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
 ...
 */ function $cbb1ac0a822ffab5$var$addAddTransitionStateButton(rIDM, rDivID, tsDiv, molecules, transitionStates) {
    // Add an add button to add a transition state.
    let addTSButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    addTSButton.addEventListener("click", ()=>{
        ...
        let ts2Div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined);
        tsDiv.insertBefore(ts2Div, addTSButton);
        // Create a selector to select a molecule as a reactant.
        let selectTS = (0, $f0396edd0a5c99f7$export$b89bf4b169286865)((0, $7e68913db756e51f$export$5ac38056c0103baa)(molecules), (0, $f0396edd0a5c99f7$export$8797b0c8298d191), "", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).tagName, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Have the select element update options if new molecules are added.
        selectTS.classList.add((0, $754b7c8446bbe616$export$b33a132661f4be58).tagName);
        ...
        selectTS.addEventListener("change", (event)=>{
            ...
            ts2Div.id = rIDM.addID(rDivID, (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).tagName, mid);
            rmAttributes.set((0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba).s_ref, mid);
            let rm = new (0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba)(rmAttributes);
            let reactant = new (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216)(new Map(), rm);
            transitionStates.set(mid, reactant);
            // Create a label for the Transition State role.
            let label = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(rm.getRef() + " role " + (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).role, (0, $7e68913db756e51f$export$39c84188a71202f7));
            ts2Div.appendChild(label);
            // Remove the select element.
            ts2Div.removeChild(selectTS);
            // Add a remove button to remove the transition state.
            let rrb = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(ts2Div, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
 ...
 */ function $cbb1ac0a822ffab5$var$removeReaction(rlDiv, rcDiv, rIDM, rDivID, reactions, r) {
    rlDiv.removeChild(rcDiv);
    rIDM.removeIDs(rDivID);
    rIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $7e68913db756e51f$export$7295f538b9762c5)));
    rIDM.removeIDs((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName));
    reactions.delete(r.id);
    (0, $7e68913db756e51f$export$3bb92be1f57fd129).getReactionList().removeReaction(r.id);
}
function $cbb1ac0a822ffab5$export$ef4959ac45646090(xml, rIDM, rsDivID, reactions, molecules) {
    let bid = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rsDivID, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let rcb = document.querySelector(bid);
    // Create div to contain the reaction list.
    let rlDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    ...
    if (reactionListTagNames.size > 0) {
        ...
        for(let i = 0; i < xml_reactions.length; i++){
            ...
            let rsDivID = rIDM.addID(reactionDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName);
            let rsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rsDivID);
            let rscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rsDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            let rscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rscDivID, reactionDiv, null, rsDiv, (0, $7e68913db756e51f$export$ae4e72e6b8ac1d64), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            let reactants = new Map();
            if (xml_reactants.length > 0) {
                for(let j = 0; j < xml_reactants.length; j++){
                    let reactantDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(rsDivID, (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).tagName, j);
                    let reactantDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(reactantDivID);
                    ...
                    let rmAttributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_molecule);
                    let molecule = new (0, $28e4a0fe6fb3e45e$export$e8a062bb2fc9e2ba)(rmAttributes);
                    ...
                    let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.getRef() + " role", (0, $28e4a0fe6fb3e45e$export$dcfd4302d04b7fb6).roleOptions, "Role", molecule.getRole(), rIDM.addID(reactantDivID, (0, $f0396edd0a5c99f7$export$8797b0c8298d191)), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            $cbb1ac0a822ffab5$var$addAddReactantButton(reaction, rcb, rIDM, reactionDivID, rsDiv, molecules, reactants);
            // Load products.
            ...
            let psDivID = rIDM.addID(reactionDivID, (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).tagName);
            let psDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(psDivID);
            let pscDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(psDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
            let pscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(pscDivID, reactionDiv, null, psDiv, (0, $7e68913db756e51f$export$2a0edc6caa2454db), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            if (xml_products.length > 0) {
                for(let j = 0; j < xml_products.length; j++){
                    ...
                    let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.getRef() + " role", (0, $28e4a0fe6fb3e45e$export$264ad599d7cef668).roleOptions, molecule.getRole(), molecule.getRef(), rIDM.addID(psDivID, j, "Role"), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
                    let select = lws.querySelector("select");
                    ...
                    // Add a remove button to remove the product.
                    let prb = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(psDiv, (0, $7e68913db756e51f$export$d6befed1f1d5e56b), ()=>{
            ...
            $cbb1ac0a822ffab5$var$addAddProductButton(reaction, rcb, rIDM, reactionDivID, psDiv, molecules, products);
            ...
            let reactioncDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(reactioncDivID, rlDiv, null, reactionDiv, reaction.getLabel(), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            // Load tunneling.
            ...
            let tscDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(tscDivID, reactionDiv, null, tsDiv, (0, $7e68913db756e51f$export$f6270d42dca30dc6), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            let transitionStates = new Map();
            if (xml_transitionStates.length > 0) {
                for(let j = 0; j < xml_transitionStates.length; j++){
                    ...
                    // Create a label for the Transition State role.
                    let label = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)(molecule.getRef() + " role " + (0, $28e4a0fe6fb3e45e$export$145c1ed87b1a2216).role, (0, $7e68913db756e51f$export$39c84188a71202f7));
                    tsDiv.appendChild(label);
                }
                reaction.setTransitionStates(transitionStates);
            }
            $cbb1ac0a822ffab5$var$addAddTransitionStateButton(rIDM, reactionDivID, tsDiv, molecules, transitionStates);
            // Load MCRCMethod.
            ...
            if (xml_crl.length > 0) {
                ...
                if (xml_k.length > 0) {
                    ...
                    for(let j = 0; j < xml_k.length; j++){
                        ...
                        (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(t, k.getHeader());
            ...
            // Add a remove reaction button.
            (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(reactionDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), ()=>{
                $cbb1ac0a822ffab5$var$removeReaction(rlDiv, reactioncDiv, rIDM, reactionDivID, reactions, reaction);
            });
        }
...
function $589572943861997b$export$120facc5efd57974(xml, conditionsIDs, molecules) {
    ...
    $589572943861997b$export$c1600199abe19050(conditionssDiv, conditionsIDs, molecules);
 ...
 */ function $589572943861997b$var$handlePTs(conditions, cDiv, xml_conditions, conditionsIDs, molecules) {
    ...
    let pTs = new (0, $754b7c8446bbe616$export$3be0efe793283834)(new Map());
    if (xml_conditions) {
        ...
        if (xml_PTss.length > 0) {
            ...
            if (xml_PTpairs.length == 0) console.warn("Expecting 1 or more " + (0, $754b7c8446bbe616$export$3fe97ecb6b172244).tagName + " but finding 0! Please add some PTpairs in " + (0, $754b7c8446bbe616$export$363c7374d425f4ad).tagName + " " + conditions.id + ".");
            else {
...
function $589572943861997b$export$c1600199abe19050(conditionssDiv, conditionsDivIDs, molecules) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        // Create collapsible div.
        let cDivID = conditionsDivIDs.addID((0, $754b7c8446bbe616$export$363c7374d425f4ad).tagName, i.toString());
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        let ccDivID = (0, $7e68913db756e51f$export$bea69a603fae01a6)(cDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        $589572943861997b$var$handleBathGases(conditions, cDiv, null, conditionsDivIDs, molecules);
        $589572943861997b$var$handlePTs(conditions, cDiv, null, conditionsDivIDs, molecules);
        // Add a remove conditions button.
        let removeButton = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(cDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), (0, $7e68913db756e51f$export$3bb92be1f57fd129).removeConditions.bind((0, $7e68913db756e51f$export$3bb92be1f57fd129)), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the conditions.
...
function $dde1c59fe054f706$export$7502110c3a5d7b36(xml, mpIDM) {
    ...
    for(let i = 0; i < xml_mps.length; i++){
        ...
        let mpDivID = mpIDM.addID((0, $f7e4eb4e898217f9$export$77f098867dc64198).tagName, i.toString());
        let mpDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(mpDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        let mpcDivID = mpIDM.addID(mpDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        $dde1c59fe054f706$var$processGrainSize(mp, xml_mps[i], mpDiv, mpIDM);
        //setGrainSize(mp, xml_mps[i], mpDiv);
        $dde1c59fe054f706$var$processModelParametersN(mp, mpIDM, xml_mps[i], mpDiv, (0, $08d0a8a73bf11acb$export$576b56ca6e34780b), mp.setAutomaticallySetMaxEne, mp.removeAutomaticallySetMaxEne.bind(mp));
        $dde1c59fe054f706$var$processModelParametersN(mp, mpIDM, xml_mps[i], mpDiv, (0, $f7e4eb4e898217f9$export$aa73446724166cdb), mp.setEnergyAboveTheTopHill, mp.removeEnergyAboveTheTopHill.bind(mp));
        $dde1c59fe054f706$var$processModelParametersN(mp, mpIDM, xml_mps[i], mpDiv, (0, $f7e4eb4e898217f9$export$f9c72965e4ddfc8e), mp.setMaxTemperature, mp.removeMaxTemperature.bind(mp));
    ...
    $dde1c59fe054f706$export$5733f83ee927902f(mpsDiv, mpIDM);
    return mpsDiv;
}
/**
 ...
 */ function $dde1c59fe054f706$var$processGrainSize(mps, xml_mps, mpsDiv, modelParametersIDs) {
    ...
    if (xml_mps != null) {
        ...
        if (xml.length == 1) {
            ...
            let value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(Number(valueString));
...
function $dde1c59fe054f706$export$5733f83ee927902f(mpsDiv, mpIDM) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), undefined, (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    button.addEventListener("click", (event)=>{
        ...
        $dde1c59fe054f706$var$addGrainSize(mp, mpDiv, mpIDM);
        $dde1c59fe054f706$var$processModelParametersN(mp, mpIDM, null, mpDiv, (0, $08d0a8a73bf11acb$export$576b56ca6e34780b), mp.setAutomaticallySetMaxEne, mp.removeAutomaticallySetMaxEne);
        $dde1c59fe054f706$var$processModelParametersN(mp, mpIDM, null, mpDiv, (0, $f7e4eb4e898217f9$export$aa73446724166cdb), mp.setEnergyAboveTheTopHill, mp.removeEnergyAboveTheTopHill);
        $dde1c59fe054f706$var$processModelParametersN(mp, mpIDM, null, mpDiv, (0, $f7e4eb4e898217f9$export$f9c72965e4ddfc8e), mp.setMaxTemperature, mp.removeMaxTemperature);
        // Add a remove modelParameters button.
        let removeButton = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(mpDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), (0, $7e68913db756e51f$export$3bb92be1f57fd129).removeModelParameters.bind((0, $7e68913db756e51f$export$3bb92be1f57fd129)), i);
        removeButton.addEventListener("click", (event)=>{
            // Remove the modelParameters.
...
function $180486e70a03b1bd$export$76caf53413cf3464(xml, controlIDM) {
    ...
    for(let i = 0; i < xml_controls.length; i++){
        ...
        let cDivID = controlIDM.addID((0, $08d0a8a73bf11acb$export$7a7fa4424cb20976).tagName, i.toString());
        let cDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(cDivID, (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        controlsDiv.appendChild(cDiv);
        let ccDivID = controlIDM.addID(cDivID, (0, $7e68913db756e51f$export$7295f538b9762c5));
        ...
        $180486e70a03b1bd$var$getControlOptionsSimple(control).forEach((option)=>{
            $180486e70a03b1bd$var$handleControl(control, cDiv, controlIDM, onOffControls, xml_control, null, option.class, option.setMethod, option.removeMethod);
        });
        ...
        $180486e70a03b1bd$var$handleTestMicroRates(control, cDiv, controlIDM, null, (0, $7e68913db756e51f$export$39c84188a71202f7));
        $180486e70a03b1bd$var$handleCalcMethod(control, cDiv, controlIDM, xml_control, (0, $7e68913db756e51f$export$39c84188a71202f7));
        $180486e70a03b1bd$var$getControlItems(control).forEach((item)=>{
            $180486e70a03b1bd$var$handleControl(control, cDiv, controlIDM, onOffControls, xml_control, (0, $7e68913db756e51f$export$39c84188a71202f7), item.class, item.setMethod, item.removeMethod, true);
        });
        ...
        if (xml_fdb.length == 1) {
            let fdb = new (0, $08d0a8a73bf11acb$export$6ffea14bdffd427f)();
            control.setForceMacroDetailedBalance(fdb);
            let fdbDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(controlIDM.addID(cDivID, (0, $08d0a8a73bf11acb$export$6ffea14bdffd427f).tagName), (0, $7e68913db756e51f$export$39c84188a71202f7));
            cDiv.appendChild(fdbDiv);
            let fdbl = (0, $f0396edd0a5c99f7$export$f2839682b8c07f35)((0, $08d0a8a73bf11acb$export$6ffea14bdffd427f).tagName, (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
        ...
        removeButton.addEventListener("click", (event)=>{
            ...
            let divCmId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(cDivID, (0, $08d0a8a73bf11acb$export$f0bfd84d03c3a22d).tagName);
    ...
    $180486e70a03b1bd$export$2e5ceda339237ce2(controlsDiv, controlIDM);
    return controlsDiv;
}
/**
 * @param control The control.
...
function $180486e70a03b1bd$export$2e5ceda339237ce2(controlsDiv, controlIDM) {
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)((0, $7e68913db756e51f$export$1bb8965d05fbf467), undefined, (0, $7e68913db756e51f$export$39c84188a71202f7));
    ...
    button.addEventListener("click", (event)=>{
        ...
        let onOffControls = new Map();
        $180486e70a03b1bd$var$getControlOptionsSimple(control).forEach((option)=>{
            $180486e70a03b1bd$var$handleControl(control, cDiv, controlIDM, onOffControls, null, null, option.class, option.setMethod, option.removeMethod);
        });
        // Create a div for the on/off controls.
        let onOffControlsDiv = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, (0, $7e68913db756e51f$export$39c84188a71202f7));
        let orderedOnOffControls = new Map([
        ...
        // Controls with additional things to set.
        $180486e70a03b1bd$var$handleTestMicroRates(control, cDiv, controlIDM, null, (0, $7e68913db756e51f$export$39c84188a71202f7));
        $180486e70a03b1bd$var$handleCalcMethod(control, cDiv, controlIDM, null, (0, $7e68913db756e51f$export$39c84188a71202f7));
        $180486e70a03b1bd$var$getControlItems(control).forEach((item)=>{
            $180486e70a03b1bd$var$handleControl(control, cDiv, controlIDM, onOffControls, null, (0, $7e68913db756e51f$export$39c84188a71202f7), item.class, item.setMethod, item.removeMethod, true);
        });
        // Add a remove control button.
        let removeButton = (0, $7e68913db756e51f$export$590bdcb7f5f5327a)(cDiv, (0, $7e68913db756e51f$export$39c84188a71202f7), (0, $7e68913db756e51f$export$3bb92be1f57fd129).removeControl.bind((0, $7e68913db756e51f$export$3bb92be1f57fd129)), i);
        removeButton.addEventListener("click", (event)=>{
 ...
 * @param xml_control The xml control. 
 * @param level The level.
 */ function $180486e70a03b1bd$var$handleCalcMethod(control, cDiv, controlIDM, xml_control, level) {
    ...
    if (xml_control != null) {
        ...
        if (xml.length > 0) {
            ...
            cm = $180486e70a03b1bd$var$getCalcMethod(controlIDM, control, divCm, xml, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (!control.index.has(tagName)) {
            ...
            let select = $180486e70a03b1bd$var$createSelectElementCalcMethod(controlIDM, control, div, options, tagName, (0, $7e68913db756e51f$export$d8b8827abc8ab7e7), divCmDetailsId, divCmDetailsSelectId);
 ...
 * @param xml_control The xml control.
 * @param level The level.
 */ function $180486e70a03b1bd$var$handleTestMicroRates(control, cDiv, controlIDM, xml_control, level) {
    ...
    let buttonTextContentSelected = tagName + (0, $7e68913db756e51f$export$f0fb6e9d3fd6cf72);
    let buttonTextContentDeselected = tagName + (0, $7e68913db756e51f$export$b758aa9bd161846e);
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, controlIDM.addID(cDiv.id, tagName, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), (0, $7e68913db756e51f$export$d6befed1f1d5e56b));
    div.appendChild(button);
    button.classList.add((0, $7e68913db756e51f$export$50cc31b59b02e033));
    button.classList.add((0, $7e68913db756e51f$export$d52efe23389358db));
    let idTmax = controlIDM.addID(cDiv.id, tagName, (0, $08d0a8a73bf11acb$export$58c8f4b7ec654137).tagName);
    let idTmin = controlIDM.addID(cDiv.id, tagName, (0, $08d0a8a73bf11acb$export$7be1a36e1f74dbc7).tagName);
    let idTstep = controlIDM.addID(cDiv.id, tagName, (0, $08d0a8a73bf11acb$export$7b8cfe3a6a460886).tagName);
    if (xml_control) {
        let xml = xml_control.getElementsByTagName(tagName);
        if (xml.length == 1) {
 ...
 */ function $180486e70a03b1bd$var$createTestMicroRates(control, div, xml_tmr, idTmax, idTmin, idTstep) {
    ...
    if (xml_tmr != null && xml_tmr.length > 0) {
        ...
        attributes.set((0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tmax, "2000"); // These should load from some kind of default...
        attributes.set((0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tmin, "100");
        attributes.set((0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tstep, "100");
        tmr = new (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31)(attributes);
    }
    control.setTestMicroRates(tmr);
    // Tmax.
    let tMax = tmr.getTmax();
    let tMaxlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(idTmax, "input"), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$b1ddbf2a116c10ee), (event)=>{
        let target = event.target;
        // Check the value is a number.
        try {
            tmr.setTmax(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value));
            console.log("Set " + (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tmax + " to " + target.value);
        } catch (e) {
            alert("Invalid input, resetting...");
            target.value = tMax.toString();
        }
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, tMax.toString(), (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tmax);
    tMaxlwi.id = idTmax;
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(tMaxlwi.querySelector("input"));
    div.appendChild(tMaxlwi);
    // Tmin.
    let tMin = tmr.getTmin();
    let tMinlwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(idTmin + "input"), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$b1ddbf2a116c10ee), (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
            tmr.setTmin(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value));
            console.log("Set " + (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tmin + " to " + target.value);
        } else {
            alert("Value is not numeric, resetting...");
            target.value = tMin.toString();
        }
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, tMin.toString(), (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tmin);
    tMinlwi.id = idTmin;
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(tMinlwi.querySelector("input"));
    div.appendChild(tMinlwi);
    // Tstep.
    let tStep = tmr.getTstep();
    let tSteplwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(idTstep + "input"), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$b1ddbf2a116c10ee), (event)=>{
        let target = event.target;
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
            tmr.setTstep(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value));
            console.log("Set " + (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tstep + " to " + target.value);
        } else {
            alert("Value is not numeric, resetting...");
            target.value = tStep.toString();
        }
        (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
    }, tStep.toString(), (0, $08d0a8a73bf11acb$export$1f37c7c73e401f31).s_Tstep);
    tSteplwi.id = idTstep;
 ...
 */ function $180486e70a03b1bd$var$getCalcMethod(controlIDM, control, divCm, xml, options, attributes, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId) {
    //console.log("getCalcMethod");
    let cm;
    // Create the select element.
    let select = $180486e70a03b1bd$var$createSelectElementCalcMethod(controlIDM, control, divCm, options, tagName, xsi_type, divCmDetailsId, divCmDetailsSelectId);
    ...
    cm = new (0, $08d0a8a73bf11acb$export$afd374542f6f3da6)(attributes);
        ...
        function processElement(xml, ClassConstructor, setterMethod, isNumber) {
            ...
            if (elementXml.length > 0) {
                if (elementXml.length == 1) {
                    ...
                    if (isNumber) {
                        if (value != undefined) {
                            if (value != "" && value != "NaN") value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(value);
                        }
                    }
                    let instance = new ClassConstructor((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(elementXml[0]), value);
                    setterMethod(instance);
        ...
        if (name != undefined && name !== xsi_type) {
            ...
            return $180486e70a03b1bd$var$getCalcMethod(controlIDM, control, divCm, xml, options, attributes, tagName, name, divCmDetailsId, divCmDetailsSelectId);
 ...
 */ function $180486e70a03b1bd$var$createSelectElementCalcMethod(controlIDM, control, div, options, tagName, value, divCmDetailsId, divCmDetailsSelectId) {
...
function $42d9507eaeb955b6$export$f1b90a337037b551(rdcID, rdcHeight, dark, rd_font, rd_lw, rd_lwc, rdWindow, molecules, reactions, draw) {
    // Destroy any existing rdWindow.
    if (rdWindow != null) {
        rdWindow.close();
        rdWindow = null;
    }
    let rddDiv = document.getElementById((0, $7e68913db756e51f$export$d475b637ed2435f7));
    let rdDivID = (0, $7e68913db756e51f$export$bea69a603fae01a6)((0, $7e68913db756e51f$export$196db41cc586e1c));
    // If rdDiv already exists, remove it.
    (0, $7e68913db756e51f$export$cd7f480d6b8286c3)(rdDivID);
    // Create collapsible content.
    let rdDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rdDivID, (0, $7e68913db756e51f$export$39c84188a71202f7));
    rddDiv.appendChild(rdDiv);
    // Create collapsible content.
    let rdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rdDivID, rddDiv, null, rdDiv, (0, $7e68913db756e51f$export$196db41cc586e1c), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$b1ddbf2a116c10ee));
    ...
    if (canvas != null && reactions.size > 0) {
        ...
        reactions.forEach(function(reaction, id) {
            ...
            if (reactantsLabel != undefined) {
                ...
                units = reaction.getEnergyUnits((0, $7e68913db756e51f$export$7577c09cb43cc206), molecules, reaction.getReactants());
            ...
            if (productsLabel != undefined) {
                ...
                console.log("energy=" + energy.toString());
                units = reaction.getEnergyUnits((0, $7e68913db756e51f$export$7577c09cb43cc206), molecules, reaction.getProducts());
                console.log("units=" + units);
                energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
                ...
                if (orders.has(productsLabel)) {
                    ...
                    if (rtss != undefined) {
                        rtss.forEach(function(ts, ref) {
                            ...
                            energy = (0, $7e68913db756e51f$export$7577c09cb43cc206)(moleculeRef, molecules).getEnergy() ?? (0, $7e68913db756e51f$export$a94c859b6fc3ec52);
                            console.log("energy=" + energy.toString());
                            units = reaction.getEnergyUnits((0, $7e68913db756e51f$export$7577c09cb43cc206), molecules, reaction.getTransitionStates());
                            console.log("units=" + units);
                            energyMin = (0, $134d19e749bf0414$export$96ec731ed4dcb222)(energyMin, energy);
                            energyMax = (0, $134d19e749bf0414$export$8960430cfd85939f)(energyMax, energy);
        ...
        reactions.forEach(function(reaction, id) {
            ...
            rtss.forEach(function(ts, ref) {
                let tsInXY = (0, $134d19e749bf0414$export$3988ae62b71be9a3)(tssInXY, ref);
                (0, $e5f7ab5c40db3f0e$export$819db45aec5fcbe5)(ctx, foreground, lwc, reactantOutXY[0], reactantOutXY[1], tsInXY[0], tsInXY[1]);
                let tsOutXY = (0, $134d19e749bf0414$export$3988ae62b71be9a3)(tssOutXY, ref);
                (0, $e5f7ab5c40db3f0e$export$819db45aec5fcbe5)(ctx, foreground, lwc, tsOutXY[0], tsOutXY[1], productInXY[0], productInXY[1]);
            });
        ...
        tss.forEach(function(value) {
            ...
            let energyRescaled = (0, $134d19e749bf0414$export$bd2782c820638828)(energyMin.toNumber(), energyRange, 0, originalCanvasHeight, energy);
            console.log("energyRescaled=" + energyRescaled.toString());
            let x0 = (0, $134d19e749bf0414$export$3988ae62b71be9a3)(tssInXY, value)[0];
            let y = energyRescaled + lw;
            let x1 = (0, $134d19e749bf0414$export$3988ae62b71be9a3)(tssOutXY, value)[0];
            let energyString = energy.toString();
...
(0, $a227f0f1258db640$exports.Big).PE = 7;
/**
...
const $7e68913db756e51f$export$2a0edc6caa2454db = "Products";
const $7e68913db756e51f$export$ae4e72e6b8ac1d64 = "Reactants";
...
const $7e68913db756e51f$export$d8b8827abc8ab7e7 = "Select an option (press a letter key to cycle through options for it)...";
const $7e68913db756e51f$export$7a850709da5c4f5b = "table";
const $7e68913db756e51f$var$s_title = "title";
const $7e68913db756e51f$export$f6270d42dca30dc6 = "Transition States";
const $7e68913db756e51f$export$de72b11c4a138de9 = "textarea";
const $7e68913db756e51f$export$4402a75a856d5151 = "Tunneling";
...
const $7e68913db756e51f$export$a59b122474df8e10 = "viewer";
 ...
 */ let $7e68913db756e51f$var$allIDs = new Set();
/**
 * A set of all IDs to be removed when loading a MESMER file.
 */ let $7e68913db756e51f$var$rIDs = new Set();
...
const $7e68913db756e51f$export$d475b637ed2435f7 = $7e68913db756e51f$export$39722580448f5a99($7e68913db756e51f$var$s_reactionsDiagram);
...
const $7e68913db756e51f$export$a94c859b6fc3ec52 = new (0, $a227f0f1258db640$exports.Big)(0);
 ...
 */ let $7e68913db756e51f$var$mIDM;
/**
 * For reactionList Div ID management.
 */ let $7e68913db756e51f$var$rIDM;
/**
 * For conditionsList Div ID management.
 */ let $7e68913db756e51f$var$conditionsIDM;
/**
 * For ModelParametersList Div ID management.
 */ let $7e68913db756e51f$var$mpIDM;
/**
 * For ControlList Div ID management.
 */ let $7e68913db756e51f$var$controlIDM;
let $7e68913db756e51f$export$3bb92be1f57fd129;
let $7e68913db756e51f$export$ebe90cb607ad99e;
let $7e68913db756e51f$export$7c97c73a2c729cf9;
function $7e68913db756e51f$export$4802e08cda112391(m) {
    $7e68913db756e51f$export$7c97c73a2c729cf9 = m;
}
function $7e68913db756e51f$export$ac55d333e780178c(ask, m, ms) {
    let mid;
    while(true){
        mid = (0, $174b37a7f81f9b54$export$194bfe7da61d65)(ask, m.getID(), m, ms);
        if (mid != undefined) break;
    }
    ms.set(mid, m);
}
...
function $7e68913db756e51f$export$7577c09cb43cc206(id, ms) {
...
const $7e68913db756e51f$var$rddDivID = $7e68913db756e51f$export$bea69a603fae01a6($7e68913db756e51f$export$196db41cc586e1c);
const $7e68913db756e51f$var$rddcID = $7e68913db756e51f$export$bea69a603fae01a6($7e68913db756e51f$var$rddDivID, "Canvas");
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Initialise mesmer.
    ...
    // StartAfresh
    $7e68913db756e51f$export$2f77af1e417942e1();
});
/**
 * (Re)Initialise the main GUI and IDManagers.
 */ function $7e68913db756e51f$var$initialise() {
    // Clear content.
    $7e68913db756e51f$var$rIDs.forEach((id)=>{
        $7e68913db756e51f$export$cd7f480d6b8286c3(id);
    });
    // Initialise
    $7e68913db756e51f$var$rIDs = new Set();
    $7e68913db756e51f$var$mIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
    $7e68913db756e51f$var$rIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
    $7e68913db756e51f$var$conditionsIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
    $7e68913db756e51f$var$mpIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
    $7e68913db756e51f$var$controlIDM = new $7e68913db756e51f$export$e0d5b774927d0e2a();
    // libmols is not reinitialised on purpose. To completely start again, reload the app.
    //libmols = new Map();
    $7e68913db756e51f$export$ebe90cb607ad99e = new (0, $cccccb2a0a919d2e$export$79d0bd4671c1fc67)();
    $7e68913db756e51f$var$molecules = new Map();
    $7e68913db756e51f$var$reactions = new Map();
    $7e68913db756e51f$var$scatterPlots = [];
}
function $7e68913db756e51f$export$2f77af1e417942e1() {
    $7e68913db756e51f$var$initialise();
    // Title.
    ...
    // Add add molecule button.
    let mb = (0, $174b37a7f81f9b54$export$12aafb9570dfb660)(mlDiv, $7e68913db756e51f$var$mIDM, $7e68913db756e51f$var$molecules);
    // Add add from library button.
    let lb = (0, $174b37a7f81f9b54$export$1f1b9bc888fe9f4c)(mlDiv, mb, $7e68913db756e51f$var$mIDM, $7e68913db756e51f$var$molecules);
    // Reaction List.
    ...
    $7e68913db756e51f$var$createReactionList((0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rlDivID));
    // Reactions Diagram.
    (0, $42d9507eaeb955b6$export$f1b90a337037b551)($7e68913db756e51f$var$rddcID, $7e68913db756e51f$var$rdcHeight, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc, $7e68913db756e51f$var$rdWindow, $7e68913db756e51f$var$molecules, $7e68913db756e51f$var$reactions, true);
    // Conditions.
    ...
    // Create an add button to add a conditions.
    (0, $589572943861997b$export$c1600199abe19050)(conditionssDiv, $7e68913db756e51f$var$conditionsIDM, $7e68913db756e51f$var$molecules);
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, conditionssDiv, "ConditionsList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Model Parameters.
    ...
    let modelParameterssDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(undefined, $7e68913db756e51f$export$d6befed1f1d5e56b);
    // Create an add button to add a model parameters.
    (0, $dde1c59fe054f706$export$5733f83ee927902f)(modelParameterssDiv, $7e68913db756e51f$var$mpIDM);
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, modelParameterssDiv, "ModelParametersList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // Control.
    ...
    // Create an add button to add a control.
    (0, $180486e70a03b1bd$export$2e5ceda339237ce2)(controlsDiv, $7e68913db756e51f$var$controlIDM);
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, controlsDiv, "ControlList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
/*
    // MetadataList.
 ...
 */ function $7e68913db756e51f$var$createReactionList(rlDiv) {
    ...
    let rb = (0, $cbb1ac0a822ffab5$export$b12ef0e3d99deb64)($7e68913db756e51f$var$rIDM, rlDiv, $7e68913db756e51f$var$reactions, $7e68913db756e51f$var$molecules);
}
function $7e68913db756e51f$export$e7cd7bead34ef747() {
    if ($7e68913db756e51f$var$rdWindow == null) {
        let rdCanvas = document.getElementById($7e68913db756e51f$var$rddcID);
        ...
        let c = $7e68913db756e51f$var$rdWindow.document.getElementById($7e68913db756e51f$var$rddcID);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    // Create collapsible content.
    let mlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mlDivID, mlDiv, null, (0, $174b37a7f81f9b54$export$ce852d72abd87240)(xml, $7e68913db756e51f$var$mIDM, $7e68913db756e51f$var$molecules), (0, $69ecbdaa96f3962d$export$19d70f3647dee606).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    //document.body.appendChild(mlcDiv);
    // Reaction List.
    let rlDivID = $7e68913db756e51f$export$bea69a603fae01a6((0, $69ecbdaa96f3962d$export$44466a39ca846289).tagName);
    // Remove any existing rlDivID HTMLDivElement.
    $7e68913db756e51f$export$cd7f480d6b8286c3(rlDivID);
    $7e68913db756e51f$var$createReactionList((0, $cbb1ac0a822ffab5$export$ef4959ac45646090)(xml, $7e68913db756e51f$var$rIDM, rlDivID, $7e68913db756e51f$var$reactions, $7e68913db756e51f$var$molecules));
    // Reactions Diagram.
    (0, $42d9507eaeb955b6$export$f1b90a337037b551)($7e68913db756e51f$var$rddcID, $7e68913db756e51f$var$rdcHeight, $7e68913db756e51f$var$dark, $7e68913db756e51f$var$rd_font, $7e68913db756e51f$var$rd_lw, $7e68913db756e51f$var$rd_lwc, $7e68913db756e51f$var$rdWindow, $7e68913db756e51f$var$molecules, $7e68913db756e51f$var$reactions, true);
    // ConditionsList.
    ...
    // Create collapsible content.
    let cdlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(cdlDivID, cdlDiv, null, (0, $589572943861997b$export$120facc5efd57974)(xml, $7e68913db756e51f$var$conditionsIDM, $7e68913db756e51f$var$molecules), "ConditionsList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // ModelParametersList.
    ...
    // Create collapsible content.
    let mplcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(mplDivID, mplDiv, null, (0, $dde1c59fe054f706$export$7502110c3a5d7b36)(xml, $7e68913db756e51f$var$mpIDM), "ModelParametersList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // ControlList.
    ...
    // Create collapsible content.
    let controlcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(clDivID, clDiv, null, (0, $180486e70a03b1bd$export$76caf53413cf3464)(xml, $7e68913db756e51f$var$controlIDM), "ControlList", $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
    // MetadataList.
    // Check if xml contains metadata.
    if (xml.getElementsByTagName((0, $97ed023cfe5af5b8$export$3e18a603070a78a).tagName).length > 0) {
    ...
    if (xml.getElementsByTagName((0, $6bf90154944bce56$export$c4c153dc94cc96b4).tagName).length > 0) {
...
function $7e68913db756e51f$export$17d48ee8ddbf2d44(id, tIDM, name, getter, setter, remover, marginComponent, margin) {
    ...
    let idb = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, name, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(buttonTextContentDeselected, idb, marginComponent);
    div.appendChild(button);
    ...
    let inputId = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(id, name, $7e68913db756e51f$export$58785e0018b77d4a);
    let value = getter();
    if (value == undefined) {
        //remover(name);
        button.textContent = buttonTextContentDeselected;
    ...
    button.addEventListener("click", (event)=>{
        if (document.getElementById(inputId) == null) {
            ...
            let input = div.querySelector($7e68913db756e51f$export$58785e0018b77d4a);
 ...
 * @param margin The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addNumber(div, id, name, value, getter, setter, margin) {
    let valueString;
    if (value == undefined) valueString = "";
    ...
    input.addEventListener("change", (event)=>{
        ...
        try {
            ...
            if (value2 == "") value2 = "0";
            setter(new (0, $a227f0f1258db640$exports.Big)(value2));
            console.log(name + " changed from " + valueString + " to " + target.value);
        } catch (e) {
            alert("Input invalid, resetting...");
            let value2 = getter();
...
function $7e68913db756e51f$export$edf19e7acee859e6(id, iDs, name, getter, setter, remover, marginComponent, margin) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, margin);
    let buttonTextContentSelected = name + $7e68913db756e51f$export$f0fb6e9d3fd6cf72;
    let buttonTextContentDeselected = name + $7e68913db756e51f$export$b758aa9bd161846e;
 ...
 * @param margin The boundary.
 * @param level The level.
 */ function $7e68913db756e51f$var$addString(div, id, name, value, setter, margin) {
    let valueString;
    if (value == undefined) valueString = "";
    else valueString = value.toString();
    //let input: HTMLInputElement = createInput("number", id, boundary);
...
function $7e68913db756e51f$export$2b2254f82abcc900(units, attributes, divToAddTo, elementToInsertBefore, id, tagOrDictRef, margin, level) {
    if (units != undefined) {
        let lws = $7e68913db756e51f$var$getUnitsLabelWithSelect(units, attributes, id, tagOrDictRef, margin, level);
...
function $7e68913db756e51f$export$88ed5e596ed31b40(message) {
    let n = 0;
    let nset = false;
    while(!nset){
        let nString = prompt(message, "0");
        if (nString != null) {
            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(nString)) {
                n = parseInt(nString);
                if (n > 0) nset = true;
            }
        }
 ...
 */ function $7e68913db756e51f$var$processMetadataList(xml) {
    ...
    if (xml_mls.length > 0) {
        ...
        let ml = new (0, $97ed023cfe5af5b8$export$3e18a603070a78a)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_mls[xml_mls.length - 1]));
    ...
    if (xml_as.length > 0) {
        ...
        if (xml_el.length > 0) for(let i = 0; i < xml_el.length; i++){
            ...
            if (xml_ei.length > 0) for(let j = 0; j < xml_ei.length; j++){
                let ev = new (0, $a227f0f1258db640$exports.Big)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_ei[j])?.nodeValue);
                evs.push(ev);
        ...
        for(let i = 0; i < xml_pl.length; i++){
            ...
            let T = pl_attributes.get("T") != undefined ? new (0, $a227f0f1258db640$exports.Big)(pl_attributes.get("T")) : $7e68913db756e51f$export$a94c859b6fc3ec52;
            let conc = pl_attributes.get("conc") != undefined ? new (0, $a227f0f1258db640$exports.Big)(pl_attributes.get("conc")) : $7e68913db756e51f$export$a94c859b6fc3ec52;
            ...
            if (xml_pn.length > 0) for(let j = 0; j < xml_pn.length; j++){
                ...
                let t = pn_attributes.get("time") != undefined ? new (0, $a227f0f1258db640$exports.Big)(pn_attributes.get("time")) : $7e68913db756e51f$export$a94c859b6fc3ec52;
                ...
                if (xml_pop.length > 0) for(let k = 0; k < xml_pop.length; k++){
                    ...
                    let p = new (0, $a227f0f1258db640$exports.Big)((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_pop[k])?.nodeValue);
            ...
            (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(tab, refs);
        ...
        if (xml_rl.length > 0) for(let i = 0; i < xml_rl.length; i++){
            let rle_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_rl[i]);
            ...
            let rl = new (0, $6bf90154944bce56$export$9cdf0fcb7c05190f)(rle_attributes);
            rl.setTemperature(new (0, $a227f0f1258db640$exports.Big)(rle_attributes.get("T")));
            rl.setConcentration(new (0, $a227f0f1258db640$exports.Big)(rle_attributes.get("conc")));
            rl.setBathGas(rle_attributes.get("bathGas"));
            let units = rle_attributes.get("units");
            rl.setUnits(units);
            a.addRateList(rl);
            let labelText = rl.tagName + " " + i.toString() + " " + (0, $134d19e749bf0414$export$dc22ec7f8e0b9ac)(rle_attributes);
            // Create a new collapsible div for the RateList.
            let rleDivID = $7e68913db756e51f$export$39722580448f5a99(rlDivID, i.toString());
            let rleDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(rleDivID);
            rlDiv.appendChild(rleDiv);
            let rlecDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rleDivID, rlDiv, null, rleDiv, labelText, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$b1ddbf2a116c10ee);
            let keys;
            let values;
            // "me:firstOrderLoss".
            // Create a new collapsible div for the FirstOrderLosses.
            let folDivID = $7e68913db756e51f$export$39722580448f5a99(rleDivID, (0, $6bf90154944bce56$export$2450ca15ad4d2ed0).tagName);
            let folDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(folDivID);
            rleDiv.appendChild(folDiv);
            let folcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(folDivID, rleDiv, null, folDiv, (0, $6bf90154944bce56$export$2450ca15ad4d2ed0).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
            let xml_fol = xml_rl[i].getElementsByTagName((0, $6bf90154944bce56$export$2450ca15ad4d2ed0).tagName);
            let folTable = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)(folDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
            let folTableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$export$bea69a603fae01a6(folDivID, $7e68913db756e51f$export$7a850709da5c4f5b), $7e68913db756e51f$export$39c84188a71202f7);
            ...
            for(let j = 0; j < xml_fol.length; j++){
                ...
                if (j == 0) {
                    ...
                    (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(folTable, keys);
                }
                ...
                let fol = new (0, $6bf90154944bce56$export$2450ca15ad4d2ed0)(fol_attributes, new (0, $a227f0f1258db640$exports.Big)(s));
                ...
                values.push(s);
                (0, $f0396edd0a5c99f7$export$67d0e2fae00985e1)(folTable, values);
            }
            // Insert a save as csv button.
            $7e68913db756e51f$export$dd526fb3a2a9c049(()=>$7e68913db756e51f$var$tableToCSV(folTable), folDiv, folTableDiv, "First Order Losses", $7e68913db756e51f$export$39c84188a71202f7);
            // "me:firstOrderRate".
            // Create a new collapsible div for the FirstOrderRates.
            let forDivID = $7e68913db756e51f$export$39722580448f5a99(rleDivID, (0, $6bf90154944bce56$export$984142e8329468e6).tagName);
            let forDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(forDivID);
            rleDiv.appendChild(forDiv);
            let forcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(forDivID, rleDiv, null, forDiv, (0, $6bf90154944bce56$export$984142e8329468e6).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
            let xml_for = xml_rl[i].getElementsByTagName((0, $6bf90154944bce56$export$984142e8329468e6).tagName);
            let forTable = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)(forDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
            let forTableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$export$bea69a603fae01a6(forDivID, $7e68913db756e51f$export$7a850709da5c4f5b), $7e68913db756e51f$export$39c84188a71202f7);
            forTableDiv.appendChild(forTable);
            forDiv.appendChild(forTableDiv);
            for(let j = 0; j < xml_for.length; j++){
                let for_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_for[j]);
                ...
                if (j == 0) {
                    ...
                    keys.push("k/" + units);
                    (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(forTable, keys);
                }
                values = Array.from(for_attributes.values());
                // Check lengths.
                if (keys.length - 1 != values.length) console.error("FirstOrderLoss values0!.length != values!.length");
                let s = ((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_for[j])?.nodeValue ?? "").trim();
                let forate = new (0, $6bf90154944bce56$export$984142e8329468e6)(for_attributes, new (0, $a227f0f1258db640$exports.Big)(s));
                ...
                values.push(s);
                // In values, replace "fromRef" to be "reactant" and "toRef" to be "product".
                values = values.map((value)=>{
                    if (value == "fromRef") return "reactant";
                    else if (value == "toRef") return "product";
                    else return value;
                });
                (0, $f0396edd0a5c99f7$export$67d0e2fae00985e1)(forTable, values);
            }
            // Insert a save as csv button.
            $7e68913db756e51f$export$dd526fb3a2a9c049(()=>$7e68913db756e51f$var$tableToCSV(forTable), forDiv, forTableDiv, "First Order Rates", $7e68913db756e51f$export$39c84188a71202f7);
            // "me:secondOrderRate".
            // Create a new collapsible div for the SecondOrderRates.
            let sorDivID = $7e68913db756e51f$export$39722580448f5a99(rleDivID, (0, $6bf90154944bce56$export$f449a9e759d0ecf8).tagName);
            let sorDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(sorDivID);
            rleDiv.appendChild(sorDiv);
            let sorcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(sorDivID, rleDiv, null, sorDiv, (0, $6bf90154944bce56$export$f449a9e759d0ecf8).tagName, $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
            let xml_sor = xml_rl[i].getElementsByTagName((0, $6bf90154944bce56$export$f449a9e759d0ecf8).tagName);
            let sorTable = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)(sorDivID, $7e68913db756e51f$export$d6befed1f1d5e56b);
            let sorTableDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$export$bea69a603fae01a6(sorDivID, $7e68913db756e51f$export$7a850709da5c4f5b), $7e68913db756e51f$export$39c84188a71202f7);
            sorTableDiv.appendChild(sorTable);
            sorDiv.appendChild(sorTableDiv);
            for(let j = 0; j < xml_sor.length; j++){
                let sor_attributes = (0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_sor[j]);
                ...
                if (j == 0) {
                    ...
                    keys.push("k/cm3mole-1" + units);
                    (0, $f0396edd0a5c99f7$export$6c1065e21382520d)(sorTable, keys);
                }
                ...
                let s = ((0, $cc8c7201a9bad777$export$4e07613bf412feb7)(xml_sor[j])?.nodeValue ?? "").trim();
                let sorate = new (0, $6bf90154944bce56$export$f449a9e759d0ecf8)(sor_attributes, new (0, $a227f0f1258db640$exports.Big)(s));
                ...
                values.push(s);
                (0, $f0396edd0a5c99f7$export$67d0e2fae00985e1)(sorTable, values);
            }
            // Insert a save as csv button.
            $7e68913db756e51f$export$dd526fb3a2a9c049(()=>$7e68913db756e51f$var$tableToCSV(sorTable), sorDiv, sorTableDiv, "Second Order Rates", $7e68913db756e51f$export$39c84188a71202f7);
        }
    }
    return aDiv;
}
...
function $7e68913db756e51f$export$b1e4cbf5b56e0e21(node, input) {
    try {
        let value = new (0, $a227f0f1258db640$exports.Big)(input.value);
        //node.setValue(value);
        node.value = value;
    } catch (e) {
