...
function $134d19e749bf0414$export$8cfbaad830aa9e0a(s) {
    let r = [];
    for(let i = 0; i < s.length; i++)if ($134d19e749bf0414$export$e90fb89750dba83f(s[i])) r.push(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(s[i]));
    return r;
}
...
function $134d19e749bf0414$export$f67be9d9b0e25d7b(n) {
    return $134d19e749bf0414$export$c3b708ed8089272f(new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(n));
}
function $134d19e749bf0414$export$c3b708ed8089272f(x) {
    if (x.eq(0)) return "0";
    if (x.abs().gte(Number.MAX_SAFE_INTEGER)) return x.toExponential();
    if (x.abs().lt(0.0001)) return x.toExponential();
 ...
 */ let $7e68913db756e51f$var$maxMoleculeEnergy;
/**
 * For storing the minimum molecule energy in a reaction.
 */ let $7e68913db756e51f$var$minMoleculeEnergy;
/**
...
const $7e68913db756e51f$var$s_ReactionsDiagram = "Reactions Diagram";
const $7e68913db756e51f$var$rdDivID = (0, $134d19e749bf0414$export$3205c97bcf96f7dc)($7e68913db756e51f$var$s_ReactionsDiagram);
 ...
 */ document.addEventListener("DOMContentLoaded", ()=>{
    ...
    */ // Update the page styles based on the user's preference.
    ...
    increaseFontSizeButton.addEventListener("click", ()=>{
        ...
        if ($7e68913db756e51f$var$rdWindow != null) //let fontSize = parseFloat(getComputedStyle(popWindow.document.body).fontSize);
 ...
 */ function $7e68913db756e51f$var$parse(xml) {
    ...
    let rdDivID = $7e68913db756e51f$var$addID($7e68913db756e51f$var$s_ReactionsDiagram);
    ...
    let rdcDiv = (0, $f0396edd0a5c99f7$export$8b2cd46c11844202)(rdDivID, rddDiv, null, rdDiv, $7e68913db756e51f$var$s_ReactionsDiagram, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0);
    ...
    popButton.addEventListener("click", ()=>{
        if ($7e68913db756e51f$var$rdWindow == null) {
            ...
            $7e68913db756e51f$var$rdWindow = window.open("", $7e68913db756e51f$var$s_ReactionsDiagram, "width=" + rdCanvas.width + ", height=" + rdCanvas.height);
    ...
    saveButton.addEventListener("click", ()=>{
        ...
        a.download = (title + $7e68913db756e51f$var$s_ReactionsDiagram).replace(/[^a-z0-9]/gi, "_") + ".png";
        a.click();
    });
    // Conditions.
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (xml_edms.length > 0) {
            ...
            if (xml_hrps.length > 0) {
                ...
                // ExpansionSize.
                hrpDiv.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(hrpDivID, (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
                    // Check the input is a number.
                    if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) hrp.setExpansionSize(parseInt(target.value));
                    else {
                    ...
                    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(target);
                }, hrp.getExpansionSize().toExponential(), (0, $ef5b9341e5193b70$export$9b8e857b9a081d2).s_expansionSize));
                // Add useSineTerms.
                ...
                for(let k = 0; k < xml_pps.length; k++){
                    ...
                    ppDiv.appendChild(l);
                    // Process angle
                    let anglelwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(ppDivID, (0, $ef5b9341e5193b70$export$86ca5149fcde8feb).s_angle), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1, (event)=>{
                        let target = event.target;
                        // Check the input is a number.
            ...
            if (xml_periodicities.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", m.getID() + "_" + (0, $ef5b9341e5193b70$export$9513c16afdf7d852).tagName, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1, (event)=>{
                    let target = event.target;
    ...
    if (scalarNodes.length > 0) {
        ...
        ps.setValue = (function(value) {
            ...
            if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) {
                ...
                if ($7e68913db756e51f$var$minMoleculeEnergy == undefined) $7e68913db756e51f$var$minMoleculeEnergy = value;
                else if (value < $7e68913db756e51f$var$minMoleculeEnergy) $7e68913db756e51f$var$minMoleculeEnergy = value;
                console.log("minMoleculeEnergy " + $7e68913db756e51f$var$minMoleculeEnergy);
                if ($7e68913db756e51f$var$maxMoleculeEnergy == undefined) $7e68913db756e51f$var$maxMoleculeEnergy = value;
                else if (value > $7e68913db756e51f$var$maxMoleculeEnergy) $7e68913db756e51f$var$maxMoleculeEnergy = value;
                console.log("maxMoleculeEnergy " + $7e68913db756e51f$var$maxMoleculeEnergy);
        ...
        */ $7e68913db756e51f$var$addAnyUnits(units, psAttributes, div, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
        ...
        if (arrayNodes.length > 0) {
            ...
            if (textArea) {
                let lwta = (0, $f0396edd0a5c99f7$export$60fee6710ef6fb16)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), boundary, level, (event)=>{
                    let target = event.target;
                    $7e68913db756e51f$export$819b5ff7dff3652c(pa, target);
                }, inputString, p.dictRef);
                let ta = lwta.querySelector("textarea");
                (0, $f0396edd0a5c99f7$export$c5eaaac137ef25d0)(ta);
                ta.addEventListener("change", (event)=>{
                    let target = event.target;
                    inputString = target.value;
                    pa = p.getProperty();
                    pa.values = (0, $134d19e749bf0414$export$8cfbaad830aa9e0a)(inputString.split(/\s+/));
                    console.log("Set " + p.dictRef + " of " + molecule.getID() + " to " + inputString);
                    (0, $f0396edd0a5c99f7$export$c5eaaac137ef25d0)(ta);
                });
                $7e68913db756e51f$var$addAnyUnits(units, psAttributes, lwta, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, (0, $ef5b9341e5193b70$export$d29b345ea2be5072).s_units), p.dictRef, boundary, boundary);
                plDiv.appendChild(lwta);
            } else {
                p.setProperty(pa);
                let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("text", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef), boundary, level, (event)=>{
                    let target = event.target;
                    $7e68913db756e51f$export$819b5ff7dff3652c(pa, target);
                }, inputString, p.dictRef);
                ...
                $7e68913db756e51f$var$addAnyUnits(units, paAttributes, lwi, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(plDiv.id, p.dictRef, $7e68913db756e51f$var$s_Select, "Units"), p.dictRef, boundary, boundary);
                plDiv.appendChild(lwi);
            }
        } else {
            // PropertyMatrix.
...
function $7e68913db756e51f$export$b1e4cbf5b56e0e21(node, input) {
    if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(input.value)) node.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(input.value);
    else {
        alert("Value is not numeric, resetting...");
        input.value = (0, $134d19e749bf0414$export$c3b708ed8089272f)(node.value);
    }
}
/**
                ...
                for(let i = 1; i < pTpairsArray.length; i++){
                    ...
                    if (index.has((0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName)) {
                        ...
                        if (er.length > 0) {
                            ...
                            pTpair.getExperimentalRate()?.setError(parseFloat(ere));
                        }
                    }
                    if (index.has((0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName)) {
                        ...
                        if (ey.length > 0) {
                            ...
                            pTpair.getExperimentalYield()?.setYieldTime(parseFloat(eyyt));
                            // error.
                            ...
                            pTpair.getExperimentalYield()?.setError(parseFloat(eye));
                        }
                    }
                    if (index.has((0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName)) {
                        ...
                        if (ee.length > 0) {
                            ...
                            pTpair.getExperimentalEigenvalue()?.setError(parseFloat(eee));
                        }
                    }
 ...
 */ function $7e68913db756e51f$var$processCalcMethodAnalyticalRepresentation(divCmDetails, cm) {
    ...
    // "me:chebNumTemp".
    let chebNumTemp = cm.getChebNumTemp() || new (0, $b6873406fb778c0b$export$19d20f3642d82681)(new Map(), $7e68913db756e51f$var$big0);
    ...
    divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", divCmDetails.id + "_ChebNumTemp_input", $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
        ...
        // Check the value is a number.
        if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
            chebNumTemp.value = new (0, (/*@__PURE__*/$parcel$interopDefault($a227f0f1258db640$exports)))(target.value);
 ...
 */ function $7e68913db756e51f$var$processCalcMethodSensitivityAnalysis(divCmDetails, cm) {
    ...
    function processNumberElement(ClassConstructor, getter, setter, tagName) {
        let element = getter() || new ClassConstructor(new Map(), NaN);
        setter(element);
        divCmDetails.appendChild((0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", (0, $134d19e749bf0414$export$3205c97bcf96f7dc)(divCmDetails.id, tagName, $7e68913db756e51f$var$s_Input), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
            let target = event.target;
            // Check the value is a number.
            if ((0, $134d19e749bf0414$export$e90fb89750dba83f)(target.value)) {
                element.value = parseFloat(target.value);
...
//# sourceMappingURL=index.895ad834.js.map
