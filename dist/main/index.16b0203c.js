 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    if (xml_PTss.length > 0) {
        ...
        if (xml_PTPairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
            ...
            for(let i = 0; i < xml_PTPairs.length; i++){
                ...
                $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair, i);
    ...
    addButton.addEventListener("click", ()=>{
        ...
        $7e68913db756e51f$var$addPercentExcessReactantConc(pTPairDiv, pTPair);
        $7e68913db756e51f$var$addPrecision(pTPairDiv, pTPair);
        $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair, pTPairIndex);
 ...
 * @param pTPair The PTpair.
 * @param i The index.
 */ function $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair, i) {
    let div = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)($7e68913db756e51f$var$boundary1);
    pTPairDiv.append(div);
 ...
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas) {
    if (bathGas == undefined) bathGas = new (0, $ae74a7b44a6504a1$export$b33a132661f4be58)(new Map(), "");
    let value = bathGas == undefined ? $7e68913db756e51f$var$selectAnotherOption : bathGas.value;
...
//# sourceMappingURL=index.16b0203c.js.map
