...
function $174b37a7f81f9b54$export$12aafb9570dfb660(mlDiv, mIDM, molecules) {
    ...
    addMoleculeButton.addEventListener("click", ()=>{
        ...
        $174b37a7f81f9b54$var$addEditIDButton(m, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), mIDM, mDiv, (0, $7e68913db756e51f$export$39c84188a71202f7));
        // Description
...
function $174b37a7f81f9b54$export$3ec2b56b5fdfd561(m, plDiv, pl) {
    ...
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    //console.log("pl.index.size" + pl.index.size);
    //console.log("Property " + m.getPropertyList()!.getProperty(ZPE.dictRef)?.toString);
    // "me:Hf0", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    // "me:HfAT0", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$a4fe62a56eafa45d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    // "me:Hf298", scalar, Mesmer.energyUnits.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$e7df60530792b964).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
    ...
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$d1d1720eff14586a).dictRef, undefined);
    // "me:TSOpticalSymmetryNumber", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$886461cafebcdaed).dictRef, undefined);
    // "me:frequenciesScaleFactor", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$1288989e9be37590).dictRef, undefined);
    ...
    // "me:MW", scalar, amu.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$a3772f6eb527275b).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).massUnits);
    // "me:spinMultiplicity", scalar, No units.
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$415ad1120b60f9f3).dictRef, undefined);
    // "me:epsilon", scalar, K (fixed).
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$cb998ac70542b2c3).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).temperatureUnits);
    // "me:sigma", scalar, Å (fixed).
    $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, (0, $01410cda1eef5011$export$79e850ed2864d13d).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).lengthUnits);
 ...
 * @param units The units. 
 */ function $174b37a7f81f9b54$var$addPropertyScalarNumber(m, pIDs, plDiv, pl, dictRef, units) {
    let pAttributes;
    let psAttributes;
    let ps;
    let p;
 ...
 */ function $174b37a7f81f9b54$var$addPropertyArray(setSize, m, pIDs, plDiv, pl, dictRef, units) {
    ...
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = (0, $7e68913db756e51f$export$e5600fc4ea245d6d)(plDiv.id, pIDs, dictRef, pa, pa.getValues.bind(pa), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, pa, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
 ...
 */ function $174b37a7f81f9b54$var$addPropertyMatrix(setSize, m, pIDs, plDiv, pl, dictRef, units) {
    ...
    m.getPropertyList().setProperty(p);
    console.log("pl.index.size" + pl.index.size);
    div = (0, $7e68913db756e51f$export$e5600fc4ea245d6d)(plDiv.id, pIDs, dictRef, pm, pm.getValues.bind(pm), (values)=>$174b37a7f81f9b54$export$3de90924239ae34e(dictRef, pl, pm, values), ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
...
function $174b37a7f81f9b54$export$1f1b9bc888fe9f4c(mlDiv, amb, mIDM, molecules) {
    ...
    addFromLibraryButton.addEventListener("click", ()=>{
        ...
        select.addEventListener("change", (event)=>{
            ...
            // Add edit Name button.
            $174b37a7f81f9b54$var$addEditIDButton(molecule, mcDiv.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), mIDM, moleculeDiv, (0, $7e68913db756e51f$export$39c84188a71202f7));
            // Description
            ...
            (0, $01410cda1eef5011$export$742f9ce317ef8ba3).propertyDictRefs.forEach(function(dictRef) {
                ...
                $174b37a7f81f9b54$var$addPropertyScalarNumber(molecule, pIDs, plDiv, pl, dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            });
            // Property array .
 ...
 * @param mDiv 
 * @param level 
 */ function $174b37a7f81f9b54$var$addEditIDButton(molecule, button, mIDM, mDiv, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        if (arrayNodes.length > 0) {
            ...
            if (inputString != "") {
                ...
                p.setProperty(pa);
                let div = (0, $7e68913db756e51f$export$e5600fc4ea245d6d)((0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef), pIDs, p.dictRef, pa, pa.getValues.bind(pa), pa.setValues, ()=>pl.removeProperty(p.dictRef), (0, $7e68913db756e51f$export$d6befed1f1d5e56b), (0, $7e68913db756e51f$export$39c84188a71202f7));
            ...
            if (matrixNodes.length > 0) {
                ...
                let inputDiv = (0, $f0396edd0a5c99f7$export$60fee6710ef6fb16)((0, $7e68913db756e51f$export$bea69a603fae01a6)(plDiv.id, p.dictRef), boundary, level, (event)=>{
                    let target = event.target;
                    (0, $7e68913db756e51f$export$819b5ff7dff3652c)(p.dictRef, pm, target);
                }, inputString, label);
...
function $7e68913db756e51f$export$f729a71031e2cfe2(attributes, iDs, value, units, pl, p, plDiv, boundary) {
    ...
    ps.setValue = (function(value) {
        ps.value = value;
        if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef) // Update the molecule energy diagram.
        $7e68913db756e51f$export$e7cd7bead34ef747();
    }).bind(ps);
    ps.value = value;
    if (p.dictRef == (0, $01410cda1eef5011$export$95174cf0748f45cd).dictRef) // Update the molecule energy diagram.
    $7e68913db756e51f$export$e7cd7bead34ef747();
    ...
    let div = $7e68913db756e51f$export$17d48ee8ddbf2d44(id, iDs, p.dictRef, ps.getValue.bind(ps), (value)=>(0, $174b37a7f81f9b54$export$c1dce3e534360efd)(p.dictRef, pl, ps, value), ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$export$d6befed1f1d5e56b, $7e68913db756e51f$export$39c84188a71202f7);
...
function $7e68913db756e51f$export$e5600fc4ea245d6d(id, iDs, name, pa, getter, setter, remover, marginComponent, margin) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, margin);
    let buttonTextContentSelected = name + $7e68913db756e51f$export$f0fb6e9d3fd6cf72;
    let buttonTextContentDeselected = name + $7e68913db756e51f$export$b758aa9bd161846e;
    let idb = $7e68913db756e51f$export$bea69a603fae01a6(id, name, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
 ...
 */ function $7e68913db756e51f$var$addNumberArray(div, id, name, values, paom, getter, setter, boundary) {
    let valueString;
    ...
    ta.addEventListener("change", (event)=>{
        let target = event.target;
        $7e68913db756e51f$export$819b5ff7dff3652c(name, paom, ta);
...
function $7e68913db756e51f$export$819b5ff7dff3652c(dictRef, node, ta) {
    ...
    if (node.getValues().length == 0) {
        let n = $7e68913db756e51f$export$88ed5e596ed31b40("Please enter the number of elements in the " + dictRef + " array");
        let values = [];
