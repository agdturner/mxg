 ...
 */ function $7e68913db756e51f$var$remove(id) {
    ...
    if (e != null) {
        e.querySelectorAll("*").forEach((element)=>{
            $7e68913db756e51f$var$remove(element.id);
        });
        e.remove();
    }
    if ($7e68913db756e51f$var$rIDs.has(id)) $7e68913db756e51f$var$rIDs.delete(id);
    else console.warn("ID " + id + " not in rIDs");
...
//# sourceMappingURL=index.c67306f5.js.map
