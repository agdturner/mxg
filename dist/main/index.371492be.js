...
class $ef5b9341e5193b70$export$9cea715eceba39a0 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
    ...
    */ this.tagName = "atomArray";
     ...
     */ addAtom(atom) {
        ...
        } else throw new Error("Atom has no id!");
        this.nodes.set(this.nodes.size, atom);
    }
    /**
...
class $ef5b9341e5193b70$export$3da9759ad07746a3 extends (0, $cc8c7201a9bad777$export$bd431b64ad3b0433) {
     ...
     */ removeAtom(id) {
        ...
        } else if (atoms instanceof $ef5b9341e5193b70$export$9cea715eceba39a0) atoms.removeAtom(id);
    }
    /**
    ...
    for(let i = 0; i < xml_molecules.length; i++){
        ...
        if (xml_atomArrays.length == 1) {
            ...
            for(let j = 0; j < xml_atoms.length; j++){
                atomsNode = new (0, $ef5b9341e5193b70$export$9cea715eceba39a0)((0, $cc8c7201a9bad777$export$fe94072fee8a6976)(xml_atomArray));
                // Create a new Atom.
                ...
                $7e68913db756e51f$var$processCoordinate(atom, atomDiv, x3id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, atom.getX3.bind(atom), atom.setX3.bind(atom), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3);
                let y3id = inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3;
                $7e68913db756e51f$var$processCoordinate(atom, atomDiv, y3id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, atom.getY3.bind(atom), atom.setY3.bind(atom), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3);
                let z3id = inputId + "_" + (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3;
                $7e68913db756e51f$var$processCoordinate(atom, atomDiv, z3id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, atom.getZ3.bind(atom), atom.setZ3.bind(atom), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3);
        ...
        addAtomButton.addEventListener("click", ()=>{
            let attributes = new Map();
            attributes.set((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_id, "a" + (atoms.size + 1));
 ...
 */ function $7e68913db756e51f$var$processCoordinate(atom, atomDiv, id, coordinate, getter, setter, logMessage) {
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$boundary1);
    atomDiv.appendChild(div);
    let buttonTextContentSelected = logMessage + $7e68913db756e51f$var$selected;
    let buttonTextContentDeselected = logMessage + $7e68913db756e51f$var$deselected;
    ...
    if (value == undefined) {
        ...
        $7e68913db756e51f$var$addCoordinate(div, atom, id, value, setter, logMessage, $7e68913db756e51f$var$boundary1);
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (document.getElementById(id) == null) {
            $7e68913db756e51f$var$addCoordinate(div, atom, id, NaN, setter, logMessage, $7e68913db756e51f$var$boundary1);
            button.textContent = buttonTextContentSelected;
            button.classList.toggle("optionOff");
            button.classList.toggle("optionOn");
        } else {
 ...
 */ function $7e68913db756e51f$var$addCoordinate(div, atom, id, value, setter, logMessage, boundary) {
...
//# sourceMappingURL=index.371492be.js.map
