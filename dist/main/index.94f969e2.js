 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
        ...
        div.appendChild($7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), bathGas));
        // Add a remove button.
        let removeButton = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$removeString, $7e68913db756e51f$var$boundary1);
        removeButton.addEventListener("click", ()=>{
        ...
        if (xml_PTPairs.length == 0) throw new Error("Expecting 1 or more " + (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + " but finding 0!");
            ...
            for(let i = 0; i < xml_PTPairs.length; i++){
                ...
                if (xml_experimentRates.length > 0) {
                    ...
                    let lwi = (0, $f0396edd0a5c99f7$export$4e9ec2b27757d9dd)("number", id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level0, (event)=>{
                        let target = event.target;
 ...
 */ function $7e68913db756e51f$var$addP(pTPairDiv, pTPair) {
    ...
    input.value = pTPair.getP().toExponential();
 ...
 */ function $7e68913db756e51f$var$addT(pTPairDiv, pTPair) {
    ...
    let input = lwi.querySelector("input");
    input.value = pTPair.getT().toExponential();
    (0, $f0396edd0a5c99f7$export$d43d96a9a8ad3e51)(input);
    pTPairDiv.appendChild(lwi);
}
/**
 ...
 */ function $7e68913db756e51f$var$addPercentExcessReactantConc(pTPairDiv, pTPair) {
    ...
    let id = (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + attribute + "_input";
 ...
 */ function $7e68913db756e51f$var$addPrecision(pTPairDiv, pTPair) {
    ...
    button.classList.add("optionOff");
    button.classList.toggle("optionOn");
    let id = (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName + "_" + tagName + "_select";
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
        button.classList.toggle("optionOn");
        button.classList.toggle("optionOff");
        if (button.textContent === buttonTextContentDeselected) {
            button.textContent = buttonTextContentSelected;
            let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)("precision", (0, $8677001474399221$export$692079bb871c6039).precisionOptions, "precision", (0, $8677001474399221$export$692079bb871c6039).precisionOptions[0], id, $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$boundary1);
            let select = lws.querySelector("select");
            select.addEventListener("change", (event)=>{
                let target = event.target;
 ...
 */ function $7e68913db756e51f$var$addBathGas(pTPairDiv, pTPair) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        if (button.textContent === buttonTextContentDeselected) {
            button.textContent = buttonTextContentSelected;
            let select = $7e68913db756e51f$var$createSelectElementBathGas(Array.from(new Set($7e68913db756e51f$var$molecules.keys())), new (0, $ae74a7b44a6504a1$export$b33a132661f4be58)(new Map(), ""));
            select.id = id;
            select.addEventListener("change", (event)=>{
                let target = event.target;
 ...
 */ function $7e68913db756e51f$var$createSelectElementBathGas(options, bathGas) {
    ...
    if (bathGas == undefined) select.value = $7e68913db756e51f$var$selectAnotherOption;
    else select.value = bathGas.value;
    // Add event listener to selectElement.
    select.addEventListener("change", (event)=>{
        let target = event.target;
...
//# sourceMappingURL=index.94f969e2.js.map
