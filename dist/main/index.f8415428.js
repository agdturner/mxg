...
function $174b37a7f81f9b54$export$ce852d72abd87240(xml, mIDM, molecules) {
    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        if (!dictRefs.has((0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef)) {
            let div = $174b37a7f81f9b54$var$addPropertyScalar(deselect, m, mIDM, plDiv, pl, (0, $01410cda1eef5011$export$90bccbae54bb6d4f).dictRef, (0, $69ecbdaa96f3962d$export$692079bb871c6039).energyUnits);
            // Click the button.
            let b = div.querySelector((0, $f0396edd0a5c99f7$export$25280bc3a7ce098e));
            b.click();
            b.click();
...
//# sourceMappingURL=index.f8415428.js.map
