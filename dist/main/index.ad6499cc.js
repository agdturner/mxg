 ...
 */ function $7e68913db756e51f$var$getAddAtomButton(molecule, atomArrayDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        let elements = document.getElementsByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
        for(let i = 0; i < elements.length; i++){
            let selectElement = elements[i];
...
function $7e68913db756e51f$var$removeAtom(molecule, id) {
    ...
    molecule.getBonds().bonds.forEach((bond)=>{
        ...
        if (atomRefs[0] == id || atomRefs[1] == id) {
            ...
            let bondDivs = document.getElementsByClassName((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(molecule.id, bondId, id));
            console.log("bondDivs.length=" + bondDivs.length);
            for(let i = 0; i < bondDivs.length; i++)bondDivs[i].remove();
        }
    });
    // Get elements with Bond.s_atomRefs2 className and update them to remove the atom option.
    let elements = document.getElementsByClassName((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
    for(let i = 0; i < elements.length; i++){
        let selectElement = elements[i];
 ...
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, bondArrayDiv, typeID, boundary, level) {
    ...
    button.addEventListener("click", ()=>{
        ...
        Array.from(atoms.keys()).forEach((atomId)=>{
            bondDiv.classList.add((0, $134d19e749bf0414$export$3205c97bcf96f7dc)(moleculeId, bondId, atomId));
        });
...
function $7e68913db756e51f$var$addAttribute(pTpairDiv, pTpair, conditionsIndex, pTIndex, attribute, createInputElement) {
    ...
    if (pTpair.attributes.has(attribute)) {
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
        button.textContent = buttonTextContentSelected;
        let input = createInputElement(id, pTpair);
 ...
 */ function $7e68913db756e51f$var$addBathGas(pTpairDiv, pTpair, conditionsIndex, pTIndex, moleculeKeys) {
    ...
    if (bathGas == undefined) {
        ...
        div.appendChild($7e68913db756e51f$var$createBathGasSelectElement(id, pTpair, bathGas, true));
    }
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
        ...
        if (button.textContent === buttonTextContentDeselected) {
            button.textContent = buttonTextContentSelected;
            div.appendChild($7e68913db756e51f$var$createBathGasSelectElement(iid, pTpair, bathGas, true));
        } else {
            button.textContent = buttonTextContentDeselected;
...
function $7e68913db756e51f$var$addExperimentalElement(pTpairDiv, pTpair, conditionsIndex, pTIndex, tagName, getAttribute, createElement) {
    ...
    if (getAttribute(pTpair) == undefined) {
        ...
        button.classList.toggle($7e68913db756e51f$var$s_optionOff);
        button.textContent = buttonTextContentSelected;
        div.appendChild(createElement(id, pTpair, pTIndex));
    }
    // Add event listener for the button.
    button.addEventListener("click", (event)=>{
        button.classList.toggle($7e68913db756e51f$var$s_optionOn);
...
function $7e68913db756e51f$var$createExperimentalRateDetails(id, pTpair, index) {
    return $7e68913db756e51f$var$addExperimentalDetails(pTpair, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName, index.toString()), (pTpair)=>pTpair.getExperimentalRate(), (pTpair, value)=>pTpair.setExperimentalRate(value), (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b), [
        {
...
function $7e68913db756e51f$var$createExperimentalYieldDetails(id, pTpair, index) {
    return $7e68913db756e51f$var$addExperimentalDetails(pTpair, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName, index.toString()), (pTpair)=>pTpair.getExperimentalYield(), (pTpair, value)=>pTpair.setExperimentalYield(value), (0, $ae74a7b44a6504a1$export$c291f4faacd745a6), [
        {
...
function $7e68913db756e51f$var$createExperimentalEigenvalueDetails(id, pTpair, index) {
    return $7e68913db756e51f$var$addExperimentalDetails(pTpair, (0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName, index.toString()), (pTpair)=>pTpair.getExperimentalEigenvalue(), (pTpair, value)=>pTpair.setExperimentalEigenvalue(value), (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1), [
        {
...
//# sourceMappingURL=index.ad6499cc.js.map
