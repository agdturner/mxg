    ...
    for(let i = 0; i < xml_msl; i++){
        ...
        pap.forEach(function(dictRef) {
            ...
            if (dictRef == "me:Hf0") {
                ...
                $7e68913db756e51f$var$addPropertyScalarNumber(s_attributes, value, (0, $8677001474399221$export$692079bb871c6039).energyUnits, pl, p, plDiv, $7e68913db756e51f$var$boundary1);
                pl.setProperty(p);
            /*
 ...
 */ function $7e68913db756e51f$var$getAddBondButton(molecule, moleculeId, baDiv, typeID, boundary, level) {
    ...
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)($7e68913db756e51f$var$s_Add_sy_add, $7e68913db756e51f$var$addRID(moleculeId, "Add" + typeID + "Button"), level);
    button.addEventListener("click", ()=>{
 ...
 */ function $7e68913db756e51f$var$addBond(molecule, atoms, ba, b, boundary, level) {
    ...
    let bDivID = $7e68913db756e51f$var$addRID(molecule.getID(), bID);
 ...
 */ function $7e68913db756e51f$var$processAtomRefs2(molecule, bDiv, bond, margin) {
    let id = $7e68913db756e51f$var$addRID(bDiv.id, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2);
    let atomRefs2 = bond.getAtomRefs2();
    let atomRefs = atomRefs2.split(" ");
    let atomRefOptions = Array.from(molecule.getAtoms().atoms.keys());
    // alws.
    let alws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + "[0]", atomRefOptions, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, atomRefs[0], $7e68913db756e51f$var$addRID(id, 0), margin, margin);
    ...
    // blws.
    let blws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_atomRefs2 + "[1]", atomRefOptions, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).tagName, atomRefs[1], $7e68913db756e51f$var$addRID(id, 1), margin, margin);
...
function $7e68913db756e51f$var$addPropertyScalarNumber(attributes, value, units, pl, p, plDiv, boundary) {
 ...
 */ function $7e68913db756e51f$var$createProperty(pap, pl, xml, plDiv, molecule, boundary, level) {
    ...
    if (p.dictRef == (0, $ef5b9341e5193b70$export$95174cf0748f45cd).dictRef) $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).energyUnits, molecule, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$984abe26ded13ee0).dictRef) $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, (0, $8677001474399221$export$692079bb871c6039).frequencyUnits, molecule, xml, plDiv, boundary, level);
    else if (p.dictRef == (0, $ef5b9341e5193b70$export$2762c8fbc03043ca).dictRef) $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml, plDiv, boundary, level);
    else $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, undefined, molecule, xml, plDiv, boundary, level);
    return p;
}
/**
 ...
 */ function $7e68913db756e51f$var$processElementType(a, aDiv, first, margin) {
    ...
    let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)((0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, selectTypes, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType, elementType, $7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_elementType), margin, margin);
 ...
 */ function $7e68913db756e51f$var$processCoordinates(a, aDiv, marginComponent, margin) {
    aDiv.appendChild($7e68913db756e51f$var$processNumber($7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_x3, a.getX3.bind(a), a.setX3.bind(a), a.removeX3, marginComponent, margin));
    aDiv.appendChild($7e68913db756e51f$var$processNumber($7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_y3, a.getY3.bind(a), a.setY3.bind(a), a.removeY3, marginComponent, margin));
    aDiv.appendChild($7e68913db756e51f$var$processNumber($7e68913db756e51f$var$addRID(aDiv.id, (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3), (0, $ef5b9341e5193b70$export$80986e6afdd7e0cb).s_z3, a.getZ3.bind(a), a.setZ3.bind(a), a.removeZ3, marginComponent, margin));
}
/**
 ...
 */ function $7e68913db756e51f$var$processOrder(bondDiv, bond, margin) {
    let id = $7e68913db756e51f$var$addRID(bondDiv.id, (0, $ef5b9341e5193b70$export$153327fc99ac0c53).s_order);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(undefined, margin);
 ...
 */ function $7e68913db756e51f$var$processPropertyScalarNumber(pl, p, units, molecule, element, plDiv, boundary, level) {
    ...
    if (scalarNodes.length > 0) {
        ...
        let div = $7e68913db756e51f$var$processNumber($7e68913db756e51f$var$addRID(plDiv.id, p.dictRef), p.dictRef, ps.getValue.bind(ps), ps.setValue, ()=>pl.removeProperty(p.dictRef), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
    ...
    for(let i = 0; i < xml_reactions.length; i++){
        ...
        if (xml_products.length > 0) {
            ...
            for(let j = 0; j < xml_products.length; j++){
                ...
                let lws = (0, $f0396edd0a5c99f7$export$4c3eba01cd3c5ba4)(molecule.ref + " role", (0, $6f7aa7a716962086$export$264ad599d7cef668).roleOptions, molecule.role, molecule.ref, $7e68913db756e51f$var$addID(psDivID, j, "Role"), $7e68913db756e51f$var$boundary1, $7e68913db756e51f$var$level1);
                let select = lws.querySelector("select");
        ...
        if (xml_crl.length > 0) {
            ...
            if (xml_k.length > 0) {
                ...
                let t = (0, $f0396edd0a5c99f7$export$33bbb3ec7652e187)($7e68913db756e51f$var$addRID(crlDiv, (0, $6f7aa7a716962086$export$5eb02c9a0d4a6c5).tagName, $7e68913db756e51f$var$s_table), $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$handleBathGases(conditions, conditionsDiv, conditionsIndex, xml_conditions) {
    // Bath Gases
    // Create a collapsible div.
    let bsDivID = $7e68913db756e51f$var$addRID((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$b33a132661f4be58).tagName);
    let bsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(bsDivID);
    let bscDivID = $7e68913db756e51f$var$addRID(bsDivID, $7e68913db756e51f$var$s_container);
    ...
    addBathGasButton.addEventListener("click", ()=>{
        ...
        let id = $7e68913db756e51f$var$addRID(bsDivID, bathGasIndex.toString());
    ...
    if (xml_conditions != null) {
        ...
        if (xml_bathGases.length > 0) for(let i = 0; i < xml_bathGases.length; i++){
            ...
            let id = $7e68913db756e51f$var$addRID(bsDivID, "0");
            let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)($7e68913db756e51f$var$addRID(bsDivID, 0), $7e68913db756e51f$var$level1);
 ...
 */ function $7e68913db756e51f$var$handlePTs(conditions, conditionsDiv, conditionsIndex, xml_conditions) {
    ...
    // Create collapsible div.
    let pTsDivId = $7e68913db756e51f$var$addRID(conditionsDiv.id, conditionsIndex.toString(), (0, $ae74a7b44a6504a1$export$3be0efe793283834).tagName);
    let pTsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)(pTsDivId);
    let pTscDivId = $7e68913db756e51f$var$addRID(pTsDivId, $7e68913db756e51f$var$s_container);
 ...
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, conditionsDivId, conditionsIndex, pTIndex, moleculeKeys, level) {
    ...
    let id = $7e68913db756e51f$var$addRID(conditionsDivId, (0, $ae74a7b44a6504a1$export$3fe97ecb6b172244).tagName, pTIndex.toString());
    // ExcessReactantConc.
 ...
 */ function $7e68913db756e51f$var$addGrainSize(mps, mpsDiv) {
    let tagName = (0, $8883b31bd809eb64$export$26e33f0df9ce919d).tagName;
    let id = $7e68913db756e51f$var$addRID(mpsDiv.id, tagName);
    let div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, $7e68913db756e51f$var$level1);
    mpsDiv.appendChild(div);
    let buttonTextContentSelected = tagName + $7e68913db756e51f$var$sy_selected;
    let buttonTextContentDeselected = tagName + $7e68913db756e51f$var$sy_deselected;
    let button = (0, $f0396edd0a5c99f7$export$9b6d6ca62970729f)(tagName, $7e68913db756e51f$var$addRID(id, (0, $f0396edd0a5c99f7$export$25280bc3a7ce098e)), $7e68913db756e51f$var$boundary1);
    button.classList.add($7e68913db756e51f$var$s_optionOn);
    button.classList.add($7e68913db756e51f$var$s_optionOff);
    div.appendChild(button);
    let idi = $7e68913db756e51f$var$addRID(id, $7e68913db756e51f$var$s_input);
    let gs;
    let valueString;
 ...
 */ function $7e68913db756e51f$var$handleControl(control, controlDiv, index, onOffControls, xml_control, level, ControlClass, setControlMethod, removeControlMethod, handleInput = false) {
    ...
    let id;
    if (level) {
        id = $7e68913db756e51f$var$addRID(controlDiv.id, tagName, index);
        div = (0, $f0396edd0a5c99f7$export$78253536c0178a32)(id, level);
        controlDiv.appendChild(div);
        div.appendChild(button);
        id = $7e68913db756e51f$var$addRID(id, $7e68913db756e51f$var$s_input);
    }
    if (xml_control) {
 ...
 */ function $7e68913db756e51f$var$handleCalcMethod(control, controlDiv, i, xml_control, level) {
    ...
    let divCmId = $7e68913db756e51f$var$addRID((0, $b6873406fb778c0b$export$7a7fa4424cb20976).tagName, tagName, i.toString());
    ...
    let divCmDetailsId = $7e68913db756e51f$var$addRID(divCmId, "details");
    let divCmDetailsSelectId = $7e68913db756e51f$var$addRID(divCmDetailsId, "select");
    let cm;
    let first = true;
    if (xml_control != null) {
 ...
 */ function $7e68913db756e51f$var$processAnalysis(xml) {
    ...
    if (xml_as.length > 0) {
        ...
        let elDivID = $7e68913db756e51f$var$addRID(aDiv, (0, $49b337e689138e29$export$f681829d43cbf50e).tagName);
        ...
        let plDivID = $7e68913db756e51f$var$addRID(aDiv, (0, $49b337e689138e29$export$8f9a53be9a409418).tagName);
        ...
        let rlDivID = $7e68913db756e51f$var$addRID(aDiv, (0, $49b337e689138e29$export$9cdf0fcb7c05190f).tagName);
 ...
 */ function $7e68913db756e51f$var$addSaveAsPNGButton(canvas, divToAddTo, elementToInsertBefore, name) {
    ...
    let saveButtonID = $7e68913db756e51f$var$addRID("saveButton");
...
//# sourceMappingURL=index.d694ac42.js.map
