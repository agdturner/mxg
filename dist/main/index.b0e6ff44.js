 ...
 */ function $7e68913db756e51f$var$processConditions(xml) {
    ...
    for(let i = 0; i < xml_conditionss.length; i++){
        ...
        let conditionsDiv = (0, $f0396edd0a5c99f7$export$331ff980f0d45cff)((0, $134d19e749bf0414$export$3205c97bcf96f7dc)((0, $ae74a7b44a6504a1$export$363c7374d425f4ad).tagName, i.toString()), $7e68913db756e51f$var$boundary1);
    ...
    $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv, $7e68913db756e51f$var$level1);
 ...
 * @param level The level.
 * @returns A button.
 */ function $7e68913db756e51f$var$createAddConditionsButton(conditionssDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        // Add the control
        let conditions = $7e68913db756e51f$var$addConditions(new Map(), conditionssDiv, elementToInsertBefore, conditionssDiv, i);
 ...
 */ function $7e68913db756e51f$var$createPTpairDiv(pTs, pTsDiv, pTpair, index, moleculeKeys, level) {
    ...
    // ExperimentalRate.
    $7e68913db756e51f$var$addButtonWithToggle(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName, (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + "_" + (0, $ae74a7b44a6504a1$export$cdeafdd1d936ed5b).tagName + index, [
        undefined,
        pTpair,
        index
    ], $7e68913db756e51f$var$addExperimentalRateDetails);
    // ExperimentalYield.
    $7e68913db756e51f$var$addButtonWithToggle(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName, (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName + "_" + (0, $ae74a7b44a6504a1$export$c291f4faacd745a6).tagName + index, [
        undefined,
        pTpair,
        index
    ], $7e68913db756e51f$var$addExperimentalYieldDetails);
    // ExperimentalEigenvalue.
    $7e68913db756e51f$var$addButtonWithToggle(pTpairDiv, pTpair, (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName, (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName + "_" + (0, $ae74a7b44a6504a1$export$ed9dfbc127680fd1).tagName + index, [
        undefined,
        pTpair,
        index
 ...
 */ function $7e68913db756e51f$var$processControl(xml) {
    ...
    for(let i = 0; i < xml_controls.length; i++){
        ...
        // Controls with additional things to set.
        $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, xml_control, level, (0, $b6873406fb778c0b$export$1f37c7c73e401f31), control.setTestMicroRates, control.removeTestMicroRates, true);
        ...
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, xml_control, level, item.class, item.setMethod, item.removeMethod, true);
        });
 ...
 */ function $7e68913db756e51f$var$createAddControlButton(controlsDiv, level) {
    ...
    button.addEventListener("click", (event)=>{
        ...
        controlDiv.appendChild(onOffControlsDiv);
        // Controls with additional things to set.
        $7e68913db756e51f$var$processTestMicroRates(control, controlDiv, null, level);
        $7e68913db756e51f$var$handleCalcMethod(control, controlDiv, i, null, level);
        $7e68913db756e51f$var$getControlItems(control).forEach((item)=>{
            $7e68913db756e51f$var$handleControl(control, controlDiv, onOffControls, null, level, item.class, item.setMethod, item.removeMethod, true);
        });
        // Add a remove control button.
        let removeButton = $7e68913db756e51f$var$addRemoveButton(controlDiv, $7e68913db756e51f$var$level2, $7e68913db756e51f$var$mesmer.removeControl.bind($7e68913db756e51f$var$mesmer), i);
        removeButton.addEventListener("click", (event)=>{
...
//# sourceMappingURL=index.b0e6ff44.js.map
