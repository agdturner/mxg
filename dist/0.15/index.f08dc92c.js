/*! For license information please see 3Dmol.ui-min.js.LICENSE.txt */ !function(e, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof exports ? exports["3Dmol.ui"] = n() : e["3Dmol.ui"] = n();
        ...
        var i;
        return i = t(692), $3Dmol.UI = function() {
            var e = {
                resn: {
                    type: "string",
                    valid: !0,
            ...
            return function(t, a, s) {
                ...
                function g(e, o = "left") {
                    ...
                    s.css("opacity", "0.9");
                    var p = i("<div></div>"), g1 = i("<div></div>"), v = new b(l.plus, 20, {
                    ...
                    this.selectionObjects = [], r.append(m.ui), r.append(p), r.css("position", "absolute"), u.append(s), p.append(u), g1.append(v.ui);
                    var y = new h;
                    p.append(y.ui), p.append(g1), y.ui.css("width", 162), "left" == o ? r.css("text-align", "left") : r.css("text-align", "right"), p.css("box-sizing", "border-box"), p.css("padding", "3px"), u.css("max-height", .8 * d), u.css("overflow-y", "auto"), u.css("overflow-x", "visible"), s.css("box-sizing", "content-box"), this.updateScrollBox = function(e) {
                ...
                function f(e, n = "left") {
                    ...
                    d.append(f1.ui), p.append(g.ui), d.append(p), "left" == n ? r.css("text-align", "left") : r.css("text-align", "right"), d.css("box-sizing", "border-box"), d.css("padding", "3px"), d.css("background-color", "#a4a4a4"), d.css("border-radius", "4px"), u.css("overflow", "hidden"), s.css("box-sizing", "content-box"), g.ui.on("click", ()=>{
                        if (c) f1.warning("Please complete editing the current form");
                        else {
                            var e = new v(a);
                            s.append(e.ui), c = !0;
                        }
                ...
                function v() {
                    ...
                    function p(e, n) {
                        ...
                        this.row.append(r, a, s, l), a.text(e), "number" == typeof n ? l.text(n.toFixed(2)) : l.text(n.replace(/\^/g, ""));
                    }
                    o.append(d);
                    var g = i("<div></div>");
                    o.append(g);
                    ...
                    function f() {
                        ...
                        O.ui.on("click", {}, function() {
                            if (I.getValue(), L.getValue(), y.getValue(), k.getValue(), H()) {
                                ...
                                } else k.getValue(), e.id = o.data("surf-id"), t.editSurface(e), f.hide();
            ...
            $3Dmol.StateManager = function(n, t) {
                ...
                this.addSelection = function(e, n = null) {
                    ...
                    n.removeSurface(s[e.id]), n.addSurface($3Dmol.SurfaceType[e.surfaceType.value], t, i.spec, o).then((n)=>{
                        s[e.id] = n[0];
                    });
...
//# sourceMappingURL=index.f08dc92c.js.map
